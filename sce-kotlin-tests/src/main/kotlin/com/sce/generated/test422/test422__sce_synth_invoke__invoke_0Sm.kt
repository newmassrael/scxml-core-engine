...
// Source: resources/422/test422__sce_synth_invoke__invoke_0.scxml
...
class Test422SceSynthInvokeInvoke0StateMachine(
...
) : StateMachineEngine<Test422SceSynthInvokeInvoke0State, Test422SceSynthInvokeInvoke0Event>(scriptEngine) {
    ...
    // SCE-MAP: test422__sce_synth_invoke__invoke_0.scxml:3
    override fun onEntry(state: Test422SceSynthInvokeInvoke0State) {
        when (state) {
