...
// Source: resources/241/test241__sce_synth_invoke__invoke_1.scxml
// Generator: SCE Kotlin Code Generator v1.0
// SCE-MAP: test241__sce_synth_invoke__invoke_1.scxml:3
...
class Test241SceSynthInvokeInvoke1StateMachine(
    ...
    private fun ensureScriptEngine() {
        ...
        engine.setupSystemVariables(sid, "test241__sce_synth_invoke__invoke_1")
        ...
        try {
            ...
            raiseInternal(Test241SceSynthInvokeInvoke1Event.Error.Execution)
        }
    ...
    // SCE-MAP: test241__sce_synth_invoke__invoke_1.scxml:3
    override fun onEntry(state: Test241SceSynthInvokeInvoke1State) {
        when (state) {
