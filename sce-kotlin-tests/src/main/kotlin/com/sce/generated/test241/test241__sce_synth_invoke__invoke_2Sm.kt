...
// Source: resources/241/test241__sce_synth_invoke__invoke_2.scxml
// Generator: SCE Kotlin Code Generator v1.0
// SCE-MAP: test241__sce_synth_invoke__invoke_2.scxml:3
...
class Test241SceSynthInvokeInvoke2StateMachine(
    ...
    private fun ensureScriptEngine() {
        ...
        engine.setupSystemVariables(sid, "test241__sce_synth_invoke__invoke_2")
        ...
        try {
            ...
            raiseInternal(Test241SceSynthInvokeInvoke2Event.Error.Execution)
        }
    ...
    // SCE-MAP: test241__sce_synth_invoke__invoke_2.scxml:3
    override fun onEntry(state: Test241SceSynthInvokeInvoke2State) {
        when (state) {
