...
) : StateMachineEngine<Test364State, Test364Event>(scriptEngine) {
    ...
    override fun onEntry(state: Test364State) {
        when (state) {
            ...
            scheduleSend("__send_0", 1000L, Test364Event.Timeout)
                ...
                activeStateIds.add("s11")
                activeStateIds.add("s11p1")
                activeStateIds.add("s11p11")
                onEntry(Test364State.S11p112)
                activeStateIds.add("s11p12")
            ...
            is Test364State.S2 -> {
                ...
                // W3C SCXML 3.6: Enter deep initial targets via ancestor path
                activeStateIds.add("s21")
                activeStateIds.add("s21p1")
                activeStateIds.add("s21p11")
                onEntry(Test364State.S21p112)
                activeStateIds.add("s21p12")
