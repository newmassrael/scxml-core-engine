...
class Test156StateMachine(
    ...
    private fun ensureScriptEngine() {
        ...
        engine.setupSystemVariables(sid, "test156")
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard("Var1 == 1") -> TransitionResult.External(Test156State.Pass)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test156State.Fail)
    }
    ...
    override fun onEntry(state: Test156State) {
        when (state) {
            ...
            executeAssign("Var5", "undefined.invalidProperty")
                    }
                } catch (e: Exception) {
                    raiseInternal(Test156Event.Error.Execution)
                }
