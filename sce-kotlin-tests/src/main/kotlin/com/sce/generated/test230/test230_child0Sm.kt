...
class Test230Child0StateMachine(
    ...
    override fun resolveState(stateId: String): Test230Child0State? = when (stateId) {
        "sub0" -> Test230Child0State.Sub0
        "subFinal" -> Test230Child0State.SubFinal
        else -> null
    }

    // W3C SCXML: Get state ID string from State object
    override fun stateIdOf(state: Test230Child0State): String = when (state) {
        is Test230Child0State.Sub0 -> "sub0"
        is Test230Child0State.SubFinal -> "subFinal"
    }
    ...
    override fun documentOrderOf(state: Test230Child0State): Int = when (state) {
        is Test230Child0State.Sub0 -> 0
        is Test230Child0State.SubFinal -> 1
    }
