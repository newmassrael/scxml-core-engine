...
class Test561StateMachine(
    ...
    private fun processS0(
        ...
        event is Test561Event.Foo && safeEvaluateGuard("_event.data.getElementsByTagName('book')[1].getAttribute('title') == 'title2'") -> TransitionResult.External(Test561State.Pass)
