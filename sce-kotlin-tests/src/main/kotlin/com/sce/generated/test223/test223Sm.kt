...
class Test223StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard("typeof Var1 !== 'undefined'") -> TransitionResult.External(Test223State.Pass)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test223State.Fail)
    }
    ...
    private fun processS0(
        ...
        else -> TransitionResult.External(Test223State.S1)
    }
    ...
    override fun onEntry(state: Test223State) {
        when (state) {
            ...
            scheduleSend("__send_0", 1000L, Test223Event.Timeout)
                ...
                startInvoke("_invoke_0", Test223Child0StateMachine(scriptEngine), false, Test223Event.Done.Invoke)
            }
            else -> {}
        }
    }
