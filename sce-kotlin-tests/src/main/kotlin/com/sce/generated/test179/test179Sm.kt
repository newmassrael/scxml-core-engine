...
class Test179StateMachine(
    ...
    private fun processS0(
        ...
        event is Test179Event.Event1 && safeEvaluateGuard("_event.data == 123") -> TransitionResult.External(Test179State.Pass)
        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test179State.Fail)
    }
    ...
    override fun onEntry(state: Test179State) {
        when (state) {
            ...
            is Test179State.S0 -> {
            send(Test179Event.Event1, EventMetadata.external(sendId = "__send_0", origin = scriptSessionId ?: ""))
            }
            else -> {}
        }
    }
