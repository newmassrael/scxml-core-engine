...
class Test205StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard("Var1 == 1") -> TransitionResult.External(Test205State.Pass)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test205State.Fail)
    }
    ...
    private fun processS0(
        ...
        event is Test205Event.Event1 -> TransitionResult.External(Test205State.S1)
    ...
    override fun onEntry(state: Test205State) {
        when (state) {
            ...
            run {
                ...
                try { paramsE["aParam"] = engineE.evaluateExpr(sidE, "1") } catch (_: Exception) {}
