...
// Source: resources/242/test242__sce_synth_invoke__invoke_1.scxml
...
class Test242SceSynthInvokeInvoke1StateMachine(
...
) : StateMachineEngine<Test242SceSynthInvokeInvoke1State, Test242SceSynthInvokeInvoke1Event>(scriptEngine) {
    ...
    // SCE-MAP: test242__sce_synth_invoke__invoke_1.scxml:3
    override fun onEntry(state: Test242SceSynthInvokeInvoke1State) {
        when (state) {
