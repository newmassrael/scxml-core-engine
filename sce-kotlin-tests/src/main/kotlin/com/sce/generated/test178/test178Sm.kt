...
class Test178StateMachine(
    ...
    private fun ensureScriptEngine() {
        ...
        engine.setupSystemVariables(sid, "test178")
    ...
    private fun processS0(
        ...
        event is Test178Event.Event1 -> TransitionResult.External(Test178State.Final)
        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test178State.Fail)
    }
    ...
    override fun onEntry(state: Test178State) {
        when (state) {
            ...
            run {
                ...
                try { paramsE["Var1"] = engineE.evaluateExpr(sidE, "2") } catch (_: Exception) {}
                try { paramsE["Var1"] = engineE.evaluateExpr(sidE, "3") } catch (_: Exception) {}
