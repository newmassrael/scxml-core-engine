...
bool ActionParser::isActionNode(const xmlpp::Element *element) const
{
    ...
    return matchNodeName(nodeName, "raise") ||
           ...
           matchNodeName(nodeName, "script") ||
           matchNodeName(nodeName, "log") ||
           matchNodeName(nodeName, "send") ||
           matchNodeName(nodeName, "cancel");
}
...
bool ActionParser::isSpecialExecutableContent(const xmlpp::Element *element) const
{
    ...
    return matchNodeName(nodeName, "if") ||
           matchNodeName(nodeName, "elseif") ||
