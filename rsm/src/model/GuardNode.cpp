...
RSM::GuardNode::GuardNode(const std::string &id, const std::string &target)
    ...
    Logger::debug("RSM::GuardNode::Constructor - Creating guard node: " + id + " -> " + target);
}
...
void RSM::GuardNode::setTargetState(const std::string &targetState) {
    ...
    Logger::debug("RSM::GuardNode::setTargetState() - Setting target state for " + id_ + ": " + targetState);
}
...
void RSM::GuardNode::setCondition(const std::string &condition) {
    ...
    Logger::debug("RSM::GuardNode::setCondition() - Setting condition for " + id_ + ": " + condition);
}
...
void RSM::GuardNode::addDependency(const std::string &property) {
    Logger::debug("RSM::GuardNode::addDependency() - Adding dependency for " + id_ + ": " + property);
...
void RSM::GuardNode::setExternalClass(const std::string &className) {
    Logger::debug("RSM::GuardNode::setExternalClass() - Setting external class for " + id_ + ": " + className);
...
void RSM::GuardNode::setExternalFactory(const std::string &factoryName) {
    Logger::debug("RSM::GuardNode::setExternalFactory() - Setting external factory for " + id_ + ": " + factoryName);
...
void RSM::GuardNode::setReactive(bool reactive) {
    Logger::debug("RSM::GuardNode::setReactive() - Setting reactive flag for " + id_ + ": " +
                  (reactive ? "true" : "false"));
    reactive_ = reactive;
}
