...
void RSM::StateNode::addEntryActionNode(std::shared_ptr<RSM::IActionNode> action) {
    if (action) {
        ...
        Logger::warn("RSM::StateNode::addEntryActionNode() - Attempt to add null action node to " + id_);
    }
}
...
void RSM::StateNode::addExitActionNode(std::shared_ptr<RSM::IActionNode> action) {
    if (action) {
        ...
        Logger::warn("RSM::StateNode::addExitActionNode() - Attempt to add null action node to " + id_);
    }
}
