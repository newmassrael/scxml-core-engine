...
const std::string &RSM::SCXMLContext::getBinding() const { return binding_; }

void RSM::SCXMLContext::addNamespace(const std::string &prefix,
                                     const std::string &uri) {
  namespaces_[prefix] = uri;
}

const std::string &
RSM::SCXMLContext::getNamespaceURI(const std::string &prefix) const {
...
void RSM::SCXMLContext::setAttribute(const std::string &name,
                                     const std::string &value) {
  attributes_[name] = value;
}

const std::string &
RSM::SCXMLContext::getAttribute(const std::string &name) const {
