...
const std::string &RSM::ActionNode::getId() const { return id_; }

void RSM::ActionNode::setExternalClass(const std::string &className) {
  Logger::debug(
      "RSM::ActionNode::setExternalClass() - Setting external class for " +
      id_ + ": " + className);
...
void RSM::ActionNode::setExternalFactory(const std::string &factoryName) {
  Logger::debug(
      "RSM::ActionNode::setExternalFactory() - Setting external factory for " +
      id_ + ": " + factoryName);
...
void RSM::ActionNode::setType(const std::string &type) {
  Logger::debug("RSM::ActionNode::setType() - Setting type for " + id_ + ": " +
                type);
  type_ = type;
}

const std::string &RSM::ActionNode::getType() const { return type_; }

void RSM::ActionNode::setAttribute(const std::string &name,
                                   const std::string &value) {
  Logger::debug("RSM::ActionNode::setAttribute() - Setting attribute for " +
                id_ + ": " + name + " = " + value);
  attributes_[name] = value;
}

const std::string &
RSM::ActionNode::getAttribute(const std::string &name) const {
...
RSM::ActionNode::getAttributes() const {
  return attributes_;
}
