...
private:
    ...
    SchedulerMode schedulerMode_ = SchedulerMode::AUTOMATIC;  // §scxml-3.13: Default to normal mode
...
public:
    ...
    /**
     * @brief Set scheduler mode for parent-child inheritance (§scxml-3.13)
     *
