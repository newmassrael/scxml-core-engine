...
//
// W3C SCXML 5.10.1: _event.origintype is bound to the SCXMLEventProcessor URI literal on every external pop — assign Var1=_event.origintype reads back the URI and the cond matches; same τ binding test336 covers (3922f9ab).
