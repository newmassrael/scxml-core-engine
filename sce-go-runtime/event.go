...
//
// Ports the Rust EventType enum from sce-rust-runtime/src/event.rs.
type EventType int
...
//
// Ports Rust EventMetadata from sce-rust-runtime/src/event.rs. Every event
...
//
// Ports the Rust EventWithMetadata<E> from sce-rust-runtime/src/event.rs. The
