...
// ── NL→IR Mapping Roadmap Item C1 (DL-7) cross-machine EventSchema
//    validation ──────────────────────────────────────────────────
//
...
/// `Quantity` / `LookupRef` etc. (every transitive struct would need
...
/// NL→IR Mapping Roadmap Item C1 (DL-7) — cross-machine EventSchema
/// consistency check. See module-level commentary above for the full
/// rejection-shape contract.
///
