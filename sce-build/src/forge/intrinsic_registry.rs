...
pub const BASELINE_SYMBOLS: &[Symbol] = &[
    ...
    atomic_load(
        "sce_atomic_load_acquire_u8",
        "(*const u8) -> u8",
        Acquire,
        U8,
    ),
    atomic_load(
        "sce_atomic_load_acquire_u16",
        "(*const u16) -> u16",
        Acquire,
        U16,
    ),
    ...
    atomic_load(
        "sce_atomic_load_acquire_u64",
        "(*const u64) -> u64",
        Acquire,
        U64,
    ),
    atomic_load(
        "sce_atomic_load_acquire_usize",
        "(*const usize) -> usize",
        Acquire,
        USize,
    ),
    atomic_load(
        "sce_atomic_load_relaxed_u8",
        "(*const u8) -> u8",
        Relaxed,
        U8,
    ),
    atomic_load(
        "sce_atomic_load_relaxed_u16",
        "(*const u16) -> u16",
        Relaxed,
        U16,
    ),
    ...
    atomic_load(
        "sce_atomic_load_relaxed_u64",
        "(*const u64) -> u64",
        Relaxed,
        U64,
    ),
    atomic_load(
        "sce_atomic_load_relaxed_usize",
        "(*const usize) -> usize",
        Relaxed,
        USize,
    ),
    ...
    atomic_store(
        "sce_atomic_store_release_u16",
        "(*mut u16, u16)",
        Release,
        U16,
    ),
    atomic_store(
        "sce_atomic_store_release_u32",
        "(*mut u32, u32)",
        Release,
        U32,
    ),
    atomic_store(
        "sce_atomic_store_release_u64",
        "(*mut u64, u64)",
        Release,
        U64,
    ),
    atomic_store(
        "sce_atomic_store_release_usize",
        "(*mut usize, usize)",
        Release,
        USize,
    ),
    ...
    atomic_store(
        "sce_atomic_store_relaxed_u16",
        "(*mut u16, u16)",
        Relaxed,
        U16,
    ),
    atomic_store(
        "sce_atomic_store_relaxed_u32",
        "(*mut u32, u32)",
        Relaxed,
        U32,
    ),
    atomic_store(
        "sce_atomic_store_relaxed_u64",
        "(*mut u64, u64)",
        Relaxed,
        U64,
    ),
    ...
    atomic_cas(
        "sce_atomic_cas_weak_acq_rel_u8",
        "(*mut u8, u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_acq_rel_u16",
        "(*mut u16, u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_acq_rel_u32",
        "(*mut u32, u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_acq_rel_u64",
        "(*mut u64, u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_acq_rel_usize",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_release_u8",
        "(*mut u8, u8, u8) -> u8",
        Release,
        U8,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_release_u16",
        "(*mut u16, u16, u16) -> u16",
        Release,
        U16,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_release_u32",
        "(*mut u32, u32, u32) -> u32",
        Release,
        U32,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_release_u64",
        "(*mut u64, u64, u64) -> u64",
        Release,
        U64,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_release_usize",
        "(*mut usize, usize, usize) -> usize",
        Release,
        USize,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_relaxed_u8",
        "(*mut u8, u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_relaxed_u16",
        "(*mut u16, u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_relaxed_u32",
        "(*mut u32, u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_relaxed_u64",
        "(*mut u64, u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_weak_relaxed_usize",
        "(*mut usize, usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-cas-weak",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_acq_rel_u8",
        "(*mut u8, u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_acq_rel_u16",
        "(*mut u16, u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_acq_rel_u32",
        "(*mut u32, u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_acq_rel_u64",
        "(*mut u64, u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_acq_rel_usize",
        "(*mut usize, usize, usize) -> usize",
        AcqRel,
        USize,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_release_u8",
        "(*mut u8, u8, u8) -> u8",
        Release,
        U8,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_release_u16",
        "(*mut u16, u16, u16) -> u16",
        Release,
        U16,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_release_u32",
        "(*mut u32, u32, u32) -> u32",
        Release,
        U32,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_release_u64",
        "(*mut u64, u64, u64) -> u64",
        Release,
        U64,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_release_usize",
        "(*mut usize, usize, usize) -> usize",
        Release,
        USize,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_relaxed_u8",
        "(*mut u8, u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_relaxed_u16",
        "(*mut u16, u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_relaxed_u32",
        "(*mut u32, u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_relaxed_u64",
        "(*mut u64, u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-cas-strong",
    ...
    atomic_cas(
        "sce_atomic_cas_strong_relaxed_usize",
        "(*mut usize, usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-cas-strong",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_acq_rel_u8",
        "(*mut u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_acq_rel_u16",
        "(*mut u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_acq_rel_u32",
        "(*mut u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_acq_rel_u64",
        "(*mut u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_acq_rel_usize",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_relaxed_u8",
        "(*mut u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_relaxed_u16",
        "(*mut u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_relaxed_u32",
        "(*mut u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_relaxed_u64",
        "(*mut u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_add_relaxed_usize",
        "(*mut usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-fetch-add",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_acq_rel_u8",
        "(*mut u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_acq_rel_u16",
        "(*mut u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_acq_rel_u32",
        "(*mut u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_acq_rel_u64",
        "(*mut u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_acq_rel_usize",
        "(*mut usize, usize) -> usize",
        AcqRel,
        USize,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_relaxed_u8",
        "(*mut u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_relaxed_u16",
        "(*mut u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_relaxed_u32",
        "(*mut u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_relaxed_u64",
        "(*mut u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_sub_relaxed_usize",
        "(*mut usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-fetch-sub",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_acq_rel_u8",
        "(*mut u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_acq_rel_u16",
        "(*mut u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_acq_rel_u32",
        "(*mut u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_acq_rel_u64",
        "(*mut u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_acq_rel_usize",
        "(*mut usize, usize) -> usize",
        AcqRel,
        USize,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_relaxed_u8",
        "(*mut u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_relaxed_u16",
        "(*mut u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_relaxed_u32",
        "(*mut u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_relaxed_u64",
        "(*mut u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_or_relaxed_usize",
        "(*mut usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-fetch-or",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_acq_rel_u8",
        "(*mut u8, u8) -> u8",
        AcqRel,
        U8,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_acq_rel_u16",
        "(*mut u16, u16) -> u16",
        AcqRel,
        U16,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_acq_rel_u32",
        "(*mut u32, u32) -> u32",
        AcqRel,
        U32,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_acq_rel_u64",
        "(*mut u64, u64) -> u64",
        AcqRel,
        U64,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_acq_rel_usize",
        "(*mut usize, usize) -> usize",
        AcqRel,
        USize,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_relaxed_u8",
        "(*mut u8, u8) -> u8",
        Relaxed,
        U8,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_relaxed_u16",
        "(*mut u16, u16) -> u16",
        Relaxed,
        U16,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_relaxed_u32",
        "(*mut u32, u32) -> u32",
        Relaxed,
        U32,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_relaxed_u64",
        "(*mut u64, u64) -> u64",
        Relaxed,
        U64,
        "atomic-fetch-and",
    ...
    atomic_fetch(
        "sce_atomic_fetch_and_relaxed_usize",
        "(*mut usize, usize) -> usize",
        Relaxed,
        USize,
        "atomic-fetch-and",
    ...
    fence(
        "sce_atomic_fence_release",
        "()",
        Some(Release),
        "atomic-fence",
    ),
    fence(
        "sce_atomic_fence_acq_rel",
        "()",
        Some(AcqRel),
        "atomic-fence",
    ),
...
mod tests {
    ...
    fn lookup_symbol_finds_baseline_entries() {
        ...
        assert!(
            lookup_symbol("sce_atomic_load").is_none(),
            "base-name without suffix must not resolve"
        );
