...
TEST(DebugTest, ComplexExpressions) {
    ...
    auto complexResult = engine
                             .evaluateExpression(sessionId, "_name.length > 0 && typeof _sessionid === "
    ...
    auto objectResult = engine.executeScript(sessionId, "var obj = {a: 1, b: {c: 2}}; obj.b.c + obj.a").get();
