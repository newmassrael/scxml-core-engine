...
package com.sce.generated.codec_zenoh_reply
...
// `CodecZenohReply()` before any encode()/decode() call. Each default
...
data class CodecZenohReply(
    ...
    fun encode(w: SceSink): CodecError? {
        ...
        this.body.encode(w)?.let { return it }
        return null
    }
    ...
    companion object {
        ...
        fun decode(cursor: SceCursor): CodecZenohReply? {
            ...
            val body = CodecZenohPushBody.decode(cursor) ?: return null
