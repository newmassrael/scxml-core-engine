...
pub struct CodecInitCookieBodyOwned {
    pub version: u8,
    pub cookie_size: Option<u16>,
    pub cookie: Option<::sce_forge_runtime::codec::SceBytes<64>>,
}

impl<'a> CodecInitCookieBody<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecInitCookieBodyOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecInitCookieBodyOwned, CodecError> {
        Ok(CodecInitCookieBodyOwned {
            ...
            cookie: self.cookie.map(::sce_forge_runtime::codec::sce_bytes_from_slice::<64>).transpose()?,
        })
    }
}

impl CodecInitCookieBodyOwned {
