...
#[allow(dead_code)]
#[derive(Default)]
pub struct CodecZenohSourceInfoExt {
    pub ext_size: u64,
    pub info: CodecZenohSourceInfo,
}

#[allow(dead_code)]
impl CodecZenohSourceInfoExt {
    ...
    pub fn encode(&self) -> Vec<u8> {
        ...
        // struct prefix.
        let mut r: Vec<u8> = Vec::with_capacity(266);
        {
            let mut _w = self.ext_size as u64;
            while _w >= 0x80 {
