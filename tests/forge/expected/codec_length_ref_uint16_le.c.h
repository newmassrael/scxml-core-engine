...
typedef struct {
    uint8_t bytes[CODEC_LENGTH_REF_UINT16_LE_MAX_BYTES];
    size_t  len;
} codec_length_ref_uint16_le_encoded_t;
...
static inline codec_length_ref_uint16_le_encoded_t codec_length_ref_uint16_le_encode(const codec_length_ref_uint16_le_t *self) {
    codec_length_ref_uint16_le_encoded_t r;
    r.len = CODEC_LENGTH_REF_UINT16_LE_MIN_BYTES;
