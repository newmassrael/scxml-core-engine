#![doc = "SCE-MAP: codec_present_if_negation:12 :: _forge_body"]
...
pub struct CodecPresentIfNegation {
    pub flags: u8,
    pub seq: Option<u16>,
}

#[allow(dead_code)]
impl CodecPresentIfNegation {
    ...
    pub fn absent_seq(&self) -> bool {
        (self.flags & 0x01) != 0
    }

    pub fn set_absent_seq(&mut self, v: bool) {
        if v {
            self.flags |= 0x01;
        } else {
            self.flags &= !0x01;
