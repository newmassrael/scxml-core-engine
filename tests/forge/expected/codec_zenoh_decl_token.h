...
namespace SCE::Generated::CodecZenohDeclToken {

struct CodecZenohDeclToken {
    uint32_t id;
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohDeclToken> decode(::SCE::Forge::SceCursor& cursor, std::uint8_t parent_flags) {
