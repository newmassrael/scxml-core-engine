...
impl<'a> CodecZenohFrame<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 65546;
...
pub struct CodecZenohFrameOwned {
    pub sn: u64,
    pub payload: ::sce_forge_runtime::codec::SceBytes<65536>,
}

impl<'a> CodecZenohFrame<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecZenohFrameOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecZenohFrameOwned, CodecError> {
        Ok(CodecZenohFrameOwned {
            sn: self.sn,
            payload: ::sce_forge_runtime::codec::sce_bytes_from_slice::<65536>(self.payload)?,
        })
    }
}

impl CodecZenohFrameOwned {
