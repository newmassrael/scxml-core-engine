...
package com.sce.generated.codec_zenoh_ext_envelope
...
// `CodecZenohExtEnvelope()` before any encode()/decode() call. Each default
...
data class CodecZenohExtEnvelope(
    var header_flags: UByte = 0.toUByte(),
    var extensions: MutableList<CodecZenohExtEntry> = mutableListOf()
) {
    ...
    companion object {
        ...
        fun decode(cursor: SceCursor): CodecZenohExtEnvelope? {
