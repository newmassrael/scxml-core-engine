...
impl<'a> CodecZenohLocator<'a> {
    ...
    /// [`CodecZenohLocatorOwned`] (alloc). Call at a decode boundary when
    ...
    /// `feature = "alloc"`.
    pub fn into_owned(self) -> CodecZenohLocatorOwned {
        CodecZenohLocatorOwned {
            locator_len: self.locator_len,
            locator: alloc::string::String::from(self.locator),
        }
    }
}
