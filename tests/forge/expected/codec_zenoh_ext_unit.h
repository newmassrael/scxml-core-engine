...
namespace SCE::Generated::CodecZenohExtUnit {

struct CodecZenohExtUnit {
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohExtUnit> decode(::SCE::Forge::SceCursor& cursor) {
        // RFC §5.B empty body — zero-byte payload, no cursor work.
        (void)cursor;
        return CodecZenohExtUnit{};
    }
    ...
    static constexpr std::size_t MAX_ENCODED_BYTES = 0;
