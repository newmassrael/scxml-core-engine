...
impl<'a> CodecZenohInitBody<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 160;
...
pub struct CodecZenohInitBodyOwned {
    pub version: u8,
    pub cbyte: u8,
...
impl<'a> CodecZenohInitBody<'a> {
    ...
    /// [`CodecZenohInitBodyOwned`]. Call at a decode boundary when the
