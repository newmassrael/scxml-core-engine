...
@dataclass
class CodecNestedBody:
    n: int = 0
    locs: List[CodecZenohLocator] = field(default_factory=list)

    @classmethod
    def decode(cls, cursor: SceCursor) -> Optional[CodecNestedBody]:
