#![doc = "SCE-MAP: codec_zenoh_msg_del:53 :: _forge_body"]
// SCE-MAP: codec_zenoh_msg_del:53 :: _forge_body
...
// build-configuration time: `CodecZenohMsgDelOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecZenohMsgDelOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecZenohMsgDelOwned` alone is the build's
...
// `let v: CodecZenohMsgDelOwned = CodecZenohMsgDelOwned { .. };`
...
#[allow(dead_code)]
#[derive(Debug, Clone, PartialEq)]
pub struct CodecZenohMsgDelOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub header: u8,
...
#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecZenohMsgDelOwned<S> {
...
impl<'a> CodecZenohMsgDel<'a> {
    ...
    /// [`CodecZenohMsgDelOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecZenohMsgDelOwned<S>, CodecError> {
...
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecZenohMsgDelOwned<S> {
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecZenohMsgDelOwned<D>, CodecError> {
