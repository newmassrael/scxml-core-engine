...
impl<'a> CodecZenohResponseFinal<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 183;
...
#[cfg(feature = "alloc")]
#[derive(Debug, Clone, PartialEq)]
pub struct CodecZenohResponseFinalOwned {
    pub header: u8,
    pub request_id: u64,
...
#[cfg(feature = "alloc")]
#[allow(dead_code)]
impl CodecZenohResponseFinalOwned {
...
impl<'a> CodecZenohResponseFinal<'a> {
    ...
    /// [`CodecZenohResponseFinalOwned`]. Call at a decode boundary when the
