...
impl<'a> CodecZenohDeclQueryable<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 274;
...
pub struct CodecZenohDeclQueryableOwned {
    pub id: u32,
    pub wireexpr: CodecZenohWireexprOwned,
    pub ext_type: Option<u8>,
    pub ext_value: Option<u64>,
}
...
impl<'a> CodecZenohDeclQueryable<'a> {
    ...
    /// [`CodecZenohDeclQueryableOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecZenohDeclQueryableOwned, CodecError> {
        Ok(CodecZenohDeclQueryableOwned {
            id: self.id,
            wireexpr: self.wireexpr.try_into_owned()?,
...
#[cfg(feature = "alloc")]
impl CodecZenohDeclQueryableOwned {
