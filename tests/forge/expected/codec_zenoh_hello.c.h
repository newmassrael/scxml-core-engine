// SCE-MAP: codec_zenoh_hello:41 :: _forge_body
...
typedef struct {
    ...
    /* RFC §synth-5-B B2 repeat: fixed array of codec_zenoh_locator_t elements (max 64) */
...
static inline sce_forge_codec_status_t codec_zenoh_hello_encode(const codec_zenoh_hello_t *self, sce_forge_writer_t *w, uint8_t l) {
    ...
    if ((l & 0x01) != 0) {
    SCE_FORGE_TRY_WRITE(sce_forge_writer_write_vle_u64(w, (uint64_t)(self->num_locators)));
    }
    if ((l & 0x01) != 0) {
