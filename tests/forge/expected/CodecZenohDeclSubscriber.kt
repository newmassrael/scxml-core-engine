...
package com.sce.generated.codec_zenoh_decl_subscriber
...
// `CodecZenohDeclSubscriber()` before any encode()/decode() call. Defaults
// mirror the zero-initialized shape that decode() fills in on success.
data class CodecZenohDeclSubscriber(
    var id: UInt = 0u,
    ...
    companion object {
        ...
        /// (RFC §5.B L494-519).
        @Suppress("UNUSED_PARAMETER")
        fun decode(cursor: SceCursor, parentFlags: UByte): CodecZenohDeclSubscriber? {
