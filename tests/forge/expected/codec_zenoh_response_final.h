...
struct CodecZenohResponseFinal {
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohResponseFinal> decode(::SCE::Forge::SceCursor& cursor) {
    ...
    static constexpr std::size_t MAX_ENCODED_BYTES = 178;
    ...
    [[nodiscard]] std::optional<::SCE::Forge::CodecError> encode(::SCE::Forge::SceSink& w) const noexcept {
        ...
        if (auto _e = w.write_vle_u64(static_cast<std::uint64_t>(request_id)); _e) return _e;
