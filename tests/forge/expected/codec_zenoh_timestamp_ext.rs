...
pub struct CodecZenohTimestampExtOwned {
    pub ext_size: u64,
    pub ts: CodecZenohTimestampOwned,
}

#[cfg(feature = "alloc")]
impl<'a> CodecZenohTimestampExt<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecZenohTimestampExtOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecZenohTimestampExtOwned, CodecError> {
        Ok(CodecZenohTimestampExtOwned {
            ...
            ts: self.ts.try_into_owned()?,
        })
    }
}

#[cfg(feature = "alloc")]
impl CodecZenohTimestampExtOwned {
