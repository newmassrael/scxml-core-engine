...
impl<'a> CodecZenohExtEnvelope<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 345;
...
pub struct CodecZenohExtEnvelopeOwned {
    pub header_flags: u8,
    pub extensions: Vec<CodecZenohExtEntryOwned>,
}

#[cfg(feature = "alloc")]
impl<'a> CodecZenohExtEnvelope<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecZenohExtEnvelopeOwned`]. Call at a decode boundary when the
...
#[cfg(feature = "alloc")]
impl CodecZenohExtEnvelopeOwned {
