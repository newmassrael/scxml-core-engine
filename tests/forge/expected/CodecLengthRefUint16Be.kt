...
package com.sce.generated.codec_length_ref_uint16_be
...
// `CodecLengthRefUint16Be()` before any encode()/decode() call. Each default
...
data class CodecLengthRefUint16Be(
    ...
    companion object {
        ...
        fun decode(cursor: SceCursor): CodecLengthRefUint16Be? {
            ...
            val payload_len = (((raw[0].toInt() and 0xFF) shl 8) or (raw[1].toInt() and 0xFF)).toUShort()
