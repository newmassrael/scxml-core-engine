...
namespace SCE::Generated::CodecZenohDeclKeyexpr {

struct CodecZenohDeclKeyexpr {
    uint16_t id;
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohDeclKeyexpr> decode(::SCE::Forge::SceCursor& cursor, std::uint8_t parent_flags) {
