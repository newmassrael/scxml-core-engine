...
namespace SCE::Generated::CodecZenohExtZint {

struct CodecZenohExtZint {
    uint64_t value;
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohExtZint> decode(::SCE::Forge::SceCursor& cursor) {
    ...
    static constexpr std::size_t MAX_ENCODED_BYTES = 9;
    ...
    [[nodiscard]] std::optional<::SCE::Forge::CodecError> encode(::SCE::Forge::SceSink& w) const noexcept {
        ...
        if (auto _e = w.write_vle_u64(static_cast<std::uint64_t>(value)); _e) return _e;
        return std::nullopt;
    }
