...
static inline sce_forge_codec_status_t codec_zenoh_decl_subscriber_decode(sce_forge_cursor_t *cursor, codec_zenoh_decl_subscriber_t *out, uint8_t parent_flags) {
...
static inline codec_zenoh_decl_subscriber_encoded_t codec_zenoh_decl_subscriber_encode(const codec_zenoh_decl_subscriber_t *self, uint8_t parent_flags) {
