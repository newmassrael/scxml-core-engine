#![doc = "SCE-MAP: codec_zenoh_undecl_subscriber:46 :: _forge_body"]
...
// build-configuration time: `CodecZenohUndeclSubscriberOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecZenohUndeclSubscriberOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecZenohUndeclSubscriberOwned` alone is the build's
...
// `let v: CodecZenohUndeclSubscriberOwned = CodecZenohUndeclSubscriberOwned { .. };`
...
pub struct CodecZenohUndeclSubscriberOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub id: u32,
...
impl<'a> CodecZenohUndeclSubscriber<'a> {
    ...
    /// [`CodecZenohUndeclSubscriberOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecZenohUndeclSubscriberOwned<S>, CodecError> {
...
#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecZenohUndeclSubscriberOwned<S> {
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecZenohUndeclSubscriberOwned<D>, CodecError> {
