...
impl<'a> CodecZenohUndeclSubscriber<'a> {
    ...
    /// [`CodecZenohUndeclSubscriberOwned`] (alloc). Call at a decode boundary when
    ...
    /// `feature = "alloc"`.
    pub fn into_owned(self) -> CodecZenohUndeclSubscriberOwned {
        CodecZenohUndeclSubscriberOwned {
            id: self.id,
