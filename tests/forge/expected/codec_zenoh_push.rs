#![doc = "SCE-MAP: codec_zenoh_push:45 :: _forge_body"]
// SCE-MAP: codec_zenoh_push:45 :: _forge_body
...
impl Default for CodecZenohPush {
    fn default() -> Self {
        Self {
            header: 0x1du8,
            body: CodecZenohPushVariant::default(),
        }
    }
}
...
impl CodecZenohPush {
    ...
    pub fn encode<S: SceSink>(&self, w: &mut S) -> Result<(), CodecError> {
        ...
        match &self.body {
            CodecZenohPushVariant::CodecZenohPushBody(b) => {
                b.encode(w)?;
            }
            CodecZenohPushVariant::Default { body, .. } => {
                body.encode(w)?;
            }
        }
        Ok(())
