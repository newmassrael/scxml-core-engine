...
pub struct CodecPresentIfTailOwned {
    pub flags: u8,
    pub payload: Option<::sce_forge_runtime::heapless::Vec<u8, 64>>,
}

#[allow(dead_code)]
impl CodecPresentIfTailOwned {
...
impl<'a> CodecPresentIfTail<'a> {
    ...
    /// [`CodecPresentIfTailOwned`]. Call at a decode boundary when the
