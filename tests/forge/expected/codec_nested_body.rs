#![doc = "SCE-MAP: codec_nested_body:18 :: _forge_body"]
// SCE-MAP: codec_nested_body:18 :: _forge_body
...
// build-configuration time: `CodecNestedBodyOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecNestedBodyOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecNestedBodyOwned` alone is the build's
...
// `let v: CodecNestedBodyOwned = CodecNestedBodyOwned { .. };`
...
pub struct CodecNestedBodyOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub n: u8,
    pub locs: S::List<CodecZenohLocatorOwned<S>, 4>,
}

#[allow(dead_code)]
impl<'a> CodecNestedBody<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecNestedBodyOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecNestedBodyOwned<S>, CodecError> {
        Ok(CodecNestedBodyOwned {
            n: self.n,
            locs: ::sce_forge_runtime::codec::try_collect_list(self.locs, |_e| _e.try_into_owned_in::<S>())?,
        })
    }
...
#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecNestedBodyOwned<S> {
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecNestedBodyOwned<D>, CodecError> {
