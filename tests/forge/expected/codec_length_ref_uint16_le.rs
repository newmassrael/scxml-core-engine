...
pub struct CodecLengthRefUint16LeOwned {
    pub payload_len: u16,
    pub payload: ::sce_forge_runtime::codec::SceBytes<1024>,
}

impl<'a> CodecLengthRefUint16Le<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`CodecLengthRefUint16LeOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecLengthRefUint16LeOwned, CodecError> {
        Ok(CodecLengthRefUint16LeOwned {
            ...
            payload: ::sce_forge_runtime::codec::sce_bytes_from_slice::<1024>(self.payload)?,
        })
    }
}

impl CodecLengthRefUint16LeOwned {
