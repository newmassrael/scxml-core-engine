...
#[allow(dead_code)]
#[derive(Default)]
pub struct CodecExtEncodingInfo {
    pub combined_id: u32,
    pub schema_size: u8,
...
impl CodecExtEncodingInfo {
    ...
    pub fn encode(&self) -> Vec<u8> {
        ...
        // unified encode path.
        let mut r: Vec<u8> = Vec::with_capacity(71);
        {
            let mut _w = self.combined_id as u64;
            while _w >= 0x80 {
