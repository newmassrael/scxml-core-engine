...
package com.sce.generated.codec_present_if_negation
...
// `CodecPresentIfNegation()` before any encode()/decode() call. Each default
...
data class CodecPresentIfNegation(
    ...
    fun absentSeq(): Boolean = (this.flags.toInt() and 0x01) != 0

    fun setAbsentSeq(v: Boolean) {
        this.flags = if (v) {
    ...
    companion object {
        ...
        fun decode(cursor: SceCursor): CodecPresentIfNegation? {
