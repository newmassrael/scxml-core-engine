...
pub struct CodecZenohTimestampOwned {
    pub time: u64,
    pub zid_len: u64,
    pub zid: Vec<u8>,
}
...
impl<'a> CodecZenohTimestamp<'a> {
    ...
    /// [`CodecZenohTimestampOwned`] (alloc). Call at a decode boundary when
    ...
    /// `feature = "alloc"`.
    pub fn into_owned(self) -> CodecZenohTimestampOwned {
        CodecZenohTimestampOwned {
            time: self.time,
