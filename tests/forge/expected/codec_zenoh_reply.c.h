...
typedef struct {
    uint8_t bytes[CODEC_ZENOH_REPLY_MAX_BYTES];
    size_t  len;
} codec_zenoh_reply_encoded_t;
...
static inline codec_zenoh_reply_encoded_t codec_zenoh_reply_encode(const codec_zenoh_reply_t *self) {
    codec_zenoh_reply_encoded_t r;
