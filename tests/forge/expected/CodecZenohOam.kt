...
data class CodecZenohOam(
    ...
    fun encode(): ByteArray {
        ...
        when (val _b = this.body) {
            is CodecZenohOamVariant.CodecZenohExtUnit -> r.addAll(_b.body.encode().toList())
            is CodecZenohOamVariant.CodecZenohExtZint -> r.addAll(_b.body.encode().toList())
            is CodecZenohOamVariant.CodecZenohExtZbuf -> r.addAll(_b.body.encode().toList())
            is CodecZenohOamVariant.Default -> r.addAll(_b.body.encode().toList())
        }
