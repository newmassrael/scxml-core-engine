...
@dataclass
class CodecFixedAfterLengthref:
    header: int = 0
    payload_len: int = 0
    payload: bytes = b""
    crc32: int = 0
    ...
    @classmethod
    def decode(cls, cursor: SceCursor) -> Optional[CodecFixedAfterLengthref]:
    ...
    def encode(self, w: SceSink) -> None:
        ...
        w.write_u8(self.payload_len & 0xFF)
        w.write_u8((self.payload_len >> 8) & 0xFF)
        w.write_bytes(self.payload)
        w.write_u8(self.crc32 & 0xFF)
        w.write_u8((self.crc32 >> 8) & 0xFF)
        w.write_u8((self.crc32 >> 16) & 0xFF)
        w.write_u8((self.crc32 >> 24) & 0xFF)
