...
data class CodecTransportEnvelope(
    ...
    fun encode(): ByteArray {
        ...
        when (val _b = this.body) {
            is CodecTransportEnvelopeVariant.CodecZenohInitBody -> r.addAll(_b.body.encode((((this.header.toInt() shr 6) and 0x1).toUByte()), (((this.header.toInt() shr 5) and 0x1).toUByte())).toList())
            is CodecTransportEnvelopeVariant.CodecZenohOpenBody -> r.addAll(_b.body.encode((((this.header.toInt() shr 5) and 0x1).toUByte())).toList())
            ...
            is CodecTransportEnvelopeVariant.CodecZenohJoin -> r.addAll(_b.body.encode((((this.header.toInt() shr 6) and 0x1).toUByte())).toList())
