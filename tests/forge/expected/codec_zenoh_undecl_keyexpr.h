...
#pragma once
#ifndef SCE_FORGE_CODEC_ZENOH_UNDECL_KEYEXPR_H
#define SCE_FORGE_CODEC_ZENOH_UNDECL_KEYEXPR_H
...
namespace SCE::Generated::CodecZenohUndeclKeyexpr {

struct CodecZenohUndeclKeyexpr {
    uint16_t id;
    ...
    /// `cursor.last_error()`.
    static std::optional<CodecZenohUndeclKeyexpr> decode(::SCE::Forge::SceCursor& cursor) {
...
#endif  // SCE_FORGE_CODEC_ZENOH_UNDECL_KEYEXPR_H
