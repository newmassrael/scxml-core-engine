#![doc = "SCE-MAP: codec_zenoh_ext_zint:11"]
...
#[allow(dead_code)]
#[derive(Default)]
pub struct CodecZenohExtZint {
    pub value: u64,
}

#[allow(dead_code)]
impl CodecZenohExtZint {
    ...
    pub fn encode(&self) -> Vec<u8> {
        ...
        // struct prefix.
        let mut r: Vec<u8> = Vec::with_capacity(10);
        {
            let mut _w = self.value as u64;
            while _w >= 0x80 {
