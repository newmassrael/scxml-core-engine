...
typedef struct {
    uint8_t bytes[CODEC_ZENOH_ERR_MAX_BYTES];
    size_t  len;
} codec_zenoh_err_encoded_t;
...
static inline codec_zenoh_err_encoded_t codec_zenoh_err_encode(const codec_zenoh_err_t *self) {
    codec_zenoh_err_encoded_t r;
