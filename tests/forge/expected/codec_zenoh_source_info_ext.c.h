...
typedef struct {
    uint8_t bytes[CODEC_ZENOH_SOURCE_INFO_EXT_MAX_BYTES];
    size_t  len;
} codec_zenoh_source_info_ext_encoded_t;
...
static inline codec_zenoh_source_info_ext_encoded_t codec_zenoh_source_info_ext_encode(const codec_zenoh_source_info_ext_t *self) {
    codec_zenoh_source_info_ext_encoded_t r;
    ...
    {
        codec_zenoh_source_info_encoded_t _sub = codec_zenoh_source_info_encode(&self->info);
