 ...
 * trait — round-trip safety (`codec_zenoh_msg_reply_t x = CODEC_ZENOH_MSG_REPLY_DEFAULT_INIT;
 * codec_zenoh_msg_reply_t_encode(&x)` decodes back to the same arm)
...
#define CODEC_ZENOH_MSG_REPLY_DEFAULT_INIT { \
    .header = 0x04u, \
}
