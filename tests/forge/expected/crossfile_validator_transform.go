...
// NewCrossfileValidatorTransform returns an initialized validator. Stateful imports
...
func NewCrossfileValidatorTransform() *CrossfileValidatorTransform {
	return &CrossfileValidatorTransform{
	}
}
