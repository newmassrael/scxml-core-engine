...
package com.sce.generated.codec_zenoh_response_final
...
// `CodecZenohResponseFinal()` before any encode()/decode() call. Each default
...
data class CodecZenohResponseFinal(
    ...
    companion object {
        ...
        fun decode(cursor: SceCursor): CodecZenohResponseFinal? {
