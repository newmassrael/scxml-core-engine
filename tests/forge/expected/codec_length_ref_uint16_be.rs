...
pub struct CodecLengthRefUint16Be<'a> {
    pub payload_len: u16,
    pub payload: &'a [u8],
}

#[allow(dead_code)]
impl<'a> CodecLengthRefUint16Be<'a> {
...
// `CodecLengthRefUint16Be<'a>` above is a zero-copy view borrowing the decode
...
// `CodecLengthRefUint16BeOwned`. The rkyv-style Archived(borrowed) ↔ native
...
// build-configuration time: `CodecLengthRefUint16BeOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecLengthRefUint16BeOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecLengthRefUint16BeOwned` alone is the build's
...
// `let v: CodecLengthRefUint16BeOwned = CodecLengthRefUint16BeOwned { .. };`
...
pub struct CodecLengthRefUint16BeOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub payload_len: u16,
...
impl<'a> CodecLengthRefUint16Be<'a> {
    ...
    /// [`CodecLengthRefUint16BeOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecLengthRefUint16BeOwned<S>, CodecError> {
        Ok(CodecLengthRefUint16BeOwned {
    ...
    pub fn try_into_owned(self) -> Result<CodecLengthRefUint16BeOwned, CodecError> {
        self.try_into_owned_in()
    }
}

#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecLengthRefUint16BeOwned<S> {
    ...
    pub fn as_borrowed(&self) -> CodecLengthRefUint16Be<'_> {
        CodecLengthRefUint16Be {
            payload_len: self.payload_len,
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecLengthRefUint16BeOwned<D>, CodecError> {
