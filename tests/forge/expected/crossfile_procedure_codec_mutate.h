...
namespace SCE::Generated::CrossfileProcedureCodecMutate {
...
class CrossfileProcedureCodecMutate {
public:
    using State = ::SCE::Generated::CrossfileProcedureCodecMutate::State;
    using Event = ::SCE::Generated::CrossfileProcedureCodecMutate::Event;

    CrossfileProcedureCodecMutate() = default;
    ...
    processTransition(State state, Event event) const {
        switch (state) {
            case State::Init:
                ...
                if (event == Event::NONE) {
                    return std::make_tuple(State::Send, std::size_t{ 0 }, true);
                }
                return std::nullopt;
            case State::Send:
...
inline SCE::Forge::ProcedureRunResult execute(
    ...
    uint8_t msgId) {
    CrossfileProcedureCodecMutate sm;
