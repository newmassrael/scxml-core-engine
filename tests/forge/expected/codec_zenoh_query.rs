...
#[cfg(feature = "alloc")]
#[derive(Debug, Clone, PartialEq)]
pub struct CodecZenohQueryOwned {
    pub header: u8,
    pub consolidation: Option<u8>,
    pub parameters_len: Option<u64>,
    pub parameters: Option<::sce_forge_runtime::heapless::Vec<u8, 256>>,
    pub extensions: Option<Vec<CodecZenohExtEntryOwned>>,
}

#[cfg(feature = "alloc")]
#[allow(dead_code)]
impl CodecZenohQueryOwned {
...
impl<'a> CodecZenohQuery<'a> {
    ...
    /// [`CodecZenohQueryOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecZenohQueryOwned, CodecError> {
        Ok(CodecZenohQueryOwned {
            ...
            parameters: self.parameters.map(|_v| ::sce_forge_runtime::heapless::Vec::from_slice(_v).map_err(|_| CodecError::TooManyElements)).transpose()?,
