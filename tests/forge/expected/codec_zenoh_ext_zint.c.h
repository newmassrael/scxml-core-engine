...
#define CODEC_ZENOH_EXT_ZINT_MAX_BYTES 10
...
typedef struct {
    uint8_t bytes[CODEC_ZENOH_EXT_ZINT_MAX_BYTES];
    size_t  len;
} codec_zenoh_ext_zint_encoded_t;
...
static inline codec_zenoh_ext_zint_encoded_t codec_zenoh_ext_zint_encode(const codec_zenoh_ext_zint_t *self) {
    codec_zenoh_ext_zint_encoded_t r;
