...
impl<'a> CodecTransportEnvelopeVariant<'a> {
    ...
    pub fn try_into_owned(self) -> Result<CodecTransportEnvelopeOwnedVariant, CodecError> {
        Ok(match self {
            CodecTransportEnvelopeVariant::CodecZenohInitBody(_b) => CodecTransportEnvelopeOwnedVariant::CodecZenohInitBody(_b.try_into_owned()?),
            CodecTransportEnvelopeVariant::CodecZenohOpenBody(_b) => CodecTransportEnvelopeOwnedVariant::CodecZenohOpenBody(_b.try_into_owned()?),
            ...
            CodecTransportEnvelopeVariant::CodecZenohFrame(_b) => CodecTransportEnvelopeOwnedVariant::CodecZenohFrame(_b.try_into_owned()?),
            CodecTransportEnvelopeVariant::CodecZenohFragment(_b) => CodecTransportEnvelopeOwnedVariant::CodecZenohFragment(_b.try_into_owned()?),
            CodecTransportEnvelopeVariant::CodecZenohJoin(_b) => CodecTransportEnvelopeOwnedVariant::CodecZenohJoin(_b.try_into_owned()?),
...
impl<'a> CodecTransportEnvelope<'a> {
    ...
    /// [`CodecTransportEnvelopeOwned`]. Call at a decode boundary when the
