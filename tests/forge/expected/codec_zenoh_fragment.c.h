...
#define CODEC_ZENOH_FRAGMENT_MAX_BYTES 65546
...
typedef struct {
    uint8_t bytes[CODEC_ZENOH_FRAGMENT_MAX_BYTES];
    size_t  len;
} codec_zenoh_fragment_encoded_t;
...
static inline codec_zenoh_fragment_encoded_t codec_zenoh_fragment_encode(const codec_zenoh_fragment_t *self) {
    codec_zenoh_fragment_encoded_t r;
