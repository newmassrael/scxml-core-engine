#![doc = "SCE-MAP: codec_scout_zid_body:35 :: _forge_body"]
// SCE-MAP: codec_scout_zid_body:35 :: _forge_body
...
pub struct CodecScoutZidBody<'a> {
    pub zid_len_m1: u8,
    pub zid: &'a [u8],
}
...
impl<'a> CodecScoutZidBody<'a> {
    ...
    pub fn decode(cursor: &mut SceCursor<'a>) -> Result<Self, CodecError> {
        ...
        let zid = &raw[1..1 + zid_len_m1 as usize + 1];
        let value = Self {
            zid_len_m1,
            zid,
        };
    ...
    pub const MAX_ENCODED_BYTES: usize = 17;
...
// build-configuration time: `CodecScoutZidBodyOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecScoutZidBodyOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecScoutZidBodyOwned` alone is the build's
...
// `let v: CodecScoutZidBodyOwned = CodecScoutZidBodyOwned { .. };`
...
pub struct CodecScoutZidBodyOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub zid_len_m1: u8,
    pub zid: S::Bytes<16>,
}
...
impl<'a> CodecScoutZidBody<'a> {
    ...
    /// [`CodecScoutZidBodyOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecScoutZidBodyOwned<S>, CodecError> {
...
#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecScoutZidBodyOwned<S> {
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecScoutZidBodyOwned<D>, CodecError> {
