#![doc = "SCE-MAP: codec_zenoh_ext_zbuf:17 :: _forge_body"]
...
pub struct CodecZenohExtZbuf<'a> {
    pub value_len: u64,
    pub value: &'a [u8],
}

#[allow(dead_code)]
impl<'a> CodecZenohExtZbuf<'a> {
...
// `CodecZenohExtZbuf<'a>` above is a zero-copy view borrowing the decode
...
// build-configuration time: `CodecZenohExtZbufOwned<Heap>` holds growable
// containers with the declared capacities advisory, `CodecZenohExtZbufOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `CodecZenohExtZbufOwned` alone is the build's
...
// `let v: CodecZenohExtZbufOwned = CodecZenohExtZbufOwned { .. };`
...
pub struct CodecZenohExtZbufOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub value_len: u64,
...
impl<'a> CodecZenohExtZbuf<'a> {
    ...
    /// [`CodecZenohExtZbufOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<CodecZenohExtZbufOwned<S>, CodecError> {
...
#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> CodecZenohExtZbufOwned<S> {
    ...
    pub fn as_borrowed(&self) -> CodecZenohExtZbuf<'_> {
        CodecZenohExtZbuf {
            value_len: self.value_len,
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<CodecZenohExtZbufOwned<D>, CodecError> {
