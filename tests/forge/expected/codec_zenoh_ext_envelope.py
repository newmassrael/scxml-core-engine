...
@dataclass
class CodecZenohExtEnvelope:
    header_flags: int = 0
    extensions: List[CodecZenohExtEntry] = field(default_factory=list)

    @classmethod
    def decode(cls, cursor: SceCursor) -> Optional[CodecZenohExtEnvelope]:
