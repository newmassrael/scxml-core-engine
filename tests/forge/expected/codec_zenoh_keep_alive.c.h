...
typedef struct {
    ...
    uint8_t bytes[1];
    size_t  len;
} codec_zenoh_keep_alive_encoded_t;
...
static inline codec_zenoh_keep_alive_encoded_t codec_zenoh_keep_alive_encode(const codec_zenoh_keep_alive_t *self) {
    codec_zenoh_keep_alive_encoded_t r;
