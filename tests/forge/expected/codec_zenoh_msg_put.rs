...
impl<'a> CodecZenohMsgPut<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 951;
...
pub struct CodecZenohMsgPutOwned {
    ...
    pub payload_len: u64,
    pub payload: ::sce_forge_runtime::codec::SceBytes<256>,
}
...
impl<'a> CodecZenohMsgPut<'a> {
    ...
    /// [`CodecZenohMsgPutOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<CodecZenohMsgPutOwned, CodecError> {
        Ok(CodecZenohMsgPutOwned {
            ...
            payload: ::sce_forge_runtime::codec::sce_bytes_from_slice::<256>(self.payload)?,
        })
    }
}
