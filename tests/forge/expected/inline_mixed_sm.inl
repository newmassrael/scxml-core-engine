...
public:
    ...
    // Script engine accessor (pluggable: override for alternative engines like Lua)
    static ::SCE::IScriptEngine& getScriptEngine() {
        return ::SCE::ScriptEngineProvider::getScriptEngine();
    }
