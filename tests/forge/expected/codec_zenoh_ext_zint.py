# SCE-MAP: codec_zenoh_ext_zint:11 :: _forge_body
...
@dataclass
class CodecZenohExtZint:
    value: int = 0

    @classmethod
    def decode(cls, cursor: SceCursor) -> Optional[CodecZenohExtZint]:
