...
int main() {
    using ParentEngine =
        SCE::Generated::scxml_invoke_zenoh_crossdev_parent::scxml_invoke_zenoh_crossdev_parent;
    ParentEngine parent;
    SCE::Generated::scxml_invoke_zenoh_crossdev_parent::TransportRouter<ParentEngine>
    ...
    while (clock::now() < deadline) {
        ...
        if (parent.getCurrentState() == State::Pass) {
            std::printf(
                "SCE Mesh §9.6 Session 5b Zenoh scxml-invoke crossdev: PASS\n");
            return 0;
        }
