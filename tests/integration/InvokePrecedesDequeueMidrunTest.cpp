...
//
// W3C SCXML Appendix D: the invoke-before-dequeue order holds mid-run — Interpreter path.
//
...
class InvokePrecedesDequeueMidrunTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(InvokePrecedesDequeueMidrunTest, PendingInvokesStartBeforeTheDequeueMidRun) {
