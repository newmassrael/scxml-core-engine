 ...
 */
struct Test335 : public SimpleJitTest<Test335, 335> {
    static constexpr const char *DESCRIPTION = "_event.origin blank for internal events (W3C 5.10 JIT)";
    using SM = RSM::Generated::test335::test335;
};

// Auto-register
inline static JitTestRegistrar<Test335> registrar_Test335;
