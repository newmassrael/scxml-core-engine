 ...
 */
struct Test324 : public SimpleJitTest<Test324, 324> {
    static constexpr const char *DESCRIPTION = "_name immutability (W3C B.2.2 JIT)";
    using SM = RSM::Generated::test324::test324;
};

// Auto-register
inline static JitTestRegistrar<Test324> registrar_Test324;
