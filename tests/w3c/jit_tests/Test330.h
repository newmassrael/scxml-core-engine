 ...
 */
struct Test330 : public SimpleJitTest<Test330, 330> {
    static constexpr const char *DESCRIPTION = "Event field binding (W3C 5.10 JIT)";
    using SM = RSM::Generated::test330::test330;
};

// Auto-register
inline static JitTestRegistrar<Test330> registrar_Test330;
