 ...
 */
struct Test314 : public SimpleJitTest<Test314, 314> {
    static constexpr const char *DESCRIPTION = "Delayed assign illegal expression (W3C 5.9.2 JIT)";
    using SM = RSM::Generated::test314::test314;
};

// Auto-register
inline static JitTestRegistrar<Test314> registrar_Test314;
