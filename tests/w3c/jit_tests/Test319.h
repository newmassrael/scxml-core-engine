 ...
 */
struct Test319 : public SimpleJitTest<Test319, 319> {
    static constexpr const char *DESCRIPTION = "_event not bound before first event (W3C B.1 JIT)";
    using SM = RSM::Generated::test319::test319;
};

// Auto-register
inline static JitTestRegistrar<Test319> registrar_Test319;
