 ...
 */
struct Test329 : public JitTestBase {
    static constexpr int TEST_ID = 329;
    static constexpr const char *DESCRIPTION = "System variables immutability (W3C 5.10 JIT)";
...
// Auto-register
inline static JitTestRegistrar<Test329> registrar_Test329;
