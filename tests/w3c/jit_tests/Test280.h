 ...
 */
struct Test280 : public SimpleJitTest<Test280, 280> {
    static constexpr const char *DESCRIPTION = "Late binding variable initialization (W3C 5.3 JIT)";
    using SM = RSM::Generated::test280::test280;
};

// Auto-register
inline static JitTestRegistrar<Test280> registrar_Test280;
