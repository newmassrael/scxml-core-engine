 ...
 * @returns {string}
 */
export function compile_scxml_lang(scxml_content, scxml_name, language) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.compile_scxml_lang(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
export function get_machine_name(scxml_content) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(scxml_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_machine_name(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sce_build_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
