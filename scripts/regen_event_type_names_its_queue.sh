...
#
# Regenerate backends/rust/tests/src/integration/event_type_names_its_queue/
...
GENERATED_DIR="backends/rust/tests/src/integration/event_type_names_its_queue"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_event_type_names_its_queue.sh)"
    echo ""
