...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/autoforward_internal_queue/
...
# during the codegen run. integration_resources/autoforward_internal_queue/
