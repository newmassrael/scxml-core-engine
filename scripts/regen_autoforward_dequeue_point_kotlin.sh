...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/autoforward_dequeue_point/
...
# during the codegen run. integration_resources/autoforward_dequeue_point/
