...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/autoforward_event_fields/
...
# during the codegen run. integration_resources/autoforward_event_fields/
