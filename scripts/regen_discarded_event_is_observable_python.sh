...
#
# Regenerate backends/python/tests/integration/discarded_event_is_observable/*_sm.py
# from the canonical fixture at
# integration_resources/discarded_event_is_observable/discarded_event_is_observable.scxml.
#
# Mirrors scripts/regen_discarded_event_is_observable.sh (Rust). Only `*_sm.py`
# is copied back, so the hand-authored
# `test_discarded_event_is_observable_aot.py` next to it is never touched.
#
...
GENERATED_DIR="backends/python/tests/integration/discarded_event_is_observable"
