...
#
# Regenerate backends/go/tests/integration/the_run_ends_by_exiting_every_state/*_sm.go
...
#   scripts/regen_the_run_ends_by_exiting_every_state_go.sh
#
# Requires:
...
GENERATED_DIR="backends/go/tests/integration/the_run_ends_by_exiting_every_state"
