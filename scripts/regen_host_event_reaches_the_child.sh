...
#
# Regenerate backends/rust/tests/src/integration/host_event_reaches_the_child/
...
GENERATED_DIR="backends/rust/tests/src/integration/host_event_reaches_the_child"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_host_event_reaches_the_child.sh)"
    echo ""
