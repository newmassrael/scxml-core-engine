...
#
# Regenerate backends/rust/tests/src/integration/autoforward_done_invoke/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/autoforward_done_invoke"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_autoforward_done_invoke.sh)"
    echo ""
