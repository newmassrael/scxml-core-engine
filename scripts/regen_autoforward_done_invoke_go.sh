...
#
# Regenerate backends/go/tests/integration/autoforward_done_invoke/{autoforward_done_invoke,
# autoforward_done_invoke__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `autoforward_done_invoke_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/autoforward_done_invoke"
