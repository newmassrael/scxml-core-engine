...
#
# Regenerate backends/python/tests/integration/the_run_ends_by_exiting_every_state/*_sm.py
...
#   scripts/regen_the_run_ends_by_exiting_every_state_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/the_run_ends_by_exiting_every_state"
