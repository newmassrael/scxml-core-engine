...
#
# Regenerate backends/python/tests/integration/parallel_done_state_is_delivered/*_sm.py
...
#
# Mirrors scripts/regen_parallel_done_state_is_delivered.sh (Rust). The
...
#   scripts/regen_parallel_done_state_is_delivered_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/parallel_done_state_is_delivered"
