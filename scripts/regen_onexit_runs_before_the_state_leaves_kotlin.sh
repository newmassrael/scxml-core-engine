...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/onexit_runs_before_the_state_leaves/
...
#   scripts/regen_onexit_runs_before_the_state_leaves_kotlin.sh
#
# Requires:
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/onexit_runs_before_the_state_leaves"
