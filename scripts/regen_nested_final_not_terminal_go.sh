...
#
# Regenerate backends/go/tests/integration/nested_final_not_terminal/{nested_final_not_terminal,
# nested_final_not_terminal__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `nested_final_not_terminal_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/nested_final_not_terminal"
