...
#
# Regenerate backends/rust/tests/src/integration/unseen_event_is_reported/
...
GENERATED_DIR="backends/rust/tests/src/integration/unseen_event_is_reported"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_unseen_event_is_reported.sh)"
    echo ""
