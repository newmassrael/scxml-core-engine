...
#
# Regenerate backends/go/tests/integration/donedata_late_completion/{donedata_late_completion,
# donedata_late_completion__sce_synth_invoke__inv_late}_sm.go from the
...
# hand-authored `donedata_late_completion_test.go` next to the generated
