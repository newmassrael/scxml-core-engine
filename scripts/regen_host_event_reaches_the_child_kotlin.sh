...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/host_event_reaches_the_child/
...
# root during the codegen run.
# integration_resources/host_event_reaches_the_child/ stays a
# parent-only canonical surface; synth-invoke children are derived and live
# only in $TMP.
#
