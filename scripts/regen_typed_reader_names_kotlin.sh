...
#
# Regenerate
# backends/kotlin/tests/src/main/kotlin/com/sce/integration/typed_reader_names/
# from the canonical fixture at
# integration_resources/typed_reader_names/typed_reader_names.scxml.
#
# Mirrors scripts/regen_typed_reader_names.sh (Rust). Only `*Sm.kt`
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/typed_reader_names"
