...
#
# Regenerate backends/rust/tests/src/integration/invoke_precedes_external_dequeue/ from
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_invoke_precedes_external_dequeue.sh)"
    echo ""
