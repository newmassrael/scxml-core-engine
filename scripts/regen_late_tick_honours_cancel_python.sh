...
#
# Regenerate backends/python/tests/integration/late_tick_honours_cancel/*_sm.py
...
#   scripts/regen_late_tick_honours_cancel_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/late_tick_honours_cancel"
