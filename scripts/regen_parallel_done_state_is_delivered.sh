...
#
# Regenerate backends/rust/tests/src/integration/parallel_done_state_is_delivered/
...
GENERATED_DIR="backends/rust/tests/src/integration/parallel_done_state_is_delivered"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_parallel_done_state_is_delivered.sh)"
    echo ""
