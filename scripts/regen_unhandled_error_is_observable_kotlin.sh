...
#
# Regenerate
# backends/kotlin/tests/src/main/kotlin/com/sce/integration/unhandled_error_is_observable/
# from the canonical fixture at
# integration_resources/unhandled_error_is_observable/unhandled_error_is_observable.scxml.
#
# Mirrors scripts/regen_unhandled_error_is_observable.sh (Rust). Only `*Sm.kt`
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/unhandled_error_is_observable"
