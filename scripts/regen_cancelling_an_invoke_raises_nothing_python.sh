...
#
# Regenerate backends/python/tests/integration/cancelling_an_invoke_raises_nothing/*_sm.py
...
#   scripts/regen_cancelling_an_invoke_raises_nothing_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/cancelling_an_invoke_raises_nothing"
