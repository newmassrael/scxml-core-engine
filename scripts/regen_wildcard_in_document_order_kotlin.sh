...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/wildcard_in_document_order/
...
# during the codegen run. integration_resources/wildcard_in_document_order/
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/wildcard_in_document_order"
