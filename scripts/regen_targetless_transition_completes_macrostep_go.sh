...
#
# Regenerate backends/go/tests/integration/targetless_transition_completes_macrostep/*_sm.go
...
#
# Mirrors scripts/regen_targetless_transition_completes_macrostep.sh (Rust). Only `*_sm.go`
# is copied back, so the hand-authored `*_test.go` next to it is never touched.
#
...
GENERATED_DIR="backends/go/tests/integration/targetless_transition_completes_macrostep"
