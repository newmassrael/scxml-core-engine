...
#
# Regenerate backends/go/tests/integration/send_param_payload/{send_param_payload,
# send_param_payload__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `send_param_payload_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/send_param_payload"
