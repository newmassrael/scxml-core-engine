...
#
# Regenerate backends/go/tests/integration/late_tick_honours_cancel/{late_tick_honours_cancel,
# late_tick_honours_cancel__sce_synth_invoke__inv_*}_sm.go from the
# canonical fixture at
# integration_resources/late_tick_honours_cancel/late_tick_honours_cancel.scxml.
#
# Mirrors scripts/regen_late_tick_honours_cancel.sh (Rust). The TMP-staging
...
# hand-authored `late_tick_honours_cancel_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/late_tick_honours_cancel"
...
#
# `--input-root` overrides the default source-hash root the synthesis RFC
# defines (the
