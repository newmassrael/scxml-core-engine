...
#
# Regenerate backends/rust/tests/src/integration/error_cascade_is_bounded/
...
GENERATED_DIR="backends/rust/tests/src/integration/error_cascade_is_bounded"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_error_cascade_is_bounded.sh)"
    echo ""
