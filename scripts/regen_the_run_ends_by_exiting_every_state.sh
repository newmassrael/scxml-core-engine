...
#
# Regenerate backends/rust/tests/src/integration/the_run_ends_by_exiting_every_state/
...
GENERATED_DIR="backends/rust/tests/src/integration/the_run_ends_by_exiting_every_state"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_the_run_ends_by_exiting_every_state.sh)"
    echo ""
