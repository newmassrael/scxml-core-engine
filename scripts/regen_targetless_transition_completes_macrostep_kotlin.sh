...
#
# Regenerate
# backends/kotlin/tests/src/main/kotlin/com/sce/integration/targetless_transition_completes_macrostep/
...
#
# Mirrors scripts/regen_targetless_transition_completes_macrostep.sh (Rust). Only `*Sm.kt`
