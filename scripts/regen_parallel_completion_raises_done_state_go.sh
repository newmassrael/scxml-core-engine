...
#
# Regenerate backends/go/tests/integration/parallel_completion_raises_done_state/*_sm.go
...
GENERATED_DIR="backends/go/tests/integration/parallel_completion_raises_done_state"
