...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/cancelling_an_invoke_raises_nothing/
...
#
# Mirrors scripts/regen_cancelling_an_invoke_raises_nothing.sh (Rust). The
...
#   scripts/regen_cancelling_an_invoke_raises_nothing_kotlin.sh
#
# Requires:
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/cancelling_an_invoke_raises_nothing"
STEM="cancelling_an_invoke_raises_nothing"
INPUT_ROOT="integration_resources/cancelling_an_invoke_raises_nothing"
