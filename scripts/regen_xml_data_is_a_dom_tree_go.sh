...
#
# Regenerate backends/go/tests/integration/xml_data_is_a_dom_tree/*_sm.go
# from the canonical fixture at
# integration_resources/xml_data_is_a_dom_tree/xml_data_is_a_dom_tree.scxml.
#
# Mirrors scripts/regen_xml_data_is_a_dom_tree.sh (Rust). The
...
GENERATED_DIR="backends/go/tests/integration/xml_data_is_a_dom_tree"
