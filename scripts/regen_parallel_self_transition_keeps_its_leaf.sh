...
#
# Regenerate backends/rust/tests/src/integration/parallel_self_transition_keeps_its_leaf/
...
GENERATED_DIR="backends/rust/tests/src/integration/parallel_self_transition_keeps_its_leaf"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_parallel_self_transition_keeps_its_leaf.sh)"
    echo ""
