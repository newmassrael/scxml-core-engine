...
#
# Regenerate backends/rust/tests/src/integration/undecodable_payload_is_reported/
...
GENERATED_DIR="backends/rust/tests/src/integration/undecodable_payload_is_reported"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_undecodable_payload_is_reported.sh)"
    echo ""
