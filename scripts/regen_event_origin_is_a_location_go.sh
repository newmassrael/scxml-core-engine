...
#
# Regenerate backends/go/tests/integration/event_origin_is_a_location/{event_origin_is_a_location,
# event_origin_is_a_location__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `event_origin_is_a_location_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/event_origin_is_a_location"
