...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/late_data_binds_on_first_entry/
# from the canonical fixture at
# integration_resources/late_data_binds_on_first_entry/late_data_binds_on_first_entry.scxml.
#
# Mirrors scripts/regen_late_data_binds_on_first_entry.sh (Rust). The
...
#   scripts/regen_late_data_binds_on_first_entry_kotlin.sh
#
# Requires:
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/late_data_binds_on_first_entry"
STEM="late_data_binds_on_first_entry"
INPUT_ROOT="integration_resources/late_data_binds_on_first_entry"
