...
#
# Regenerate backends/rust/tests/src/integration/autoforward_internal_queue/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/autoforward_internal_queue"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_autoforward_internal_queue.sh)"
    echo ""
