...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/event_descriptor_spellings_agree/
...
# during the codegen run. integration_resources/event_descriptor_spellings_agree/
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/event_descriptor_spellings_agree"
