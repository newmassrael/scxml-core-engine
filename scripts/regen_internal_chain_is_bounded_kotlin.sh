...
#
# Regenerate
# backends/kotlin/tests/src/main/kotlin/com/sce/integration/internal_chain_is_bounded/
# from the canonical fixture at
# integration_resources/internal_chain_is_bounded/internal_chain_is_bounded.scxml.
#
# Mirrors scripts/regen_internal_chain_is_bounded.sh (Rust). Only `*Sm.kt`
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/internal_chain_is_bounded"
