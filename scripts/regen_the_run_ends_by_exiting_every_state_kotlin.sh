...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/the_run_ends_by_exiting_every_state/
...
#
# Mirrors scripts/regen_the_run_ends_by_exiting_every_state.sh (Rust). The
...
#   scripts/regen_the_run_ends_by_exiting_every_state_kotlin.sh
#
# Requires:
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/the_run_ends_by_exiting_every_state"
STEM="the_run_ends_by_exiting_every_state"
INPUT_ROOT="integration_resources/the_run_ends_by_exiting_every_state"
