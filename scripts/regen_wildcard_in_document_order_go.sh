...
#
# Regenerate backends/go/tests/integration/wildcard_in_document_order/{wildcard_in_document_order,
# wildcard_in_document_order__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `wildcard_in_document_order_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/wildcard_in_document_order"
