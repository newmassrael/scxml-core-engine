...
#
# Regenerate backends/python/tests/integration/ancestor_entry_is_not_default_entry/*_sm.py
...
#   scripts/regen_ancestor_entry_is_not_default_entry_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/ancestor_entry_is_not_default_entry"
