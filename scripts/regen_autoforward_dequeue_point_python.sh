...
#
# Regenerate backends/python/tests/integration/autoforward_dequeue_point/*_sm.py
...
# files. The pybind11 channel test at `backends/python/bindings/tests/test_autoforward_dequeue_point.py`
# stays untouched (dual-channel: pybind11 → C++ Interpreter +
# Python AOT codegen).
#
# Usage (from repo root):
#   scripts/regen_autoforward_dequeue_point_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/autoforward_dequeue_point"
