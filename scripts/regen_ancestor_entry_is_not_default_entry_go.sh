...
#
# Regenerate backends/go/tests/integration/ancestor_entry_is_not_default_entry/*_sm.go
...
#
# Mirrors scripts/regen_ancestor_entry_is_not_default_entry.sh (Rust). The
...
GENERATED_DIR="backends/go/tests/integration/ancestor_entry_is_not_default_entry"
