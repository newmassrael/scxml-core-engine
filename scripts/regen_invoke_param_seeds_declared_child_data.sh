...
#
# Regenerate backends/rust/tests/src/integration/invoke_param_seeds_declared_child_data/
...
GENERATED_DIR="backends/rust/tests/src/integration/invoke_param_seeds_declared_child_data"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_invoke_param_seeds_declared_child_data.sh)"
    echo ""
