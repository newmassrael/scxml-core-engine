...
#
# Regenerate backends/rust/tests/src/integration/nested_final_not_terminal/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/nested_final_not_terminal"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_nested_final_not_terminal.sh)"
    echo ""
