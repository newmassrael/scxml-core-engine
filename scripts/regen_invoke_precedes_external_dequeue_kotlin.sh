...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/invoke_precedes_external_dequeue/
...
# during the codegen run. integration_resources/invoke_precedes_external_dequeue/
