...
#
# Regenerate backends/go/tests/integration/internal_chain_is_bounded/*_sm.go
# from the canonical fixture at
# integration_resources/internal_chain_is_bounded/internal_chain_is_bounded.scxml.
#
# Mirrors scripts/regen_internal_chain_is_bounded.sh (Rust). Only `*_sm.go`
...
GENERATED_DIR="backends/go/tests/integration/internal_chain_is_bounded"
