...
#
# Regenerate backends/rust/tests/src/integration/late_tick_honours_cancel/ from
...
# the canonical input path, the embedded `// From:` and the synthesis RFC's
...
GENERATED_DIR="backends/rust/tests/src/integration/late_tick_honours_cancel"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_late_tick_honours_cancel.sh)"
    echo ""
