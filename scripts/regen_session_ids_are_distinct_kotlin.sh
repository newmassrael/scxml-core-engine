...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/session_ids_are_distinct/
...
# during the codegen run. integration_resources/session_ids_are_distinct/
