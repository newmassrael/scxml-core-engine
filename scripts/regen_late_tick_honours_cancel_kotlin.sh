...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/late_tick_honours_cancel/
...
# during the codegen run. integration_resources/late_tick_honours_cancel/
