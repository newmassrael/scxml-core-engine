...
#
# Regenerate backends/go/tests/integration/autoforward_internal_queue/{autoforward_internal_queue,
# autoforward_internal_queue__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `autoforward_internal_queue_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/autoforward_internal_queue"
