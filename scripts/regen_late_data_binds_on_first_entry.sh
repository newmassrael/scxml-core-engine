...
#
# Regenerate backends/rust/tests/src/integration/late_data_binds_on_first_entry/
...
GENERATED_DIR="backends/rust/tests/src/integration/late_data_binds_on_first_entry"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_late_data_binds_on_first_entry.sh)"
    echo ""
