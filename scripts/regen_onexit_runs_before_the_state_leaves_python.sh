...
#
# Regenerate backends/python/tests/integration/onexit_runs_before_the_state_leaves/*_sm.py
...
#   scripts/regen_onexit_runs_before_the_state_leaves_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/onexit_runs_before_the_state_leaves"
