...
#
# Regenerate backends/rust/tests/src/integration/parallel_completion_raises_done_state/
...
GENERATED_DIR="backends/rust/tests/src/integration/parallel_completion_raises_done_state"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_parallel_completion_raises_done_state.sh)"
    echo ""
