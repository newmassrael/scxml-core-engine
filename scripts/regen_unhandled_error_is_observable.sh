...
#
# Regenerate backends/rust/tests/src/integration/unhandled_error_is_observable/
...
GENERATED_DIR="backends/rust/tests/src/integration/unhandled_error_is_observable"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_unhandled_error_is_observable.sh)"
    echo ""
