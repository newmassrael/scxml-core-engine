...
#
# Regenerate backends/rust/tests/src/integration/invoke_precedes_dequeue_midrun/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/invoke_precedes_dequeue_midrun"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_invoke_precedes_dequeue_midrun.sh)"
    echo ""
