...
#
# Regenerate backends/go/tests/integration/parallel_self_transition_keeps_its_leaf/*_sm.go
...
GENERATED_DIR="backends/go/tests/integration/parallel_self_transition_keeps_its_leaf"
