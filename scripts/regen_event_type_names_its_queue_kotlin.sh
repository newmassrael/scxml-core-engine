...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/event_type_names_its_queue/
...
#   scripts/regen_event_type_names_its_queue_kotlin.sh
#
# Requires:
...
GENERATED_DIR="${SCE_KOTLIN_GENERATED_ROOT:-backends/kotlin/tests/src/main/kotlin}/com/sce/integration/event_type_names_its_queue"
