...
#
# Regenerate backends/rust/tests/src/integration/xml_data_is_a_dom_tree/
...
GENERATED_DIR="backends/rust/tests/src/integration/xml_data_is_a_dom_tree"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_xml_data_is_a_dom_tree.sh)"
    echo ""
