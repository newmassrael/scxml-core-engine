...
#
# Regenerate backends/rust/tests/src/integration/targetless_transition_completes_macrostep/
...
# driver at backends/rust/tests/tests/targetless_transition_completes_macrostep.rs is
# never touched.
#
...
GENERATED_DIR="backends/rust/tests/src/integration/targetless_transition_completes_macrostep"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_targetless_transition_completes_macrostep.sh)"
    echo ""
