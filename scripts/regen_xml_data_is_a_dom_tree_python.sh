...
#
# Regenerate backends/python/tests/integration/xml_data_is_a_dom_tree/*_sm.py
...
#   scripts/regen_xml_data_is_a_dom_tree_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/xml_data_is_a_dom_tree"
