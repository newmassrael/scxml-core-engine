...
#
# Regenerate backends/python/tests/integration/event_descriptor_spellings_agree/*_sm.py
...
#   scripts/regen_event_descriptor_spellings_agree_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/event_descriptor_spellings_agree"
