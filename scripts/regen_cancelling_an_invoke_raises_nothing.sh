...
#
# Regenerate backends/rust/tests/src/integration/cancelling_an_invoke_raises_nothing/
...
GENERATED_DIR="backends/rust/tests/src/integration/cancelling_an_invoke_raises_nothing"
STEM="cancelling_an_invoke_raises_nothing"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_cancelling_an_invoke_raises_nothing.sh)"
    echo ""
