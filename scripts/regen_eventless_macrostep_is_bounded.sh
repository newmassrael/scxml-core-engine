...
#
# Regenerate backends/rust/tests/src/integration/eventless_macrostep_is_bounded/
...
# driver at backends/rust/tests/tests/eventless_macrostep_is_bounded.rs is
# never touched.
#
...
GENERATED_DIR="backends/rust/tests/src/integration/eventless_macrostep_is_bounded"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_eventless_macrostep_is_bounded.sh)"
    echo ""
