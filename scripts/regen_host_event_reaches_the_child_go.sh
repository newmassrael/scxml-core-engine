...
#
# Regenerate backends/go/tests/integration/host_event_reaches_the_child/{host_event_reaches_the_child,
# host_event_reaches_the_child__sce_synth_invoke__inv_*}_sm.go from the
# canonical fixture at
# integration_resources/host_event_reaches_the_child/host_event_reaches_the_child.scxml.
#
# Mirrors scripts/regen_host_event_reaches_the_child.sh (Rust). The
...
# hand-authored `host_event_reaches_the_child_test.go` next to the
...
GENERATED_DIR="backends/go/tests/integration/host_event_reaches_the_child"
