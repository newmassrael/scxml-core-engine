...
#
# Regenerate backends/go/tests/integration/autoforward_event_fields/{autoforward_event_fields,
# autoforward_event_fields__sce_synth_invoke__inv_*}_sm.go from the
...
# hand-authored `autoforward_event_fields_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/autoforward_event_fields"
