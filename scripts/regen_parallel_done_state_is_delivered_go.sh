...
#
# Regenerate backends/go/tests/integration/parallel_done_state_is_delivered/*_sm.go
...
GENERATED_DIR="backends/go/tests/integration/parallel_done_state_is_delivered"
