...
#
# Regenerate backends/rust/tests/src/integration/event_origin_is_a_location/ from
...
# the canonical input path, the embedded `// From:` and the synth RFC 6.2.6
...
GENERATED_DIR="backends/rust/tests/src/integration/event_origin_is_a_location"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_event_origin_is_a_location.sh)"
    echo ""
