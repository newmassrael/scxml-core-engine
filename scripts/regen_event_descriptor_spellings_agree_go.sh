...
#
# Regenerate backends/go/tests/integration/event_descriptor_spellings_agree/{event_descriptor_spellings_agree,
# event_descriptor_spellings_agree__sce_synth_invoke__inv_*}_sm.go from the
# canonical fixture at
# integration_resources/event_descriptor_spellings_agree/event_descriptor_spellings_agree.scxml.
#
# Mirrors scripts/regen_event_descriptor_spellings_agree.sh (Rust). The TMP-staging
...
# hand-authored `event_descriptor_spellings_agree_test.go` next to the generated
...
GENERATED_DIR="backends/go/tests/integration/event_descriptor_spellings_agree"
STEM="event_descriptor_spellings_agree"
INPUT_ROOT="integration_resources/event_descriptor_spellings_agree"
