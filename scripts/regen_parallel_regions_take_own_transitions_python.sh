...
#
# Regenerate backends/python/tests/integration/parallel_regions_take_own_transitions/*_sm.py
...
#   scripts/regen_parallel_regions_take_own_transitions_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/parallel_regions_take_own_transitions"
