...
#
# Regenerate backends/python/tests/integration/donedata_late_completion/*_sm.py
# from the canonical fixture at
# integration_resources/donedata_late_completion/donedata_late_completion.scxml.
#
# Mirrors scripts/regen_donedata_late_completion.sh (Rust). The TMP-staging
...
# files. Only the Python AOT channel covers this fixture; the C++
# Interpreter path that the pybind11 binding wraps is asserted directly
# by `tests/integration/DonedataLateCompletionTest.cpp`.
#
