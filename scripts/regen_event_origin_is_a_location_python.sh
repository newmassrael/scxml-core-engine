...
#
# Regenerate backends/python/tests/integration/event_origin_is_a_location/*_sm.py
...
# files. The pybind11 channel test at `backends/python/bindings/tests/test_event_origin_is_a_location.py`
# stays untouched (dual-channel: pybind11 → C++ Interpreter +
# Python AOT codegen).
#
# Usage (from repo root):
#   scripts/regen_event_origin_is_a_location_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/event_origin_is_a_location"
