...
#
# Regenerate backends/python/tests/integration/autoforward_done_invoke/*_sm.py
...
# files. The pybind11 channel test at `backends/python/bindings/tests/test_autoforward_done_invoke.py`
