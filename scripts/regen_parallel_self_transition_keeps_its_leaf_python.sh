...
#
# Regenerate backends/python/tests/integration/parallel_self_transition_keeps_its_leaf/*_sm.py
...
#   scripts/regen_parallel_self_transition_keeps_its_leaf_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/parallel_self_transition_keeps_its_leaf"
