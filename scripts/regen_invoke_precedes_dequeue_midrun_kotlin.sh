...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/invoke_precedes_dequeue_midrun/
...
# during the codegen run. integration_resources/invoke_precedes_dequeue_midrun/
