...
#
# Regenerate backends/rust/tests/src/integration/typed_reader_names/
# from the canonical fixture at
# integration_resources/typed_reader_names/typed_reader_names.scxml.
#
# Pipeline:
...
GENERATED_DIR="backends/rust/tests/src/integration/typed_reader_names"
STEM="typed_reader_names"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_typed_reader_names.sh)"
    echo ""
