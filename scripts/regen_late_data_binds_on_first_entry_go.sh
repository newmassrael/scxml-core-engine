...
#
# Regenerate backends/go/tests/integration/late_data_binds_on_first_entry/*_sm.go
...
#   scripts/regen_late_data_binds_on_first_entry_go.sh
#
# Requires:
...
GENERATED_DIR="backends/go/tests/integration/late_data_binds_on_first_entry"
