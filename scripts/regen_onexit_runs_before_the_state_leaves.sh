...
#
# Regenerate backends/rust/tests/src/integration/onexit_runs_before_the_state_leaves/
...
GENERATED_DIR="backends/rust/tests/src/integration/onexit_runs_before_the_state_leaves"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_onexit_runs_before_the_state_leaves.sh)"
    echo ""
