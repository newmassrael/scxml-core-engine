...
#
# Regenerate backends/go/tests/integration/undecodable_payload_is_reported/*_sm.go
# from the canonical fixture at
# integration_resources/undecodable_payload_is_reported/undecodable_payload_is_reported.scxml.
#
# Mirrors scripts/regen_undecodable_payload_is_reported.sh (Rust). The TMP-staging
...
# back, so the hand-authored `undecodable_payload_is_reported_test.go` next to the
...
GENERATED_DIR="backends/go/tests/integration/undecodable_payload_is_reported"
