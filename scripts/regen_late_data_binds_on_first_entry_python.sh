...
#
# Regenerate backends/python/tests/integration/late_data_binds_on_first_entry/*_sm.py
...
#   scripts/regen_late_data_binds_on_first_entry_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/late_data_binds_on_first_entry"
