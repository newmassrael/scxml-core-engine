...
#
# Regenerate backends/rust/tests/src/integration/invoke_param_error_starts_the_child/
...
GENERATED_DIR="backends/rust/tests/src/integration/invoke_param_error_starts_the_child"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_invoke_param_error_starts_the_child.sh)"
    echo ""
