...
#
# Regenerate backends/python/tests/integration/host_event_reaches_the_child/*_sm.py
...
# `backends/python/bindings/tests/test_host_event_reaches_the_child.py`
# stays untouched (dual-channel: pybind11 → C++ Interpreter +
# Python AOT codegen).
#
# Usage (from repo root):
#   scripts/regen_host_event_reaches_the_child_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/host_event_reaches_the_child"
