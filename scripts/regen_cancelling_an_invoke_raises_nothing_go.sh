...
#
# Regenerate backends/go/tests/integration/cancelling_an_invoke_raises_nothing/*_sm.go
...
#   scripts/regen_cancelling_an_invoke_raises_nothing_go.sh
#
# Requires:
...
GENERATED_DIR="backends/go/tests/integration/cancelling_an_invoke_raises_nothing"
