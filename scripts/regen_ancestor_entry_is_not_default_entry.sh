...
#
# Regenerate backends/rust/tests/src/integration/ancestor_entry_is_not_default_entry/
...
GENERATED_DIR="backends/rust/tests/src/integration/ancestor_entry_is_not_default_entry"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_ancestor_entry_is_not_default_entry.sh)"
    echo ""
