...
#
# Regenerate backends/go/tests/integration/onexit_runs_before_the_state_leaves/*_sm.go
...
#
# Mirrors scripts/regen_onexit_runs_before_the_state_leaves.sh (Rust). The
...
#   scripts/regen_onexit_runs_before_the_state_leaves_go.sh
#
# Requires:
...
GENERATED_DIR="backends/go/tests/integration/onexit_runs_before_the_state_leaves"
STEM="onexit_runs_before_the_state_leaves"
INPUT_ROOT="integration_resources/onexit_runs_before_the_state_leaves"
