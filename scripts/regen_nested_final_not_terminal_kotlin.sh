...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/nested_final_not_terminal/
...
# during the codegen run. integration_resources/nested_final_not_terminal/
