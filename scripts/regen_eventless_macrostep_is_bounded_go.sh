...
#
# Regenerate backends/go/tests/integration/eventless_macrostep_is_bounded/*_sm.go
# from the canonical fixture at
# integration_resources/eventless_macrostep_is_bounded/eventless_macrostep_is_bounded.scxml.
#
# Mirrors scripts/regen_eventless_macrostep_is_bounded.sh (Rust). Only `*_sm.go`
...
GENERATED_DIR="backends/go/tests/integration/eventless_macrostep_is_bounded"
