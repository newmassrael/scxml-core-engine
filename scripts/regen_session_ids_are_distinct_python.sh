...
#
# Regenerate backends/python/tests/integration/session_ids_are_distinct/*_sm.py
...
# files. The pybind11 channel test at `backends/python/bindings/tests/test_session_ids_are_distinct.py`
# stays untouched (dual-channel: pybind11 → C++ Interpreter +
# Python AOT codegen).
#
# Usage (from repo root):
#   scripts/regen_session_ids_are_distinct_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/session_ids_are_distinct"
