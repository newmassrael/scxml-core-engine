...
#
# Regenerate backends/go/tests/integration/discarded_event_is_observable/*_sm.go
# from the canonical fixture at
# integration_resources/discarded_event_is_observable/discarded_event_is_observable.scxml.
#
# Mirrors scripts/regen_discarded_event_is_observable.sh (Rust). The TMP-staging
...
# back, so the hand-authored `discarded_event_is_observable_test.go` next to the
...
GENERATED_DIR="backends/go/tests/integration/discarded_event_is_observable"
