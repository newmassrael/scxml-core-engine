...
#
# Regenerate backends/python/tests/integration/parallel_completion_raises_done_state/*_sm.py
...
#
# Mirrors scripts/regen_parallel_completion_raises_done_state.sh (Rust). The
...
#   scripts/regen_parallel_completion_raises_done_state_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/parallel_completion_raises_done_state"
