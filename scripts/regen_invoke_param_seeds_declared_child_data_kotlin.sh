...
#
# Regenerate backends/kotlin/tests/src/main/kotlin/com/sce/integration/invoke_param_seeds_declared_child_data/
...
# integration_resources/invoke_param_seeds_declared_child_data/ stays a
