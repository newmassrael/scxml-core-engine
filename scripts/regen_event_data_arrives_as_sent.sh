...
#
# Regenerate backends/rust/tests/src/integration/event_data_arrives_as_sent/
...
GENERATED_DIR="backends/rust/tests/src/integration/event_data_arrives_as_sent"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_event_data_arrives_as_sent.sh)"
    echo ""
