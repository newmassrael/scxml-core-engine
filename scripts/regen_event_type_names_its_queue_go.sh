...
#
# Regenerate backends/go/tests/integration/event_type_names_its_queue/*_sm.go
# from the canonical fixture at
# integration_resources/event_type_names_its_queue/event_type_names_its_queue.scxml.
#
# Mirrors scripts/regen_event_type_names_its_queue.sh (Rust). The
...
#   scripts/regen_event_type_names_its_queue_go.sh
#
# Requires:
...
GENERATED_DIR="backends/go/tests/integration/event_type_names_its_queue"
STEM="event_type_names_its_queue"
INPUT_ROOT="integration_resources/event_type_names_its_queue"
