...
#
# Regenerate backends/python/tests/integration/event_type_names_its_queue/*_sm.py
...
#   scripts/regen_event_type_names_its_queue_python.sh
#
# Requires:
...
GENERATED_DIR="backends/python/tests/integration/event_type_names_its_queue"
