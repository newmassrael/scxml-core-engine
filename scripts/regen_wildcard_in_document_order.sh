...
#
# Regenerate backends/rust/tests/src/integration/wildcard_in_document_order/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/wildcard_in_document_order"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_wildcard_in_document_order.sh)"
    echo ""
