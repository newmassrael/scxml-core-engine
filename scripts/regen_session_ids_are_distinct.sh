...
#
# Regenerate backends/rust/tests/src/integration/session_ids_are_distinct/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/session_ids_are_distinct"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_session_ids_are_distinct.sh)"
    echo ""
