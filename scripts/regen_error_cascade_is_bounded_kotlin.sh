...
#
# Regenerate
# backends/kotlin/tests/src/main/kotlin/com/sce/integration/error_cascade_is_bounded/
# from the canonical fixture at
# integration_resources/error_cascade_is_bounded/error_cascade_is_bounded.scxml.
#
# Mirrors scripts/regen_error_cascade_is_bounded.sh (Rust). Only `*Sm.kt` is
# copied back, so the hand-authored driver under `src/test/kotlin/` is never
# touched.
#
