...
#
# Regenerate backends/rust/tests/src/integration/event_descriptor_spellings_agree/ from
...
GENERATED_DIR="backends/rust/tests/src/integration/event_descriptor_spellings_agree"
...
{
    echo "// GENERATED -- DO NOT EDIT (scripts/regen_event_descriptor_spellings_agree.sh)"
    echo ""
