...
fn test_342() {
    ...
    let policy = sce_rust_tests::generated::test342::Test342Policy::new(script_engine);
    ...
    assert!(completed, "Test 342 timed out");
    assert_eq!(
        engine.get_current_state(),
        sce_rust_tests::generated::test342::Test342State::Pass,
        "Test 342 reached wrong final state"
    );
}
