...
fn test_277() {
    ...
    let policy = sce_rust_tests::generated::test277::Test277Policy::new(script_engine);
    ...
    assert!(completed, "Test 277 timed out");
    assert_eq!(
        engine.get_current_state(),
        sce_rust_tests::generated::test277::Test277State::Pass,
        "Test 277 reached wrong final state"
    );
}
