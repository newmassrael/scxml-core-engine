...
fn test_176() {
    ...
    let policy = sce_rust_tests::generated::test176::Test176Policy::new(script_engine);
    ...
    assert!(completed, "Test 176 timed out");
    assert_eq!(
        engine.get_current_state(),
        sce_rust_tests::generated::test176::Test176State::Pass,
        "Test 176 reached wrong final state"
    );
}
