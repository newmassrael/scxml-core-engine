...
// From: resources/449/test449.scxml
//
...
//! Generated Rust state machine for `test449`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test449Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test449State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test449", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test449Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test449Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test449Policy {
    type State = Test449State;
    type Event = Test449Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test449State::Fail => true,
            Test449State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test449Event::ErrorExecution => "error.execution",
            Test449Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test449Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test449State::Fail => "fail",
            Test449State::Pass => "pass",
            Test449State::S0 => "s0",
        }
    }
...
impl Test449Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test449State,
        event: Test449Event,
        current_state: &mut Test449State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test449State::Fail => false,
            Test449State::Pass => false,
            Test449State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test449Event::Null {
if self.safe_evaluate_guard("_scxml_truthy('foo')", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test449State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test449State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
