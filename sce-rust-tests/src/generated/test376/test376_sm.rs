...
impl Test376Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test376Event::ErrorExecution));
        }
...
impl Default for Test376Policy {
    fn default() -> Self {
        Self::new()
    }
}
                ...
                'action_block: {
{
    ...
    // W3C SCXML 6.2: Invalid target "!invalid" raises error.execution
    {
        ...
        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test376Event::ErrorExecution);
