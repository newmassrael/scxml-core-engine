    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test578Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test578Policy {
    fn default() -> Self {
        Self::new()
    }
}
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test578Event::Foo);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test578State::S0 => {
                ...
                if event != Test578Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
