...
impl Test172Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "'event1'") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test172Event::ErrorExecution));
        }
...
impl Default for Test172Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test172State::S0 => {
                ...
                if event != Test172Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
