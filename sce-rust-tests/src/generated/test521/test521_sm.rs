    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test521Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test521Policy {
    fn default() -> Self {
        Self::new()
    }
}
...

{
    ...
    let _resolved_target: Option<String> = {
        ...
        match se.evaluate_expression(&sid, "nil") {
            Ok(ref val) if matches!(val, sce_rust_runtime::ScriptValue::Null | sce_rust_runtime::ScriptValue::Undefined) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test521Event::ErrorCommunication));
                None
            }
            Ok(val) => {
                ...
                if trimmed.starts_with("!") {
                    ...
                    {
                        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test521Event::ErrorExecution);
    ...
    if _rt == "#_internal" {
        {
            let mut meta = sce_rust_runtime::EventWithMetadata::new(Test521Event::Event2);
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test521Event::Timeout);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test521State::S0 => {
                ...
                if event != Test521Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
