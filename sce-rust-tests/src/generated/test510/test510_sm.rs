...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test510Event::Internal));
                }
            }
            _ => {}
        }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test510State::S0 => {
                ...
                if event != Test510Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
