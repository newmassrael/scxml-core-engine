...
// From: resources/232/test232_child0.scxml
//
...
//! Generated Rust state machine for `test232_child0`.
//!
...
impl Test232Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test232Child0State::SubFinal,
            session_id: None,
...
impl Default for Test232Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test232Child0Policy {
    type State = Test232Child0State;
    type Event = Test232Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test232Child0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test232Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test232Child0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test232Child0Event::ChildToParent1 => "childToParent1",
            Test232Child0Event::ChildToParent2 => "childToParent2",
            Test232Child0Event::ErrorExecution => "error.execution",
            Test232Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent1" => Some(Test232Child0Event::ChildToParent1),
            "childToParent2" => Some(Test232Child0Event::ChildToParent2),
            "error.execution" => Some(Test232Child0Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test232Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test232Child0State,
        event: Test232Child0Event,
        current_state: &mut Test232Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test232Child0State::SubFinal => false,
            _ => false,
        }
    }
