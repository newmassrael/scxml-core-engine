...
// From: resources/233/test233__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test233__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:3"]
...
pub enum Test233SceSynthInvokeInvoke0State {
    SubFinal,
}
...
pub struct Test233SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test233SceSynthInvokeInvoke0State,
...
impl Test233SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test233SceSynthInvokeInvoke0State::SubFinal,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test233__sce_synth_invoke__invoke_0", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test233SceSynthInvokeInvoke0Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test233SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test233SceSynthInvokeInvoke0Policy {
    type State = Test233SceSynthInvokeInvoke0State;
    type Event = Test233SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        Test233SceSynthInvokeInvoke0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test233SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test233SceSynthInvokeInvoke0State::SubFinal => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test233SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...
impl Test233SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test233SceSynthInvokeInvoke0State,
        event: Test233SceSynthInvokeInvoke0Event,
        current_state: &mut Test233SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test233SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
