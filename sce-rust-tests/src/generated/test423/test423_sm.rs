                ...
                'action_block: {
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test423Event::ExternalEvent1);
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test423Event::InternalEvent));
                }
            }
            _ => {}
        }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test423State::S0 => {
                ...
                if event != Test423Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
