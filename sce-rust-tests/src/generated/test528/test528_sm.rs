    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test528Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test528Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test528Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test528State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test528State::S01,
            ]),
    ...
    fn execute_entry_actions(&mut self, state: Self::State, engine: &mut sce_rust_runtime::Engine<Self>) {
        match state {
            Test528State::S02 => {
                ...
                if done_data_ok {
                    let mut done_meta = sce_rust_runtime::EventWithMetadata::new(Test528Event::DoneStateS0);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test528State::S1 => {
                ...
                if event != Test528Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
