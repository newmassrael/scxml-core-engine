...
pub struct Test230Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test230__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test230__sce_synth_invoke__invoke_0_sm::Test230SceSynthInvokeInvoke0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test230__sce_synth_invoke__invoke_0_sm::Test230SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test230Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test230State::Fail => "fail",
            Test230State::Final => "final",
            Test230State::S0 => "s0",
            Test230State::S01 => "s01",
            Test230State::S02 => "s02",
        }
    }
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test230State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test230State::S01,
            ]),
