...
// From: resources/230/test230__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test230__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:3"]
// SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:3
...
pub enum Test230SceSynthInvokeInvoke0State {
    Sub0,
    SubFinal,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test230SceSynthInvokeInvoke0Event {
    ChildToParent,
    ErrorExecution,
    Timeout,
...
pub struct Test230SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test230SceSynthInvokeInvoke0State,
...
impl Test230SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test230SceSynthInvokeInvoke0State::Sub0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test230__sce_synth_invoke__invoke_0", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test230SceSynthInvokeInvoke0Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test230SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test230SceSynthInvokeInvoke0Policy {
    type State = Test230SceSynthInvokeInvoke0State;
    type Event = Test230SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        Test230SceSynthInvokeInvoke0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test230SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test230SceSynthInvokeInvoke0State::Sub0 => 0,
            Test230SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test230SceSynthInvokeInvoke0Event::ChildToParent => "childToParent",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test230SceSynthInvokeInvoke0Event::ChildToParent),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test230SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test230SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...
impl Test230SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test230SceSynthInvokeInvoke0State,
        event: Test230SceSynthInvokeInvoke0Event,
        current_state: &mut Test230SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test230SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test230SceSynthInvokeInvoke0Event::ChildToParent {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test230SceSynthInvokeInvoke0State::SubFinal;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test230SceSynthInvokeInvoke0Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
            ...
            Test230SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
