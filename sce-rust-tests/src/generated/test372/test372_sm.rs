...
impl Test372Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test372Event::ErrorExecution));
        }
...
impl Default for Test372Policy {
    fn default() -> Self {
        Self::new()
    }
}
                ...
                'action_block: {
{
    ...
    if let Err(e) = se.execute_script(&sid, &assign_script) {
        ...
        break 'action_block;
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test372Event::DoneStateS0));
            }
            _ => {}
        }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test372State::S0 => {
                ...
                if event != Test372Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
