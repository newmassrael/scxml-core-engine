...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test185Event::Event1);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test185State::S0 => {
                ...
                if event != Test185Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
