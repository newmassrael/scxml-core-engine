...
// From: /tmp/tmp.9b5WoB1CrH/donedata_local_invoke.scxml
//
...
pub struct DonedataLocalInvokePolicy {
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_param' (donedata_local_invoke_child0)
    child_inv_param: Option<Box<sce_rust_runtime::Engine<super::donedata_local_invoke_child0_sm::DonedataLocalInvokeChild0Policy>>>,
    pending_done_invoke_inv_param: bool,
    // W3C SCXML 6.4: Static invoke child 'inv_content' (donedata_local_invoke_child1)
    child_inv_content: Option<Box<sce_rust_runtime::Engine<super::donedata_local_invoke_child1_sm::DonedataLocalInvokeChild1Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_content") {
                ...
                let mut child_policy = super::donedata_local_invoke_child1_sm::DonedataLocalInvokeChild1Policy::new();
            ...
            if pending.invoke_id.contains(".inv_param") {
                ...
                // W3C SCXML 6.4: Create child state machine
                let mut child_policy = super::donedata_local_invoke_child0_sm::DonedataLocalInvokeChild0Policy::new();
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
