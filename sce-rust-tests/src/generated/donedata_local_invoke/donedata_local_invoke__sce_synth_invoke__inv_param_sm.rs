...
// source-hash: 57b747b8275f1a36fbb3868254444eb48b73b7612da6c511ced042c37745732a
...
// From: /tmp/tmp.SgvhbQrIuH/donedata_local_invoke__sce_synth_invoke__inv_param.scxml
//
...
//! Generated Rust state machine for `donedata_local_invoke__sce_synth_invoke__inv_param`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: donedata_local_invoke__sce_synth_invoke__inv_param.scxml:3"]
...
pub enum DonedataLocalInvokeSceSynthInvokeInvParamState {
    Done,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum DonedataLocalInvokeSceSynthInvokeInvParamEvent {
    ErrorExecution,
...
pub struct DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: DonedataLocalInvokeSceSynthInvokeInvParamState,
...
impl DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: DonedataLocalInvokeSceSynthInvokeInvParamState::Done,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "donedata_local_invoke__sce_synth_invoke__inv_param", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(DonedataLocalInvokeSceSynthInvokeInvParamEvent::ErrorExecution));
                false
            }
        }
    }
...
impl Default for DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    type State = DonedataLocalInvokeSceSynthInvokeInvParamState;
    type Event = DonedataLocalInvokeSceSynthInvokeInvParamEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvParamState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvParamState::Done => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            DonedataLocalInvokeSceSynthInvokeInvParamEvent::ErrorExecution => "error.execution",
            DonedataLocalInvokeSceSynthInvokeInvParamEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(DonedataLocalInvokeSceSynthInvokeInvParamEvent::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvParamState::Done => "done",
        }
    }
...
impl DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DonedataLocalInvokeSceSynthInvokeInvParamState,
        event: DonedataLocalInvokeSceSynthInvokeInvParamEvent,
        current_state: &mut DonedataLocalInvokeSceSynthInvokeInvParamState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DonedataLocalInvokeSceSynthInvokeInvParamState::Done => false,
            _ => false,
        }
    }
