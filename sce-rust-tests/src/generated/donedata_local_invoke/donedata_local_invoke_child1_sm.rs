...
// From: /tmp/tmp.TAvPai4FnD/donedata_local_invoke_child1.scxml
//
...
//! Generated Rust state machine for `donedata_local_invoke_child1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum DonedataLocalInvokeChild1State {
    Done,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum DonedataLocalInvokeChild1Event {
    ErrorExecution,
...
impl DonedataLocalInvokeChild1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: DonedataLocalInvokeChild1State::Done,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "donedata_local_invoke_child1", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(DonedataLocalInvokeChild1Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for DonedataLocalInvokeChild1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for DonedataLocalInvokeChild1Policy {
    type State = DonedataLocalInvokeChild1State;
    type Event = DonedataLocalInvokeChild1Event;
    ...
    fn initial_state() -> Self::State {
        DonedataLocalInvokeChild1State::Done
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            DonedataLocalInvokeChild1State::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DonedataLocalInvokeChild1State::Done => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            DonedataLocalInvokeChild1Event::ErrorExecution => "error.execution",
            DonedataLocalInvokeChild1Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(DonedataLocalInvokeChild1Event::ErrorExecution),
            _ => None,
        }
    }
...
impl DonedataLocalInvokeChild1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DonedataLocalInvokeChild1State,
        event: DonedataLocalInvokeChild1Event,
        current_state: &mut DonedataLocalInvokeChild1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DonedataLocalInvokeChild1State::Done => false,
            _ => false,
        }
    }
