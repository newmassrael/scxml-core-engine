...
// From: resources/318/test318.scxml
//
...
//! Generated Rust state machine for `test318`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test318Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test318State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test318", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test318Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test318Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test318Policy {
    type State = Test318State;
    type Event = Test318Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test318State::Fail => true,
            Test318State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test318Event::Bar => "bar",
            Test318Event::ErrorExecution => "error.execution",
            Test318Event::Foo => "foo",
            Test318Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "bar" => Some(Test318Event::Bar),
            "error.execution" => Some(Test318Event::ErrorExecution),
            "foo" => Some(Test318Event::Foo),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test318State::Fail => "fail",
            Test318State::Pass => "pass",
            Test318State::S0 => "s0",
            Test318State::S1 => "s1",
        }
    }
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test318Event::Foo));
                }
            }
            Test318State::S1 => {
                // W3C SCXML 3.8: onentry block 1/1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test318Event::Bar));
...
impl Test318Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test318State,
        event: Test318Event,
        current_state: &mut Test318State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test318State::Fail => false,
            Test318State::Pass => false,
            Test318State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test318Event::Foo {
            ...
            Test318State::S1 => {
                ...
                if event == Test318Event::Null {
if self.safe_evaluate_guard("Var1 == 'foo'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test318State::Pass;
                            *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test318State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
