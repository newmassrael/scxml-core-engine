    ...
    child_foo: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test228__sce_synth_invoke__foo_sm::Test228SceSynthInvokeFooPolicy,
            >,
        >,
    >,
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy =
                    super::test228__sce_synth_invoke__foo_sm::Test228SceSynthInvokeFooPolicy::new();
