...
// From: resources/228/test228.scxml
//
...
//! Generated Rust state machine for `test228`.
//!
...
pub struct Test228Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test228State>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'foo' (test228_child0)
    child_foo: Option<Box<sce_rust_runtime::Engine<super::test228_child0_sm::Test228Child0Policy>>>,
...
impl Test228Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test228State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test228", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test228Event::ErrorExecution));
                false
            }
        }
    }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy = super::test228_child0_sm::Test228Child0Policy::new();
...
impl Default for Test228Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test228Policy {
    type State = Test228State;
    type Event = Test228Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test228State::Fail => true,
            Test228State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test228Event::CancelInvoke => "cancel.invoke",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test228Event::CancelInvoke),
...
impl Test228Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test228State,
        event: Test228Event,
        current_state: &mut Test228State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test228State::Fail => false,
            Test228State::Pass => false,
            Test228State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test228Event::DoneInvoke {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test228State::S1;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test228Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), "*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test228State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            Test228State::S1 => {
                ...
                if event == Test228Event::Null {
if self.safe_evaluate_guard("Var1 == 'foo'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test228State::Pass;
                            *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
