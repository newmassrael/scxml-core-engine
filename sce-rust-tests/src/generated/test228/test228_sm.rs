...
pub struct Test228Policy {
    ...
    // W3C SCXML 6.4: Static invoke child 'foo' (test228__sce_synth_invoke__foo)
    child_foo: Option<Box<sce_rust_runtime::Engine<super::test228__sce_synth_invoke__foo_sm::Test228SceSynthInvokeFooPolicy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy = super::test228__sce_synth_invoke__foo_sm::Test228SceSynthInvokeFooPolicy::new();
...
impl StatePolicy for Test228Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test228State::Fail => "fail",
            Test228State::Pass => "pass",
            Test228State::S0 => "s0",
            Test228State::S1 => "s1",
        }
    }
