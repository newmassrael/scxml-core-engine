...
// From: resources/187/test187__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test187__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test187__sce_synth_invoke__invoke_0.scxml:3"]
...
pub enum Test187SceSynthInvokeInvoke0State {
    Sub0,
    SubFinal,
}
...
pub struct Test187SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test187SceSynthInvokeInvoke0State,
...
impl Test187SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test187SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test187SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test187SceSynthInvokeInvoke0Policy {
    type State = Test187SceSynthInvokeInvoke0State;
    type Event = Test187SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test187SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test187SceSynthInvokeInvoke0State::Sub0 => 0,
            Test187SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test187SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test187SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...

{
    ...
    engine.schedule_event(
        Test187SceSynthInvokeInvoke0Event::ChildToParent,
...
impl Test187SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test187SceSynthInvokeInvoke0State,
        event: Test187SceSynthInvokeInvoke0Event,
        current_state: &mut Test187SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test187SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test187SceSynthInvokeInvoke0Event::Null {
                    ...
                    self.last_transition_is_targetless = false;
                        *current_state = Test187SceSynthInvokeInvoke0State::SubFinal;
                        *transition_taken = true;
                    return true;
                }
                false
            }
            Test187SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
