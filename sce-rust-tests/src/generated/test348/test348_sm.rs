...
// From: resources/348/test348.scxml
//
...
//! Generated Rust state machine for `test348`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test348Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test348State::S0,
...
impl Default for Test348Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test348Policy {
    type State = Test348State;
    type Event = Test348Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test348State::Fail => true,
            Test348State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test348State::Fail => "fail",
            Test348State::Pass => "pass",
            Test348State::S0 => "s0",
        }
    }
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test348Event::S0Event);
...
impl Test348Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test348State,
        event: Test348Event,
        current_state: &mut Test348State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test348State::Fail => false,
            Test348State::Pass => false,
            Test348State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test348Event::S0Event {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test348State::Pass;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test348Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), "*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test348State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
