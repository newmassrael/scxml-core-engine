...
pub struct Test225Policy {
    ...
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test225__sce_synth_invoke__invoke_0_sm::Test225SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    ...
    child_invoke_1: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test225__sce_synth_invoke__invoke_1_sm::Test225SceSynthInvokeInvoke1Policy,
            >,
        >,
    >,
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test225State::S0 => {
                ...
                {
                    let generated_invoke_id =
                        format!("{}.{}._invoke_1", "s0", self as *const _ as usize);
                    // W3C SCXML 6.4.1: Store generated invokeId in datamodel via idlocation
                    // W3C SCXML: Full runtime ID stored (test 224 checks format)
                    self.ensure_script_engine();
                    {
