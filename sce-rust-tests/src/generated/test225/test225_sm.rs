...
pub struct Test225Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test225__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test225__sce_synth_invoke__invoke_0_sm::Test225SceSynthInvokeInvoke0Policy>>>,
    pending_done_invoke_invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test225__sce_synth_invoke__invoke_1)
    child_invoke_1: Option<Box<sce_rust_runtime::Engine<super::test225__sce_synth_invoke__invoke_1_sm::Test225SceSynthInvokeInvoke1Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test225__sce_synth_invoke__invoke_0_sm::Test225SceSynthInvokeInvoke0Policy::new();
            ...
            if pending.invoke_id.contains("._invoke_1") {
                ...
                // W3C SCXML 6.4: Create child state machine
                let mut child_policy = super::test225__sce_synth_invoke__invoke_1_sm::Test225SceSynthInvokeInvoke1Policy::new();
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
...
impl StatePolicy for Test225Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test225State::Fail => "fail",
            Test225State::Pass => "pass",
            Test225State::S0 => "s0",
            Test225State::S1 => "s1",
        }
    }
