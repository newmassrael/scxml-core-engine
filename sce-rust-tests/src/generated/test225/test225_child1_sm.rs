...
// From: resources/225/test225_child1.scxml
//
...
//! Generated Rust state machine for `test225_child1`.
//!
...
impl Test225Child1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test225Child1State::SubFinal2,
            session_id: None,
...
impl Default for Test225Child1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test225Child1Policy {
    type State = Test225Child1State;
    type Event = Test225Child1Event;
    ...
    fn initial_state() -> Self::State {
        Test225Child1State::SubFinal2
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test225Child1State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test225Child1State::SubFinal2 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test225Child1Event::Null => "",
        }
    }
...
impl Test225Child1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test225Child1State,
        event: Test225Child1Event,
        current_state: &mut Test225Child1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test225Child1State::SubFinal2 => false,
            _ => false,
        }
    }
