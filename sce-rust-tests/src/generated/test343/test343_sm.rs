...
impl StatePolicy for Test343Policy {
    ...
    fn get_initial_children(
        ...
        match state {
            Test343State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test343State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test343State::S0 => Test343State::S01,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test343State::S02 => {
                ...
                if done_data_ok {
                    let mut done_meta =
                        sce_rust_runtime::EventWithMetadata::new(Test343Event::DoneStateS0);
