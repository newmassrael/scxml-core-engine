...
// From: resources/242/test242_child0.scxml
//
...
//! Generated Rust state machine for `test242_child0`.
//!
...
impl Test242Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test242Child0State::SubFinal1,
            session_id: None,
...
impl Default for Test242Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test242Child0Policy {
    type State = Test242Child0State;
    type Event = Test242Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test242Child0State::SubFinal1
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test242Child0State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test242Child0State::SubFinal1 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test242Child0Event::Null => "",
        }
    }
...
impl Test242Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test242Child0State,
        event: Test242Child0Event,
        current_state: &mut Test242Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test242Child0State::SubFinal1 => false,
            _ => false,
        }
    }
