...
pub struct Test234Policy {
    ...
    active_states: Vec<Test234State>,
    ...
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test234_child0_sm::Test234Child0Policy>>>,
    pending_done_invoke__invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test234_child1)
    child__invoke_1: Option<Box<sce_rust_runtime::Engine<super::test234_child1_sm::Test234Child1Policy>>>,
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        match se.evaluate_expression(&sid, "1") {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test234Event::ErrorExecution));
            }
        }
        // W3C SCXML 5.2/5.3: Initialize variable from expr (test 277: raise error.execution on failure)
        match se.evaluate_expression(&sid, "1") {
                ...
                if event == Test234Event::Timeout {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test234State::Fail,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test234State::P01 => {
                ...
                if event == Test234Event::ChildToParent {
                    ...
                    if self.safe_evaluate_guard("Var1 == 2", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test234State::S1,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
...
if self.safe_evaluate_guard("Var2 == 1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test234State::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
    ...
    fn compute_exit_set(source: Test234State, target: Test234State, is_internal: bool, is_targetless: bool) -> Vec<Test234State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test234State> = Vec::new();
