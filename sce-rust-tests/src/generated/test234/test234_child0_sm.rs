...
// From: resources/234/test234_child0.scxml
//
...
//! Generated Rust state machine for `test234_child0`.
//!
...
impl Test234Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test234Child0State::SubFinal1,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test234_child0", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test234Child0Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test234Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test234Child0Policy {
    type State = Test234Child0State;
    type Event = Test234Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test234Child0State::SubFinal1
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test234Child0State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test234Child0State::SubFinal1 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test234Child0Event::ChildToParent => "childToParent",
            Test234Child0Event::ErrorExecution => "error.execution",
            Test234Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test234Child0Event::ChildToParent),
            "error.execution" => Some(Test234Child0Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test234Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test234Child0State,
        event: Test234Child0Event,
        current_state: &mut Test234Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test234Child0State::SubFinal1 => false,
            _ => false,
        }
    }
