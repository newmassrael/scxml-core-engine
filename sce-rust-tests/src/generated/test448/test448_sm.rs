...
pub struct Test448Policy {
    ...
    active_states: Vec<Test448State>,
...
impl Default for Test448Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
if self.safe_evaluate_guard("var1==1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test448State::S1,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test448State::Fail,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
...
if self.safe_evaluate_guard("var2==1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test448State::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
    ...
    fn compute_exit_set(source: Test448State, target: Test448State, is_internal: bool, is_targetless: bool) -> Vec<Test448State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test448State> = Vec::new();
