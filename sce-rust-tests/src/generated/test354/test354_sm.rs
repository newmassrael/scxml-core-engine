...
// From: resources/354/test354.scxml
//
...
//! Generated Rust state machine for `test354`.
//!
...
impl Test354Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test354State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test354", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test354Event::ErrorExecution));
        }
...
impl Default for Test354Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test354Policy {
    type State = Test354State;
    type Event = Test354Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test354State::Fail => true,
            Test354State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test354Event::ErrorExecution => "error.execution",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test354Event::ErrorExecution),
...
}
{
    ...
    let event_data_string: String = {
        ...
        match se.evaluate_expression(&sid, "2") {
            Ok(val) => {
                parts.push(format!("[{:?}]={}", "param1", val.to_lua_literal()));
            }
            Err(e) => {
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test354Event::Event1);
...
}
{
    ...
    // W3C SCXML 6.2: Default send (no target = external event)
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test354Event::Event2);
        // W3C SCXML 5.10.1: External send — preserve sendid and SCXML event processor origintype
        meta.metadata = sce_rust_runtime::EventMetadata::external(send_id.clone(), String::new());
        meta.metadata.data = event_data.to_string();
        engine.raise_external_with_meta(meta);
...
impl Test354Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test354State,
        event: Test354Event,
        current_state: &mut Test354State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test354State::Fail => false,
            Test354State::Pass => false,
            Test354State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test354Event::Event1 {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test354State::S1;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test354Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), "*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test354State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            Test354State::S3 => {
                ...
                if event == Test354Event::Event2 {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test354State::Pass;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
