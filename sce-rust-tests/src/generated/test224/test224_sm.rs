...
pub struct Test224Policy {
    ...
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test224__sce_synth_invoke__invoke_0_sm::Test224SceSynthInvokeInvoke0Policy>>>,
