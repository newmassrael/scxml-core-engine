    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test488Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test488Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test488Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test488State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test488State::S01,
            ]),
    ...
    fn execute_entry_actions(&mut self, state: Self::State, engine: &mut sce_rust_runtime::Engine<Self>) {
        match state {
            Test488State::S02 => {
                ...
                if done_data_ok {
                    let mut done_meta = sce_rust_runtime::EventWithMetadata::new(Test488Event::DoneStateS0);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test488State::S1 => {
                ...
                if event != Test488Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
