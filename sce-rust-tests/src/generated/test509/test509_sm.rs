...
// From: resources/509/test509.scxml
//
...
//! Generated Rust state machine for `test509`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test509Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test509State::S0,
            session_id: None,
...
impl Default for Test509Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test509Policy {
    type State = Test509State;
    type Event = Test509Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test509State::Fail => true,
            Test509State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test509State::Fail => "fail",
            Test509State::Pass => "pass",
            Test509State::S0 => "s0",
        }
    }
...
impl Test509Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test509State,
        event: Test509Event,
        current_state: &mut Test509State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test509State::Fail => false,
            Test509State::Pass => false,
            Test509State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test509Event::Test {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test509State::Pass;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test509Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), "*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test509State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
