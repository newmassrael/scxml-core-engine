...
// From: resources/207/test207__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test207__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test207__sce_synth_invoke__invoke_0.scxml:3"]
...
pub enum Test207SceSynthInvokeInvoke0State {
    Sub0,
    SubFinal,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test207SceSynthInvokeInvoke0Event {
    ChildToParent,
    ErrorExecution,
    Event1,
    Event2,
...
pub struct Test207SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test207SceSynthInvokeInvoke0State,
...
impl Test207SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test207SceSynthInvokeInvoke0State::Sub0,
...
impl Default for Test207SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test207SceSynthInvokeInvoke0Policy {
    type State = Test207SceSynthInvokeInvoke0State;
    type Event = Test207SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test207SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test207SceSynthInvokeInvoke0State::Sub0 => 0,
            Test207SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test207SceSynthInvokeInvoke0Event::ChildToParent => "childToParent",
            Test207SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test207SceSynthInvokeInvoke0Event::Event1 => "event1",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test207SceSynthInvokeInvoke0Event::ChildToParent),
            "error.execution" => Some(Test207SceSynthInvokeInvoke0Event::ErrorExecution),
            "event1" => Some(Test207SceSynthInvokeInvoke0Event::Event1),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test207SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test207SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...

{
    ...
    engine.schedule_event(
        Test207SceSynthInvokeInvoke0Event::Event1,
...

{
    ...
    engine.schedule_event(
        Test207SceSynthInvokeInvoke0Event::Event2,
...
{
    let send_id = "__send_3".to_string();
...

{
    ...
    if let Some(ref parent_queue) = self.parent_external_queue {
        if let Ok(mut q) = parent_queue.lock() {
            q.push(("pass".to_string(), event_data.to_string()));
        }
    } else {
    }
...

{
    ...
    if let Some(ref parent_queue) = self.parent_external_queue {
        if let Ok(mut q) = parent_queue.lock() {
            q.push(("fail".to_string(), event_data.to_string()));
        }
    } else {
    }
...
impl Test207SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test207SceSynthInvokeInvoke0State,
        event: Test207SceSynthInvokeInvoke0Event,
        current_state: &mut Test207SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test207SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test207SceSynthInvokeInvoke0Event::Event1 {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test207SceSynthInvokeInvoke0State::SubFinal;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test207SceSynthInvokeInvoke0Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
            ...
            Test207SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
