...
// From: resources/207/test207_child0.scxml
//
...
//! Generated Rust state machine for `test207_child0`.
//!
...
impl Test207Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test207Child0State::Sub0,
...
impl Default for Test207Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test207Child0Policy {
    type State = Test207Child0State;
    type Event = Test207Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test207Child0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test207Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test207Child0State::Sub0 => 0,
            Test207Child0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test207Child0Event::ChildToParent => "childToParent",
            Test207Child0Event::ErrorExecution => "error.execution",
            Test207Child0Event::Event1 => "event1",
            Test207Child0Event::Event2 => "event2",
            Test207Child0Event::Fail => "fail",
            Test207Child0Event::Pass => "pass",
            Test207Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test207Child0Event::ChildToParent),
            "error.execution" => Some(Test207Child0Event::ErrorExecution),
            "event1" => Some(Test207Child0Event::Event1),
            "event2" => Some(Test207Child0Event::Event2),
            "fail" => Some(Test207Child0Event::Fail),
            "pass" => Some(Test207Child0Event::Pass),
            _ => None,
        }
    }
...
impl Test207Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test207Child0State,
        event: Test207Child0Event,
        current_state: &mut Test207Child0State,
        ...
        match check_state {
            Test207Child0State::Sub0 => {
                ...
                if event == Test207Child0Event::Event1 {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test207Child0State::SubFinal;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test207Child0Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
            ...
            Test207Child0State::SubFinal => false,
            _ => false,
        }
    }
