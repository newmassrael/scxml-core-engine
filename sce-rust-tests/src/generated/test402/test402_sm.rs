    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test402Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test402Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test402Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test402State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test402State::S01,
            ]),
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test402Event::Event1));
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test402Event::Event2));
                    }
                    _ => {}
                }
            }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test402State::S01 => {
                ...
                if event != Test402Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
