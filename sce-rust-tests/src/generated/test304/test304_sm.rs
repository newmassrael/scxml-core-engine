...
// From: resources/304/test304.scxml
//
...
//! Generated Rust state machine for `test304`.
//!
...
impl Test304Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test304State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test304", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = se.execute_script(&sid, "Var1 = 1") {
            log::error!("Global script execution failed: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test304Event::ErrorExecution));
        }
...
impl Default for Test304Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test304Policy {
    type State = Test304State;
    type Event = Test304Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test304State::Fail => true,
            Test304State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test304Event::ErrorExecution => "error.execution",
            Test304Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test304Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test304Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test304State,
        event: Test304Event,
        current_state: &mut Test304State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test304State::Fail => false,
            Test304State::Pass => false,
            Test304State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test304Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test304State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test304State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
