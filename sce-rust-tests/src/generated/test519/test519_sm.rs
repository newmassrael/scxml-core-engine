    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test519Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test519Policy {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        let mut http_params = std::collections::HashMap::<String, Vec<String>>::new();
        {
            ...
            match se.evaluate_expression(&sid, "1") {
                Ok(val) => {
                    ...
                    http_params.entry("param1".to_string()).or_default().push(trimmed.to_string());
                }
                Err(_) => {}
            }
        }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test519State::S0 => {
                ...
                if event != Test519Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
