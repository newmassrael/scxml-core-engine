...
// From: resources/422/test422__sce_synth_invoke__invoke_2.scxml
//
...
//! Generated Rust state machine for `test422__sce_synth_invoke__invoke_2`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test422__sce_synth_invoke__invoke_2.scxml:3"]
...
pub enum Test422SceSynthInvokeInvoke2State {
    Sub2,
    SubFinal2,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test422SceSynthInvokeInvoke2Event {
    ErrorExecution,
    InvokeS12,
...
pub struct Test422SceSynthInvokeInvoke2Policy {
...
impl Test422SceSynthInvokeInvoke2Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test422SceSynthInvokeInvoke2State::Sub2,
            session_id: None,
...
impl Default for Test422SceSynthInvokeInvoke2Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test422SceSynthInvokeInvoke2Policy {
    type State = Test422SceSynthInvokeInvoke2State;
    type Event = Test422SceSynthInvokeInvoke2Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test422SceSynthInvokeInvoke2State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test422SceSynthInvokeInvoke2State::Sub2 => 0,
            Test422SceSynthInvokeInvoke2State::SubFinal2 => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test422SceSynthInvokeInvoke2Event::ErrorExecution => "error.execution",
            Test422SceSynthInvokeInvoke2Event::InvokeS12 => "invokeS12",
            Test422SceSynthInvokeInvoke2Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test422SceSynthInvokeInvoke2Event::ErrorExecution),
            "invokeS12" => Some(Test422SceSynthInvokeInvoke2Event::InvokeS12),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test422SceSynthInvokeInvoke2State::Sub2 => "sub2",
            Test422SceSynthInvokeInvoke2State::SubFinal2 => "subFinal2",
        }
    }
...

{
    ...
    if let Some(ref parent_queue) = self.parent_external_queue {
        if let Ok(mut q) = parent_queue.lock() {
            q.push(("invokeS12".to_string(), event_data.to_string()));
        }
    } else {
    }
...
impl Test422SceSynthInvokeInvoke2Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test422SceSynthInvokeInvoke2State,
        event: Test422SceSynthInvokeInvoke2Event,
        current_state: &mut Test422SceSynthInvokeInvoke2State,
        ...
        match check_state {
            Test422SceSynthInvokeInvoke2State::Sub2 => {
                ...
                if event == Test422SceSynthInvokeInvoke2Event::Null {
                    ...
                    self.last_transition_is_targetless = false;
                        *current_state = Test422SceSynthInvokeInvoke2State::SubFinal2;
                        *transition_taken = true;
                    return true;
                }
                false
            }
            Test422SceSynthInvokeInvoke2State::SubFinal2 => false,
            _ => false,
        }
    }
