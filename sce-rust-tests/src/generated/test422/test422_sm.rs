...
pub struct Test422Policy {
    ...
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test422__sce_synth_invoke__invoke_0_sm::Test422SceSynthInvokeInvoke0Policy>>>,
    pending_done_invoke_invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test422__sce_synth_invoke__invoke_1)
    child_invoke_1: Option<Box<sce_rust_runtime::Engine<super::test422__sce_synth_invoke__invoke_1_sm::Test422SceSynthInvokeInvoke1Policy>>>,
    pending_done_invoke_invoke_1: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_2' (test422__sce_synth_invoke__invoke_2)
    child_invoke_2: Option<Box<sce_rust_runtime::Engine<super::test422__sce_synth_invoke__invoke_2_sm::Test422SceSynthInvokeInvoke2Policy>>>,
        ...
        for pending in &invokes_to_execute {
            ...
            if pending.invoke_id.contains("._invoke_2") {
                ...
                if self.child_invoke_2.as_ref().map_or(false, |c| c.is_in_final_state()) {
                    ...
                    // tools/codegen/templates/invoke_methods.jinja2 (child->donedataAtFinal()
                    // + EventMetadataHelper::createDoneInvokeEvent).
                    let donedata = self.child_invoke_2
                        .as_ref()
                        .map(|c| c.donedata_at_final().to_string())
                        .unwrap_or_default();
                    sce_rust_runtime::helpers::invoke_processing::raise_done_invoke(
...
impl StatePolicy for Test422Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test422State::S1 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test422State::S11,
            ]),
