...
// From: resources/422/test422__sce_synth_invoke__invoke_1.scxml
//
...
//! Generated Rust state machine for `test422__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test422__sce_synth_invoke__invoke_1.scxml:3"]
...
pub enum Test422SceSynthInvokeInvoke1State {
    Sub1,
    SubFinal1,
}
...
pub struct Test422SceSynthInvokeInvoke1Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test422SceSynthInvokeInvoke1State,
...
impl Test422SceSynthInvokeInvoke1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test422SceSynthInvokeInvoke1State::Sub1,
            session_id: None,
...
impl Default for Test422SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test422SceSynthInvokeInvoke1Policy {
    type State = Test422SceSynthInvokeInvoke1State;
    type Event = Test422SceSynthInvokeInvoke1Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test422SceSynthInvokeInvoke1State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test422SceSynthInvokeInvoke1State::Sub1 => 0,
            Test422SceSynthInvokeInvoke1State::SubFinal1 => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test422SceSynthInvokeInvoke1State::Sub1 => "sub1",
            Test422SceSynthInvokeInvoke1State::SubFinal1 => "subFinal1",
        }
    }
...
impl Test422SceSynthInvokeInvoke1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test422SceSynthInvokeInvoke1State,
        event: Test422SceSynthInvokeInvoke1Event,
        current_state: &mut Test422SceSynthInvokeInvoke1State,
        ...
        match check_state {
            Test422SceSynthInvokeInvoke1State::Sub1 => {
                ...
                if event == Test422SceSynthInvokeInvoke1Event::Null {
                    ...
                    self.last_transition_is_targetless = false;
                        *current_state = Test422SceSynthInvokeInvoke1State::SubFinal1;
                        *transition_taken = true;
                    return true;
                }
                false
            }
            Test422SceSynthInvokeInvoke1State::SubFinal1 => false,
            _ => false,
        }
    }
