...
pub struct Test240Policy {
    ...
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test240__sce_synth_invoke__invoke_0_sm::Test240SceSynthInvokeInvoke0Policy>>>,
    pending_done_invoke_invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test240__sce_synth_invoke__invoke_1)
    child_invoke_1: Option<Box<sce_rust_runtime::Engine<super::test240__sce_synth_invoke__invoke_1_sm::Test240SceSynthInvokeInvoke1Policy>>>,
...
impl Test240Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test240Event::ErrorExecution));
        }
...
impl StatePolicy for Test240Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test240State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test240State::S01,
            ]),
