...
// From: resources/240/test240__sce_synth_invoke__invoke_1.scxml
//
...
//! Generated Rust state machine for `test240__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test240__sce_synth_invoke__invoke_1.scxml:3"]
...
pub enum Test240SceSynthInvokeInvoke1State {
    Sub02,
    SubFinal2,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test240SceSynthInvokeInvoke1Event {
    ErrorExecution,
    Failure,
    Success,
...
pub struct Test240SceSynthInvokeInvoke1Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test240SceSynthInvokeInvoke1State,
...
impl Test240SceSynthInvokeInvoke1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test240SceSynthInvokeInvoke1State::Sub02,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test240__sce_synth_invoke__invoke_1", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test240SceSynthInvokeInvoke1Event::ErrorExecution));
        }
...
impl Default for Test240SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test240SceSynthInvokeInvoke1Policy {
    type State = Test240SceSynthInvokeInvoke1State;
    type Event = Test240SceSynthInvokeInvoke1Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test240SceSynthInvokeInvoke1State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test240SceSynthInvokeInvoke1State::Sub02 => 0,
            Test240SceSynthInvokeInvoke1State::SubFinal2 => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test240SceSynthInvokeInvoke1Event::ErrorExecution => "error.execution",
            Test240SceSynthInvokeInvoke1Event::Failure => "failure",
            Test240SceSynthInvokeInvoke1Event::Success => "success",
            Test240SceSynthInvokeInvoke1Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test240SceSynthInvokeInvoke1Event::ErrorExecution),
            "failure" => Some(Test240SceSynthInvokeInvoke1Event::Failure),
            "success" => Some(Test240SceSynthInvokeInvoke1Event::Success),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test240SceSynthInvokeInvoke1State::Sub02 => "sub02",
            Test240SceSynthInvokeInvoke1State::SubFinal2 => "subFinal2",
        }
    }
...
impl Test240SceSynthInvokeInvoke1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test240SceSynthInvokeInvoke1State,
        event: Test240SceSynthInvokeInvoke1Event,
        current_state: &mut Test240SceSynthInvokeInvoke1State,
        ...
        match check_state {
            Test240SceSynthInvokeInvoke1State::Sub02 => {
                ...
                if event == Test240SceSynthInvokeInvoke1Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test240SceSynthInvokeInvoke1State::SubFinal2;
            ...
            Test240SceSynthInvokeInvoke1State::SubFinal2 => false,
            _ => false,
        }
    }
