...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test419Event::InternalEvent));
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test419Event::ExternalEvent);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test419State::S1 => {
                ...
                if event != Test419Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
