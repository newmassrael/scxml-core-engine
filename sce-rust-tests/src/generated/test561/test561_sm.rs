    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test561Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test561Policy {
    fn default() -> Self {
        Self::new()
    }
}
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test561Event::Foo);
        ...
        match check_state {
            ...
            Test561State::S0 => {
                ...
                if event == Test561Event::Foo {
                    ...
                    if self.safe_evaluate_guard("_event.data:getElementsByTagName('book')[2]:getAttribute('title') == 'title2'", engine) {
                ...
                if event != Test561Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
