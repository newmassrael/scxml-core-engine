    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test496Event::ErrorExecution));
                false
            }
        }
    }
                ...
                'action_block: {
{
    ...
    // W3C SCXML 6.2: Dynamic target evaluation (targetexpr="undefined")
    {
        self.ensure_script_engine();
        let sid = self.session_id.as_ref().unwrap().clone();
        let se = sce_rust_runtime::ScriptEngineProvider::get();
        match se.evaluate_expression(&sid, "nil") {
            Ok(ref val) if matches!(val, sce_rust_runtime::ScriptValue::Null | sce_rust_runtime::ScriptValue::Undefined) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test496Event::ErrorCommunication));
            }
            Ok(val) => {
                ...
                if dynamic_target.starts_with("!") {
                    ...
                    {
                        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test496Event::Event);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test496State::S0 => {
                ...
                if event != Test496Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
