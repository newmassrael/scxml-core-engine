...
impl Test506Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test506Event::ErrorExecution));
        }
...
impl Default for Test506Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test506Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test506State::S2 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test506State::S21,
            ]),
