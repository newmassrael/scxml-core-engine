...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test364Event::InS11p112));
                }
            }
            Test364State::S21p112 => {
                // W3C SCXML 3.8: onentry block 1/1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test364Event::InS21p112));
                }
            }
            _ => {}
        }
...
impl Test364Policy {
        ...
        match check_state {
                ...
                if event == Test364Event::Timeout {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test364State::Fail,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test364State::S11p122 => {
                ...
                if event == Test364Event::InS11p112 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test364State::S2,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test364State::S21p122 => {
                ...
                if event == Test364Event::InS21p112 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test364State::S3,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test364State::S3111 => {
                ...
                if event == Test364Event::Null {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push(TransitionInfo {
                            source: check_state, target: Test364State::Pass,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
    ...
    fn compute_exit_set(source: Test364State, target: Test364State, is_internal: bool, is_targetless: bool) -> Vec<Test364State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test364State> = Vec::new();
