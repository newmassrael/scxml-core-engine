...
// From: resources/241/test241__sce_synth_invoke__invoke_2.scxml
//
...
//! Generated Rust state machine for `test241__sce_synth_invoke__invoke_2`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test241__sce_synth_invoke__invoke_2.scxml:3"]
...
pub enum Test241SceSynthInvokeInvoke2State {
    Sub03,
    SubFinal3,
}
...
pub struct Test241SceSynthInvokeInvoke2Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test241SceSynthInvokeInvoke2State,
...
impl Test241SceSynthInvokeInvoke2Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test241SceSynthInvokeInvoke2State::Sub03,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test241__sce_synth_invoke__invoke_2", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test241SceSynthInvokeInvoke2Event::ErrorExecution));
        }
...
impl Default for Test241SceSynthInvokeInvoke2Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test241SceSynthInvokeInvoke2Policy {
    type State = Test241SceSynthInvokeInvoke2State;
    type Event = Test241SceSynthInvokeInvoke2Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test241SceSynthInvokeInvoke2State::SubFinal3 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test241SceSynthInvokeInvoke2State::Sub03 => 0,
            Test241SceSynthInvokeInvoke2State::SubFinal3 => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            Test241SceSynthInvokeInvoke2Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test241SceSynthInvokeInvoke2State::Sub03 => "sub03",
            Test241SceSynthInvokeInvoke2State::SubFinal3 => "subFinal3",
        }
    }
...
impl Test241SceSynthInvokeInvoke2Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test241SceSynthInvokeInvoke2State,
        event: Test241SceSynthInvokeInvoke2Event,
        current_state: &mut Test241SceSynthInvokeInvoke2State,
        ...
        match check_state {
            Test241SceSynthInvokeInvoke2State::Sub03 => {
                ...
                if event == Test241SceSynthInvokeInvoke2Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test241SceSynthInvokeInvoke2State::SubFinal3;
            ...
            Test241SceSynthInvokeInvoke2State::SubFinal3 => false,
            _ => false,
        }
    }
