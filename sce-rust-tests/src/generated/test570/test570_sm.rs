...
impl Test570Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::ErrorExecution));
        }
...
impl Default for Test570Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test570Policy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ...
            Test570State::P0 => 3,
            Test570State::P0s1 => 4,
            Test570State::P0s11 => 5,
            Test570State::P0s1final => 6,
            Test570State::P0s2 => 7,
            Test570State::P0s21 => 8,
            Test570State::P0s2final => 9,
            Test570State::Pass => 1,
            Test570State::S1 => 0,
        }
    }
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::E2));
            ...
            Test570State::P0s1final => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::DoneStateP0s1));
                // W3C SCXML 3.4: Check if parallel grandparent p0 has all regions complete
                {
                    ...
                    if all_complete {
                        engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::DoneStateP0));
                    }
                }
            }
            Test570State::P0s2final => {
                // W3C SCXML 3.7: Generate done.state.p0s2 event
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::DoneStateP0s2));
                // W3C SCXML 3.4: Check if parallel grandparent p0 has all regions complete
                {
                    let parallel_state = Test570State::P0;
                    let regions = Self::get_parallel_regions(parallel_state);
...
impl Test570Policy {
        ...
        match check_state {
            ...
            Test570State::P0 => {
                ...
                if event == Test570Event::DoneStateP0s2 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test570State::S1,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                ...
                if event == Test570Event::Timeout {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test570State::Fail,
                                transition_index: 2,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test570State::P0s11 => {
                ...
                if event == Test570Event::E1 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test570State::P0s1final,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test570State::P0s21 => {
                ...
                if event == Test570Event::E2 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test570State::P0s2final,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test570State::S1 => {
                ...
                if event == Test570Event::DoneStateP0 {
                    ...
                    if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test570State::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                ...
                if event != Test570Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
    ...
    fn compute_exit_set(source: Test570State, target: Test570State, is_internal: bool, is_targetless: bool) -> Vec<Test570State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test570State> = Vec::new();
