...
impl Test210Policy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        match se.evaluate_expression(&sid, "'bar'") {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        match se.evaluate_expression(&sid, "'bar'") {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test210Event::ErrorExecution));
            }
        }
...
impl Default for Test210Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test210State::S0 => {
                ...
                if event != Test210Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
