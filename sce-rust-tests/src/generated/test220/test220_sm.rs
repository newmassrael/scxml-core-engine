...
pub struct Test220Policy {
    ...
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test220__sce_synth_invoke__invoke_0_sm::Test220SceSynthInvokeInvoke0Policy>>>,
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test220State::S0 => {
                ...
                if event != Test220Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
