...
// From: resources/220/test220_child0.scxml
//
...
//! Generated Rust state machine for `test220_child0`.
//!
...
impl Test220Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test220Child0State::SubFinal,
            session_id: None,
...
impl Default for Test220Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test220Child0Policy {
    type State = Test220Child0State;
    type Event = Test220Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test220Child0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test220Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test220Child0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test220Child0Event::Null => "",
        }
    }
...
impl Test220Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test220Child0State,
        event: Test220Child0Event,
        current_state: &mut Test220Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test220Child0State::SubFinal => false,
            _ => false,
        }
    }
