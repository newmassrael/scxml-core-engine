    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test336Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test336Policy {
    fn default() -> Self {
        Self::new()
    }
}
                ...
                'action_block: {
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test336Event::Foo);
                ...
                'action_block: {
{
    ...
    // W3C SCXML 6.2: Default send (no target = external event)
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test336Event::Baz);
        // W3C SCXML 5.10.1: External send — preserve sendid and SCXML event processor origintype
        meta.metadata = sce_rust_runtime::EventMetadata::external(send_id.clone(), String::new());
        meta.metadata.data = event_data.to_string();
        engine.raise_external_with_meta(meta);
                        ...
                        // W3C SCXML 3.13: Transition 0 actions
{
    ...
    let _resolved_target: Option<String> = {
        ...
        match se.evaluate_expression(&sid, "_event.origin") {
            Ok(ref val) if matches!(val, sce_rust_runtime::ScriptValue::Null | sce_rust_runtime::ScriptValue::Undefined) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test336Event::ErrorCommunication));
                None
            }
            Ok(val) => {
                ...
                if trimmed.starts_with("!") {
                    ...
                    {
                        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test336Event::ErrorExecution);
    ...
    if _rt == "#_internal" {
        {
            let mut meta = sce_rust_runtime::EventWithMetadata::new(Test336Event::Bar);
            meta.metadata.data = event_data.to_string();
            engine.raise(meta);
        }
    } else {
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test336State::S0 => {
                ...
                if event != Test336Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
