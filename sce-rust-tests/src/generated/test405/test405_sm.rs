...
impl StatePolicy for Test405Policy {
    ...
    fn get_parallel_regions(state: Self::State) -> &'static [Self::State] {
        match state {
            Test405State::S01p => &[Test405State::S01p1, Test405State::S01p2],
            _ => &[],
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test405State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test405State::S01p])
            }
            Test405State::S01p1 => {
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test405State::S0 => Test405State::S01p,
            Test405State::S01p1 => Test405State::S01p11,
            Test405State::S01p2 => Test405State::S01p21,
            _ => state,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test405State, usize)> =
...
impl Test405Policy {
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test405State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test405State> =
