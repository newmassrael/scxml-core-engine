...
// From: resources/239/test239_child0.scxml
//
...
//! Generated Rust state machine for `test239_child0`.
//!
...
impl Test239Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test239Child0State::Final,
            session_id: None,
...
impl Default for Test239Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test239Child0Policy {
    type State = Test239Child0State;
    type Event = Test239Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test239Child0State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test239Child0State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test239Child0State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test239Child0Event::Null => "",
        }
    }
...
impl Test239Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test239Child0State,
        event: Test239Child0Event,
        current_state: &mut Test239Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test239Child0State::Final => false,
            _ => false,
        }
    }
