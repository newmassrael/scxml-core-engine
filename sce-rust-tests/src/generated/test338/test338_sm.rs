...
pub struct Test338Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test338_machineName)
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test338_machineName_sm::Test338MachineNamePolicy>>>,
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test338Event::ErrorExecution));
                false
            }
        }
    }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test338_machineName_sm::Test338MachineNamePolicy::new();
...
impl Default for Test338Policy {
    fn default() -> Self {
        Self::new()
    }
}
