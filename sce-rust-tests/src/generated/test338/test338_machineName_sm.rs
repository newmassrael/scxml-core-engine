...
// From: resources/338/test338_machineName.scxml
//
...
//! Generated Rust state machine for `test338_machineName`.
//!
...
pub enum Test338MachineNameState {
    Sub0,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test338MachineNameEvent {
    ErrorExecution,
    Event1,
...
impl Test338MachineNamePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test338MachineNameState::Sub0,
            session_id: None,
...
impl Default for Test338MachineNamePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test338MachineNamePolicy {
    ...
    fn initial_state() -> Self::State {
        Test338MachineNameState::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test338MachineNameState::Sub0 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test338MachineNameState::Sub0 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test338MachineNameEvent::ErrorExecution => "error.execution",
            Test338MachineNameEvent::Event1 => "event1",
            Test338MachineNameEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test338MachineNameEvent::ErrorExecution),
            "event1" => Some(Test338MachineNameEvent::Event1),
            _ => None,
        }
    }
...
impl Test338MachineNamePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test338MachineNameState,
        event: Test338MachineNameEvent,
        current_state: &mut Test338MachineNameState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test338MachineNameState::Sub0 => false,
            _ => false,
        }
    }
