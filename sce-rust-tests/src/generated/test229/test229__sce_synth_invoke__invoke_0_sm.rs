...
// From: resources/229/test229__sce_synth_invoke__invoke_0.scxml
//
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            Test229SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event != Test229SceSynthInvokeInvoke0Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
