...
pub struct Test243Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test243__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test243__sce_synth_invoke__invoke_0_sm::Test243SceSynthInvokeInvoke0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test243__sce_synth_invoke__invoke_0_sm::Test243SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test243Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test243State::Fail => "fail",
            Test243State::Pass => "pass",
            Test243State::S0 => "s0",
        }
    }
