...
// From: resources/191/test191_child0.scxml
//
...
//! Generated Rust state machine for `test191_child0`.
//!
...
impl Test191Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test191Child0State::Sub0,
            session_id: None,
...
impl Default for Test191Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test191Child0Policy {
    type State = Test191Child0State;
    type Event = Test191Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test191Child0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test191Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test191Child0State::Sub0 => 0,
            Test191Child0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test191Child0Event::ChildToParent => "childToParent",
            Test191Child0Event::ErrorExecution => "error.execution",
            Test191Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test191Child0Event::ChildToParent),
            "error.execution" => Some(Test191Child0Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test191Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test191Child0State,
        event: Test191Child0Event,
        current_state: &mut Test191Child0State,
        ...
        match check_state {
            Test191Child0State::Sub0 => {
                ...
                if event == Test191Child0Event::Null {
                    ...
                    self.last_transition_is_targetless = false;
                        *current_state = Test191Child0State::SubFinal;
                        *transition_taken = true;
                    return true;
                }
                false
            }
            Test191Child0State::SubFinal => false,
            _ => false,
        }
    }
