...
// From: resources/191/test191__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test191__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test191__sce_synth_invoke__invoke_0.scxml:3"]
...
pub enum Test191SceSynthInvokeInvoke0State {
    Sub0,
    SubFinal,
}
...
pub struct Test191SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test191SceSynthInvokeInvoke0State,
...
impl Test191SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test191SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test191SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test191SceSynthInvokeInvoke0Policy {
    type State = Test191SceSynthInvokeInvoke0State;
    type Event = Test191SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test191SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test191SceSynthInvokeInvoke0State::Sub0 => 0,
            Test191SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test191SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test191SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...
impl Test191SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test191SceSynthInvokeInvoke0State,
        event: Test191SceSynthInvokeInvoke0Event,
        current_state: &mut Test191SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test191SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test191SceSynthInvokeInvoke0Event::Null {
                    ...
                    self.last_transition_is_targetless = false;
                        *current_state = Test191SceSynthInvokeInvoke0State::SubFinal;
                        *transition_taken = true;
                    return true;
                }
                false
            }
            Test191SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
