...
impl StatePolicy for Test580Policy {
    ...
    fn get_initial_children(
        ...
        match state {
            Test580State::S1 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test580State::S11])
            }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test580State, usize)> =
...
impl Test580Policy {
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test580State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test580State> =
