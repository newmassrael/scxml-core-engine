...
pub struct Test580Policy {
    ...
    history_sh1: Option<Vec<Test580State>>,
...
impl Test580Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test580State::S0,
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test580Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test580Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    fn execute_exit_actions(
        ...
        if state == Test580State::S1 {
            ...
            let filtered: Vec<Self::State> = pre_transition_active.iter()
                .filter(|&&s| Self::get_parent(s) == Some(Test580State::S1))
                .copied()
                .collect();
...
impl Test580Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test580State,
        event: Test580Event,
        current_state: &mut Test580State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut Vec<TransitionInfo>>,
    ) -> bool {
        match check_state {
            Test580State::Fail => false,
            Test580State::P1 => false,
            Test580State::Pass => false,
            Test580State::S0 => {
                ...
                if event == Test580Event::Timeout {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test580State::Fail,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = Test580State::Fail;
...
if self.is_state_active("sh1") {
                        ...
                        return true;
} else if self.safe_evaluate_guard("Var1 == 0", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        if let Some(ref mut collect) = collect_mode {
                            let resolved_target = self.resolve_history_target_sh1();
                            collect.push(TransitionInfo {
                            ...
                            *current_state = self.resolve_history_target_sh1();
                            *transition_taken = true;
                        }
                        return true;
} else if self.safe_evaluate_guard("Var1 == 1", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test580State::Pass,
                                transition_index: 2,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = Test580State::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    }
...
if self.is_state_active("sh1") {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test580State::S12,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = Test580State::S12;
                            *transition_taken = true;
                        }
                        return true;
                    }
            ...
            Test580State::S12 => false,
            _ => false,
        }
    }

    // W3C SCXML 3.11: Resolve history target for sh1
    fn resolve_history_target_sh1(&self) -> Test580State {
    ...
    fn compute_exit_set(source: Test580State, target: Test580State, is_internal: bool, is_targetless: bool) -> Vec<Test580State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test580State> = Vec::new();
        for trans in transitions {
            ...
            let domain: Option<Test580State> = if is_internal_to_descendant {
                Some(trans.source)
            } else {
