...
// From: resources/307/test307.scxml
//
...
//! Generated Rust state machine for `test307`.
//!
...
impl Test307Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test307State::S0,
...
impl Default for Test307Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test307Policy {
    type State = Test307State;
    type Event = Test307Event;
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test307Event::Bar => "bar",
            Test307Event::Error => "error",
            Test307Event::ErrorExecution => "error.execution",
            Test307Event::Foo => "foo",
            Test307Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "bar" => Some(Test307Event::Bar),
            "error" => Some(Test307Event::Error),
            "error.execution" => Some(Test307Event::ErrorExecution),
            "foo" => Some(Test307Event::Foo),
            _ => None,
        }
    }
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test307Event::Foo));
                }
            }
            Test307State::S1 => {
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test307Event::Bar));
                }
            }
            _ => {}
        }
...
impl Test307Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test307State,
        event: Test307Event,
        current_state: &mut Test307State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test307State::Final => false,
            Test307State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Precomputed prefix match for "error"
                if event == Test307Event::Error || event == Test307Event::ErrorExecution {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test307State::S1;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test307Event::Foo {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
            ...
            Test307State::S1 => {
                ...
                if event == Test307Event::Error || event == Test307Event::ErrorExecution {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test307State::Final;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test307Event::Bar {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 1;
                        self.has_transition_actions = true;
