...
impl StatePolicy for Test409Policy {
    ...
    fn get_initial_children(
        ...
        match state {
            Test409State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test409State::S01])
            }
            Test409State::S01 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test409State::S011])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test409State::S0 => Test409State::S01,
            Test409State::S01 => Test409State::S011,
            _ => state,
        }
    }
