...
pub struct Test409Policy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test409State>,
...
impl StatePolicy for Test409Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test409State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test409State::S01,
            ]),
            Test409State::S01 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test409State::S011,
            ]),
