...
// From: resources/436/test436.scxml
//
...
//! Generated Rust state machine for `test436`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub struct Test436Policy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test436State>,
...
impl Test436Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test436State::Ps0,
...
impl Default for Test436Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test436Policy {
    type State = Test436State;
    type Event = Test436Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test436State::Fail => true,
            Test436State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test436State::Ps0 => Some(Test436State::P),
            Test436State::Ps1 => Some(Test436State::P),
            _ => None,
        }
    }
    ...
    fn get_parallel_regions(state: Self::State) -> &'static [Self::State] {
        match state {
            Test436State::P => &[Test436State::Ps0, Test436State::Ps1],
            _ => &[],
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test436State::Fail => "fail",
            Test436State::P => "p",
            Test436State::Pass => "pass",
            Test436State::Ps0 => "ps0",
            Test436State::Ps1 => "ps1",
            Test436State::S1 => "s1",
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test436State, usize)> =
...
impl Test436Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test436State,
        event: Test436Event,
        current_state: &mut Test436State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            Test436State::Fail => false,
            Test436State::P => false,
            Test436State::Pass => false,
            Test436State::Ps0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test436Event::Null {
                    if self.is_state_active("s1") {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test436State::Fail;
                            *transition_taken = true;
                        }
                        return true;
                    } else if self.is_state_active("ps1") {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test436State::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    } else {
            ...
            Test436State::Ps1 => false,
            Test436State::S1 => false,
            _ => false,
        }
    }
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test436State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test436State> =
        ...
        for trans in transitions {
            ...
            let domain: Option<Test436State> = if is_internal_to_descendant {
                Some(trans.source)
            } else {
