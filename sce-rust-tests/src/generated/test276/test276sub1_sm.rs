...
// From: resources/276/test276sub1.scxml
//
...
//! Generated Rust state machine for `test276sub1`.
//!
...
impl Test276sub1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test276sub1State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test276sub1", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        match se.evaluate_expression(&sid, "0") {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test276sub1Event::ErrorExecution));
            }
        }
...
impl Default for Test276sub1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test276sub1Policy {
    type State = Test276sub1State;
    type Event = Test276sub1Event;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test276sub1State::Final => 1,
            Test276sub1State::S0 => 0,
        }
    }
...
impl Test276sub1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test276sub1State,
        event: Test276sub1Event,
        current_state: &mut Test276sub1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test276sub1State::Final => false,
            Test276sub1State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test276sub1Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test276sub1State::Final;
