...
pub struct Test276Policy {
    ...
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test276sub1_sm::Test276sub1Policy>>>,
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test276Event::ErrorExecution));
                false
            }
        }
    }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test276sub1_sm::Test276sub1Policy::new();
...
impl Default for Test276Policy {
    fn default() -> Self {
        Self::new()
    }
}
