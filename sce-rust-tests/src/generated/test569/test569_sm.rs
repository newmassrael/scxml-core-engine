...
// From: resources/569/test569.scxml
//
...
//! Generated Rust state machine for `test569`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test569Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test569State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test569", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test569Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test569Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test569Policy {
    type State = Test569State;
    type Event = Test569Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test569State::Fail => true,
            Test569State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test569Event::ErrorExecution => "error.execution",
            Test569Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test569Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test569State::Fail => "fail",
            Test569State::Pass => "pass",
            Test569State::S0 => "s0",
        }
    }
...
impl Test569Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test569State,
        event: Test569Event,
        current_state: &mut Test569State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test569State::Fail => false,
            Test569State::Pass => false,
            Test569State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test569Event::Null {
if self.safe_evaluate_guard("_scxml_truthy(_ioprocessors['scxml'].location)", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test569State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test569State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
