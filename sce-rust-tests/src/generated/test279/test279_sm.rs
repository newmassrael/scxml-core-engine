...
// From: resources/279/test279.scxml
//
...
//! Generated Rust state machine for `test279`.
//!
...
impl Test279Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test279State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test279", &io_processors) {
...
impl Default for Test279Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test279Policy {
    type State = Test279State;
    type Event = Test279Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test279State::Fail => true,
            Test279State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test279Event::ErrorExecution => "error.execution",
            Test279Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test279Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test279Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test279State,
        event: Test279Event,
        current_state: &mut Test279State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test279State::Fail => false,
            Test279State::Pass => false,
            Test279State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test279Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test279State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test279State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
