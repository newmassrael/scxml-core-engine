...
pub struct Test533Policy {
    ...
    active_states: Vec<Test533State>,
...
impl Test533Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test533Event::ErrorExecution));
        }
...
impl Default for Test533Policy {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        match check_state {
            ...
            Test533State::P => {
                ...
                if event == Test533Event::Foo {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::Ps1,
                                transition_index: 0,
                                has_actions: true,
                                is_internal: false,
                                is_targetless: false,
                ...
                if event == Test533Event::Bar {
                    ...
                    if self.safe_evaluate_guard("Var4 == 1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::S2,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                ...
                if event == Test533Event::Bar {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::Fail,
                                transition_index: 2,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
            ...
            Test533State::S1 => {
                ...
                if event == Test533Event::Null {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push(TransitionInfo {
                            source: check_state, target: Test533State::P,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
...
if self.safe_evaluate_guard("Var1 == 2", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::S3,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
...
if self.safe_evaluate_guard("Var2 == 2", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::S4,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
...
if self.safe_evaluate_guard("Var3 == 2", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test533State::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
    ...
    fn compute_exit_set(source: Test533State, target: Test533State, is_internal: bool, is_targetless: bool) -> Vec<Test533State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test533State> = Vec::new();
