...
// From: resources/253/test253__sce_synth_invoke__foo.scxml
//
...
impl Test253SceSynthInvokeFooPolicy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test253__sce_synth_invoke__foo", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test253SceSynthInvokeFooEvent::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test253SceSynthInvokeFooPolicy {
    fn default() -> Self {
        Self::new()
    }
}
