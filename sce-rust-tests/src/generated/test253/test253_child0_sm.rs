...
// From: resources/253/test253_child0.scxml
//
...
//! Generated Rust state machine for `test253_child0`.
//!
...
impl Test253Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test253Child0State::Sub0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test253_child0", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test253Child0Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test253Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test253Child0Policy {
    type State = Test253Child0State;
    type Event = Test253Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test253Child0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test253Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test253Child0State::Sub0 => 0,
            Test253Child0State::Sub1 => 1,
            Test253Child0State::SubFinal => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test253Child0Event::ChildRunning => "childRunning",
            Test253Child0Event::ErrorExecution => "error.execution",
            Test253Child0Event::Failure => "failure",
            Test253Child0Event::ParentToChild => "parentToChild",
            Test253Child0Event::Success => "success",
            Test253Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childRunning" => Some(Test253Child0Event::ChildRunning),
            "error.execution" => Some(Test253Child0Event::ErrorExecution),
            "failure" => Some(Test253Child0Event::Failure),
            "parentToChild" => Some(Test253Child0Event::ParentToChild),
            "success" => Some(Test253Child0Event::Success),
            _ => None,
        }
    }
...
impl Test253Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test253Child0State,
        event: Test253Child0Event,
        current_state: &mut Test253Child0State,
        ...
        match check_state {
            Test253Child0State::Sub0 => {
                ...
                if event == Test253Child0Event::ParentToChild {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test253Child0State::Sub1;
            ...
            Test253Child0State::Sub1 => {
                ...
                if event == Test253Child0Event::Null {
if self.safe_evaluate_guard("Var2 == 'http://www.w3.org/TR/scxml/#SCXMLEventProcessor'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test253Child0State::SubFinal;
                            *transition_taken = true;
                        return true;
            ...
            Test253Child0State::SubFinal => false,
            _ => false,
        }
    }
