...
pub struct Test253Policy {
    ...
    // W3C SCXML 6.4: Static invoke child 'foo' (test253_child0)
    child_foo: Option<Box<sce_rust_runtime::Engine<super::test253_child0_sm::Test253Child0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy = super::test253_child0_sm::Test253Child0Policy::new();
    ...
    fn execute_exit_actions(
        ...
        match state {
            Test253State::S0 => {
                ...
                // W3C SCXML 6.4: Cleanup running child 'foo'
