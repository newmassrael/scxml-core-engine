...
pub struct Test245Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test245_child0)
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test245_child0_sm::Test245Child0Policy>>>,
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        match se.evaluate_expression(&sid, "3") {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test245Event::ErrorExecution));
            }
        }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test245_child0_sm::Test245Child0Policy::new();
...
impl Default for Test245Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test245State::S0 => {
                ...
                if event != Test245Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
