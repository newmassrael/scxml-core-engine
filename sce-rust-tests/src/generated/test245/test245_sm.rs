...
pub struct Test245Policy {
    ...
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test245__sce_synth_invoke__invoke_0_sm::Test245SceSynthInvokeInvoke0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test245__sce_synth_invoke__invoke_0_sm::Test245SceSynthInvokeInvoke0Policy::new();
