...
// From: resources/245/test245__sce_synth_invoke__invoke_0.scxml
//
...
impl Test245SceSynthInvokeInvoke0Policy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test245__sce_synth_invoke__invoke_0", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test245SceSynthInvokeInvoke0Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test245SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
