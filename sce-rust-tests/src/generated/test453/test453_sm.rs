...
impl Default for Test453Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test453Event::Event1));
                }
            }
            _ => {}
        }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test453State::S0 => {
                ...
                if event != Test453Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
