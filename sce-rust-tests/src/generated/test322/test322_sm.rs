...
// From: resources/322/test322.scxml
//
...
//! Generated Rust state machine for `test322`.
//!
...
impl Test322Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test322State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test322", &io_processors) {
...
impl Default for Test322Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test322Policy {
    type State = Test322State;
    type Event = Test322Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test322State::Fail => true,
            Test322State::Pass => true,
            _ => false,
        }
    }
...
impl Test322Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test322State,
        event: Test322Event,
        current_state: &mut Test322State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test322State::Fail => false,
            Test322State::Pass => false,
            Test322State::S0 => {
