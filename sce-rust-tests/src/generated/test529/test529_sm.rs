...
impl Default for Test529Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test529Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test529State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test529State::S01,
            ]),
    ...
    fn execute_entry_actions(&mut self, state: Self::State, engine: &mut sce_rust_runtime::Engine<Self>) {
        match state {
            Test529State::S02 => {
                ...
                if done_data_ok {
                    let mut done_meta = sce_rust_runtime::EventWithMetadata::new(Test529Event::DoneStateS0);
