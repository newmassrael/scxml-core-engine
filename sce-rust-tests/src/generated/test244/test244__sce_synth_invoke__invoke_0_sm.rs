...
// From: resources/244/test244__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test244__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:3"]
...
pub enum Test244SceSynthInvokeInvoke0State {
    Sub0,
    SubFinal,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test244SceSynthInvokeInvoke0Event {
    ErrorExecution,
    Failure,
    Success,
...
pub struct Test244SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test244SceSynthInvokeInvoke0State,
...
impl Test244SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test244SceSynthInvokeInvoke0State::Sub0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test244__sce_synth_invoke__invoke_0", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test244SceSynthInvokeInvoke0Event::ErrorExecution));
        }
...
impl Default for Test244SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test244SceSynthInvokeInvoke0Policy {
    type State = Test244SceSynthInvokeInvoke0State;
    type Event = Test244SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test244SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test244SceSynthInvokeInvoke0State::Sub0 => 0,
            Test244SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test244SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test244SceSynthInvokeInvoke0Event::Failure => "failure",
            Test244SceSynthInvokeInvoke0Event::Success => "success",
            Test244SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test244SceSynthInvokeInvoke0Event::ErrorExecution),
            "failure" => Some(Test244SceSynthInvokeInvoke0Event::Failure),
            "success" => Some(Test244SceSynthInvokeInvoke0Event::Success),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test244SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test244SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...
impl Test244SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test244SceSynthInvokeInvoke0State,
        event: Test244SceSynthInvokeInvoke0Event,
        current_state: &mut Test244SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test244SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test244SceSynthInvokeInvoke0Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test244SceSynthInvokeInvoke0State::SubFinal;
            ...
            Test244SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
