...
// From: resources/311/test311.scxml
//
...
//! Generated Rust state machine for `test311`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test311Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test311State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test311", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test311Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test311Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test311Policy {
    type State = Test311State;
    type Event = Test311Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test311State::Fail => true,
            Test311State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test311State::Fail => "fail",
            Test311State::Pass => "pass",
            Test311State::S0 => "s0",
        }
    }
...
impl Test311Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test311State,
        event: Test311Event,
        current_state: &mut Test311State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test311State::Fail => false,
            Test311State::Pass => false,
            Test311State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test311Event::ErrorExecution {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test311State::Pass;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test311Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), ".*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test311State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
