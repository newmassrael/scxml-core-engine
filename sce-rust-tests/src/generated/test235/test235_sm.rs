    ...
    child_foo: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test235__sce_synth_invoke__foo_sm::Test235SceSynthInvokeFooPolicy,
            >,
        >,
    >,
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy =
                    super::test235__sce_synth_invoke__foo_sm::Test235SceSynthInvokeFooPolicy::new();
