...
pub struct Test235Policy {
    ...
    // W3C SCXML 6.4: Static invoke child 'foo' (test235__sce_synth_invoke__foo)
    child_foo: Option<Box<sce_rust_runtime::Engine<super::test235__sce_synth_invoke__foo_sm::Test235SceSynthInvokeFooPolicy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".foo") {
                ...
                let mut child_policy = super::test235__sce_synth_invoke__foo_sm::Test235SceSynthInvokeFooPolicy::new();
...
impl StatePolicy for Test235Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test235State::Fail => "fail",
            Test235State::Pass => "pass",
            Test235State::S0 => "s0",
        }
    }
