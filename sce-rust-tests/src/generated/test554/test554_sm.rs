...
pub struct Test554Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test554__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test554__sce_synth_invoke__invoke_0_sm::Test554SceSynthInvokeInvoke0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test554__sce_synth_invoke__invoke_0_sm::Test554SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test554Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test554State::Fail => "fail",
            Test554State::Pass => "pass",
            Test554State::S0 => "s0",
        }
    }
