...
impl Test444Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test444Event::ErrorExecution));
        }
...
impl Default for Test444Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
if self.safe_evaluate_guard("(function() var1 = var1 + 1 return var1 end)()==2", engine) {
