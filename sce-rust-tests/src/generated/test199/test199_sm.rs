                ...
                'action_block: {
{
    ...
    {
        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test199Event::ErrorExecution);
...
}
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test199Event::Timeout);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test199State::S0 => {
                ...
                if event != Test199Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
