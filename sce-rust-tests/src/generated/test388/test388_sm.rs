...
impl StatePolicy for Test388Policy {
    ...
    fn get_initial_children(
        ...
        match state {
            Test388State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test388State::S01])
            }
            Test388State::S01 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test388State::S011])
            }
            Test388State::S02 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test388State::S021])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test388State::S0 => Test388State::S01,
            Test388State::S01 => Test388State::S011,
            Test388State::S02 => Test388State::S021,
            _ => state,
        }
    }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test388State::S0 => {
                ...
                if event == Test388Event::Entering
                    || event == Test388Event::EnteringS011
                    || event == Test388Event::EnteringS012
                    || event == Test388Event::EnteringS021
                    || event == Test388Event::EnteringS022
                {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("Var1 == 2", engine) {
                        // W3C SCXML 3.4: Track transition metadata
