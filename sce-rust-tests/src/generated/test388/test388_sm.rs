...
// From: resources/388/test388.scxml
//
...
//! Generated Rust state machine for `test388`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test388Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test388State::S012,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test388", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test388Event::ErrorExecution));
        }
...
impl Default for Test388Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test388Policy {
    type State = Test388State;
    type Event = Test388Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test388State::Fail => true,
            Test388State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test388State::S01 => Some(Test388State::S0),
            Test388State::S011 => Some(Test388State::S01),
            Test388State::S012 => Some(Test388State::S01),
            Test388State::S02 => Some(Test388State::S0),
            Test388State::S021 => Some(Test388State::S02),
            Test388State::S022 => Some(Test388State::S02),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test388State::S0 => true,
            Test388State::S01 => true,
            Test388State::S02 => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test388Event::Entering => "entering",
            Test388Event::EnteringS011 => "entering.s011",
            Test388Event::EnteringS012 => "entering.s012",
            Test388Event::EnteringS021 => "entering.s021",
            Test388Event::EnteringS022 => "entering.s022",
            Test388Event::ErrorExecution => "error.execution",
            Test388Event::Timeout => "timeout",
            Test388Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "entering" => Some(Test388Event::Entering),
            "entering.s011" => Some(Test388Event::EnteringS011),
            "entering.s012" => Some(Test388Event::EnteringS012),
            "entering.s021" => Some(Test388Event::EnteringS021),
            "entering.s022" => Some(Test388Event::EnteringS022),
            "error.execution" => Some(Test388Event::ErrorExecution),
            "timeout" => Some(Test388Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test388State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test388State::S01,
            ]),
            Test388State::S01 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test388State::S011,
            ]),
            Test388State::S02 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test388State::S021,
            ]),
...
// W3C SCXML 3.8.1: <raise event="entering.s011">
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test388Event::EnteringS011));
                }
            }
            Test388State::S012 => {
                // W3C SCXML 3.8: onentry block 1/1
...
// W3C SCXML 3.8.1: <raise event="entering.s012">
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test388Event::EnteringS012));
                }
            }
            Test388State::S021 => {
                // W3C SCXML 3.8: onentry block 1/1
...
// W3C SCXML 3.8.1: <raise event="entering.s021">
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test388Event::EnteringS021));
                }
            }
            Test388State::S022 => {
                // W3C SCXML 3.8: onentry block 1/1
...
// W3C SCXML 3.8.1: <raise event="entering.s022">
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test388Event::EnteringS022));
                }
            }
            _ => {}
        }
    ...
    fn execute_exit_actions(
        ...
        if state == Test388State::S0 {
            ...
            let filtered: Vec<Self::State> = pre_transition_active.iter()
                .filter(|&&s| Self::is_descendant_of(s, Test388State::S0)
...
impl Test388Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test388State,
        event: Test388Event,
        current_state: &mut Test388State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test388State::Fail => false,
            Test388State::Pass => false,
            Test388State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test388Event::EnteringS012 {
                ...
                if event == Test388Event::EnteringS012 {
                    ...
                    if self.safe_evaluate_guard("Var1 == 2", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test388State::S2;
                            *transition_taken = true;
                        return true;
                    }
                }
                // W3C SCXML 5.9.3: Precomputed prefix match for "entering"
                if event == Test388Event::Entering || event == Test388Event::EnteringS011 || event == Test388Event::EnteringS012 || event == Test388Event::EnteringS021 || event == Test388Event::EnteringS022 {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("Var1 == 2", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test388State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test388Event::EnteringS011 {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("Var1 == 3", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test388State::Pass;
                            *transition_taken = true;
                        return true;
                    }
                }
            ...
            Test388State::S01 => false,
            Test388State::S011 => false,
            Test388State::S012 => false,
            Test388State::S02 => false,
            Test388State::S021 => false,
            Test388State::S022 => false,
            Test388State::S1 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test388Event::Null {
                    ...
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                        *current_state = self.resolve_history_target_s0HistDeep();
                        *transition_taken = true;
                    return true;
                }
                false
    ...
    fn resolve_history_target_s0HistDeep(&self) -> Test388State {
    ...
    fn resolve_history_target_s0HistShallow(&self) -> Test388State {
