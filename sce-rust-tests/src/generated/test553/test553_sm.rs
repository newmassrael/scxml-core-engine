    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test553Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test553Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
}
{
    ...
    let event_data_string: String = {
        ...
        if !se.has_variable(&sid, "__undefined_variable_for_error__") {
            ...
            match se.evaluate_expression(&sid, "__undefined_variable_for_error__") {
                Ok(val) => {
                    parts.push(format!("[{:?}]={}", "__undefined_variable_for_error__", val.to_lua_literal()));
                }
                Err(e) => {
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test553Event::Event1);
