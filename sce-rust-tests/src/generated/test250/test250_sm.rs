...
pub struct Test250Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test250_child0)
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test250_child0_sm::Test250Child0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test250_child0_sm::Test250Child0Policy::new();
