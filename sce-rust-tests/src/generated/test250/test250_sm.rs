...
// From: resources/250/test250.scxml
//
...
//! Generated Rust state machine for `test250`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub struct Test250Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test250State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test250__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::test250__sce_synth_invoke__invoke_0_sm::Test250SceSynthInvokeInvoke0Policy>>>,
...
impl Test250Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test250State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test250", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test250Event::ErrorExecution));
                false
            }
        }
    }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test250__sce_synth_invoke__invoke_0_sm::Test250SceSynthInvokeInvoke0Policy::new();
...
impl Default for Test250Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test250Policy {
    type State = Test250State;
    type Event = Test250Event;
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test250Event::CancelInvoke => "cancel.invoke",
            Test250Event::DoneInvoke => "done.invoke",
            Test250Event::ErrorExecution => "error.execution",
            Test250Event::Foo => "foo",
            Test250Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test250Event::CancelInvoke),
            "done.invoke" => Some(Test250Event::DoneInvoke),
            "error.execution" => Some(Test250Event::ErrorExecution),
            "foo" => Some(Test250Event::Foo),
            _ => None,
        }
    }
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test250Event::Foo);
...
impl Test250Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test250State,
        event: Test250Event,
        current_state: &mut Test250State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test250State::Final => false,
            Test250State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test250Event::Foo {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test250State::Final;
