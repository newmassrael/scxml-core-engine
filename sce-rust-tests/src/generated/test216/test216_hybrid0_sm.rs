...
// From: sce-rust-tests/src/generated/test216/test216_hybrid0.scxml
//
...
//! Generated Rust state machine for `test216_hybrid0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test216_hybrid0.scxml:2"]
// SCE-MAP: test216_hybrid0.scxml:2
...
impl Test216Hybrid0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test216Hybrid0State::Final,
            session_id: None,
...
impl Default for Test216Hybrid0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test216Hybrid0Policy {
    type State = Test216Hybrid0State;
    type Event = Test216Hybrid0Event;
    ...
    fn initial_state() -> Self::State {
        Test216Hybrid0State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test216Hybrid0State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test216Hybrid0State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test216Hybrid0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test216Hybrid0State::Final => "final",
        }
    }
...
impl Test216Hybrid0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test216Hybrid0State,
        event: Test216Hybrid0Event,
        current_state: &mut Test216Hybrid0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test216Hybrid0State::Final => false,
            _ => false,
        }
    }
}
