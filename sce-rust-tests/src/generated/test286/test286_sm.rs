    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test286Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test286Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test286State::S0 => {
                ...
                if event != Test286Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
