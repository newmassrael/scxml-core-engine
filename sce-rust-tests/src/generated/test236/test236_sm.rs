...
pub struct Test236Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test236_child0)
    child__invoke_0: Option<Box<sce_rust_runtime::Engine<super::test236_child0_sm::Test236Child0Policy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test236_child0_sm::Test236Child0Policy::new();
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test236State::S1 => {
                ...
                if event != Test236Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
