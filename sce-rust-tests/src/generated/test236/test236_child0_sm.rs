...
// From: resources/236/test236_child0.scxml
//
...
//! Generated Rust state machine for `test236_child0`.
//!
...
impl Test236Child0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test236Child0State::SubFinal,
            session_id: None,
...
impl Default for Test236Child0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test236Child0Policy {
    type State = Test236Child0State;
    type Event = Test236Child0Event;
    ...
    fn initial_state() -> Self::State {
        Test236Child0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test236Child0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test236Child0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test236Child0Event::ChildToParent => "childToParent",
            Test236Child0Event::ErrorExecution => "error.execution",
            Test236Child0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test236Child0Event::ChildToParent),
            "error.execution" => Some(Test236Child0Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test236Child0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test236Child0State,
        event: Test236Child0Event,
        current_state: &mut Test236Child0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test236Child0State::SubFinal => false,
            _ => false,
        }
    }
