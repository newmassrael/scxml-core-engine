...
// From: resources/159/test159.scxml
//
...
//! Generated Rust state machine for `test159`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test159.scxml:6"]
// SCE-MAP: test159.scxml:6
...
impl Test159Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test159State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test159", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test159Event::ErrorExecution));
        }
...
impl Default for Test159Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test159Policy {
    type State = Test159State;
    type Event = Test159Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test159State::Fail => true,
            Test159State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test159Event::ErrorExecution => "error.execution",
            Test159Event::ThisWillFail => "thisWillFail",
            Test159Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test159Event::ErrorExecution),
            "thisWillFail" => Some(Test159Event::ThisWillFail),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test159State::Fail => "fail",
            Test159State::Pass => "pass",
            Test159State::S0 => "s0",
        }
    }
...

{
    ...
    // W3C SCXML 6.2: Invalid target "!invalid" raises error.execution
    {
        ...
        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test159Event::ErrorExecution);
...
impl Test159Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test159State,
        event: Test159Event,
        current_state: &mut Test159State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test159State::Fail => false,
            Test159State::Pass => false,
            Test159State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test159Event::Null {
if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test159State::Fail;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test159State::Pass;
                            *transition_taken = true;
                        return true;
                    }
                }
