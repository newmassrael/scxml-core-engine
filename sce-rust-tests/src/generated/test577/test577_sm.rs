                ...
                'action_block: {
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test577Event::Event1);
...
}
{
    ...
    {
        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test577Event::ErrorCommunication);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test577State::S0 => {
                ...
                if event != Test577Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
