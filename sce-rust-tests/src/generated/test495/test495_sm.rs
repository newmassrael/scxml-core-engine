                ...
                'action_block: {
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test495Event::Event1);
...
}
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test495Event::Event2);
        meta.metadata.data = event_data.to_string();
        engine.raise(meta);
    }
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test495State::S1 => {
                ...
                if event != Test495Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
