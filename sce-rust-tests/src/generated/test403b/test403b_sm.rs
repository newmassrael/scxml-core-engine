...
impl Test403bPolicy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "0") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test403bEvent::ErrorExecution));
        }
...
impl Default for Test403bPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test403bPolicy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test403bState::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test403bState::P0,
            ]),
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test403bEvent::Event1));

// W3C SCXML 3.8.1: <raise event="event2">
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test403bEvent::Event2));
                }
            }
            _ => {}
        }
...
impl Test403bPolicy {
            ...
            Test403bState::P0s1 => {
                ...
                if event == Test403bEvent::Event2 {
                    ...
                    if self.safe_evaluate_guard("Var1 == 1", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test403bState::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                ...
                if event == Test403bEvent::Event2 {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test403bState::Fail,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
    ...
    fn compute_exit_set(source: Test403bState, target: Test403bState, is_internal: bool, is_targetless: bool) -> Vec<Test403bState> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test403bState> = Vec::new();
