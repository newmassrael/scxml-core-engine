...
if self.is_state_active("s1") {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test451State::Pass,
                                transition_index: 0,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push(TransitionInfo {
                                source: check_state, target: Test451State::Fail,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
    ...
    fn compute_exit_set(source: Test451State, target: Test451State, is_internal: bool, is_targetless: bool) -> Vec<Test451State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: Vec<Test451State> = Vec::new();
