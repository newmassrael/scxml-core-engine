...
// From: resources/331/test331.scxml
//
...
//! Generated Rust state machine for `test331`.
//!
...
impl Test331Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test331State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test331", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test331Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test331Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test331Policy {
    type State = Test331State;
    type Event = Test331Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test331State::Fail => true,
            Test331State::Pass => true,
            _ => false,
        }
    }
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(Test331Event::Foo));
                }
            }
            Test331State::S2 => {
                // W3C SCXML 3.8: onentry block 1/1
...

{
    ...
    log::error!("W3C SCXML 5.3: Invalid assign location ''");
    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test331Event::ErrorExecution));
}
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test331Event::Foo);
...
impl Test331Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test331State,
        event: Test331Event,
        current_state: &mut Test331State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test331State::Fail => false,
            Test331State::Pass => false,
            Test331State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test331Event::Foo {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test331State::S1;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test331Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
                    Self::get_event_name(event), "*") {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = Test331State::Fail;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            Test331State::S1 => {
                ...
                if event == Test331Event::Null {
if self.safe_evaluate_guard("Var1 == 'internal'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
            ...
            Test331State::S2 => {
                ...
                if event == Test331Event::Error || event == Test331Event::ErrorExecution {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
            ...
            Test331State::S3 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test331Event::Null {
if self.safe_evaluate_guard("Var1 == 'platform'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
            ...
            Test331State::S5 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test331Event::Null {
if self.safe_evaluate_guard("Var1 == 'external'", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test331State::Pass;
                            *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
