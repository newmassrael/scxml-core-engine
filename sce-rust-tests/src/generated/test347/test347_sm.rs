...
pub struct Test347Policy {
    ...
    // W3C SCXML 6.4: Static invoke child 'child' (test347_machineName)
    child_child: Option<Box<sce_rust_runtime::Engine<super::test347_machineName_sm::Test347MachineNamePolicy>>>,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".child") {
                ...
                let mut child_policy = super::test347_machineName_sm::Test347MachineNamePolicy::new();
                ...
                {
                    let child_ref = self.child_child.as_ref().unwrap();
                ...
                if self.child_child.as_ref().map_or(false, |c| c.is_in_final_state()) {
                    ...
                    let runtime_invoke_id = "child".to_string();
                    {
                        let mut done_meta = sce_rust_runtime::EventWithMetadata::new(
                            Test347Event::DoneInvoke);
    ...
    fn execute_exit_actions(
        ...
        match state {
            Test347State::S0 => {
                ...
                // W3C SCXML 6.4: Cleanup running child 'child'
