...
// From: resources/445/test445.scxml
//
...
//! Generated Rust state machine for `test445`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test445Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test445State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test445", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test445Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test445Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test445Policy {
    type State = Test445State;
    type Event = Test445Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test445State::Fail => true,
            Test445State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test445Event::ErrorExecution => "error.execution",
            Test445Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test445Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test445State::Fail => "fail",
            Test445State::Pass => "pass",
            Test445State::S0 => "s0",
        }
    }
...
impl Test445Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test445State,
        event: Test445Event,
        current_state: &mut Test445State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test445State::Fail => false,
            Test445State::Pass => false,
            Test445State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test445Event::Null {
if self.safe_evaluate_guard("var1==nil", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test445State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test445State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
