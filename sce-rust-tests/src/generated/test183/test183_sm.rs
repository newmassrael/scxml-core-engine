...
// From: resources/183/test183.scxml
//
...
//! Generated Rust state machine for `test183`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test183Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test183State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test183", &io_processors) {
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test183Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test183Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test183Policy {
    type State = Test183State;
    type Event = Test183Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test183State::Fail => true,
            Test183State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test183Event::ErrorExecution => "error.execution",
            Test183Event::Event1 => "event1",
            Test183Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test183Event::ErrorExecution),
            "event1" => Some(Test183Event::Event1),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test183State::Fail => "fail",
            Test183State::Pass => "pass",
            Test183State::S0 => "s0",
        }
    }
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test183Event::Event1);
...
impl Test183Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test183State,
        event: Test183Event,
        current_state: &mut Test183State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test183State::Fail => false,
            Test183State::Pass => false,
            Test183State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test183Event::Null {
if self.safe_evaluate_guard("Var1 ~= nil", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test183State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test183State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
