...
impl Test314Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test314Event::ErrorExecution));
        }
...
impl Default for Test314Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test314Policy {
    ...
    fn get_initial_children(state: Self::State) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Self::State> {
        match state {
            Test314State::S0 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test314State::S01,
            ]),
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test314State::S03 => {
                ...
                if event != Test314Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
