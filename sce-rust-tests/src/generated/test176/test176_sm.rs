...
impl Test176Policy {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "1") {
            log::error!("global: {}", e);
            engine.raise(sce_rust_runtime::EventWithMetadata::new(Test176Event::ErrorExecution));
        }
...
impl Default for Test176Policy {
    fn default() -> Self {
        Self::new()
    }
}
...

{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test176Event::Event1);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test176State::S0 => {
                ...
                if event != Test176Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
