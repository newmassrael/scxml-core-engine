                ...
                'action_block: {
{
    ...
    {
        let mut meta = sce_rust_runtime::EventWithMetadata::new(Test330Event::Foo);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test330State::S0 => {
                ...
                if event != Test330Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
