...
impl Test173Policy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "Var1", "'invalid_session_id'") {
            log::error!("global: {}", e);
        }
...
impl Default for Test173Policy {
    fn default() -> Self {
        Self::new()
    }
}
    ...
    let _resolved_target: Option<String> = {
        ...
        match se.evaluate_expression(&sid, "Var1") {
            Ok(ref val) if matches!(val, sce_rust_runtime::ScriptValue::Null | sce_rust_runtime::ScriptValue::Undefined) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test173Event::ErrorCommunication));
                None
            }
            Ok(val) => {
                ...
                if trimmed.starts_with("!") {
                    ...
                    {
                        let mut err_meta = sce_rust_runtime::EventWithMetadata::new(Test173Event::ErrorExecution);
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test173State::S0 => {
                ...
                if event != Test173Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
