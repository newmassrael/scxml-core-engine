...
// From: resources/247/test247__sce_synth_invoke__invoke_0.scxml
//
...
//! Generated Rust state machine for `test247__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum Test247SceSynthInvokeInvoke0State {
    SubFinal,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Test247SceSynthInvokeInvoke0Event {
...
pub struct Test247SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test247SceSynthInvokeInvoke0State,
...
impl Test247SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test247SceSynthInvokeInvoke0State::SubFinal,
            session_id: None,
...
impl StatePolicy for Test247SceSynthInvokeInvoke0Policy {
    type State = Test247SceSynthInvokeInvoke0State;
    type Event = Test247SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        Test247SceSynthInvokeInvoke0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test247SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test247SceSynthInvokeInvoke0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test247SceSynthInvokeInvoke0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test247SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
...
impl Test247SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test247SceSynthInvokeInvoke0State,
        event: Test247SceSynthInvokeInvoke0Event,
        current_state: &mut Test247SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test247SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
