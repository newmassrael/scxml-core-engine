...
// From: resources/321/test321.scxml
//
...
//! Generated Rust state machine for `test321`.
//!
...
impl Test321Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test321State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test321", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        match se.evaluate_expression(&sid, "_sessionid") {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test321Event::ErrorExecution));
            }
        }
...
impl Default for Test321Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test321Policy {
    type State = Test321State;
    type Event = Test321Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test321State::Fail => true,
            Test321State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test321Event::ErrorExecution => "error.execution",
            Test321Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test321Event::ErrorExecution),
            _ => None,
        }
    }
...
impl Test321Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test321State,
        event: Test321Event,
        current_state: &mut Test321State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test321State::Fail => false,
            Test321State::Pass => false,
            Test321State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test321Event::Null {
if self.safe_evaluate_guard("Var1 ~= nil", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            *current_state = Test321State::Pass;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                            *current_state = Test321State::Fail;
                            *transition_taken = true;
                        return true;
                    }
                }
