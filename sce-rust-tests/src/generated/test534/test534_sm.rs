    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(Test534Event::ErrorExecution));
                false
            }
        }
    }
...
impl Default for Test534Policy {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        match check_state {
            ...
            Test534State::S0 => {
                ...
                if event == Test534Event::Test {
                    ...
                    if self.safe_evaluate_guard("_event.data[\"_scxmleventname\"] == \"test\"", engine) {
                ...
                if event != Test534Event::Null && sce_rust_runtime::helpers::event_matching::matches_event_descriptor(
