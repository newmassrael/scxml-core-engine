...
#![doc = "SCE-MAP: statechart_minimal.scxml:8"]
...
pub struct StatechartMinimalPolicy {
    ...
    last_transition_source_state: StatechartMinimalState,
...
impl StatechartMinimalPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: StatechartMinimalState::Waiting,
...
impl StatechartMinimalPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: StatechartMinimalState,
        event: StatechartMinimalEvent,
        current_state: &mut StatechartMinimalState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            StatechartMinimalState::Done => false,
            StatechartMinimalState::Waiting => {
                ...
                if event == StatechartMinimalEvent::JobCompleted {
                    ...
                    if matches!(&self.pending_payload, StatechartMinimalPayload::JobCompleted(ev) if ev.elapsed_ms == 0)
                    {
                        ...
                        *current_state = StatechartMinimalState::Done;
