...
//!
//! SCE Protocol-Synthesis RFC §synth-5-J-2 (lines 1989-1994): the `Box<dyn FnMut()>` block
...
///
/// SCE Protocol-Synthesis RFC §synth-5-J-2: gated to `!no_std` because `Box<dyn FnMut()>`
