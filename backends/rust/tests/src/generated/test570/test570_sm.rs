...
pub struct Test570Policy {
    ...
    last_transition_source_state: Test570State,
...
impl Test570Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test570State::P0s11,
...
impl StatePolicy for Test570Policy {
    ...
    fn get_initial_children(
        ...
        match state {
            Test570State::P0s1 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test570State::P0s11,
            ]),
            Test570State::P0s2 => ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([
                Test570State::P0s21,
            ]),
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test570State::P0s1 => Test570State::P0s11,
            Test570State::P0s2 => Test570State::P0s21,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            ...
            Test570State::P0s1final => {
                ...
                // W3C SCXML 3.4: Check if parallel grandparent p0 has all regions complete
                {
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test570State, usize)> =
...
impl Test570Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test570State,
        event: Test570Event,
        current_state: &mut Test570State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            Test570State::Fail => false,
            Test570State::P0 => {
                ...
                if event == Test570Event::Timeout {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test570State::Fail;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test570State::P0s11 => {
                ...
                if event == Test570Event::E1 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test570State::P0s1final;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test570State::P0s1final => false,
            Test570State::P0s2 => false,
            Test570State::P0s21 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test570Event::E2 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test570State::P0s2final;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test570State::P0s2final => false,
            Test570State::Pass => false,
            Test570State::S1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test570Event::DoneStateP0 {
                    ...
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test570State::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    }
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test570State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test570State> =
