...
// From: resources/570/test570.scxml
//
...
//! Generated Rust state machine for `test570`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test570Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test570Event] = &[Test570Event::Timeout];
}
...
pub struct Test570Policy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test570State>,
...
impl Test570Policy {
    ...
    fn activate(&mut self, state: Test570State) -> bool {
    ...
    fn deactivate(&mut self, state: Test570State) {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test570", &io_processors) {
    ...
    fn state_name_matches(state: Test570State, name: &str) -> bool {
...
impl StatePolicy for Test570Policy {
    type State = Test570State;
    type Event = Test570Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test570State::Fail => true,
            Test570State::P0s1final => true,
            Test570State::P0s2final => true,
            Test570State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test570State::P0s1 => Some(Test570State::P0),
            Test570State::P0s11 => Some(Test570State::P0s1),
            Test570State::P0s1final => Some(Test570State::P0s1),
            Test570State::P0s2 => Some(Test570State::P0),
            Test570State::P0s21 => Some(Test570State::P0s2),
            Test570State::P0s2final => Some(Test570State::P0s2),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test570State::P0s1 => true,
            Test570State::P0s2 => true,
            _ => false,
        }
    }
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test570State::P0 => &[Test570State::P0s1, Test570State::P0s2],
            Test570State::P0s1 => &[Test570State::P0s11, Test570State::P0s1final],
            Test570State::P0s2 => &[Test570State::P0s21, Test570State::P0s2final],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test570State::P0s1 => &[::sce_rust_runtime::EntryTarget::State(Test570State::P0s11)],
            Test570State::P0s2 => &[::sce_rust_runtime::EntryTarget::State(Test570State::P0s21)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test570State::P0)]
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ...
            Test570State::P0 => 0,
            Test570State::P0s1 => 1,
            Test570State::P0s11 => 2,
            Test570State::P0s1final => 3,
            Test570State::P0s2 => 4,
            Test570State::P0s21 => 5,
            Test570State::P0s2final => 6,
            Test570State::Pass => 8,
            Test570State::S1 => 7,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test570Event::DoneStateP0 => "done.state.p0",
            Test570Event::DoneStateP0s1 => "done.state.p0s1",
            Test570Event::DoneStateP0s2 => "done.state.p0s2",
            Test570Event::E1 => "e1",
            Test570Event::E2 => "e2",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "done.state.p0" => Some(Test570Event::DoneStateP0),
            "done.state.p0s1" => Some(Test570Event::DoneStateP0s1),
            "done.state.p0s2" => Some(Test570Event::DoneStateP0s2),
            "e1" => Some(Test570Event::E1),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test570State::Fail => "fail",
            Test570State::P0 => "p0",
            Test570State::P0s1 => "p0s1",
            Test570State::P0s11 => "p0s11",
            Test570State::P0s1final => "p0s1final",
            Test570State::P0s2 => "p0s2",
            Test570State::P0s21 => "p0s21",
            Test570State::P0s2final => "p0s2final",
            Test570State::Pass => "pass",
            Test570State::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test570State::Fail),
            "p0" => Some(Test570State::P0),
            "p0s1" => Some(Test570State::P0s1),
            "p0s11" => Some(Test570State::P0s11),
            "p0s1final" => Some(Test570State::P0s1final),
            "p0s2" => Some(Test570State::P0s2),
            "p0s21" => Some(Test570State::P0s21),
            "p0s2final" => Some(Test570State::P0s2final),
            "pass" => Some(Test570State::Pass),
            "s1" => Some(Test570State::S1),
            _ => None,
        }
    }
        ...
        match state {
            Test570State::P0 => {
                ...
                'action_block: {
                    ...
                    // W3C SCXML 3.8.1: <raise event="e1">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::E1));

                    // W3C SCXML 3.8.1: <raise event="e2">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test570Event::E2));
                }
            }
            Test570State::P0s1final => {
                ...
                // p0 has reached a final state, and the
                ...
                {
                    let parallel_state = Test570State::P0;
    ...
    fn first_enabled_transition(
        ...
        match state {
            Test570State::P0 => {
                if event == Test570Event::DoneStateP0s1 {
                    {
                ...
                if event == Test570Event::DoneStateP0s2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test570State::S1)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test570Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test570State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test570State::S1 => {
                if event == Test570Event::DoneStateP0 {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test570State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
