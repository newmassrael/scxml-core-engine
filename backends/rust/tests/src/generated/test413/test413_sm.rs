...
impl Test413Policy {
    ...
    fn activate(&mut self, state: Test413State) -> bool {
    ...
    fn deactivate(&mut self, state: Test413State) {
...
impl StatePolicy for Test413Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            ...
            Test413State::S2p11 => &[Test413State::S2p111, Test413State::S2p112],
            Test413State::S2p12 => &[Test413State::S2p121, Test413State::S2p122],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test413State::S2 => &[::sce_rust_runtime::EntryTarget::State(Test413State::S2p1)],
            Test413State::S2p11 => &[::sce_rust_runtime::EntryTarget::State(Test413State::S2p111)],
            Test413State::S2p12 => &[::sce_rust_runtime::EntryTarget::State(Test413State::S2p121)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[
            ::sce_rust_runtime::EntryTarget::State(Test413State::S2p112),
            ::sce_rust_runtime::EntryTarget::State(Test413State::S2p122),
        ]
    }
                ...
                if event == Test413Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test413State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test413State::S2p112 => {
                if event == Test413Event::Null {
                    if self.is_state_active("s2p122") {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test413State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
