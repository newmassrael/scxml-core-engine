...
// From: resources/413/test413.scxml
//
...
//! Generated Rust state machine for `test413`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test413.scxml:7 :: _machine"]
...
impl Test413Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test413Event] = &[];
}
...
pub struct Test413Policy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test413State>,
...
impl Test413Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test413State::S2p112,
...
impl StatePolicy for Test413Policy {
    type State = Test413State;
    type Event = Test413Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test413State::Fail => true,
            Test413State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test413State::S2p1 => Some(Test413State::S2),
            Test413State::S2p11 => Some(Test413State::S2p1),
            Test413State::S2p111 => Some(Test413State::S2p11),
            Test413State::S2p112 => Some(Test413State::S2p11),
            Test413State::S2p12 => Some(Test413State::S2p1),
            Test413State::S2p121 => Some(Test413State::S2p12),
            Test413State::S2p122 => Some(Test413State::S2p12),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test413State::S2 => true,
            Test413State::S2p11 => true,
            Test413State::S2p12 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test413State::Fail => 10,
            Test413State::Pass => 9,
            Test413State::S1 => 0,
            Test413State::S2 => 1,
            Test413State::S2p1 => 2,
            Test413State::S2p11 => 3,
            Test413State::S2p111 => 4,
            Test413State::S2p112 => 5,
            Test413State::S2p12 => 6,
            Test413State::S2p121 => 7,
            Test413State::S2p122 => 8,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test413State::Fail => "fail",
            Test413State::Pass => "pass",
            Test413State::S1 => "s1",
            Test413State::S2 => "s2",
            Test413State::S2p1 => "s2p1",
            Test413State::S2p11 => "s2p11",
            Test413State::S2p111 => "s2p111",
            Test413State::S2p112 => "s2p112",
            Test413State::S2p12 => "s2p12",
            Test413State::S2p121 => "s2p121",
            Test413State::S2p122 => "s2p122",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test413State::Fail),
            "pass" => Some(Test413State::Pass),
            "s1" => Some(Test413State::S1),
            "s2" => Some(Test413State::S2),
            "s2p1" => Some(Test413State::S2p1),
            "s2p11" => Some(Test413State::S2p11),
            "s2p111" => Some(Test413State::S2p111),
            "s2p112" => Some(Test413State::S2p112),
            "s2p12" => Some(Test413State::S2p12),
            "s2p121" => Some(Test413State::S2p121),
            "s2p122" => Some(Test413State::S2p122),
            _ => None,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test413State, usize)> =
...
impl Test413Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test413State,
        event: Test413Event,
        current_state: &mut Test413State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            Test413State::Fail => false,
            Test413State::Pass => false,
            Test413State::S1 => {
                ...
                if event == Test413Event::Null {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test413State::Fail;
                ...
                if event == Test413Event::Null {
                    if self.is_state_active("s2p122") {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test413State::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    }
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test413State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test413State> =
