...
impl StatePolicy for Test372Policy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test372State::S0 => &[::sce_rust_runtime::EntryTarget::State(
                Test372State::S0final,
            )],
            _ => &[],
        }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test372State::S0)]
    }
                ...
                if event == Test372Event::DoneStateS0 {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test372State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test372State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
