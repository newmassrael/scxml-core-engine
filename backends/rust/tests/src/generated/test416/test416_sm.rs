...
impl StatePolicy for Test416Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            ...
            Test416State::S11 => &[Test416State::S111, Test416State::S11final],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test416State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test416State::S11)],
            Test416State::S11 => &[::sce_rust_runtime::EntryTarget::State(Test416State::S111)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test416State::S1)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test416State::Fail),
            "pass" => Some(Test416State::Pass),
            "s1" => Some(Test416State::S1),
            "s11" => Some(Test416State::S11),
            "s111" => Some(Test416State::S111),
            "s11final" => Some(Test416State::S11final),
            _ => None,
        }
    }
                ...
                if event == Test416Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test416State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test416Event::DoneStateS11 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test416State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
