...
impl StatePolicy for Test198Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test198State::S0)]
    }
                ...
                if event == Test198Event::Event1 {
                    if self.safe_evaluate_guard("_scxml_eq(_event.origintype, \"http://www.w3.org/TR/scxml/#SCXMLEventProcessor\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test198State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test198State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
