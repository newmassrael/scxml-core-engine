...
impl Test198Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test198Event] = &[Test198Event::Event1];
}
...
impl StatePolicy for Test198Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test198State::Fail),
            "pass" => Some(Test198State::Pass),
            "s0" => Some(Test198State::S0),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test198Event::Event1);
...

                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test198Event::Timeout);
                            // W3C SCXML 5.10.1: External send — preserve sendid and SCXML event processor origintype
                            meta.metadata = sce_rust_runtime::EventMetadata::external(
                                send_id.clone(),
                                ::sce_rust_runtime::SceString::new(),
        ...
        match check_state {
            ...
            Test198State::S0 => {
                ...
                if event == Test198Event::Event1 {
                    ...
                    if self.safe_evaluate_guard("_scxml_eq(_event.origintype, \"http://www.w3.org/TR/scxml/#SCXMLEventProcessor\")", engine) {
