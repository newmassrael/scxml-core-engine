...
impl StatePolicy for Test525Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test525State::S0)]
    }
                ...
                if event == Test525Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 3)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test525State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test525Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test525State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
