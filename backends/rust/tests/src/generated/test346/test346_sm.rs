...
// From: resources/346/test346.scxml
//
...
//! Generated Rust state machine for `test346`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test346.scxml:7 :: _machine"]
...
impl Test346Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test346Event] = &[];
}
...
impl Test346Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test346State::S0,
...
impl StatePolicy for Test346Policy {
    type State = Test346State;
    type Event = Test346Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test346State::Fail => true,
            Test346State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test346Event::ErrorExecution => "error.execution",
            Test346Event::Event1 => "event1",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test346Event::ErrorExecution),
            "event1" => Some(Test346Event::Event1),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test346State::Fail => "fail",
            Test346State::Pass => "pass",
            Test346State::S0 => "s0",
            Test346State::S1 => "s1",
            Test346State::S2 => "s2",
            Test346State::S3 => "s3",
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test346State::Fail),
            "pass" => Some(Test346State::Pass),
            "s0" => Some(Test346State::S0),
            "s1" => Some(Test346State::S1),
            "s2" => Some(Test346State::S2),
            "s3" => Some(Test346State::S3),
            _ => None,
        }
    }
...
impl Test346Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test346State,
        event: Test346Event,
        current_state: &mut Test346State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test346State::Fail => false,
            Test346State::Pass => false,
            Test346State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test346Event::ErrorExecution {
                    ...
                    *current_state = Test346State::S1;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test346Event::Null
                    ...
                    )
                {
                    ...
                    *current_state = Test346State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test346State::S3 => {
                ...
                if event == Test346Event::ErrorExecution {
                    ...
                    *current_state = Test346State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
