...
impl StatePolicy for Test229Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test229State::S0)]
    }
                ...
                if event == Test229Event::EventReceived {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test229State::Pass)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test229State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
