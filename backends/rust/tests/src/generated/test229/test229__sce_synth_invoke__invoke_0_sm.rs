...
//! Generated Rust state machine for `test229__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test229__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test229SceSynthInvokeInvoke0State {
...
impl Test229SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test229SceSynthInvokeInvoke0Event] =
        &[Test229SceSynthInvokeInvoke0Event::ChildToParent];
}
...
pub struct Test229SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test229SceSynthInvokeInvoke0State,
...
impl Test229SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test229SceSynthInvokeInvoke0State::Sub0,
...
impl Default for Test229SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test229SceSynthInvokeInvoke0Policy {
    type State = Test229SceSynthInvokeInvoke0State;
    type Event = Test229SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test229SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test229SceSynthInvokeInvoke0State::Sub0 => 0,
            Test229SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test229SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test229SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test229SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test229SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
                ...
                'action_block: {
...

                    {
                        ...
                        engine.schedule_event(
                            Test229SceSynthInvokeInvoke0Event::Timeout,
...
impl Test229SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test229SceSynthInvokeInvoke0State,
        event: Test229SceSynthInvokeInvoke0Event,
        current_state: &mut Test229SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test229SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test229SceSynthInvokeInvoke0Event::ChildToParent {
                    ...
                    *current_state = Test229SceSynthInvokeInvoke0State::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test229SceSynthInvokeInvoke0Event::Null
            ...
            Test229SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
