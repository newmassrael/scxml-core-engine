...
// From: resources/421/test421.scxml
//
...
//! Generated Rust state machine for `test421`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test421Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test421Event] = &[Test421Event::ExternalEvent];
}
...
impl Test421Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test421State::S11,
            session_id: None,
...
impl Default for Test421Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test421Policy {
    type State = Test421State;
    type Event = Test421Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test421State::Fail => true,
            Test421State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test421State::S11 => Some(Test421State::S1),
            Test421State::S12 => Some(Test421State::S1),
            _ => None,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test421Event::ErrorExecution => "error.execution",
            Test421Event::ExternalEvent => "externalEvent",
            Test421Event::InternalEvent1 => "internalEvent1",
            Test421Event::InternalEvent2 => "internalEvent2",
            Test421Event::InternalEvent3 => "internalEvent3",
            Test421Event::InternalEvent4 => "internalEvent4",
            Test421Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test421Event::ErrorExecution),
            "externalEvent" => Some(Test421Event::ExternalEvent),
            "internalEvent1" => Some(Test421Event::InternalEvent1),
            "internalEvent2" => Some(Test421Event::InternalEvent2),
            "internalEvent3" => Some(Test421Event::InternalEvent3),
            "internalEvent4" => Some(Test421Event::InternalEvent4),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test421State::Fail => "fail",
            Test421State::Pass => "pass",
            Test421State::S1 => "s1",
            Test421State::S11 => "s11",
            Test421State::S12 => "s12",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test421State::Fail),
            "pass" => Some(Test421State::Pass),
            "s1" => Some(Test421State::S1),
            "s11" => Some(Test421State::S11),
            "s12" => Some(Test421State::S12),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test421State::S1 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test421State::S11])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test421State::S1 => Test421State::S11,
            _ => state,
        }
    }
        ...
        match state {
            Test421State::S1 => {
                ...
                'action_block: {
                    ...
                    // W3C SCXML 3.8.1: <raise event="internalEvent1">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test421Event::InternalEvent1,
                    ));

                    // W3C SCXML 3.8.1: <raise event="internalEvent2">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test421Event::InternalEvent2,
                    ));

                    // W3C SCXML 3.8.1: <raise event="internalEvent3">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test421Event::InternalEvent3,
                    ));

                    // W3C SCXML 3.8.1: <raise event="internalEvent4">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test421Event::InternalEvent4,
                    ));
                }
            }
            _ => {}
...
impl Test421Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test421State,
        event: Test421Event,
        current_state: &mut Test421State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test421State::Fail => false,
            Test421State::Pass => false,
            Test421State::S1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test421Event::ExternalEvent {
                    ...
                    *current_state = Test421State::Fail;
            ...
            Test421State::S11 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test421Event::InternalEvent3 {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test421State::S12;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test421State::S12 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test421Event::InternalEvent4 {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test421State::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
