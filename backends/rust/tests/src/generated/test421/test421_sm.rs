...
impl StatePolicy for Test421Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test421State::S1 => &[Test421State::S11, Test421State::S12],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test421State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test421State::S11)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test421State::S1)]
    }
                ...
                if event == Test421Event::ExternalEvent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test421State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test421Event::InternalEvent3 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test421State::S12)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test421Event::InternalEvent4 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test421State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
