...
impl StatePolicy for Test528Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test528State::S0 => &[Test528State::S01, Test528State::S02],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test528State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test528State::S01)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test528State::S0)]
    }
                ...
                if event == Test528Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test528State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test528Event::DoneStateS0 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test528State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test528Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test528State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test528Event::DoneStateS0 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test528State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
