...
// From: resources/245/test245.scxml
//
...
//! Generated Rust state machine for `test245`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test245.scxml:6 :: _machine"]
// SCE-MAP: test245.scxml:6 :: _machine
...
impl Test245Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test245Event] = &[Test245Event::Success];
}
...
pub struct Test245Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test245State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test245__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test245__sce_synth_invoke__invoke_0_sm::Test245SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl Test245Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test245State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test245", &io_processors) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                // 1:1 port of C++ NamelistHelper::evaluateNamelist — validate in parent scope
                {
                    ...
                    if !se.has_variable(&sid, "Var2") {
                        ::sce_rust_runtime::sce_log_error!(
                            "Namelist validation failed: 'Var2' not declared in parent"
                        );
                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                            Test245Event::ErrorExecution,
                            "<invoke> namelist names 'Var2', which the parent does not declare",
                        ));
                ...
                let mut child_policy = super::test245__sce_synth_invoke__invoke_0_sm::Test245SceSynthInvokeInvoke0Policy::new(self.script_engine.clone());
                ...
                // W3C SCXML 6.3.2: Only set if variable is declared in child's datamodel
                {
                    ...
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                    let child_vars: &[&str] = &[];
                    if child_vars.contains(&"Var2") {
                        if let Ok(val) = se.evaluate_expression(&sid, "Var2") {
                            // §scxml-6.4.1: "the value stored at the location
                            // is the value" — so the value crosses, not a
                            // rendering of it.
                            child_policy.set_param_value_in_script_engine("Var2", val);
                        }
                    }
                }
...
impl StatePolicy for Test245Policy {
    type State = Test245State;
    type Event = Test245Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test245State::Fail => true,
            Test245State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test245Event::CancelInvoke => "cancel.invoke",
            Test245Event::DoneInvoke => "done.invoke",
            Test245Event::ErrorExecution => "error.execution",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test245Event::CancelInvoke),
            "done.invoke" => Some(Test245Event::DoneInvoke),
            "error.execution" => Some(Test245Event::ErrorExecution),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test245State::Fail => "fail",
            Test245State::Pass => "pass",
            Test245State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test245State::Fail),
            "pass" => Some(Test245State::Pass),
            "s0" => Some(Test245State::S0),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test245State::S0 => {
                // SCE-MAP: test245.scxml:11 :: s0 :: _state_body
...
impl Test245Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test245State,
        event: Test245Event,
        current_state: &mut Test245State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test245State::Fail => false,
            Test245State::Pass => false,
            Test245State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test245Event::Success {
                    ...
                    *current_state = Test245State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test245Event::Null
                    ...
                    )
                {
                    ...
                    *current_state = Test245State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
