...
//! Generated Rust state machine for `test245__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
// SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
pub enum Test245SceSynthInvokeInvoke0State {
...
pub enum Test245SceSynthInvokeInvoke0Event {
    ErrorExecution,
    Failure,
    Success,
...
impl Test245SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test245SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test245SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test245SceSynthInvokeInvoke0State,
...
impl Test245SceSynthInvokeInvoke0Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test245SceSynthInvokeInvoke0State::Sub0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "test245__sce_synth_invoke__invoke_0", &io_processors)
        {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    Test245SceSynthInvokeInvoke0Event::ErrorExecution,
...
impl StatePolicy for Test245SceSynthInvokeInvoke0Policy {
    type State = Test245SceSynthInvokeInvoke0State;
    type Event = Test245SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test245SceSynthInvokeInvoke0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test245SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test245SceSynthInvokeInvoke0State::Sub0 => 0,
            Test245SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test245SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test245SceSynthInvokeInvoke0Event::Failure => "failure",
            Test245SceSynthInvokeInvoke0Event::Success => "success",
            Test245SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test245SceSynthInvokeInvoke0Event::ErrorExecution),
            "failure" => Some(Test245SceSynthInvokeInvoke0Event::Failure),
            "success" => Some(Test245SceSynthInvokeInvoke0Event::Success),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test245SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test245SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test245SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test245SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
        ...
        match self.last_transition_source_state {
            Test245SceSynthInvokeInvoke0State::Sub0 => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:5 :: sub0 :: _transition_0
                    ...
                    1 => {
                        // SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:8 :: sub0 :: _transition_1
...
impl Test245SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test245SceSynthInvokeInvoke0State,
        event: Test245SceSynthInvokeInvoke0Event,
        current_state: &mut Test245SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test245SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test245SceSynthInvokeInvoke0Event::Null {
                    if self.safe_evaluate_guard("(_typeof(Var2) ~= \"undefined\")", engine) {
                        ...
                        *current_state = Test245SceSynthInvokeInvoke0State::SubFinal;
            ...
            Test245SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
