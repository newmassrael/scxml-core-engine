...
#![doc = "SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:3"]
        ...
        match self.last_transition_source_state {
            Test245SceSynthInvokeInvoke0State::Sub0 => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:5
                    ...
                    1 => {
                        // SCE-MAP: test245__sce_synth_invoke__invoke_0.scxml:8
