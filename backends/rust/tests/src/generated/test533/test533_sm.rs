...
impl Test533Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test533Event] = &[];
}
...
pub struct Test533Policy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test533State>,
...
impl Test533Policy {
    ...
    fn activate(&mut self, state: Test533State) -> bool {
    ...
    fn deactivate(&mut self, state: Test533State) {
    ...
    fn state_name_matches(state: Test533State, name: &str) -> bool {
...
impl StatePolicy for Test533Policy {
    type State = Test533State;
    type Event = Test533Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test533State::Fail => true,
            Test533State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test533State::Ps1 => Some(Test533State::P),
            Test533State::Ps2 => Some(Test533State::P),
            _ => None,
        }
    }
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test533State::P => &[Test533State::Ps1, Test533State::Ps2],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test533State::S1)]
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test533Event::Bar => "bar",
            Test533Event::ErrorExecution => "error.execution",
            Test533Event::Foo => "foo",
            Test533Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "bar" => Some(Test533Event::Bar),
            "error.execution" => Some(Test533Event::ErrorExecution),
            "foo" => Some(Test533Event::Foo),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test533State::Fail => "fail",
            Test533State::P => "p",
            Test533State::Pass => "pass",
            Test533State::Ps1 => "ps1",
            Test533State::Ps2 => "ps2",
            Test533State::S1 => "s1",
            Test533State::S2 => "s2",
            Test533State::S3 => "s3",
            Test533State::S4 => "s4",
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test533State::Fail),
            "p" => Some(Test533State::P),
            "pass" => Some(Test533State::Pass),
            "ps1" => Some(Test533State::Ps1),
            "ps2" => Some(Test533State::Ps2),
            "s1" => Some(Test533State::S1),
            "s2" => Some(Test533State::S2),
            "s3" => Some(Test533State::S3),
            "s4" => Some(Test533State::S4),
            _ => None,
        }
    }
        ...
        match state {
            Test533State::S1 => {
                ...
                'action_block: {
                    ...
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test533Event::Foo));

                    // W3C SCXML 3.8.1: <raise event="bar">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test533Event::Bar));
                }
            }
            _ => {}
        }
    ...
    fn first_enabled_transition(
        ...
        match state {
            Test533State::P => {
                if event == Test533Event::Foo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::Ps1)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == Test533Event::Bar {
                    if self.safe_evaluate_guard("_scxml_eq(Var4, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::S2)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test533Event::Bar {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test533State::S1 => {
                if event == Test533Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::P)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test533State::S2 => {
                if event == Test533Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::S3)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test533State::S3 => {
                if event == Test533Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::S4)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test533State::S4 => {
                if event == Test533Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var3, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test533State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
