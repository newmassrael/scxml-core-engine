...
pub struct Test533Policy {
    ...
    last_transition_source_state: Test533State,
...
impl Test533Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test533State::S1,
...
impl StatePolicy for Test533Policy {
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test533State, usize)> =
...
impl Test533Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test533State,
        event: Test533Event,
        current_state: &mut Test533State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            Test533State::Fail => false,
            Test533State::P => {
                ...
                if event == Test533Event::Foo {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test533State::Ps1;
                ...
                if event == Test533Event::Bar {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test533State::Fail;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test533State::Pass => false,
            Test533State::Ps1 => false,
            Test533State::Ps2 => false,
            Test533State::S1 => {
                ...
                if event == Test533Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var3, 2)", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test533State::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    } else {
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test533State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test533State> =
