...
//! Generated Rust state machine for `test554__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test554__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test554SceSynthInvokeInvoke0State {
...
pub enum Test554SceSynthInvokeInvoke0Event {
...
impl Test554SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test554SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test554SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test554SceSynthInvokeInvoke0State,
...
impl Test554SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test554SceSynthInvokeInvoke0State::SubFinal,
            session_id: None,
...
impl Default for Test554SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test554SceSynthInvokeInvoke0Policy {
    type State = Test554SceSynthInvokeInvoke0State;
    type Event = Test554SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test554SceSynthInvokeInvoke0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test554SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test554SceSynthInvokeInvoke0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test554SceSynthInvokeInvoke0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test554SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test554SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
...
impl Test554SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test554SceSynthInvokeInvoke0State,
        event: Test554SceSynthInvokeInvoke0Event,
        current_state: &mut Test554SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test554SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
