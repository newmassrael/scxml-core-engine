...
// From: resources/294/test294.scxml
//
...
//! Generated Rust state machine for `test294`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test294Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test294Event] = &[];
}
...
impl Test294Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test294State::S01,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test294", &io_processors) {
...
impl StatePolicy for Test294Policy {
    type State = Test294State;
    type Event = Test294Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test294State::Fail => true,
            Test294State::Pass => true,
            Test294State::S02 => true,
            Test294State::S12 => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test294State::S01 => Some(Test294State::S0),
            Test294State::S02 => Some(Test294State::S0),
            Test294State::S11 => Some(Test294State::S1),
            Test294State::S12 => Some(Test294State::S1),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test294State::S0 => true,
            Test294State::S1 => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test294Event::DoneStateS0 => "done.state.s0",
            Test294Event::DoneStateS1 => "done.state.s1",
            Test294Event::ErrorExecution => "error.execution",
            Test294Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "done.state.s0" => Some(Test294Event::DoneStateS0),
            "done.state.s1" => Some(Test294Event::DoneStateS1),
            "error.execution" => Some(Test294Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test294State::Fail => "fail",
            Test294State::Pass => "pass",
            Test294State::S0 => "s0",
            Test294State::S01 => "s01",
            Test294State::S02 => "s02",
            Test294State::S1 => "s1",
            Test294State::S11 => "s11",
            Test294State::S12 => "s12",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test294State::Fail),
            "pass" => Some(Test294State::Pass),
            "s0" => Some(Test294State::S0),
            "s01" => Some(Test294State::S01),
            "s02" => Some(Test294State::S02),
            "s1" => Some(Test294State::S1),
            "s11" => Some(Test294State::S11),
            "s12" => Some(Test294State::S12),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test294State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test294State::S01])
            }
            Test294State::S1 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test294State::S11])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test294State::S0 => Test294State::S01,
            Test294State::S1 => Test294State::S11,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test294State::S02 => {
                    ...
                    match se.evaluate_expression(&sid, "1") {
                        ...
                        Err(e) => {
                            ::sce_rust_runtime::sce_log_error!(
                                "Donedata param 'Var1' eval failed: {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                Test294Event::ErrorExecution,
                                "<donedata> <param name='Var1'> failed to evaluate",
                            ));
                        }
                    }
                    if done_data_ok {
                ...
                // W3C SCXML 3.7: Generate done.state.s0 event
                // W3C SCXML 5.5: Carry evaluated donedata in done.state event
                if done_data_ok {
                    let mut done_meta =
                        sce_rust_runtime::EventWithMetadata::new(Test294Event::DoneStateS0);
            ...
            Test294State::S12 => {
                ...
                let mut done_data_ok = true;
                {
                    ...
                    match se.evaluate_expression(&sid, "\"foo\"") {
                        ...
                        Err(e) => {
                            ::sce_rust_runtime::sce_log_error!(
                                "Donedata content expr eval failed: {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                Test294Event::ErrorExecution,
                                "<donedata> <content expr> failed to evaluate",
                            ));
                        }
                    }
                }
                // W3C SCXML 3.7: Generate done.state.s1 event
                // W3C SCXML 5.5: Carry evaluated donedata in done.state event
                if done_data_ok {
                    let mut done_meta =
                        sce_rust_runtime::EventWithMetadata::new(Test294Event::DoneStateS1);
                    done_meta.set_event_data(&done_event_data);
                    engine.raise(done_meta);
                }
            }
...
impl Test294Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test294State,
        event: Test294Event,
        current_state: &mut Test294State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test294State::Fail => false,
            Test294State::Pass => false,
            Test294State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test294Event::DoneStateS0 {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("_scxml_eq(_event.data.Var1, 1)", engine) {
                ...
                if event == Test294Event::DoneStateS0 {
                    ...
                    *current_state = Test294State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test294State::S01 => {
                ...
                if event == Test294Event::Null {
                    // Unconditional eventless transition
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = Test294State::S02;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test294State::S02 => false,
            Test294State::S1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test294Event::DoneStateS1 {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("_scxml_eq(_event.data, \"foo\")", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;

                        *current_state = Test294State::Pass;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            Test294State::S11 => {
                ...
                if event == Test294Event::Null {
                    ...
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = Test294State::S12;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test294State::S12 => false,
            _ => false,
        }
    }
}
