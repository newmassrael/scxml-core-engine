...
impl StatePolicy for Test294Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test294State::S0 => &[Test294State::S01, Test294State::S02],
            Test294State::S1 => &[Test294State::S11, Test294State::S12],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test294State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test294State::S01)],
            Test294State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test294State::S11)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test294State::S0)]
    }
                ...
                if event == Test294Event::DoneStateS0 {
                    if self.safe_evaluate_guard("_scxml_eq(_event.data.Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test294State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test294Event::DoneStateS0 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test294State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test294Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test294State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test294State::S1 => {
                if event == Test294Event::DoneStateS1 {
                    if self.safe_evaluate_guard("_scxml_eq(_event.data, \"foo\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test294State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test294Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test294State::S12)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
