...
// From: backends/rust/tests/src/generated/test530/test530_hybrid0.scxml
//
...
//! Generated Rust state machine for `test530_hybrid0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test530_hybrid0.scxml:2 :: _machine"]
...
impl Test530Hybrid0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test530Hybrid0Event] = &[];
}
...
impl Test530Hybrid0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test530Hybrid0State::Final,
            session_id: None,
...
impl Default for Test530Hybrid0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test530Hybrid0Policy {
    type State = Test530Hybrid0State;
    type Event = Test530Hybrid0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test530Hybrid0State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test530Hybrid0State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test530Hybrid0State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test530Hybrid0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test530Hybrid0State::Final => "final",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test530Hybrid0State::Final),
            _ => None,
        }
    }
...
impl Test530Hybrid0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test530Hybrid0State,
        event: Test530Hybrid0Event,
        current_state: &mut Test530Hybrid0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test530Hybrid0State::Final => false,
            _ => false,
        }
    }
}
