...
//! Generated Rust state machine for `test347__sce_synth_invoke__child`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test347__sce_synth_invoke__child.scxml:3 :: _machine"]
...
pub enum Test347SceSynthInvokeChildState {
...
impl Test347SceSynthInvokeChildEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test347SceSynthInvokeChildEvent] =
        &[Test347SceSynthInvokeChildEvent::ParentToChild];
}
...
pub struct Test347SceSynthInvokeChildPolicy {
    ...
    last_transition_source_state: Test347SceSynthInvokeChildState,
...
impl Test347SceSynthInvokeChildPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test347SceSynthInvokeChildState::Sub0,
...
impl Default for Test347SceSynthInvokeChildPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test347SceSynthInvokeChildPolicy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test347SceSynthInvokeChildState::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test347SceSynthInvokeChildState::Sub0 => 0,
            Test347SceSynthInvokeChildState::SubFinal => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test347SceSynthInvokeChildState::Sub0 => "sub0",
            Test347SceSynthInvokeChildState::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test347SceSynthInvokeChildState::Sub0),
            "subFinal" => Some(Test347SceSynthInvokeChildState::SubFinal),
            _ => None,
        }
    }
...
impl Test347SceSynthInvokeChildPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test347SceSynthInvokeChildState,
        event: Test347SceSynthInvokeChildEvent,
        current_state: &mut Test347SceSynthInvokeChildState,
        ...
        match check_state {
            Test347SceSynthInvokeChildState::Sub0 => {
                ...
                if event == Test347SceSynthInvokeChildEvent::ParentToChild {
                    ...
                    *current_state = Test347SceSynthInvokeChildState::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test347SceSynthInvokeChildState::SubFinal => false,
            _ => false,
        }
    }
}
