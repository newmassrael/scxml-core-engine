...
impl Test223Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test223Event] = &[];
}
    ...
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test223__sce_synth_invoke__invoke_0_sm::Test223SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl StatePolicy for Test223Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test223State::Fail),
            "pass" => Some(Test223State::Pass),
            "s0" => Some(Test223State::S0),
            "s1" => Some(Test223State::S1),
            _ => None,
        }
    }
