...
impl Test348Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test348Event] = &[Test348Event::S0Event];
}
...
impl StatePolicy for Test348Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test348State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test348State::Fail),
            "pass" => Some(Test348State::Pass),
            "s0" => Some(Test348State::S0),
            _ => None,
        }
    }
                ...
                if event == Test348Event::S0Event {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test348State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test348State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
