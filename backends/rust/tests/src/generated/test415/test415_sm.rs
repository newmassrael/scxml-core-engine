...
// From: resources/415/test415.scxml
//
...
//! Generated Rust state machine for `test415`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test415.scxml:8 :: _machine"]
...
impl Test415Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test415Event] = &[];
}
...
impl Test415Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test415State::Final,
            session_id: None,
...
impl StatePolicy for Test415Policy {
    type State = Test415State;
    type Event = Test415Event;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test415State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test415Event::Event1 => "event1",
            Test415Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "event1" => Some(Test415Event::Event1),
            _ => None,
        }
    }
...
impl Test415Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test415State,
        event: Test415Event,
        current_state: &mut Test415State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test415State::Final => false,
            _ => false,
        }
    }
}
