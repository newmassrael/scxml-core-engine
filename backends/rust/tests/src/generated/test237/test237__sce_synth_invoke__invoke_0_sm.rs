...
//! Generated Rust state machine for `test237__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test237__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test237SceSynthInvokeInvoke0State {
...
pub enum Test237SceSynthInvokeInvoke0Event {
    ErrorExecution,
    Timeout,
...
impl Test237SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test237SceSynthInvokeInvoke0Event] =
        &[Test237SceSynthInvokeInvoke0Event::Timeout];
}
...
pub struct Test237SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test237SceSynthInvokeInvoke0State,
...
impl Test237SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test237SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test237SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test237SceSynthInvokeInvoke0Policy {
    type State = Test237SceSynthInvokeInvoke0State;
    type Event = Test237SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test237SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test237SceSynthInvokeInvoke0State::Sub0 => 0,
            Test237SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test237SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test237SceSynthInvokeInvoke0Event::Timeout => "timeout",
            Test237SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test237SceSynthInvokeInvoke0Event::ErrorExecution),
            "timeout" => Some(Test237SceSynthInvokeInvoke0Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test237SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test237SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test237SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test237SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
...
impl Test237SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test237SceSynthInvokeInvoke0State,
        event: Test237SceSynthInvokeInvoke0Event,
        current_state: &mut Test237SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test237SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test237SceSynthInvokeInvoke0Event::Timeout {
                    ...
                    *current_state = Test237SceSynthInvokeInvoke0State::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test237SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
