...
impl Test237Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test237Event] = &[Test237Event::Timeout1];
}
...
pub struct Test237Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test237__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test237__sce_synth_invoke__invoke_0_sm::Test237SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test237__sce_synth_invoke__invoke_0_sm::Test237SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test237Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test237State::Fail => "fail",
            Test237State::Pass => "pass",
            Test237State::S0 => "s0",
            Test237State::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test237State::Fail),
            "pass" => Some(Test237State::Pass),
            "s0" => Some(Test237State::S0),
            "s1" => Some(Test237State::S1),
            _ => None,
        }
    }
