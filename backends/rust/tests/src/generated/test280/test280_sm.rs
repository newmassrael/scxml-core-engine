...
impl StatePolicy for Test280Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test280State::S0)]
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test280State::S1 => {
                ...
                if engine.claim_late_binding_first_entry(Test280State::S1) {
                    self.ensure_script_engine();
                    let sid = self.session_id.as_ref().unwrap().clone();
                    let se = self.script_engine.clone();
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                ...
                if event == Test280Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test280State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test280Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test280State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test280State::S1 => {
                if event == Test280Event::Null {
                    if self.safe_evaluate_guard("(Var1 == Var2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test280State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
