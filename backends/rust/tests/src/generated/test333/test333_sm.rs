...
#![doc = "SCE-MAP: test333.scxml:5 :: _machine"]
...
impl Test333Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test333Event] = &[Test333Event::Foo];
}
...
impl StatePolicy for Test333Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test333State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test333State::Fail => "fail",
            Test333State::Pass => "pass",
            Test333State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test333State::Fail),
            "pass" => Some(Test333State::Pass),
            "s0" => Some(Test333State::S0),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test333Event::Foo);
                ...
                if event == Test333Event::Foo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test333State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test333State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
