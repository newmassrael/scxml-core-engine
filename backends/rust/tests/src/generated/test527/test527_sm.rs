...
// From: resources/527/test527.scxml
//
...
//! Generated Rust state machine for `test527`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test527Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test527Event] = &[];
}
...
impl Test527Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test527State::S01,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test527", &io_processors) {
...
impl StatePolicy for Test527Policy {
    type State = Test527State;
    type Event = Test527Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test527State::Fail => true,
            Test527State::Pass => true,
            Test527State::S02 => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test527State::S01 => Some(Test527State::S0),
            Test527State::S02 => Some(Test527State::S0),
            _ => None,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test527Event::DoneStateS0 => "done.state.s0",
            Test527Event::ErrorExecution => "error.execution",
            Test527Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "done.state.s0" => Some(Test527Event::DoneStateS0),
            "error.execution" => Some(Test527Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test527State::Fail => "fail",
            Test527State::Pass => "pass",
            Test527State::S0 => "s0",
            Test527State::S01 => "s01",
            Test527State::S02 => "s02",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test527State::Fail),
            "pass" => Some(Test527State::Pass),
            "s0" => Some(Test527State::S0),
            "s01" => Some(Test527State::S01),
            "s02" => Some(Test527State::S02),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test527State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test527State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test527State::S0 => Test527State::S01,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test527State::S02 => {
                ...
                if done_data_ok {
                    let mut done_meta =
                        sce_rust_runtime::EventWithMetadata::new(Test527Event::DoneStateS0);
...
impl Test527Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test527State,
        event: Test527Event,
        current_state: &mut Test527State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test527State::Fail => false,
            Test527State::Pass => false,
            Test527State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test527Event::DoneStateS0 {
                    ...
                    if self.safe_evaluate_guard("_scxml_eq(_event.data, \"foo\")", engine) {
                        ...
                        *current_state = Test527State::Pass;
                ...
                if event == Test527Event::DoneStateS0 {
                    ...
                    *current_state = Test527State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test527State::S01 => {
                ...
                if event == Test527Event::Null {
                    // Unconditional eventless transition
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = Test527State::S02;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test527State::S02 => false,
            _ => false,
        }
    }
}
