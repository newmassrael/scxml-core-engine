...
impl StatePolicy for Test155Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test155State::S0)]
    }
                ...
                if event == Test155Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 6)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test155State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test155Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test155State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
