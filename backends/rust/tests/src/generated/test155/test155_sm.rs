...
// From: resources/155/test155.scxml
//
...
//! Generated Rust state machine for `test155`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test155.scxml:6 :: _machine"]
// SCE-MAP: test155.scxml:6 :: _machine
...
impl Test155Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test155Event] = &[];
}
...
impl Test155Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test155State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test155", &io_processors) {
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::eval_or_set_string(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                Test155Event::ErrorExecution,
                "<data id='Var3'> content failed to initialise",
            ));
        }
...
impl StatePolicy for Test155Policy {
    type State = Test155State;
    type Event = Test155Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test155State::Fail => true,
            Test155State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test155Event::ErrorExecution => "error.execution",
            Test155Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test155Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test155State::Fail => "fail",
            Test155State::Pass => "pass",
            Test155State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test155State::Fail),
            "pass" => Some(Test155State::Pass),
            "s0" => Some(Test155State::S0),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test155State::S0 => {
                ...
                'action_block: {
                    {
                        // W3C SCXML 5.6: <foreach array="Var3" item="Var2">
                        self.ensure_script_engine();
                        let sid = self.session_id.as_ref().unwrap().clone();
                        let se = self.script_engine.clone();
                        let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                        ...
                        if !sce_rust_runtime::helpers::foreach::is_legal_variable_name(item_name) {
                            ...
                            match se.evaluate_expression(&sid, "Var3") {
                                        ...
                                        'foreach_body: {
                                            {
                                                    ...
                                                    se.execute_script(&sid, &assign_script)
                                                {
                                                    ...
                                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test155Event::ErrorExecution, "<assign> to 'Var1' failed"));
                                ...
                                Err(e) => {
                                    ::sce_rust_runtime::sce_log_error!(
                                        "Foreach: failed to evaluate array 'Var3': {}",
                                        e
                                    );
                                    engine.raise(
                                        sce_rust_runtime::EventWithMetadata::platform_error(
...
impl Test155Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test155State,
        event: Test155Event,
        current_state: &mut Test155State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test155State::Fail => false,
            Test155State::Pass => false,
            Test155State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test155Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 6)", engine) {
                        ...
                        *current_state = Test155State::Pass;
                        *transition_taken = true;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = Test155State::Fail;
                        *transition_taken = true;
                        return true;
                    }
                }
