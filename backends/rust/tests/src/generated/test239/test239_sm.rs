...
#![doc = "SCE-MAP: test239.scxml:5 :: _machine"]
...
impl StatePolicy for Test239Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test239State::Fail),
            "pass" => Some(Test239State::Pass),
            "s0" => Some(Test239State::S0),
            "s01" => Some(Test239State::S01),
            "s02" => Some(Test239State::S02),
            _ => None,
        }
    }
