...
pub struct Test239sub1Policy {
    ...
    last_transition_source_state: Test239sub1State,
...
impl Test239sub1Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test239sub1State::Final,
            session_id: None,
...
impl Test239sub1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test239sub1State,
        event: Test239sub1Event,
        current_state: &mut Test239sub1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test239sub1State::Final => false,
            _ => false,
        }
    }
}
