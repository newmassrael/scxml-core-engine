...
//! Generated Rust state machine for `test239__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test239__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
pub enum Test239SceSynthInvokeInvoke1State {
...
pub enum Test239SceSynthInvokeInvoke1Event {
...
impl Test239SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test239SceSynthInvokeInvoke1Event] = &[];
}
...
pub struct Test239SceSynthInvokeInvoke1Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test239SceSynthInvokeInvoke1State,
...
impl Test239SceSynthInvokeInvoke1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test239SceSynthInvokeInvoke1State::Final,
            session_id: None,
...
impl Default for Test239SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test239SceSynthInvokeInvoke1Policy {
    type State = Test239SceSynthInvokeInvoke1State;
    type Event = Test239SceSynthInvokeInvoke1Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test239SceSynthInvokeInvoke1State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test239SceSynthInvokeInvoke1State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test239SceSynthInvokeInvoke1State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test239SceSynthInvokeInvoke1Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test239SceSynthInvokeInvoke1State::Final => "final",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test239SceSynthInvokeInvoke1State::Final),
            _ => None,
        }
    }
...
impl Test239SceSynthInvokeInvoke1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test239SceSynthInvokeInvoke1State,
        event: Test239SceSynthInvokeInvoke1Event,
        current_state: &mut Test239SceSynthInvokeInvoke1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test239SceSynthInvokeInvoke1State::Final => false,
            _ => false,
        }
    }
}
