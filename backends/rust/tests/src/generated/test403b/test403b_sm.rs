...
impl StatePolicy for Test403bPolicy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test403bState::Fail),
            "p0" => Some(Test403bState::P0),
            "p0s1" => Some(Test403bState::P0s1),
            "p0s2" => Some(Test403bState::P0s2),
            "pass" => Some(Test403bState::Pass),
            "s0" => Some(Test403bState::S0),
            _ => None,
        }
    }
