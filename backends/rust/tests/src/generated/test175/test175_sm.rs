...
#![doc = "SCE-MAP: test175.scxml:6 :: _machine"]
...
impl Test175Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test175Event] =
        &[Test175Event::Event1, Test175Event::Event2];
}
...
impl StatePolicy for Test175Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test175State::Fail),
            "pass" => Some(Test175State::Pass),
            "s0" => Some(Test175State::S0),
            "s1" => Some(Test175State::S1),
            _ => None,
        }
    }
