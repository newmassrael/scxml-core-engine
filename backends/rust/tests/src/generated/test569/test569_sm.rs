...
impl Test569Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test569Event] = &[];
}
...
impl StatePolicy for Test569Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test569State::Fail),
            "pass" => Some(Test569State::Pass),
            "s0" => Some(Test569State::S0),
            _ => None,
        }
    }
