...
impl StatePolicy for Test569Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test569State::S0)]
    }
                ...
                if event == Test569Event::Null {
                        ...
                        .safe_evaluate_guard("_scxml_truthy(_ioprocessors.scxml.location)", engine)
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test569State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test569Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test569State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
