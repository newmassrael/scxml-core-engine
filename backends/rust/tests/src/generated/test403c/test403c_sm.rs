...
// From: resources/403/test403c.scxml
//
...
//! Generated Rust state machine for `test403c`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test403c.scxml:5 :: _machine"]
...
impl Test403cEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test403cEvent] = &[Test403cEvent::Timeout];
}
...
pub struct Test403cPolicy {
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test403cState>,
...
impl Test403cPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test403cState::P0s1,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test403c", &io_processors) {
    ...
    fn state_name_matches(state: Test403cState, name: &str) -> bool {
...
impl StatePolicy for Test403cPolicy {
    type State = Test403cState;
    type Event = Test403cEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test403cState::Fail => true,
            Test403cState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test403cState::P0 => Some(Test403cState::S0),
            Test403cState::P0s1 => Some(Test403cState::P0),
            Test403cState::P0s2 => Some(Test403cState::P0),
            Test403cState::P0s3 => Some(Test403cState::P0),
            Test403cState::P0s4 => Some(Test403cState::P0),
            _ => None,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test403cState::Fail => 8,
            Test403cState::P0 => 1,
            Test403cState::P0s1 => 2,
            Test403cState::P0s2 => 3,
            Test403cState::P0s3 => 4,
            Test403cState::P0s4 => 5,
            Test403cState::Pass => 7,
            Test403cState::S0 => 0,
            Test403cState::S1 => 6,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test403cEvent::ErrorExecution => "error.execution",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test403cEvent::ErrorExecution),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test403cState::Fail => "fail",
            Test403cState::P0 => "p0",
            Test403cState::P0s1 => "p0s1",
            Test403cState::P0s2 => "p0s2",
            Test403cState::P0s3 => "p0s3",
            Test403cState::P0s4 => "p0s4",
            Test403cState::Pass => "pass",
            Test403cState::S0 => "s0",
            Test403cState::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test403cState::Fail),
            "p0" => Some(Test403cState::P0),
            "p0s1" => Some(Test403cState::P0s1),
            "p0s2" => Some(Test403cState::P0s2),
            "p0s3" => Some(Test403cState::P0s3),
            "p0s4" => Some(Test403cState::P0s4),
            "pass" => Some(Test403cState::Pass),
            "s0" => Some(Test403cState::S0),
            "s1" => Some(Test403cState::S1),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test403cState::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test403cState::P0])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test403cState::S0 => Test403cState::P0,
            _ => state,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test403cState, usize)> =
...
impl Test403cPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test403cState,
        event: Test403cEvent,
        current_state: &mut Test403cState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            Test403cState::Fail => false,
            Test403cState::P0 => false,
            Test403cState::P0s1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test403cEvent::Event1 {
            ...
            Test403cState::P0s2 => {
                ...
                if event == Test403cEvent::Event1 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test403cState::P0s1;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test403cState::P0s3 => {
                ...
                if event == Test403cEvent::Event1 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test403cState::Fail;
                        *transition_taken = true;
                    }
                    return true;
                }
                ...
                if event == Test403cEvent::Event2 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test403cState::S1;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test403cState::S0 => {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test403cEvent::Timeout {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 1;
                    self.has_transition_actions = false;
                ...
                if event == Test403cEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            ...
                            *current_state = Test403cState::Pass;
                            *transition_taken = true;
                        }
                        return true;
                    } else {
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test403cState> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test403cState> =
