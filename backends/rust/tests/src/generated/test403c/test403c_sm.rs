...
impl Test403cPolicy {
    ...
    fn activate(&mut self, state: Test403cState) -> bool {
    ...
    fn deactivate(&mut self, state: Test403cState) {
...
impl StatePolicy for Test403cPolicy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test403cState::S0 => &[::sce_rust_runtime::EntryTarget::State(Test403cState::P0)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test403cState::S0)]
    }
                ...
                if event == Test403cEvent::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403cState::P0s1)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == Test403cEvent::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403cState::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test403cEvent::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403cState::S1)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test403cState::S1 => {
                if event == Test403cEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403cState::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
