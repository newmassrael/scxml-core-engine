...
impl StatePolicy for Test519Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test519State::S0)]
    }
                ...
                if event == Test519Event::Test {
                    if self.safe_evaluate_guard("_scxml_eq(_event.data.param1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test519State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test519State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
