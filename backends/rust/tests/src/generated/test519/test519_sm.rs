...

                    {
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "1") {
                                ...
                                Err(e) => {
                                    log::error!("send param 'param1' eval failed: {}", e);
                                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                                        Test519Event::ErrorExecution,
                                    ));
                                }
                        ...
                        let _resolved_target: Option<String> = {
                                ...
                                .evaluate_expression(&sid, "_ioprocessors['basichttp'].location")
                            {
                                    ...
                                    ) =>
                                {
                                    ...
                                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                                        Test519Event::ErrorCommunication,
                                    ));
                                    None
                                }
                                Ok(val) => {
        ...
        match check_state {
            ...
            Test519State::S0 => {
                ...
                if event == Test519Event::Test {
                    ...
                    if self.safe_evaluate_guard("_event.data[\"param1\"] == 1", engine) {
