...
impl Test505Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test505Event] = &[];
}
...
impl StatePolicy for Test505Policy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test505State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test505State::S11)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test505State::S1)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test505State::Fail),
            "pass" => Some(Test505State::Pass),
            "s1" => Some(Test505State::S1),
            "s11" => Some(Test505State::S11),
            "s2" => Some(Test505State::S2),
            "s3" => Some(Test505State::S3),
            _ => None,
        }
    }
            ...
            Test505State::S1 => {
                if event == Test505Event::Foo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test505State::S11)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: true,
                        });
                ...
                if event == Test505Event::Bar {
                    if self.safe_evaluate_guard("_scxml_eq(Var3, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test505State::S2)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test505Event::Bar {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test505State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test505State::S2 => {
                if event == Test505Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test505State::S3)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test505State::S3 => {
                if event == Test505Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test505State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
