...
impl Test332Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test332Event] = &[Test332Event::Error];
}
...
impl StatePolicy for Test332Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test332State::Fail),
            "pass" => Some(Test332State::Pass),
            "s0" => Some(Test332State::S0),
            "s1" => Some(Test332State::S1),
            _ => None,
        }
    }
