...
// From: resources/419/test419.scxml
//
...
//! Generated Rust state machine for `test419`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test419.scxml:6 :: _machine"]
...
impl Test419Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test419Event] = &[];
}
...
impl Test419Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test419State::S1,
            session_id: None,
...
impl Default for Test419Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test419Policy {
    type State = Test419State;
    type Event = Test419Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test419State::Fail => true,
            Test419State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test419State::Fail => "fail",
            Test419State::Pass => "pass",
            Test419State::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test419State::Fail),
            "pass" => Some(Test419State::Pass),
            "s1" => Some(Test419State::S1),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test419State::S1 => {
                ...
                'action_block: {
                    // W3C SCXML 3.8.1: <raise event="internalEvent">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test419Event::InternalEvent,
                    ));
        ...
        match check_state {
            ...
            Test419State::S1 => {
                    ...
                    )
                {
                    ...
                    *current_state = Test419State::Fail;
                ...
                if event == Test419Event::Null {
                    ...
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = Test419State::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
