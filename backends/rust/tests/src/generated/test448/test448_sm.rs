...
impl Test448Policy {
    ...
    fn activate(&mut self, state: Test448State) -> bool {
    ...
    fn deactivate(&mut self, state: Test448State) {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            ::sce_rust_runtime::sce_log_error!("s01: {}", e);
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            ::sce_rust_runtime::sce_log_error!("s01p2: {}", e);
        }
...
impl StatePolicy for Test448Policy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test448State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test448State::S01)],
            Test448State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test448State::S01p)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test448State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test448State::Fail),
            "pass" => Some(Test448State::Pass),
            "s0" => Some(Test448State::S0),
            "s01" => Some(Test448State::S01),
            "s01p" => Some(Test448State::S01p),
            "s01p1" => Some(Test448State::S01p1),
            "s01p2" => Some(Test448State::S01p2),
            "s1" => Some(Test448State::S1),
            _ => None,
        }
    }
                ...
                if event == Test448Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test448State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test448Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test448State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test448State::S01p1 => {
                if event == Test448Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(var2, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test448State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
