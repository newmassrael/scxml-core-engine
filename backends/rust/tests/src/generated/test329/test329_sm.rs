...
impl Test329Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test329Event] = &[];
}
...
impl StatePolicy for Test329Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test329State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test329State::Fail),
            "pass" => Some(Test329State::Pass),
            "s0" => Some(Test329State::S0),
            "s1" => Some(Test329State::S1),
            "s2" => Some(Test329State::S2),
            "s3" => Some(Test329State::S3),
            _ => None,
        }
    }
        ...
        match state {
            Test329State::S0 => {
                if event == Test329Event::Foo {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, _sessionid)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test329State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test329State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test329State::S1 => {
                if event == Test329Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, _event)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test329State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test329State::S2 => {
                if event == Test329Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var3, _name)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test329State::S3)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test329State::S3 => {
                if event == Test329Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var4, _ioprocessors)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test329State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
