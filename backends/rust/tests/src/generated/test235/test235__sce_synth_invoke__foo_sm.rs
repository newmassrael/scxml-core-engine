...
//! Generated Rust state machine for `test235__sce_synth_invoke__foo`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test235__sce_synth_invoke__foo.scxml:3 :: _machine"]
...
pub enum Test235SceSynthInvokeFooState {
...
pub enum Test235SceSynthInvokeFooEvent {
...
impl Test235SceSynthInvokeFooEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test235SceSynthInvokeFooEvent] = &[];
}
...
impl Test235SceSynthInvokeFooPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test235SceSynthInvokeFooState::SubFinal,
            session_id: None,
...
impl Default for Test235SceSynthInvokeFooPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test235SceSynthInvokeFooPolicy {
    type State = Test235SceSynthInvokeFooState;
    type Event = Test235SceSynthInvokeFooEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        Test235SceSynthInvokeFooState::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test235SceSynthInvokeFooState::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test235SceSynthInvokeFooState::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test235SceSynthInvokeFooEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test235SceSynthInvokeFooState::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test235SceSynthInvokeFooState::SubFinal),
            _ => None,
        }
    }
...
impl Test235SceSynthInvokeFooPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test235SceSynthInvokeFooState,
        event: Test235SceSynthInvokeFooEvent,
        current_state: &mut Test235SceSynthInvokeFooState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test235SceSynthInvokeFooState::SubFinal => false,
            _ => false,
        }
    }
}
