...
impl Test235Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test235Event] = &[];
}
...
impl StatePolicy for Test235Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test235State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test235State::Fail),
            "pass" => Some(Test235State::Pass),
            "s0" => Some(Test235State::S0),
            _ => None,
        }
    }
                ...
                if event == Test235Event::DoneInvokeFoo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test235State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test235State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
