...
impl StatePolicy for Test561Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test561State::S0)]
    }
                ...
                if event == Test561Event::Foo {
                    if self.safe_evaluate_guard("_scxml_eq(_event.data:getElementsByTagName(\"book\")[2]:getAttribute(\"title\"), \"title2\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test561State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test561State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
