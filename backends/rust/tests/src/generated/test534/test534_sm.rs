...
impl StatePolicy for Test534Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test534State::S0)]
    }
                ...
                if event == Test534Event::Test {
                    if self.safe_evaluate_guard(
                        ...
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test534State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test534State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
