...
#![doc = "SCE-MAP: test354.scxml:6 :: _machine"]
...
impl Test354Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test354Event] =
        &[Test354Event::Event1, Test354Event::Event2];
}
...
impl StatePolicy for Test354Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test354State::Fail),
            "pass" => Some(Test354State::Pass),
            "s0" => Some(Test354State::S0),
            "s1" => Some(Test354State::S1),
            "s2" => Some(Test354State::S2),
            "s3" => Some(Test354State::S3),
            _ => None,
        }
    }
                ...
                'action_block: {
...

                    {
                        ...
                        if !_send_aborted {
                            ...
                            {
                                let mut meta =
                                    sce_rust_runtime::EventWithMetadata::new(Test354Event::Event1);
            ...
            Test354State::S3 => {
                ...
                'action_block: {
...

                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test354Event::Event2);
                            // W3C SCXML 5.10.1: External send — preserve sendid and SCXML event processor origintype
                            meta.metadata = sce_rust_runtime::EventMetadata::external(
                                send_id.clone(),
                                ::sce_rust_runtime::SceString::new(),
