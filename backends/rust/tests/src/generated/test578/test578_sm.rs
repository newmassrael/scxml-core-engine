...
impl StatePolicy for Test578Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test578State::S0)]
    }
                ...
                if event == Test578Event::Foo {
                        ...
                        .safe_evaluate_guard("_scxml_eq(_event.data.productName, \"bar\")", engine)
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test578State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test578State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
