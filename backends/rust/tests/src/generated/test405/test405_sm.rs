...
impl Test405Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test405Event] = &[Test405Event::Timeout];
}
...
impl Test405Policy {
    ...
    fn activate(&mut self, state: Test405State) -> bool {
    ...
    fn deactivate(&mut self, state: Test405State) {
...
impl StatePolicy for Test405Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            ...
            Test405State::S01p1 => &[Test405State::S01p11, Test405State::S01p12],
            Test405State::S01p2 => &[Test405State::S01p21, Test405State::S01p22],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test405State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test405State::S01p)],
            Test405State::S01p1 => &[::sce_rust_runtime::EntryTarget::State(Test405State::S01p11)],
            Test405State::S01p2 => &[::sce_rust_runtime::EntryTarget::State(Test405State::S01p21)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test405State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test405State::Fail),
            "pass" => Some(Test405State::Pass),
            "s0" => Some(Test405State::S0),
            "s01p" => Some(Test405State::S01p),
            "s01p1" => Some(Test405State::S01p1),
            "s01p11" => Some(Test405State::S01p11),
            "s01p12" => Some(Test405State::S01p12),
            "s01p2" => Some(Test405State::S01p2),
            "s01p21" => Some(Test405State::S01p21),
            "s01p22" => Some(Test405State::S01p22),
            "s02" => Some(Test405State::S02),
            "s03" => Some(Test405State::S03),
            "s04" => Some(Test405State::S04),
            _ => None,
        }
    }
                ...
                if event == Test405Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test405State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test405Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test405State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test405Event::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test405State::S03)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test405Event::Event3 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test405State::S04)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test405Event::Event4 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test405State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
