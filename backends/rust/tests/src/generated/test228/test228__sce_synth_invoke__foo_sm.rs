...
//! Generated Rust state machine for `test228__sce_synth_invoke__foo`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test228__sce_synth_invoke__foo.scxml:3 :: _machine"]
...
pub enum Test228SceSynthInvokeFooState {
...
pub enum Test228SceSynthInvokeFooEvent {
...
impl Test228SceSynthInvokeFooEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test228SceSynthInvokeFooEvent] = &[];
}
...
impl Test228SceSynthInvokeFooPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test228SceSynthInvokeFooState::SubFinal,
            session_id: None,
...
impl Default for Test228SceSynthInvokeFooPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test228SceSynthInvokeFooPolicy {
    type State = Test228SceSynthInvokeFooState;
    type Event = Test228SceSynthInvokeFooEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        Test228SceSynthInvokeFooState::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test228SceSynthInvokeFooState::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test228SceSynthInvokeFooState::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test228SceSynthInvokeFooEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test228SceSynthInvokeFooState::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test228SceSynthInvokeFooState::SubFinal),
            _ => None,
        }
    }
...
impl Test228SceSynthInvokeFooPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test228SceSynthInvokeFooState,
        event: Test228SceSynthInvokeFooEvent,
        current_state: &mut Test228SceSynthInvokeFooState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test228SceSynthInvokeFooState::SubFinal => false,
            _ => false,
        }
    }
}
