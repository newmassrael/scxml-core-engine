...
// From: resources/244/test244.scxml
//
...
//! Generated Rust state machine for `test244`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test244Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test244Event] = &[Test244Event::Success];
}
...
pub struct Test244Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test244State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test244__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test244__sce_synth_invoke__invoke_0_sm::Test244SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl Test244Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test244State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test244", &io_processors) {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test244__sce_synth_invoke__invoke_0_sm::Test244SceSynthInvokeInvoke0Policy::new(self.script_engine.clone());
...
impl StatePolicy for Test244Policy {
    type State = Test244State;
    type Event = Test244Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test244State::Fail => true,
            Test244State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test244Event::CancelInvoke => "cancel.invoke",
            Test244Event::DoneInvoke => "done.invoke",
            Test244Event::ErrorExecution => "error.execution",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test244Event::CancelInvoke),
            "done.invoke" => Some(Test244Event::DoneInvoke),
            "error.execution" => Some(Test244Event::ErrorExecution),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test244State::Fail => "fail",
            Test244State::Pass => "pass",
            Test244State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test244State::Fail),
            "pass" => Some(Test244State::Pass),
            "s0" => Some(Test244State::S0),
            _ => None,
        }
    }
...
impl Test244Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test244State,
        event: Test244Event,
        current_state: &mut Test244State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test244State::Fail => false,
            Test244State::Pass => false,
            Test244State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test244Event::Success {
                    ...
                    *current_state = Test244State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test244Event::Null
                    ...
                    )
                {
                    ...
                    *current_state = Test244State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
