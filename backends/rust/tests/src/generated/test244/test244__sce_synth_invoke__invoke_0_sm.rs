...
#![doc = "SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test244SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test244SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test244SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test244SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test244SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
