...
#![doc = "SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
// SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
impl Test233SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test233SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test233SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test233SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test233SceSynthInvokeInvoke0State::SubFinal => {
                // SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:4 :: subFinal :: _state_body
