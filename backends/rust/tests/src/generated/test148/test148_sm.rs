...
impl Test148Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test148Event] = &[];
}
...
impl StatePolicy for Test148Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test148State::Fail),
            "pass" => Some(Test148State::Pass),
            "s0" => Some(Test148State::S0),
            _ => None,
        }
    }
