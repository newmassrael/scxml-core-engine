...
#![doc = "SCE-MAP: test247__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test247SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test247SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test247SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test247SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
