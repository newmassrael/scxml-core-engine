...
// From: resources/201/test201.scxml
//
...
//! Generated Rust state machine for `test201`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test201.scxml:6 :: _machine"]
// SCE-MAP: test201.scxml:6 :: _machine
...
impl Test201Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test201Event] = &[Test201Event::Event1];
}
...
impl Test201Policy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test201", &io_processors) {
...
impl StatePolicy for Test201Policy {
    type State = Test201State;
    type Event = Test201Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test201State::Fail => true,
            Test201State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test201Event::ErrorCommunication => "error.communication",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.communication" => Some(Test201Event::ErrorCommunication),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test201State::Fail => "fail",
            Test201State::Pass => "pass",
            Test201State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test201State::Fail),
            "pass" => Some(Test201State::Pass),
            "s0" => Some(Test201State::S0),
            _ => None,
        }
    }
                        ...
                        let _resolved_target: Option<String> = {
                            ...
                            match se.evaluate_expression(&sid, "_ioprocessors.basichttp.location") {
                                    ...
                                    ) =>
                                {
                                    ...
                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test201Event::ErrorCommunication, "<send> targetexpr evaluated to nothing, so there is no target to reach"));
                                    None
                                }
                                Ok(val) => {
                                    ...
                                    if trimmed.starts_with("!") {
                                        ...
                                        {
                                            let mut err_meta = sce_rust_runtime::EventWithMetadata::platform_error(Test201Event::ErrorExecution, "<send> targetexpr produced a target this processor cannot address");
                        ...
                        if let Some(ref _rt) = _resolved_target {
                            // W3C SCXML C.2: BasicHTTP send to HTTP target
                            {
                                ...
                                if !_rt.starts_with("http://") && !_rt.starts_with("https://") {
                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test201Event::ErrorCommunication, "<send> over BasicHTTPEventProcessor resolved a target that is not an http(s) URL"));
                                } else {
                                    let http_params =
...
impl Test201Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test201State,
        event: Test201Event,
        current_state: &mut Test201State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test201State::Fail => false,
            Test201State::Pass => false,
            Test201State::S0 => {
