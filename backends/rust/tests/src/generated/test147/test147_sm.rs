...
impl Test147Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test147Event] = &[];
}
...
impl StatePolicy for Test147Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test147State::Fail),
            "pass" => Some(Test147State::Pass),
            "s0" => Some(Test147State::S0),
            _ => None,
        }
    }
