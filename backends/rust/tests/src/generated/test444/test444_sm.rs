...
impl StatePolicy for Test444Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test444State::S0)]
    }
                ...
                if event == Test444Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq((function() var1 = _scxml_tonumber(var1) + 1 return var1 end)(), 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test444State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test444Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test444State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
