...
// From: resources/220/test220.scxml
//
...
//! Generated Rust state machine for `test220`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test220Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test220Event] = &[];
}
...
pub struct Test220Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test220State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test220__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test220__sce_synth_invoke__invoke_0_sm::Test220SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl Test220Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test220State::S0,
            session_id: None,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test220__sce_synth_invoke__invoke_0_sm::Test220SceSynthInvokeInvoke0Policy::new();
...
impl Default for Test220Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test220Policy {
    type State = Test220State;
    type Event = Test220Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test220State::Fail => true,
            Test220State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test220Event::CancelInvoke => "cancel.invoke",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test220Event::CancelInvoke),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test220State::Fail => "fail",
            Test220State::Pass => "pass",
            Test220State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test220State::Fail),
            "pass" => Some(Test220State::Pass),
            "s0" => Some(Test220State::S0),
            _ => None,
        }
    }
...
impl Test220Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test220State,
        event: Test220Event,
        current_state: &mut Test220State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test220State::Fail => false,
            Test220State::Pass => false,
            Test220State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test220Event::DoneInvoke {
                    ...
                    *current_state = Test220State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test220Event::Null
                    ...
                    )
                {
                    ...
                    *current_state = Test220State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
