...
#![doc = "SCE-MAP: test220__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test220SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test220SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test220SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test220SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
