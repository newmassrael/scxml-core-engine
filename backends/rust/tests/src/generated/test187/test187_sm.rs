...
impl Test187Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test187Event] =
        &[Test187Event::ChildToParent, Test187Event::Timeout];
}
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test187__sce_synth_invoke__invoke_0_sm::Test187SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test187Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test187State::Fail => "fail",
            Test187State::Pass => "pass",
            Test187State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test187State::Fail),
            "pass" => Some(Test187State::Pass),
            "s0" => Some(Test187State::S0),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test187State::S0 => {
                // SCE-MAP: test187.scxml:10 :: s0 :: _state_body
