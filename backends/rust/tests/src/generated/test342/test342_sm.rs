...
impl Test342Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test342Event] = &[Test342Event::Foo];
}
...
impl StatePolicy for Test342Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test342State::Fail),
            "pass" => Some(Test342State::Pass),
            "s0" => Some(Test342State::S0),
            "s1" => Some(Test342State::S1),
            _ => None,
        }
    }
