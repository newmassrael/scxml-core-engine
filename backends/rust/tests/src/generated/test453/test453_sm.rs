...
impl StatePolicy for Test453Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test453State::S0)]
    }
                ...
                if event == Test453Event::Event1 {
                    if self.safe_evaluate_guard("_scxml_eq(var1(2), 3)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test453State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test453State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
