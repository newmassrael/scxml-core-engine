...
#![doc = "SCE-MAP: test225__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test225SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test225SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test225SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal1" => Some(Test225SceSynthInvokeInvoke0State::SubFinal1),
            _ => None,
        }
    }
