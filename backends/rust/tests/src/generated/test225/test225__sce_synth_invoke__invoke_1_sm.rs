...
//! Generated Rust state machine for `test225__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test225__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
pub enum Test225SceSynthInvokeInvoke1State {
...
pub enum Test225SceSynthInvokeInvoke1Event {
...
impl Test225SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test225SceSynthInvokeInvoke1Event] = &[];
}
...
pub struct Test225SceSynthInvokeInvoke1Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test225SceSynthInvokeInvoke1State,
...
impl Test225SceSynthInvokeInvoke1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test225SceSynthInvokeInvoke1State::SubFinal2,
            session_id: None,
...
impl Default for Test225SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test225SceSynthInvokeInvoke1Policy {
    type State = Test225SceSynthInvokeInvoke1State;
    type Event = Test225SceSynthInvokeInvoke1Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test225SceSynthInvokeInvoke1State::SubFinal2
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test225SceSynthInvokeInvoke1State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test225SceSynthInvokeInvoke1State::SubFinal2 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test225SceSynthInvokeInvoke1Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test225SceSynthInvokeInvoke1State::SubFinal2 => "subFinal2",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal2" => Some(Test225SceSynthInvokeInvoke1State::SubFinal2),
            _ => None,
        }
    }
...
impl Test225SceSynthInvokeInvoke1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test225SceSynthInvokeInvoke1State,
        event: Test225SceSynthInvokeInvoke1Event,
        current_state: &mut Test225SceSynthInvokeInvoke1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test225SceSynthInvokeInvoke1State::SubFinal2 => false,
            _ => false,
        }
    }
}
