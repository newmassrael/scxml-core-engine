...
impl Test409Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test409Event] = &[Test409Event::Timeout];
}
...
impl Test409Policy {
    ...
    fn activate(&mut self, state: Test409State) -> bool {
    ...
    fn deactivate(&mut self, state: Test409State) {
...
impl StatePolicy for Test409Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test409State::S0 => &[Test409State::S01, Test409State::S02],
    ...
    fn get_initial_targets(
        ...
        match state {
            Test409State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test409State::S01)],
            Test409State::S01 => &[::sce_rust_runtime::EntryTarget::State(Test409State::S011)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test409State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test409State::Fail),
            "pass" => Some(Test409State::Pass),
            "s0" => Some(Test409State::S0),
            "s01" => Some(Test409State::S01),
            "s011" => Some(Test409State::S011),
            "s02" => Some(Test409State::S02),
            _ => None,
        }
    }
                ...
                if event == Test409Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test409State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test409Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test409State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test409Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test409State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
