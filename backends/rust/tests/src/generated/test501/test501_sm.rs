...
impl Test501Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test501Event] = &[Test501Event::Foo];
}
...
impl StatePolicy for Test501Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test501State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test501State::Fail),
            "pass" => Some(Test501State::Pass),
            "s0" => Some(Test501State::S0),
            _ => None,
        }
    }
                ...
                if event == Test501Event::Foo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test501State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test501State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
