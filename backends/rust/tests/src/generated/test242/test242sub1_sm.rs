...
// From: resources/242/test242sub1.scxml
//
...
//! Generated Rust state machine for `test242sub1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test242sub1.scxml:5 :: _machine"]
...
impl Test242sub1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test242sub1Event] = &[];
}
...
impl Test242sub1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test242sub1State::Final,
            session_id: None,
...
impl Default for Test242sub1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test242sub1Policy {
    type State = Test242sub1State;
    type Event = Test242sub1Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test242sub1State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test242sub1State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test242sub1State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test242sub1Event::Null => "",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test242sub1State::Final),
            _ => None,
        }
    }
...
impl Test242sub1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test242sub1State,
        event: Test242sub1Event,
        current_state: &mut Test242sub1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test242sub1State::Final => false,
            _ => false,
        }
    }
}
