...
//! Generated Rust state machine for `test242__sce_synth_invoke__invoke_2`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test242__sce_synth_invoke__invoke_2.scxml:3 :: _machine"]
...
pub enum Test242SceSynthInvokeInvoke2State {
...
pub enum Test242SceSynthInvokeInvoke2Event {
...
impl Test242SceSynthInvokeInvoke2Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test242SceSynthInvokeInvoke2Event] = &[];
}
...
pub struct Test242SceSynthInvokeInvoke2Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test242SceSynthInvokeInvoke2State,
...
impl Test242SceSynthInvokeInvoke2Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test242SceSynthInvokeInvoke2State::SubFinal2,
            session_id: None,
...
impl Default for Test242SceSynthInvokeInvoke2Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test242SceSynthInvokeInvoke2Policy {
    type State = Test242SceSynthInvokeInvoke2State;
    type Event = Test242SceSynthInvokeInvoke2Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test242SceSynthInvokeInvoke2State::SubFinal2
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test242SceSynthInvokeInvoke2State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test242SceSynthInvokeInvoke2State::SubFinal2 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test242SceSynthInvokeInvoke2Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test242SceSynthInvokeInvoke2State::SubFinal2 => "subFinal2",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal2" => Some(Test242SceSynthInvokeInvoke2State::SubFinal2),
            _ => None,
        }
    }
...
impl Test242SceSynthInvokeInvoke2Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test242SceSynthInvokeInvoke2State,
        event: Test242SceSynthInvokeInvoke2Event,
        current_state: &mut Test242SceSynthInvokeInvoke2State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test242SceSynthInvokeInvoke2State::SubFinal2 => false,
            _ => false,
        }
    }
}
