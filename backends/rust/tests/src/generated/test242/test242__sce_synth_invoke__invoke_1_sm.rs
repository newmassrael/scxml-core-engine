...
//! Generated Rust state machine for `test242__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum Test242SceSynthInvokeInvoke1State {
...
pub enum Test242SceSynthInvokeInvoke1Event {
...
impl Test242SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test242SceSynthInvokeInvoke1Event] = &[];
}
...
impl Default for Test242SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test242SceSynthInvokeInvoke1Policy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test242SceSynthInvokeInvoke1State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test242SceSynthInvokeInvoke1State::SubFinal1 => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test242SceSynthInvokeInvoke1State::SubFinal1 => "subFinal1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal1" => Some(Test242SceSynthInvokeInvoke1State::SubFinal1),
            _ => None,
        }
    }
