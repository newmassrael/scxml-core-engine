...
#![doc = "SCE-MAP: test377.scxml:5 :: _machine"]
...
impl Test377Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test377Event] = &[];
}
...
impl StatePolicy for Test377Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test377State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test377State::Fail => "fail",
            Test377State::Pass => "pass",
            Test377State::S0 => "s0",
            Test377State::S1 => "s1",
            Test377State::S2 => "s2",
        }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test377State::Fail),
            "pass" => Some(Test377State::Pass),
            "s0" => Some(Test377State::S0),
            "s1" => Some(Test377State::S1),
            "s2" => Some(Test377State::S2),
            _ => None,
        }
    }
                ...
                if event == Test377Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test377State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test377Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test377State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test377State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test377Event::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test377State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
