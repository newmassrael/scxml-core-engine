...
impl Test307Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test307Event] = &[Test307Event::Error];
}
...
impl StatePolicy for Test307Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test307State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test307State::Final),
            "s0" => Some(Test307State::S0),
            "s1" => Some(Test307State::S1),
            _ => None,
        }
    }
                ...
                if event == Test307Event::Error || event == Test307Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test307State::S1)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == Test307Event::Error || event == Test307Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test307State::Final)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
