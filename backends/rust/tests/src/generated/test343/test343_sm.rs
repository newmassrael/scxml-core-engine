...
impl Test343Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test343Event] = &[];
}
...
impl StatePolicy for Test343Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test343State::S0 => &[Test343State::S01, Test343State::S02],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test343State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test343State::S01)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test343State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test343State::Fail),
            "pass" => Some(Test343State::Pass),
            "s0" => Some(Test343State::S0),
            "s01" => Some(Test343State::S01),
            "s02" => Some(Test343State::S02),
            "s1" => Some(Test343State::S1),
            _ => None,
        }
    }
                ...
                let mut done_data_ok = true;
                {
                    ...
                    match se.evaluate_expression(&sid, "error(\"SCXML expr is not valid ECMAScript: foo: foo is not declared by this document\")") {
                        ...
                        Err(e) => {
                            ...
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test343Event::ErrorExecution, "<donedata> <param name='someParam'> failed to evaluate"));
                        }
                    }
                    if done_data_ok {
                ...
                if event == Test343Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test343State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test343Event::DoneStateS0 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test343State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test343Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test343State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test343Event::DoneStateS0 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test343State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
