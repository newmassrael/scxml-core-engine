...
impl Test457Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test457Event] = &[];
}
...
impl Test457Policy {
    ...
    pub fn var5(&self) -> Option<String> {
...
impl StatePolicy for Test457Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test457State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test457State::Fail => "fail",
            Test457State::Pass => "pass",
            Test457State::S0 => "s0",
            Test457State::S1 => "s1",
            Test457State::S2 => "s2",
            Test457State::S3 => "s3",
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test457State::Fail),
            "pass" => Some(Test457State::Pass),
            "s0" => Some(Test457State::S0),
            "s1" => Some(Test457State::S1),
            "s2" => Some(Test457State::S2),
            "s3" => Some(Test457State::S3),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test457State::Fail => {
                // SCE-MAP: test457.scxml:58 :: fail :: _state_body
            ...
            Test457State::Pass => {
                // SCE-MAP: test457.scxml:57 :: pass :: _state_body
                // W3C SCXML 3.8: onentry block 1/1
                // Labeled block allows actions to break out on error (W3C 3.8: error stops block)
                'action_block: {
                    // W3C SCXML 4.7: <log> with script engine expression
            ...
            Test457State::S3 => {
                // SCE-MAP: test457.scxml:47 :: s3 :: _state_body
                // W3C SCXML 3.8: onentry block 1/1
                // Labeled block allows actions to break out on error (W3C 3.8: error stops block)
                'action_block: {
                    {
    ...
    fn first_enabled_transition(
        ...
        match state {
                ...
                if event == Test457Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test457State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test457State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test457Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test457State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test457State::S2 => {
                if event == Test457Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 0)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test457State::S3)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test457State::S3 => {
                if event == Test457Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var6, 6)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test457State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
