...
#![doc = "SCE-MAP: test241__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test241SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test241SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test241SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub01" => Some(Test241SceSynthInvokeInvoke0State::Sub01),
            "subFinal1" => Some(Test241SceSynthInvokeInvoke0State::SubFinal1),
            _ => None,
        }
    }
