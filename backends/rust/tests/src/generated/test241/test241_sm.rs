...
// From: resources/241/test241.scxml
//
...
//! Generated Rust state machine for `test241`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test241.scxml:8 :: _machine"]
...
impl Test241Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test241Event] = &[
        Test241Event::Failure,
        Test241Event::Success,
        Test241Event::Timeout,
    ];
}
...
pub struct Test241Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test241State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test241__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test241__sce_synth_invoke__invoke_0_sm::Test241SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    pending_done_invoke_invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test241__sce_synth_invoke__invoke_1)
    child_invoke_1: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test241__sce_synth_invoke__invoke_1_sm::Test241SceSynthInvokeInvoke1Policy,
            >,
        >,
    >,
    pending_done_invoke_invoke_1: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_2' (test241__sce_synth_invoke__invoke_2)
    child_invoke_2: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test241__sce_synth_invoke__invoke_2_sm::Test241SceSynthInvokeInvoke2Policy,
            >,
        >,
    >,
...
impl Test241Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test241State::S01,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test241", &io_processors) {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                // 1:1 port of C++ NamelistHelper::evaluateNamelist — validate in parent scope
                {
                    ...
                    if !se.has_variable(&sid, "Var1") {
                        ::sce_rust_runtime::sce_log_error!(
                            "Namelist validation failed: 'Var1' not declared in parent"
                        );
                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                            Test241Event::ErrorExecution,
                            "<invoke> namelist names 'Var1', which the parent does not declare",
                        ));
                ...
                let mut child_policy = super::test241__sce_synth_invoke__invoke_0_sm::Test241SceSynthInvokeInvoke0Policy::new(self.script_engine.clone());
            ...
            if pending.invoke_id.contains("._invoke_1") {
                ...
                // Engine DI Parity RFC: forward parent's script engine to child when the
                // child Policy was generated with `model.needs_script_engine = true`.
                let mut child_policy = super::test241__sce_synth_invoke__invoke_1_sm::Test241SceSynthInvokeInvoke1Policy::new(self.script_engine.clone());
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
            ...
            if pending.invoke_id.contains("._invoke_2") {
                ...
                // Engine DI Parity RFC: forward parent's script engine to child when the
                // child Policy was generated with `model.needs_script_engine = true`.
                let mut child_policy = super::test241__sce_synth_invoke__invoke_2_sm::Test241SceSynthInvokeInvoke2Policy::new(self.script_engine.clone());
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
...
impl StatePolicy for Test241Policy {
    type State = Test241State;
    type Event = Test241Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test241State::Fail => true,
            Test241State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test241State::S01 => Some(Test241State::S0),
            Test241State::S02 => Some(Test241State::S0),
            Test241State::S03 => Some(Test241State::S0),
            _ => None,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test241Event::CancelInvoke => "cancel.invoke",
            Test241Event::DoneInvoke => "done.invoke",
            Test241Event::ErrorExecution => "error.execution",
            Test241Event::Failure => "failure",
            Test241Event::Success => "success",
            Test241Event::Timeout => "timeout",
            Test241Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test241Event::CancelInvoke),
            "done.invoke" => Some(Test241Event::DoneInvoke),
            "error.execution" => Some(Test241Event::ErrorExecution),
            "failure" => Some(Test241Event::Failure),
            "success" => Some(Test241Event::Success),
            "timeout" => Some(Test241Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test241State::Fail => "fail",
            Test241State::Pass => "pass",
            Test241State::S0 => "s0",
            Test241State::S01 => "s01",
            Test241State::S02 => "s02",
            Test241State::S03 => "s03",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test241State::Fail),
            "pass" => Some(Test241State::Pass),
            "s0" => Some(Test241State::S0),
            "s01" => Some(Test241State::S01),
            "s02" => Some(Test241State::S02),
            "s03" => Some(Test241State::S03),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test241State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test241State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test241State::S0 => Test241State::S01,
            _ => state,
        }
    }
...
impl Test241Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test241State,
        event: Test241Event,
        current_state: &mut Test241State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test241State::Fail => false,
            Test241State::Pass => false,
            Test241State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test241Event::Timeout {
                    ...
                    *current_state = Test241State::Fail;
            ...
            Test241State::S01 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test241Event::Success {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test241State::S02;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test241Event::Failure {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test241State::S03;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test241State::S02 => {
                ...
                if event == Test241Event::Success {
                    ...
                    *current_state = Test241State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
