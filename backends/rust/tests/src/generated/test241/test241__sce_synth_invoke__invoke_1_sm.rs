...
#![doc = "SCE-MAP: test241__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
impl Test241SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test241SceSynthInvokeInvoke1Event] = &[];
}
...
impl StatePolicy for Test241SceSynthInvokeInvoke1Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub02" => Some(Test241SceSynthInvokeInvoke1State::Sub02),
            "subFinal2" => Some(Test241SceSynthInvokeInvoke1State::SubFinal2),
            _ => None,
        }
    }
