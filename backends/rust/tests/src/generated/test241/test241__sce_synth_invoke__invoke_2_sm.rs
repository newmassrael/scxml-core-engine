...
#![doc = "SCE-MAP: test241__sce_synth_invoke__invoke_2.scxml:3 :: _machine"]
...
impl Test241SceSynthInvokeInvoke2Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test241SceSynthInvokeInvoke2Event] = &[];
}
...
impl StatePolicy for Test241SceSynthInvokeInvoke2Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub03" => Some(Test241SceSynthInvokeInvoke2State::Sub03),
            "subFinal3" => Some(Test241SceSynthInvokeInvoke2State::SubFinal3),
            _ => None,
        }
    }
