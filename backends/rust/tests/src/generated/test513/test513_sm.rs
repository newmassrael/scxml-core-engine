...
impl StatePolicy for Test513Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test513State::S0)]
    }
                ...
                if event == Test513Event::Test {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test513State::Pass)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == Test513Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test513State::Fail)],
                            transition_index: 1,
                            has_actions: true,
                            is_internal: false,
                        });
