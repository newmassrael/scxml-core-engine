...
// From: backends/rust/tests/src/generated/test216/test216_hybrid0.scxml
//
...
#![doc = "SCE-MAP: test216_hybrid0.scxml:2 :: _machine"]
...
impl Test216Hybrid0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test216Hybrid0Event] = &[];
}
...
impl StatePolicy for Test216Hybrid0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test216Hybrid0State::Final),
            _ => None,
        }
    }
