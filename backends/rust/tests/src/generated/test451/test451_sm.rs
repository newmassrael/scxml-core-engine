...
impl Test451Policy {
    ...
    fn activate(&mut self, state: Test451State) -> bool {
    ...
    fn deactivate(&mut self, state: Test451State) {
...
impl StatePolicy for Test451Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test451State::P)]
    }
                ...
                if event == Test451Event::Null {
                    if self.is_state_active("s1") {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test451State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test451Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test451State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
