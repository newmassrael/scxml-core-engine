...
impl Test350Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test350Event] = &[Test350Event::S0Event];
}
...
impl StatePolicy for Test350Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test350State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test350State::Fail),
            "pass" => Some(Test350State::Pass),
            "s0" => Some(Test350State::S0),
            _ => None,
        }
    }
                ...
                if event == Test350Event::S0Event {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test350State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test350State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
