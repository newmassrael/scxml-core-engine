...
//! Generated Rust state machine for `test338__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test338__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test338SceSynthInvokeInvoke0State {
...
impl Test338SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test338SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test338SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test338SceSynthInvokeInvoke0State,
...
impl Test338SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test338SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test338SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test338SceSynthInvokeInvoke0Policy {
    type State = Test338SceSynthInvokeInvoke0State;
    type Event = Test338SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test338SceSynthInvokeInvoke0State::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test338SceSynthInvokeInvoke0State::Sub0 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test338SceSynthInvokeInvoke0State::Sub0 => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test338SceSynthInvokeInvoke0State::Sub0 => "sub0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test338SceSynthInvokeInvoke0State::Sub0),
            _ => None,
        }
    }
...
impl Test338SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test338SceSynthInvokeInvoke0State,
        event: Test338SceSynthInvokeInvoke0Event,
        current_state: &mut Test338SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test338SceSynthInvokeInvoke0State::Sub0 => false,
            _ => false,
        }
    }
}
