...
// From: resources/301/test301.scxml
//
...
//! Generated Rust state machine for `test301`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test301Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test301Event] = &[];
}
...
impl Test301Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test301State::Pass,
            session_id: None,
...
impl StatePolicy for Test301Policy {
    type State = Test301State;
    type Event = Test301Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test301State::Fail => true,
            Test301State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test301State::Fail => "fail",
            Test301State::Pass => "pass",
            Test301State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test301State::Fail),
            "pass" => Some(Test301State::Pass),
            "s0" => Some(Test301State::S0),
            _ => None,
        }
    }
...
impl Test301Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test301State,
        event: Test301Event,
        current_state: &mut Test301State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test301State::Fail => false,
            Test301State::Pass => false,
            Test301State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test301Event::Null {
