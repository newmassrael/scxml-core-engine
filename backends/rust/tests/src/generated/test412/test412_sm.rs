...
impl Test412Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test412Event] = &[Test412Event::Timeout];
}
...
impl StatePolicy for Test412Policy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test412State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test412State::S01)],
            Test412State::S01 => &[::sce_rust_runtime::EntryTarget::State(Test412State::S011)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test412State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test412State::Fail),
            "pass" => Some(Test412State::Pass),
            "s0" => Some(Test412State::S0),
            "s01" => Some(Test412State::S01),
            "s011" => Some(Test412State::S011),
            "s02" => Some(Test412State::S02),
            "s03" => Some(Test412State::S03),
            "s04" => Some(Test412State::S04),
            _ => None,
        }
    }
                ...
                if event == Test412Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test412State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test412Event::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test412State::Pass)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test412Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test412State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test412Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test412State::S03)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test412Event::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test412State::S04)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
