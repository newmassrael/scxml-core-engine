...
impl Test230Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test230Event] =
        &[Test230Event::ChildToParent, Test230Event::Timeout];
}
    ...
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test230__sce_synth_invoke__invoke_0_sm::Test230SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test230__sce_synth_invoke__invoke_0_sm::Test230SceSynthInvokeInvoke0Policy::new(self.script_engine.clone());
...
impl StatePolicy for Test230Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test230State::Fail),
            "final" => Some(Test230State::Final),
            "s0" => Some(Test230State::S0),
            "s01" => Some(Test230State::S01),
            "s02" => Some(Test230State::S02),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test230State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test230State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test230State::S0 => Test230State::S01,
            _ => state,
        }
    }
