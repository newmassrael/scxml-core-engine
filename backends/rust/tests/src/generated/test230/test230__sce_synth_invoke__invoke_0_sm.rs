...
#![doc = "SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test230SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test230SceSynthInvokeInvoke0Event] =
        &[Test230SceSynthInvokeInvoke0Event::ChildToParent];
}
...
impl StatePolicy for Test230SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test230SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test230SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
                ...
                if event == Test230SceSynthInvokeInvoke0Event::ChildToParent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test230SceSynthInvokeInvoke0State::SubFinal,
                            )],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
