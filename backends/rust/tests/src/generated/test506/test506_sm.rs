...
impl StatePolicy for Test506Policy {
    ...
    fn get_initial_targets(
        ...
        match state {
            Test506State::S2 => &[::sce_rust_runtime::EntryTarget::State(Test506State::S21)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test506State::S1)]
    }
                ...
                if event == Test506Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test506State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test506State::S2 => {
                ...
                if event == Test506Event::Bar {
                    if self.safe_evaluate_guard("_scxml_eq(Var3, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test506State::S3)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test506Event::Bar {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test506State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test506State::S3 => {
                if event == Test506Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test506State::S4)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test506State::S4 => {
                if event == Test506Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test506State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
