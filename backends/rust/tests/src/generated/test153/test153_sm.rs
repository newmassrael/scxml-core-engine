...
impl StatePolicy for Test153Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test153State::S0)]
    }
                ...
                if event == Test153Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var4, 0)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test153State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test153Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test153State::Pass)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
