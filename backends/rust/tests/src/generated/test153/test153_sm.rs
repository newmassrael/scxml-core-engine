...
// From: resources/153/test153.scxml
//
...
//! Generated Rust state machine for `test153`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test153Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test153Event] = &[];
}
...
impl Test153Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test153State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test153", &io_processors) {
...
impl StatePolicy for Test153Policy {
    type State = Test153State;
    type Event = Test153Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test153State::Fail => true,
            Test153State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test153Event::ErrorExecution => "error.execution",
            Test153Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test153Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test153State::Fail => "fail",
            Test153State::Pass => "pass",
            Test153State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test153State::Fail),
            "pass" => Some(Test153State::Pass),
            "s0" => Some(Test153State::S0),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            Test153State::S0 => {
                // SCE-MAP: test153.scxml:17 :: s0 :: _state_body
...
impl Test153Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test153State,
        event: Test153Event,
        current_state: &mut Test153State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test153State::Fail => false,
            Test153State::Pass => false,
            Test153State::S0 => {
                ...
                if event == Test153Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var4, 0)", engine) {
                        ...
                        *current_state = Test153State::Fail;
                        *transition_taken = true;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = Test153State::Pass;
                        *transition_taken = true;
                        return true;
                    }
                }
