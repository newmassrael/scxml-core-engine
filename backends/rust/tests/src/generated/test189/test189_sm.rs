...
impl StatePolicy for Test189Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test189State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test189State::Fail),
            "pass" => Some(Test189State::Pass),
            "s0" => Some(Test189State::S0),
            _ => None,
        }
    }
                ...
                if event == Test189Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test189State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test189Event::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test189State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
