...
impl StatePolicy for Test460Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test460State::S0)]
    }
                ...
                if event == Test460Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 3)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test460State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test460Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test460State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
