...
impl Test250Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test250Event] = &[Test250Event::Foo];
}
    ...
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test250__sce_synth_invoke__invoke_0_sm::Test250SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl StatePolicy for Test250Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test250State::Final),
            "s0" => Some(Test250State::S0),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test250Event::Foo);
