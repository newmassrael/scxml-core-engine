...
//! Generated Rust state machine for `test250__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test250__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
// SCE-MAP: test250__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
pub enum Test250SceSynthInvokeInvoke0State {
    Sub0,
...
pub enum Test250SceSynthInvokeInvoke0Event {
    ErrorExecution,
    Timeout,
...
impl Test250SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test250SceSynthInvokeInvoke0Event] =
...
pub struct Test250SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test250SceSynthInvokeInvoke0State,
...
impl Test250SceSynthInvokeInvoke0Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test250SceSynthInvokeInvoke0State::Sub01,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "test250__sce_synth_invoke__invoke_0", &io_processors)
        {
...
impl StatePolicy for Test250SceSynthInvokeInvoke0Policy {
    type State = Test250SceSynthInvokeInvoke0State;
    type Event = Test250SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test250SceSynthInvokeInvoke0State::Sub01
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test250SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test250SceSynthInvokeInvoke0State::Sub01 => {
                Some(Test250SceSynthInvokeInvoke0State::Sub0)
            }
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test250SceSynthInvokeInvoke0State::Sub0 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test250SceSynthInvokeInvoke0State::Sub0 => 0,
            Test250SceSynthInvokeInvoke0State::Sub01 => 1,
            Test250SceSynthInvokeInvoke0State::SubFinal => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test250SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test250SceSynthInvokeInvoke0Event::Timeout => "timeout",
            Test250SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test250SceSynthInvokeInvoke0Event::ErrorExecution),
            "timeout" => Some(Test250SceSynthInvokeInvoke0Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test250SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test250SceSynthInvokeInvoke0State::Sub01 => "sub01",
            Test250SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test250SceSynthInvokeInvoke0State::Sub0),
            "sub01" => Some(Test250SceSynthInvokeInvoke0State::Sub01),
            "subFinal" => Some(Test250SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test250SceSynthInvokeInvoke0State::Sub0 => Test250SceSynthInvokeInvoke0State::Sub01,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            ...
            Test250SceSynthInvokeInvoke0State::SubFinal => {
...
impl Test250SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test250SceSynthInvokeInvoke0State,
        event: Test250SceSynthInvokeInvoke0Event,
        current_state: &mut Test250SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test250SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test250SceSynthInvokeInvoke0Event::Timeout {
                    ...
                    *current_state = Test250SceSynthInvokeInvoke0State::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test250SceSynthInvokeInvoke0State::Sub01 => false,
            Test250SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
