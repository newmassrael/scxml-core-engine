...
// From: resources/252/test252.scxml
//
...
//! Generated Rust state machine for `test252`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test252.scxml:7 :: _machine"]
...
impl Test252Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test252Event] = &[
        Test252Event::ChildToParent,
        Test252Event::Foo,
        Test252Event::Timeout,
    ];
}
...
pub struct Test252Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test252State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test252__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test252__sce_synth_invoke__invoke_0_sm::Test252SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl Test252Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test252State::S01,
            session_id: None,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test252__sce_synth_invoke__invoke_0_sm::Test252SceSynthInvokeInvoke0Policy::new();
...
impl Default for Test252Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test252Policy {
    type State = Test252State;
    type Event = Test252Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test252State::Fail => true,
            Test252State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test252State::S01 => Some(Test252State::S0),
            Test252State::S02 => Some(Test252State::S0),
            _ => None,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test252Event::CancelInvoke => "cancel.invoke",
            Test252Event::ChildToParent => "childToParent",
            Test252Event::DoneInvoke => "done.invoke",
            Test252Event::ErrorExecution => "error.execution",
            Test252Event::Foo => "foo",
            Test252Event::Timeout => "timeout",
            Test252Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test252Event::CancelInvoke),
            "childToParent" => Some(Test252Event::ChildToParent),
            "done.invoke" => Some(Test252Event::DoneInvoke),
            "error.execution" => Some(Test252Event::ErrorExecution),
            "foo" => Some(Test252Event::Foo),
            "timeout" => Some(Test252Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test252State::Fail => "fail",
            Test252State::Pass => "pass",
            Test252State::S0 => "s0",
            Test252State::S01 => "s01",
            Test252State::S02 => "s02",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test252State::Fail),
            "pass" => Some(Test252State::Pass),
            "s0" => Some(Test252State::S0),
            "s01" => Some(Test252State::S01),
            "s02" => Some(Test252State::S02),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test252State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test252State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test252State::S0 => Test252State::S01,
            _ => state,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test252Event::Foo);
...
impl Test252Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test252State,
        event: Test252Event,
        current_state: &mut Test252State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test252State::Fail => false,
            Test252State::Pass => false,
            Test252State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test252Event::Timeout {
                    ...
                    *current_state = Test252State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test252Event::ChildToParent {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test252State::Fail;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test252Event::DoneInvoke {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
            ...
            Test252State::S01 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test252Event::Foo {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test252State::S02;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test252State::S02 => false,
            _ => false,
        }
    }
}
