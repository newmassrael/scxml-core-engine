...
//! Generated Rust state machine for `test252__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test252__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test252SceSynthInvokeInvoke0State {
...
impl Test252SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test252SceSynthInvokeInvoke0Event] =
...
pub struct Test252SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test252SceSynthInvokeInvoke0State,
...
impl Test252SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test252SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test252SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test252SceSynthInvokeInvoke0Policy {
    type State = Test252SceSynthInvokeInvoke0State;
    type Event = Test252SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test252SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test252SceSynthInvokeInvoke0State::Sub0 => 0,
            Test252SceSynthInvokeInvoke0State::SubFinal => 1,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test252SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test252SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test252SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test252SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
...
impl Test252SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test252SceSynthInvokeInvoke0State,
        event: Test252SceSynthInvokeInvoke0Event,
        current_state: &mut Test252SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test252SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test252SceSynthInvokeInvoke0Event::Timeout {
                    ...
                    *current_state = Test252SceSynthInvokeInvoke0State::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test252SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
