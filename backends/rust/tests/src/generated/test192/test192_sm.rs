...
impl Test192Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test192Event] = &[
        Test192Event::ChildToParent,
        Test192Event::EventReceived,
...
pub struct Test192Policy {
    ...
    // W3C SCXML 6.4: Static invoke child 'invokedChild' (test192__sce_synth_invoke__invokedChild)
    child_invokedChild: Option<Box<sce_rust_runtime::Engine<super::test192__sce_synth_invoke__invokedChild_sm::Test192SceSynthInvokeInvokedChildPolicy>>>,
...
impl Test192Policy {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.document_id == "invokedChild" {
                ...
                let mut child_policy = super::test192__sce_synth_invoke__invokedChild_sm::Test192SceSynthInvokeInvokedChildPolicy::new();
...
impl StatePolicy for Test192Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test192State::S0 => &[Test192State::S01, Test192State::S02],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test192State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test192State::S01)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test192State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test192State::Fail => "fail",
            Test192State::Pass => "pass",
            Test192State::S0 => "s0",
            Test192State::S01 => "s01",
            Test192State::S02 => "s02",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test192State::Fail),
            "pass" => Some(Test192State::Pass),
            "s0" => Some(Test192State::S0),
            "s01" => Some(Test192State::S01),
            "s02" => Some(Test192State::S02),
            _ => None,
        }
    }
    ...
    fn execute_exit_actions(
        ...
        match state {
            Test192State::S0 => {
                ...
                // W3C SCXML 6.4: Cleanup running static child 'invokedChild'
                ...
                if event == Test192Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test192State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test192Event::ChildToParent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test192State::S02)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == Test192Event::EventReceived {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test192State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
