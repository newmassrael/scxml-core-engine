...
//! Generated Rust state machine for `test192__sce_synth_invoke__invokedChild`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test192__sce_synth_invoke__invokedChild.scxml:3 :: _machine"]
...
pub enum Test192SceSynthInvokeInvokedChildState {
...
impl Test192SceSynthInvokeInvokedChildEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test192SceSynthInvokeInvokedChildEvent] = &[
        Test192SceSynthInvokeInvokedChildEvent::ParentToChild,
...
pub struct Test192SceSynthInvokeInvokedChildPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test192SceSynthInvokeInvokedChildState,
...
impl Test192SceSynthInvokeInvokedChildPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test192SceSynthInvokeInvokedChildState::Sub0,
...
impl Default for Test192SceSynthInvokeInvokedChildPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test192SceSynthInvokeInvokedChildPolicy {
    type State = Test192SceSynthInvokeInvokedChildState;
    type Event = Test192SceSynthInvokeInvokedChildEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test192SceSynthInvokeInvokedChildState::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test192SceSynthInvokeInvokedChildState::Sub0 => 0,
            Test192SceSynthInvokeInvokedChildState::SubFinal => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            Test192SceSynthInvokeInvokedChildEvent::Timeout => "timeout",
            Test192SceSynthInvokeInvokedChildEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "timeout" => Some(Test192SceSynthInvokeInvokedChildEvent::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test192SceSynthInvokeInvokedChildState::Sub0 => "sub0",
            Test192SceSynthInvokeInvokedChildState::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test192SceSynthInvokeInvokedChildState::Sub0),
            "subFinal" => Some(Test192SceSynthInvokeInvokedChildState::SubFinal),
            _ => None,
        }
    }
...
impl Test192SceSynthInvokeInvokedChildPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test192SceSynthInvokeInvokedChildState,
        event: Test192SceSynthInvokeInvokedChildEvent,
        current_state: &mut Test192SceSynthInvokeInvokedChildState,
        ...
        match check_state {
            Test192SceSynthInvokeInvokedChildState::Sub0 => {
                ...
                if event == Test192SceSynthInvokeInvokedChildEvent::ParentToChild {
                    ...
                    *current_state = Test192SceSynthInvokeInvokedChildState::SubFinal;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test192SceSynthInvokeInvokedChildEvent::Timeout {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
            ...
            Test192SceSynthInvokeInvokedChildState::SubFinal => false,
            _ => false,
        }
    }
}
