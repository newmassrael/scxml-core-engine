...
impl Test403aPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test403aState::S01,
            session_id: None,
...
impl Test403aPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test403aState,
        event: Test403aEvent,
        current_state: &mut Test403aState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test403aState::Fail => false,
            Test403aState::Pass => false,
            Test403aState::S0 => {
            ...
            Test403aState::S02 => {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test403aEvent::Event2 {
                    // W3C SCXML 5.9: cond="false" decided at build time
                    if false {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
