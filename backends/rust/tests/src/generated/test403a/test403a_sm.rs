...
// From: resources/403/test403a.scxml
//
...
//! Generated Rust state machine for `test403a`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test403a.scxml:11 :: _machine"]
...
impl Test403aEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test403aEvent] = &[Test403aEvent::Timeout];
}
...
impl StatePolicy for Test403aPolicy {
    type State = Test403aState;
    type Event = Test403aEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test403aState::Fail => true,
            Test403aState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test403aState::S01 => Some(Test403aState::S0),
            Test403aState::S02 => Some(Test403aState::S0),
            _ => None,
        }
    }
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test403aState::S0 => &[Test403aState::S01, Test403aState::S02],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test403aState::S0 => &[::sce_rust_runtime::EntryTarget::State(Test403aState::S01)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test403aState::S0)]
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test403aState::Fail => 4,
            Test403aState::Pass => 3,
            Test403aState::S0 => 0,
            Test403aState::S01 => 1,
            Test403aState::S02 => 2,
        }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test403aEvent::ErrorExecution => "error.execution",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test403aEvent::ErrorExecution),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test403aState::Fail => "fail",
            Test403aState::Pass => "pass",
            Test403aState::S0 => "s0",
            Test403aState::S01 => "s01",
            Test403aState::S02 => "s02",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test403aState::Fail),
            "pass" => Some(Test403aState::Pass),
            "s0" => Some(Test403aState::S0),
            "s01" => Some(Test403aState::S01),
            "s02" => Some(Test403aState::S02),
            _ => None,
        }
    }
                ...
                if event == Test403aEvent::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403aState::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test403aEvent::Event2 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403aState::Pass)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test403aEvent::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test403aState::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
