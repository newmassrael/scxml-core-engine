...
// From: resources/577/test577.scxml
//
...
//! Generated Rust state machine for `test577`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test577.scxml:5 :: _machine"]
...
impl Test577Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test577Event] = &[];
}
...
impl Test577Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test577State::S0,
            session_id: None,
...
impl Default for Test577Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test577Policy {
    type State = Test577State;
    type Event = Test577Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test577State::Fail => true,
            Test577State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test577Event::ErrorCommunication => "error.communication",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.communication" => Some(Test577Event::ErrorCommunication),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test577State::Fail => "fail",
            Test577State::Pass => "pass",
            Test577State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test577State::Fail),
            "pass" => Some(Test577State::Pass),
            "s0" => Some(Test577State::S0),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test577Event::Event1);
...

                    {
                        ...
                        // W3C SCXML C.2: BasicHTTP without target raises error.communication
                        {
                            let mut err_meta = sce_rust_runtime::EventWithMetadata::platform_error(
                                Test577Event::ErrorCommunication,
...
impl Test577Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test577State,
        event: Test577Event,
        current_state: &mut Test577State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test577State::Fail => false,
            Test577State::Pass => false,
            Test577State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test577Event::ErrorCommunication {
                    ...
                    *current_state = Test577State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != Test577Event::Null
                    ...
                    )
                {
                    ...
                    *current_state = Test577State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
