...
// From: resources/406/test406.scxml
//
...
//! Generated Rust state machine for `test406`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test406Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test406Event] = &[Test406Event::Timeout];
}
...
pub struct Test406Policy {
    ...
    last_transition_source_state: Test406State,
    ...
    active_states: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test406State>,
...
impl Test406Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test406State::S01,
...
impl Default for Test406Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test406Policy {
    type State = Test406State;
    type Event = Test406Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test406State::Fail => true,
            Test406State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test406State::S01 => Some(Test406State::S0),
            Test406State::S01p21 => Some(Test406State::S0p2),
            Test406State::S01p22 => Some(Test406State::S0p2),
            Test406State::S03 => Some(Test406State::S0),
            Test406State::S04 => Some(Test406State::S0),
            Test406State::S05 => Some(Test406State::S0),
            Test406State::S0p2 => Some(Test406State::S0),
            _ => None,
        }
    }
    ...
    fn get_parallel_regions(state: Self::State) -> &'static [Self::State] {
        match state {
            Test406State::S0p2 => &[Test406State::S01p21, Test406State::S01p22],
            _ => &[],
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test406Event::ErrorExecution => "error.execution",
            Test406Event::Event1 => "event1",
            Test406Event::Event2 => "event2",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test406Event::ErrorExecution),
            "event1" => Some(Test406Event::Event1),
            "event2" => Some(Test406Event::Event2),
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test406State::Fail => "fail",
            Test406State::Pass => "pass",
            Test406State::S0 => "s0",
            Test406State::S01 => "s01",
            Test406State::S01p21 => "s01p21",
            Test406State::S01p22 => "s01p22",
            Test406State::S03 => "s03",
            Test406State::S04 => "s04",
            Test406State::S05 => "s05",
            Test406State::S0p2 => "s0p2",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test406State::Fail),
            "pass" => Some(Test406State::Pass),
            "s0" => Some(Test406State::S0),
            "s01" => Some(Test406State::S01),
            "s01p21" => Some(Test406State::S01p21),
            "s01p22" => Some(Test406State::S01p22),
            "s03" => Some(Test406State::S03),
            "s04" => Some(Test406State::S04),
            "s05" => Some(Test406State::S05),
            "s0p2" => Some(Test406State::S0p2),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test406State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test406State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test406State::S0 => Test406State::S01,
            _ => state,
        }
    }
...
impl Test406Policy {
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test406State::S0 => {
                ...
                if event == Test406Event::Timeout {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::Fail;
            ...
            Test406State::S01 => {
                ...
                if event == Test406Event::Null {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::S0p2;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test406State::S01p21 => false,
            Test406State::S01p22 => false,
            Test406State::S03 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test406Event::Event2 {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = false;
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::S04;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test406State::S04 => {
                ...
                if event == Test406Event::Event3 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::S05;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test406State::S05 => {
                ...
                if event == Test406Event::Event4 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::Pass;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test406State::S0p2 => {
                ...
                if event == Test406Event::Event1 {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test406State::S03;
                        *transition_taken = true;
                    }
                    return true;
                }
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test406State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test406State> =
