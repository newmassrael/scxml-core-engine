...
impl StatePolicy for Test503Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test503State::S1)]
    }
                ...
                if event == Test503Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test503State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test503State::S2 => {
                ...
                if event == Test503Event::Bar {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test503State::S3)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test503Event::Bar {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test503State::Fail)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test503State::S3 => {
                if event == Test503Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test503State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
