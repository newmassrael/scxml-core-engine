...
impl Test243Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test243Event] = &[Test243Event::Success];
}
...
impl StatePolicy for Test243Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test243State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test243State::Fail),
            "pass" => Some(Test243State::Pass),
            "s0" => Some(Test243State::S0),
            _ => None,
        }
    }
                ...
                if event == Test243Event::Success {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test243State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test243State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
