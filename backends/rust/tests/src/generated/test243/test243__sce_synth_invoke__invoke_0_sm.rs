...
#![doc = "SCE-MAP: test243__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test243SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test243SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test243SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test243SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test243SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
                    ...
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test243SceSynthInvokeInvoke0State::SubFinal,
                            )],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
