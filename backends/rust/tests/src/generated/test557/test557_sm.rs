...
impl StatePolicy for Test557Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test557State::S0)]
    }
                ...
                if event == Test557Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(var1:getElementsByTagName(\"book\")[1]:getAttribute(\"title\"), \"title1\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test557State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test557Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test557State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test557State::S1 => {
                if event == Test557Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(var2:getElementsByTagName(\"book\")[2]:getAttribute(\"title\"), \"title2\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test557State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
