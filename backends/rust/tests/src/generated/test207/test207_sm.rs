...
impl Test207Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test207Event] = &[
        Test207Event::ChildToParent,
        Test207Event::Fail,
        Test207Event::Pass,
...
impl StatePolicy for Test207Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test207State::Fail),
            "pass" => Some(Test207State::Pass),
            "s0" => Some(Test207State::S0),
            "s01" => Some(Test207State::S01),
            "s02" => Some(Test207State::S02),
            _ => None,
        }
    }
