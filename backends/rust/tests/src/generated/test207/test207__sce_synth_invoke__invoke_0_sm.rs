...
#![doc = "SCE-MAP: test207__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test207SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test207SceSynthInvokeInvoke0Event] =
...
impl StatePolicy for Test207SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test207SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test207SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
                ...
                if event == Test207SceSynthInvokeInvoke0Event::Event1 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test207SceSynthInvokeInvoke0State::SubFinal,
                            )],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
