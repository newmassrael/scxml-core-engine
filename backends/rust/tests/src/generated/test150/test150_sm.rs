...
impl Test150Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test150Event] = &[Test150Event::Error];
}
...
impl StatePolicy for Test150Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test150State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test150State::Fail),
            "pass" => Some(Test150State::Pass),
            "s0" => Some(Test150State::S0),
            "s1" => Some(Test150State::S1),
            "s2" => Some(Test150State::S2),
            _ => None,
        }
    }
    ...
    fn first_enabled_transition(
        ...
        match state {
                ...
                if event == Test150Event::Error || event == Test150Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test150State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test150State::S1)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test150State::S2)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test150State::S2 => {
                if event == Test150Event::Null {
                    if self.safe_evaluate_guard("(_typeof(Var4) ~= \"undefined\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test150State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
