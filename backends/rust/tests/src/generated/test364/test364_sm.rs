...
// From: resources/364/test364.scxml
//
...
//! Generated Rust state machine for `test364`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test364.scxml:7 :: _machine"]
...
impl Test364Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test364Event] = &[Test364Event::Timeout];
}
...
impl Default for Test364Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test364Policy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test364State::Fail => true,
            Test364State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test364State::S11 => Some(Test364State::S1),
            Test364State::S111 => Some(Test364State::S11),
            Test364State::S11p1 => Some(Test364State::S11),
            Test364State::S11p11 => Some(Test364State::S11p1),
            Test364State::S11p111 => Some(Test364State::S11p11),
            Test364State::S11p112 => Some(Test364State::S11p11),
            Test364State::S11p12 => Some(Test364State::S11p1),
            Test364State::S11p121 => Some(Test364State::S11p12),
            Test364State::S11p122 => Some(Test364State::S11p12),
            Test364State::S21 => Some(Test364State::S2),
            Test364State::S211 => Some(Test364State::S21),
            Test364State::S21p1 => Some(Test364State::S21),
            Test364State::S21p11 => Some(Test364State::S21p1),
            Test364State::S21p111 => Some(Test364State::S21p11),
            Test364State::S21p112 => Some(Test364State::S21p11),
            Test364State::S21p12 => Some(Test364State::S21p1),
            Test364State::S21p121 => Some(Test364State::S21p12),
            Test364State::S21p122 => Some(Test364State::S21p12),
            Test364State::S31 => Some(Test364State::S3),
            Test364State::S311 => Some(Test364State::S31),
            Test364State::S3111 => Some(Test364State::S311),
            Test364State::S3112 => Some(Test364State::S311),
            Test364State::S312 => Some(Test364State::S311),
            Test364State::S32 => Some(Test364State::S311),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            Test364State::S1 => true,
            Test364State::S11 => true,
            Test364State::S11p11 => true,
            Test364State::S11p12 => true,
            Test364State::S2 => true,
            Test364State::S21 => true,
            Test364State::S21p11 => true,
            Test364State::S21p12 => true,
            Test364State::S3 => true,
            Test364State::S31 => true,
            Test364State::S311 => true,
            _ => false,
        }
    }
    ...
    fn is_parallel_state(state: Self::State) -> bool {
        match state {
            Test364State::S11p1 => true,
            Test364State::S21p1 => true,
            _ => false,
        }
    }
    ...
    fn get_parallel_regions(state: Self::State) -> &'static [Self::State] {
        match state {
            Test364State::S11p1 => &[Test364State::S11p11, Test364State::S11p12],
            Test364State::S21p1 => &[Test364State::S21p11, Test364State::S21p12],
            _ => &[],
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test364State::Fail => 28,
            Test364State::Pass => 27,
            Test364State::S1 => 0,
            Test364State::S11 => 1,
            Test364State::S111 => 2,
            Test364State::S11p1 => 3,
            Test364State::S11p11 => 4,
            Test364State::S11p111 => 5,
            Test364State::S11p112 => 6,
            Test364State::S11p12 => 7,
            Test364State::S11p121 => 8,
            Test364State::S11p122 => 9,
            Test364State::S2 => 10,
            Test364State::S21 => 11,
            Test364State::S211 => 12,
            Test364State::S21p1 => 13,
            Test364State::S21p11 => 14,
            Test364State::S21p111 => 15,
            Test364State::S21p112 => 16,
            Test364State::S21p12 => 17,
            Test364State::S21p121 => 18,
            Test364State::S21p122 => 19,
            Test364State::S3 => 20,
            Test364State::S31 => 21,
            Test364State::S311 => 22,
            Test364State::S3111 => 23,
            Test364State::S3112 => 24,
            Test364State::S312 => 25,
            Test364State::S32 => 26,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test364Event::ErrorExecution => "error.execution",
            Test364Event::InS11p112 => "In-s11p112",
            Test364Event::InS21p112 => "In-s21p112",
            Test364Event::Timeout => "timeout",
            Test364Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test364Event::ErrorExecution),
            "In-s11p112" => Some(Test364Event::InS11p112),
            "In-s21p112" => Some(Test364Event::InS21p112),
            "timeout" => Some(Test364Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test364State::Fail => "fail",
            Test364State::Pass => "pass",
            Test364State::S1 => "s1",
            Test364State::S11 => "s11",
            Test364State::S111 => "s111",
            Test364State::S11p1 => "s11p1",
            Test364State::S11p11 => "s11p11",
            Test364State::S11p111 => "s11p111",
            Test364State::S11p112 => "s11p112",
            Test364State::S11p12 => "s11p12",
            Test364State::S11p121 => "s11p121",
            Test364State::S11p122 => "s11p122",
            Test364State::S2 => "s2",
            Test364State::S21 => "s21",
            Test364State::S211 => "s211",
            Test364State::S21p1 => "s21p1",
            Test364State::S21p11 => "s21p11",
            Test364State::S21p111 => "s21p111",
            Test364State::S21p112 => "s21p112",
            Test364State::S21p12 => "s21p12",
            Test364State::S21p121 => "s21p121",
            Test364State::S21p122 => "s21p122",
            Test364State::S3 => "s3",
            Test364State::S31 => "s31",
            Test364State::S311 => "s311",
            Test364State::S3111 => "s3111",
            Test364State::S3112 => "s3112",
            Test364State::S312 => "s312",
            Test364State::S32 => "s32",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test364State::Fail),
            "pass" => Some(Test364State::Pass),
            "s1" => Some(Test364State::S1),
            "s11" => Some(Test364State::S11),
            "s111" => Some(Test364State::S111),
            "s11p1" => Some(Test364State::S11p1),
            "s11p11" => Some(Test364State::S11p11),
            "s11p111" => Some(Test364State::S11p111),
            "s11p112" => Some(Test364State::S11p112),
            "s11p12" => Some(Test364State::S11p12),
            "s11p121" => Some(Test364State::S11p121),
            "s11p122" => Some(Test364State::S11p122),
            "s2" => Some(Test364State::S2),
            "s21" => Some(Test364State::S21),
            "s211" => Some(Test364State::S211),
            "s21p1" => Some(Test364State::S21p1),
            "s21p11" => Some(Test364State::S21p11),
            "s21p111" => Some(Test364State::S21p111),
            "s21p112" => Some(Test364State::S21p112),
            "s21p12" => Some(Test364State::S21p12),
            "s21p121" => Some(Test364State::S21p121),
            "s21p122" => Some(Test364State::S21p122),
            "s3" => Some(Test364State::S3),
            "s31" => Some(Test364State::S31),
            "s311" => Some(Test364State::S311),
            "s3111" => Some(Test364State::S3111),
            "s3112" => Some(Test364State::S3112),
            "s312" => Some(Test364State::S312),
            "s32" => Some(Test364State::S32),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            ...
            Test364State::S3 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test364State::S31])
            }
            Test364State::S31 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test364State::S311])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test364State::S1 => Test364State::S11p112,
            Test364State::S11 => Test364State::S11p1,
            Test364State::S11p11 => Test364State::S11p112,
            Test364State::S11p12 => Test364State::S11p122,
            Test364State::S2 => Test364State::S21p112,
            Test364State::S21 => Test364State::S21p1,
            Test364State::S21p11 => Test364State::S21p112,
            Test364State::S21p12 => Test364State::S21p122,
            Test364State::S3 => Test364State::S31,
            Test364State::S31 => Test364State::S311,
            Test364State::S311 => Test364State::S3111,
            _ => state,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            ...
            Test364State::S21p112 => {
                ...
                // Labeled block allows actions to break out on error (W3C 3.8: error stops block)
                'action_block: {
                    // W3C SCXML 3.8.1: <raise event="In-s21p112">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        Test364Event::InS21p112,
                    ));
                }
            }
            _ => {}
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(Test364State, usize)> =
...
impl Test364Policy {
    ...
    fn try_transition_in_state(
        ...
        match check_state {
            ...
            Test364State::S1 => {
                ...
                if event == Test364Event::Timeout {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test364State::Fail;
            ...
            Test364State::S11 => false,
            Test364State::S111 => false,
            Test364State::S11p1 => false,
            Test364State::S11p11 => false,
            Test364State::S11p111 => false,
            Test364State::S11p112 => false,
            Test364State::S11p12 => false,
            Test364State::S11p121 => false,
            Test364State::S11p122 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test364Event::InS11p112 {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
            ...
            Test364State::S21 => false,
            Test364State::S211 => false,
            Test364State::S21p1 => false,
            Test364State::S21p11 => false,
            Test364State::S21p111 => false,
            Test364State::S21p112 => false,
            Test364State::S21p12 => false,
            Test364State::S21p121 => false,
            Test364State::S21p122 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test364Event::InS21p112 {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
            ...
            Test364State::S31 => false,
            Test364State::S311 => false,
            Test364State::S3111 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test364Event::Null {
                    // Unconditional eventless transition
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        ...
                        *current_state = Test364State::Pass;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            Test364State::S3112 => false,
            Test364State::S312 => false,
            Test364State::S32 => false,
            _ => false,
        }
    }
    ...
    fn compute_exit_set(
        ...
        is_internal: bool,
        is_targetless: bool,
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<Test364State> {
    ...
    fn execute_microstep(
        ...
        let mut states_to_exit: ::sce_rust_runtime::helpers::hierarchy::StateChain<Test364State> =
        ...
        for trans in transitions {
            ...
            let domain: Option<Test364State> = if is_internal_to_descendant {
                Some(trans.source)
            } else {
