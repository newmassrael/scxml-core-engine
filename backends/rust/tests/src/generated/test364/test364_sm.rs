...
impl Test364Policy {
    ...
    fn activate(&mut self, state: Test364State) -> bool {
    ...
    fn deactivate(&mut self, state: Test364State) {
...
impl StatePolicy for Test364Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test364State::S1 => &[Test364State::S11],
            Test364State::S11 => &[Test364State::S111, Test364State::S11p1],
            Test364State::S11p1 => &[Test364State::S11p11, Test364State::S11p12],
            Test364State::S11p11 => &[Test364State::S11p111, Test364State::S11p112],
            Test364State::S11p12 => &[Test364State::S11p121, Test364State::S11p122],
            Test364State::S2 => &[Test364State::S21],
            Test364State::S21 => &[Test364State::S211, Test364State::S21p1],
            Test364State::S21p1 => &[Test364State::S21p11, Test364State::S21p12],
            Test364State::S21p11 => &[Test364State::S21p111, Test364State::S21p112],
            Test364State::S21p12 => &[Test364State::S21p121, Test364State::S21p122],
    ...
    fn get_initial_targets(
        ...
        match state {
            Test364State::S1 => &[
                ::sce_rust_runtime::EntryTarget::State(Test364State::S11p112),
                ::sce_rust_runtime::EntryTarget::State(Test364State::S11p122),
            ],
            Test364State::S11 => &[::sce_rust_runtime::EntryTarget::State(Test364State::S111)],
            Test364State::S11p11 => &[::sce_rust_runtime::EntryTarget::State(
                Test364State::S11p111,
            )],
            Test364State::S11p12 => &[::sce_rust_runtime::EntryTarget::State(
                Test364State::S11p121,
            )],
            Test364State::S2 => &[
                ::sce_rust_runtime::EntryTarget::State(Test364State::S21p112),
                ::sce_rust_runtime::EntryTarget::State(Test364State::S21p122),
            ],
            Test364State::S21 => &[::sce_rust_runtime::EntryTarget::State(Test364State::S211)],
            Test364State::S21p11 => &[::sce_rust_runtime::EntryTarget::State(
                Test364State::S21p111,
            )],
            Test364State::S21p12 => &[::sce_rust_runtime::EntryTarget::State(
                Test364State::S21p121,
            )],
            Test364State::S3 => &[::sce_rust_runtime::EntryTarget::State(Test364State::S31)],
            Test364State::S31 => &[::sce_rust_runtime::EntryTarget::State(Test364State::S311)],
            Test364State::S311 => &[::sce_rust_runtime::EntryTarget::State(Test364State::S3111)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test364State::S1)]
    }
                ...
                if event == Test364Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test364State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test364Event::InS11p112 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test364State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test364Event::InS21p112 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test364State::S3)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test364Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test364State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
