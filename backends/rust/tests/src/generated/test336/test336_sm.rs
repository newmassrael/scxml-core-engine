...
impl Test336Policy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test336", &io_processors) {
                            ...
                            let _resolved_target: Option<String> = {
                                ...
                                match se.evaluate_expression(&sid, "_event.origin") {
                                        ...
                                        ) =>
                                    {
                                        ...
                                        engine.raise(sce_rust_runtime::EventWithMetadata::new(
                                            Test336Event::ErrorCommunication,
                                        ));
                                        None
                                    }
                                    Ok(val) => {
