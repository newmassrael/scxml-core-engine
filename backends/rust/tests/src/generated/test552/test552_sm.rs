...
// From: resources/552/test552.scxml
//
...
//! Generated Rust state machine for `test552`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test552Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test552Event] = &[];
}
...
impl Test552Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test552State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test552", &io_processors) {
        ...
        // W3C SCXML 5.2.2: Load variable 'Var1' from src (global)
        {
            ...
            if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_src(
                ...
                ::sce_rust_runtime::sce_log_error!(
                    "Failed to init 'Var1' from src in global: {}",
                    e
                );
            }
        }
        ...
        // W3C SCXML 5.2.2: Load variable 'Var1' from src (global)
        {
            ...
            if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_src(
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    Test552Event::ErrorExecution,
                    "<data id='Var1' src='file:test552.txt'> could not be loaded",
                ));
            }
        }
...
impl StatePolicy for Test552Policy {
    type State = Test552State;
    type Event = Test552Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test552State::Fail => true,
            Test552State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test552Event::ErrorExecution => "error.execution",
            Test552Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test552Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test552State::Fail => "fail",
            Test552State::Pass => "pass",
            Test552State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test552State::Fail),
            "pass" => Some(Test552State::Pass),
            "s0" => Some(Test552State::S0),
            _ => None,
        }
    }
...
impl Test552Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test552State,
        event: Test552Event,
        current_state: &mut Test552State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test552State::Fail => false,
            Test552State::Pass => false,
            Test552State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test552Event::Null {
                    if self.safe_evaluate_guard("(_typeof(Var1) ~= \"undefined\")", engine) {
                        ...
                        *current_state = Test552State::Pass;
                        *transition_taken = true;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = Test552State::Fail;
                        *transition_taken = true;
                        return true;
                    }
                }
