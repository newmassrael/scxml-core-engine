...
impl Test174Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test174Event] = &[Test174Event::Event1];
}
...
impl StatePolicy for Test174Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test174State::Fail),
            "pass" => Some(Test174State::Pass),
            "s0" => Some(Test174State::S0),
            _ => None,
        }
    }
