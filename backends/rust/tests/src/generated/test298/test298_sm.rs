...
impl Test298Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test298Event] = &[];
}
...
impl StatePolicy for Test298Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test298State::S0 => &[Test298State::S01, Test298State::S02],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test298State::S0 => &[::sce_rust_runtime::EntryTarget::State(Test298State::S01)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test298State::S0)]
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test298State::Fail),
            "pass" => Some(Test298State::Pass),
            "s0" => Some(Test298State::S0),
            "s01" => Some(Test298State::S01),
            "s02" => Some(Test298State::S02),
            _ => None,
        }
    }
            ...
            Test298State::S02 => {
                ...
                let mut done_data_ok = true;
                {
                    ...
                    ::sce_rust_runtime::sce_log_error!(
                        "Donedata param 'Var3': empty location (structural error)"
                    );
                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                        Test298Event::ErrorExecution,
                        "<donedata> <param name='Var3'> has an empty location",
                    ));
                    done_data_ok = false;
                    if done_data_ok {
                ...
                if event == Test298Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test298State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test298State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test298Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test298State::S02)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
