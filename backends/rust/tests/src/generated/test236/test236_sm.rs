...
pub struct Test236Policy {
    ...
    last_transition_source_state: Test236State,
...
impl Test236Policy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: Test236State::S0,
            session_id: None,
...
impl Test236Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test236State,
        event: Test236Event,
        current_state: &mut Test236State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test236State::Fail => false,
            Test236State::Pass => false,
            Test236State::S0 => {
                ...
                if event == Test236Event::DoneInvoke {
                    ...
                    *current_state = Test236State::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            Test236State::S2 => {
                ...
                if event == Test236Event::Timeout {
                    ...
                    *current_state = Test236State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Runtime event descriptor matching
