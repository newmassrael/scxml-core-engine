...
impl Test191Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test191Event] = &[Test191Event::ChildToParent];
}
...
pub struct Test191Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test191State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test191__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test191__sce_synth_invoke__invoke_0_sm::Test191SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.document_id == "_invoke_0" {
                ...
                let mut child_policy = super::test191__sce_synth_invoke__invoke_0_sm::Test191SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test191Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test191State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test191State::Fail => "fail",
            Test191State::Pass => "pass",
            Test191State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test191State::Fail),
            "pass" => Some(Test191State::Pass),
            "s0" => Some(Test191State::S0),
            _ => None,
        }
    }
                ...
                if event == Test191Event::ChildToParent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test191State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test191State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
