...
#![doc = "SCE-MAP: test191__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
impl Test191SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test191SceSynthInvokeInvoke0Event] = &[];
}
...
impl StatePolicy for Test191SceSynthInvokeInvoke0Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test191SceSynthInvokeInvoke0State::Sub0),
            "subFinal" => Some(Test191SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
                ...
                if event == Test191SceSynthInvokeInvoke0Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test191SceSynthInvokeInvoke0State::SubFinal,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
