...
#![doc = "SCE-MAP: test190.scxml:7 :: _machine"]
// SCE-MAP: test190.scxml:7 :: _machine
...
impl Test190Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test190Event] = &[Test190Event::Event2];
}
...
impl StatePolicy for Test190Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test190State::Fail),
            "pass" => Some(Test190State::Pass),
            "s0" => Some(Test190State::S0),
            "s1" => Some(Test190State::S1),
            _ => None,
        }
    }
            ...
            Test190State::S0 => {
                ...
                'action_block: {
...

                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test190Event::Timeout);
