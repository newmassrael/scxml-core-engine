...
impl Test149Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test149Event] = &[];
}
...
impl StatePolicy for Test149Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test149State::Fail),
            "pass" => Some(Test149State::Pass),
            "s0" => Some(Test149State::S0),
            _ => None,
        }
    }
