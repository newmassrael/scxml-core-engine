...
// From: resources/144/test144.scxml
//
...
//! Generated Rust state machine for `test144`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test144Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test144Event] = &[];
}
...
impl Default for Test144Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test144Policy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test144State::Fail => true,
            Test144State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test144State::S0)]
    }
        ...
        match state {
            Test144State::S0 => {
                ...
                'action_block: {
                    ...
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test144Event::Foo));

                    // W3C SCXML 3.8.1: <raise event="bar">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(Test144Event::Bar));
                }
            }
            _ => {}
        }
    ...
    fn first_enabled_transition(
        ...
        match state {
            Test144State::S0 => {
                if event == Test144Event::Foo {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test144State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test144State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test144State::S1 => {
                if event == Test144Event::Bar {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test144State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
