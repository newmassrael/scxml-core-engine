...
// From: resources/226/test226sub1.scxml
//
...
//! Generated Rust state machine for `test226sub1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test226sub1.scxml:5 :: _machine"]
...
impl Test226sub1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test226sub1Event] = &[];
}
...
impl Test226sub1Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test226sub1State::S0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test226sub1", &io_processors) {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    Test226sub1Event::ErrorExecution,
...
impl StatePolicy for Test226sub1Policy {
    type State = Test226sub1State;
    type Event = Test226sub1Event;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test226sub1State::Final => 1,
            Test226sub1State::S0 => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test226sub1State::Final => "final",
            Test226sub1State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(Test226sub1State::Final),
            "s0" => Some(Test226sub1State::S0),
            _ => None,
        }
    }
...
impl Test226sub1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test226sub1State,
        event: Test226sub1Event,
        current_state: &mut Test226sub1State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test226sub1State::Final => false,
            Test226sub1State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test226sub1Event::Null {
                    if self.safe_evaluate_guard("(_typeof(Var1) ~= \"undefined\")", engine) {
                        ...
                        *current_state = Test226sub1State::Final;
