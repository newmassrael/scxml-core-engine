...
#![doc = "SCE-MAP: test422__sce_synth_invoke__invoke_2.scxml:3 :: _machine"]
...
impl Test422SceSynthInvokeInvoke2Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test422SceSynthInvokeInvoke2Event] = &[];
}
...
impl StatePolicy for Test422SceSynthInvokeInvoke2Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub2" => Some(Test422SceSynthInvokeInvoke2State::Sub2),
            "subFinal2" => Some(Test422SceSynthInvokeInvoke2State::SubFinal2),
            _ => None,
        }
    }
                ...
                if event == Test422SceSynthInvokeInvoke2Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test422SceSynthInvokeInvoke2State::SubFinal2,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
