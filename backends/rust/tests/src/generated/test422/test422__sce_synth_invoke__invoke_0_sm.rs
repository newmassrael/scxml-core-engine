...
//! Generated Rust state machine for `test422__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test422__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test422SceSynthInvokeInvoke0State {
...
pub enum Test422SceSynthInvokeInvoke0Event {
    ErrorExecution,
    InvokeS1,
...
impl Test422SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test422SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test422SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test422SceSynthInvokeInvoke0State,
...
impl Test422SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test422SceSynthInvokeInvoke0State::Sub0,
            session_id: None,
...
impl Default for Test422SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test422SceSynthInvokeInvoke0Policy {
    type State = Test422SceSynthInvokeInvoke0State;
    type Event = Test422SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test422SceSynthInvokeInvoke0State::SubFinal0 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test422SceSynthInvokeInvoke0State::Sub0 => 0,
            Test422SceSynthInvokeInvoke0State::SubFinal0 => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test422SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test422SceSynthInvokeInvoke0Event::InvokeS1 => "invokeS1",
            Test422SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test422SceSynthInvokeInvoke0Event::ErrorExecution),
            "invokeS1" => Some(Test422SceSynthInvokeInvoke0Event::InvokeS1),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test422SceSynthInvokeInvoke0State::Sub0 => "sub0",
            Test422SceSynthInvokeInvoke0State::SubFinal0 => "subFinal0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test422SceSynthInvokeInvoke0State::Sub0),
            "subFinal0" => Some(Test422SceSynthInvokeInvoke0State::SubFinal0),
            _ => None,
        }
    }
...
impl Test422SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test422SceSynthInvokeInvoke0State,
        event: Test422SceSynthInvokeInvoke0Event,
        current_state: &mut Test422SceSynthInvokeInvoke0State,
        ...
        match check_state {
            Test422SceSynthInvokeInvoke0State::Sub0 => {
                ...
                if event == Test422SceSynthInvokeInvoke0Event::Null {
                    ...
                    *current_state = Test422SceSynthInvokeInvoke0State::SubFinal0;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test422SceSynthInvokeInvoke0State::SubFinal0 => false,
            _ => false,
        }
    }
}
