...
#![doc = "SCE-MAP: test422__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
impl Test422SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test422SceSynthInvokeInvoke1Event] = &[];
}
...
impl StatePolicy for Test422SceSynthInvokeInvoke1Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub1" => Some(Test422SceSynthInvokeInvoke1State::Sub1),
            "subFinal1" => Some(Test422SceSynthInvokeInvoke1State::SubFinal1),
            _ => None,
        }
    }
