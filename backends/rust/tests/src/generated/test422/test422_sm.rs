...
impl StatePolicy for Test422Policy {
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            Test422State::S1 => &[Test422State::S11, Test422State::S12],
            _ => &[],
        }
    }
    ...
    fn get_initial_targets(
        ...
        match state {
            Test422State::S1 => &[::sce_rust_runtime::EntryTarget::State(Test422State::S11)],
            _ => &[],
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test422State::S1)]
    }
            ...
            Test422State::S1 => {
                ...
                if event == Test422Event::InvokeS11 {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test422State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test422Event::Timeout {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test422State::Pass)],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test422Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test422State::S12)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
