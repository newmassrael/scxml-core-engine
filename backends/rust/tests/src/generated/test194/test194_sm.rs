...
impl Test194Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test194Event] = &[];
}
...
impl StatePolicy for Test194Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test194State::Fail),
            "pass" => Some(Test194State::Pass),
            "s0" => Some(Test194State::S0),
            _ => None,
        }
    }
            ...
            Test194State::S0 => {
                ...
                'action_block: {
...

                    {
                        ...
                        {
                            let mut meta =
                                sce_rust_runtime::EventWithMetadata::new(Test194Event::Timeout);
