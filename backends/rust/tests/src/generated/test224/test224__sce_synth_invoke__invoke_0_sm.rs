...
//! Generated Rust state machine for `test224__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test224__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
...
pub enum Test224SceSynthInvokeInvoke0State {
...
pub enum Test224SceSynthInvokeInvoke0Event {
...
impl Test224SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test224SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test224SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test224SceSynthInvokeInvoke0State,
...
impl Test224SceSynthInvokeInvoke0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test224SceSynthInvokeInvoke0State::SubFinal,
            session_id: None,
...
impl Default for Test224SceSynthInvokeInvoke0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test224SceSynthInvokeInvoke0Policy {
    type State = Test224SceSynthInvokeInvoke0State;
    type Event = Test224SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test224SceSynthInvokeInvoke0State::SubFinal
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test224SceSynthInvokeInvoke0State::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test224SceSynthInvokeInvoke0State::SubFinal => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test224SceSynthInvokeInvoke0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test224SceSynthInvokeInvoke0State::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal" => Some(Test224SceSynthInvokeInvoke0State::SubFinal),
            _ => None,
        }
    }
...
impl Test224SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test224SceSynthInvokeInvoke0State,
        event: Test224SceSynthInvokeInvoke0Event,
        current_state: &mut Test224SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test224SceSynthInvokeInvoke0State::SubFinal => false,
            _ => false,
        }
    }
}
