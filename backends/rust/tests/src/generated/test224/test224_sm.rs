...
impl Test224Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test224Event] = &[];
}
...
pub struct Test224Policy {
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test224__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test224__sce_synth_invoke__invoke_0_sm::Test224SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
...
impl Test224Policy {
    ...
    pub fn var2(&self) -> Option<String> {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test224__sce_synth_invoke__invoke_0_sm::Test224SceSynthInvokeInvoke0Policy::new();
...
impl StatePolicy for Test224Policy {
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test224State::Fail => "fail",
            Test224State::Pass => "pass",
            Test224State::S0 => "s0",
            Test224State::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test224State::Fail),
            "pass" => Some(Test224State::Pass),
            "s0" => Some(Test224State::S0),
            "s1" => Some(Test224State::S1),
            _ => None,
        }
    }
