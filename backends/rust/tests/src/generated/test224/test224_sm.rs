...
impl StatePolicy for Test224Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test224State::S0)]
    }
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test224State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test224State::S1 => {
                if event == Test224Event::Null {
                    if self.safe_evaluate_guard("(_indexOf(Var1, Var2) == 0)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test224State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test224Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test224State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
