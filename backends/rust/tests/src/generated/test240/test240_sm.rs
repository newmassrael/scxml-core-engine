...
// From: resources/240/test240.scxml
//
...
//! Generated Rust state machine for `test240`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test240Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test240Event] = &[
        Test240Event::Failure,
        Test240Event::Success,
        Test240Event::Timeout,
    ];
}
...
pub struct Test240Policy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<Test240State>>,
    ...
    // W3C SCXML 6.4: Static invoke child '_invoke_0' (test240__sce_synth_invoke__invoke_0)
    child_invoke_0: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test240__sce_synth_invoke__invoke_0_sm::Test240SceSynthInvokeInvoke0Policy,
            >,
        >,
    >,
    pending_done_invoke_invoke_0: bool,
    // W3C SCXML 6.4: Static invoke child '_invoke_1' (test240__sce_synth_invoke__invoke_1)
    child_invoke_1: Option<
        Box<
            sce_rust_runtime::Engine<
                super::test240__sce_synth_invoke__invoke_1_sm::Test240SceSynthInvokeInvoke1Policy,
            >,
        >,
    >,
...
impl Test240Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test240State::S01,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "test240", &io_processors) {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let mut child_policy = super::test240__sce_synth_invoke__invoke_0_sm::Test240SceSynthInvokeInvoke0Policy::new(self.script_engine.clone());
            ...
            if pending.invoke_id.contains("._invoke_1") {
                ...
                // Engine DI Parity RFC: forward parent's script engine to child when the
                // child Policy was generated with `model.needs_script_engine = true`.
                let mut child_policy = super::test240__sce_synth_invoke__invoke_1_sm::Test240SceSynthInvokeInvoke1Policy::new(self.script_engine.clone());
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
...
impl StatePolicy for Test240Policy {
    type State = Test240State;
    type Event = Test240Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test240State::Fail => true,
            Test240State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            Test240State::S01 => Some(Test240State::S0),
            Test240State::S02 => Some(Test240State::S0),
            _ => None,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test240Event::CancelInvoke => "cancel.invoke",
            Test240Event::DoneInvoke => "done.invoke",
            Test240Event::ErrorExecution => "error.execution",
            Test240Event::Failure => "failure",
            Test240Event::Success => "success",
            Test240Event::Timeout => "timeout",
            Test240Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(Test240Event::CancelInvoke),
            "done.invoke" => Some(Test240Event::DoneInvoke),
            "error.execution" => Some(Test240Event::ErrorExecution),
            "failure" => Some(Test240Event::Failure),
            "success" => Some(Test240Event::Success),
            "timeout" => Some(Test240Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test240State::Fail => "fail",
            Test240State::Pass => "pass",
            Test240State::S0 => "s0",
            Test240State::S01 => "s01",
            Test240State::S02 => "s02",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test240State::Fail),
            "pass" => Some(Test240State::Pass),
            "s0" => Some(Test240State::S0),
            "s01" => Some(Test240State::S01),
            "s02" => Some(Test240State::S02),
            _ => None,
        }
    }
    ...
    fn get_initial_children(
        ...
        match state {
            Test240State::S0 => {
                ::sce_rust_runtime::helpers::hierarchy::state_chain_from_slice([Test240State::S01])
            }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            Test240State::S0 => Test240State::S01,
            _ => state,
        }
    }
...
impl Test240Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test240State,
        event: Test240Event,
        current_state: &mut Test240State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test240State::Fail => false,
            Test240State::Pass => false,
            Test240State::S0 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test240Event::Timeout {
                    ...
                    *current_state = Test240State::Fail;
            ...
            Test240State::S01 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test240Event::Success {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = Test240State::S02;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == Test240Event::Failure {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
            ...
            Test240State::S02 => {
                ...
                if event == Test240Event::Success {
                    ...
                    *current_state = Test240State::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
