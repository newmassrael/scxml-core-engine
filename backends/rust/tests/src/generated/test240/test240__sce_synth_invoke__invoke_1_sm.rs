...
#![doc = "SCE-MAP: test240__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
impl Test240SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test240SceSynthInvokeInvoke1Event] = &[];
}
...
impl StatePolicy for Test240SceSynthInvokeInvoke1Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub02" => Some(Test240SceSynthInvokeInvoke1State::Sub02),
            "subFinal2" => Some(Test240SceSynthInvokeInvoke1State::SubFinal2),
            _ => None,
        }
    }
                    ...
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                Test240SceSynthInvokeInvoke1State::SubFinal2,
                            )],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
