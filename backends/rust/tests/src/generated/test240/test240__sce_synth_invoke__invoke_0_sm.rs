...
//! Generated Rust state machine for `test240__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test240__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
// SCE-MAP: test240__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
pub enum Test240SceSynthInvokeInvoke0State {
...
impl Test240SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test240SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test240SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test240SceSynthInvokeInvoke0State,
...
impl Test240SceSynthInvokeInvoke0Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test240SceSynthInvokeInvoke0State::Sub01,
...
impl StatePolicy for Test240SceSynthInvokeInvoke0Policy {
    type State = Test240SceSynthInvokeInvoke0State;
    type Event = Test240SceSynthInvokeInvoke0Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test240SceSynthInvokeInvoke0State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test240SceSynthInvokeInvoke0State::Sub01 => 0,
            Test240SceSynthInvokeInvoke0State::SubFinal1 => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            Test240SceSynthInvokeInvoke0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test240SceSynthInvokeInvoke0State::Sub01 => "sub01",
            Test240SceSynthInvokeInvoke0State::SubFinal1 => "subFinal1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub01" => Some(Test240SceSynthInvokeInvoke0State::Sub01),
            "subFinal1" => Some(Test240SceSynthInvokeInvoke0State::SubFinal1),
            _ => None,
        }
    }
...
impl Test240SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test240SceSynthInvokeInvoke0State,
        event: Test240SceSynthInvokeInvoke0Event,
        current_state: &mut Test240SceSynthInvokeInvoke0State,
        ...
        match check_state {
            ...
            Test240SceSynthInvokeInvoke0State::SubFinal1 => false,
            _ => false,
        }
    }
}
