...
// From: resources/324/test324.scxml
//
...
//! Generated Rust state machine for `test324`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test324.scxml:5 :: _machine"]
...
impl Test324Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test324Event] = &[];
}
...
impl Test324Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test324State::S0,
...
impl StatePolicy for Test324Policy {
    type State = Test324State;
    type Event = Test324Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test324State::Fail => true,
            Test324State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test324Event::ErrorExecution => "error.execution",
            Test324Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test324Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test324State::Fail => "fail",
            Test324State::Pass => "pass",
            Test324State::S0 => "s0",
            Test324State::S1 => "s1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test324State::Fail),
            "pass" => Some(Test324State::Pass),
            "s0" => Some(Test324State::S0),
            "s1" => Some(Test324State::S1),
            _ => None,
        }
    }
...
impl Test324Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test324State,
        event: Test324Event,
        current_state: &mut Test324State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test324State::Fail => false,
            Test324State::Pass => false,
            Test324State::S0 => {
                // W3C SCXML 3.13: Eventless transitions
                if event == Test324Event::Null {
            ...
            Test324State::S1 => {
                ...
                if event == Test324Event::Null {
                    ...
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = Test324State::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
