...
#![doc = "SCE-MAP: test487.scxml:5 :: _machine"]
...
impl Test487Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test487Event] = &[];
}
...
impl StatePolicy for Test487Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test487State::Fail),
            "pass" => Some(Test487State::Pass),
            "s0" => Some(Test487State::S0),
            _ => None,
        }
    }
