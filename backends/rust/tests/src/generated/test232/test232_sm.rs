...
impl StatePolicy for Test232Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test232State::Fail),
            "pass" => Some(Test232State::Pass),
            "s0" => Some(Test232State::S0),
            "s01" => Some(Test232State::S01),
            "s02" => Some(Test232State::S02),
            "s03" => Some(Test232State::S03),
            _ => None,
        }
    }
