...
impl StatePolicy for Test253Policy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test253State::Fail),
            "pass" => Some(Test253State::Pass),
            "s0" => Some(Test253State::S0),
            "s01" => Some(Test253State::S01),
            "s02" => Some(Test253State::S02),
            "s03" => Some(Test253State::S03),
            _ => None,
        }
    }
