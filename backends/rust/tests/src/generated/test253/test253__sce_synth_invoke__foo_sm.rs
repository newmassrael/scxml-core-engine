...
//! Generated Rust state machine for `test253__sce_synth_invoke__foo`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test253__sce_synth_invoke__foo.scxml:3 :: _machine"]
...
pub enum Test253SceSynthInvokeFooState {
...
impl Test253SceSynthInvokeFooEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test253SceSynthInvokeFooEvent] =
        &[Test253SceSynthInvokeFooEvent::ParentToChild];
}
...
impl Test253SceSynthInvokeFooPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test253SceSynthInvokeFooState::Sub0,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "test253__sce_synth_invoke__foo", &io_processors)
        {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    Test253SceSynthInvokeFooEvent::ErrorExecution,
...
impl StatePolicy for Test253SceSynthInvokeFooPolicy {
    type State = Test253SceSynthInvokeFooState;
    type Event = Test253SceSynthInvokeFooEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        Test253SceSynthInvokeFooState::Sub0
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test253SceSynthInvokeFooState::SubFinal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test253SceSynthInvokeFooState::Sub0 => 0,
            Test253SceSynthInvokeFooState::Sub1 => 1,
            Test253SceSynthInvokeFooState::SubFinal => 2,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            Test253SceSynthInvokeFooEvent::Success => "success",
            Test253SceSynthInvokeFooEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "success" => Some(Test253SceSynthInvokeFooEvent::Success),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test253SceSynthInvokeFooState::Sub0 => "sub0",
            Test253SceSynthInvokeFooState::Sub1 => "sub1",
            Test253SceSynthInvokeFooState::SubFinal => "subFinal",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test253SceSynthInvokeFooState::Sub0),
            "sub1" => Some(Test253SceSynthInvokeFooState::Sub1),
            "subFinal" => Some(Test253SceSynthInvokeFooState::SubFinal),
            _ => None,
        }
    }
    ...
    fn execute_transition_actions(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        match self.last_transition_source_state {
            ...
            Test253SceSynthInvokeFooState::Sub1 => {
                match self.last_transition_index {
                    0 => {
...
impl Test253SceSynthInvokeFooPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test253SceSynthInvokeFooState,
        event: Test253SceSynthInvokeFooEvent,
        current_state: &mut Test253SceSynthInvokeFooState,
        ...
        match check_state {
            Test253SceSynthInvokeFooState::Sub0 => {
                ...
                if event == Test253SceSynthInvokeFooEvent::ParentToChild {
                    ...
                    *current_state = Test253SceSynthInvokeFooState::Sub1;
            ...
            Test253SceSynthInvokeFooState::Sub1 => {
                ...
                if event == Test253SceSynthInvokeFooEvent::Null {
                    if self.safe_evaluate_guard(
                        "_scxml_eq(Var2, \"http://www.w3.org/TR/scxml/#SCXMLEventProcessor\")",
                        engine,
                    ) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = Test253SceSynthInvokeFooState::SubFinal;
                        *transition_taken = true;
                        return true;
                    } else if self.safe_evaluate_guard("_scxml_eq(Var2, \"scxml\")", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
            ...
            Test253SceSynthInvokeFooState::SubFinal => false,
            _ => false,
        }
    }
}
