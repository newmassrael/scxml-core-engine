...
impl StatePolicy for Test452Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test452State::S0)]
    }
                ...
                if event == Test452Event::Event1 {
                    if self.safe_evaluate_guard("_scxml_eq(foo.bar, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test452State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test452State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
