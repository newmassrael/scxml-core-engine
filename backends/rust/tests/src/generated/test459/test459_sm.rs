...
// From: resources/459/test459.scxml
//
...
//! Generated Rust state machine for `test459`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test459.scxml:5 :: _machine"]
// SCE-MAP: test459.scxml:5 :: _machine
...
impl Test459Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test459Event] = &[];
}
...
impl Test459Policy {
    ...
    pub fn var4(&self) -> Option<String> {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test459State::S0,
...
impl StatePolicy for Test459Policy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test459State::Fail => true,
            Test459State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test459Event::ErrorExecution => "error.execution",
            Test459Event::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test459Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test459State::Fail => "fail",
            Test459State::Pass => "pass",
            Test459State::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test459State::Fail),
            "pass" => Some(Test459State::Pass),
            "s0" => Some(Test459State::S0),
            _ => None,
        }
    }
                                            ...
                                            if self.safe_evaluate_guard("(Var1 < Var2)", engine) {
                                                {
                                                        ...
                                                        se.execute_script(&sid, &assign_script)
                                                    {
                                                        ...
                                                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test459Event::ErrorExecution, "<assign> to 'Var1' failed"));
                                            ...
                                            } else {
                                                {
                                                        ...
                                                        se.execute_script(&sid, &assign_script)
                                                    {
                                                        ...
                                                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(Test459Event::ErrorExecution, "<assign> to 'Var5' failed"));
                                                        // W3C SCXML 4.6: Stop current foreach iteration and loop on error
                                                        iteration_success = false;
                                                        break 'foreach_body;
                                                    }
...
impl Test459Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test459State,
        event: Test459Event,
        current_state: &mut Test459State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test459State::Fail => false,
            Test459State::Pass => false,
            Test459State::S0 => {
                ...
                if event == Test459Event::Null {
                    if self.safe_evaluate_guard(
                        ...
                        *current_state = Test459State::Fail;
                        *transition_taken = true;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = Test459State::Pass;
                        *transition_taken = true;
                        return true;
                    }
                }
