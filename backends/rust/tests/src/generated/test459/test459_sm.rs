...
impl StatePolicy for Test459Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test459State::S0)]
    }
                ...
                if event == Test459Event::Null {
                    if self.safe_evaluate_guard(
                        ...
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test459State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test459Event::Null {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test459State::Pass)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
