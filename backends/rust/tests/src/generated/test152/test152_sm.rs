...
pub struct Test152Policy {
    ...
    last_transition_source_state: Test152State,
...
impl Test152Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test152State::S0,
...
impl Test152Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test152State,
        event: Test152Event,
        current_state: &mut Test152State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test152State::Fail => false,
            Test152State::Pass => false,
            Test152State::S0 => {
