...
// From: resources/152/test152.scxml
//
...
//! Generated Rust state machine for `test152`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
impl Test152Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test152Event] = &[];
}
...
impl StatePolicy for Test152Policy {
    type State = Test152State;
    type Event = Test152Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test152State::Fail => true,
            Test152State::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test152State::S0)]
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test152State::Fail => "fail",
            Test152State::Pass => "pass",
            Test152State::S0 => "s0",
            Test152State::S1 => "s1",
            Test152State::S2 => "s2",
        }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(Test152State::Fail),
            "pass" => Some(Test152State::Pass),
            "s0" => Some(Test152State::S0),
            "s1" => Some(Test152State::S1),
            "s2" => Some(Test152State::S2),
            _ => None,
        }
    }
                ...
                if event == Test152Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test152State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test152State::Fail)],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                        });
                ...
                if event == Test152Event::ErrorExecution {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test152State::S2)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test152State::S2 => {
                if event == Test152Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 0)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test152State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
