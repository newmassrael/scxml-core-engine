...
//! Generated Rust state machine for `test234__sce_synth_invoke__invoke_1`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test234__sce_synth_invoke__invoke_1.scxml:3 :: _machine"]
...
pub enum Test234SceSynthInvokeInvoke1State {
...
pub enum Test234SceSynthInvokeInvoke1Event {
    ErrorExecution,
    Timeout,
...
impl Test234SceSynthInvokeInvoke1Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test234SceSynthInvokeInvoke1Event] =
        &[Test234SceSynthInvokeInvoke1Event::Timeout];
}
...
pub struct Test234SceSynthInvokeInvoke1Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test234SceSynthInvokeInvoke1State,
...
impl Test234SceSynthInvokeInvoke1Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: Test234SceSynthInvokeInvoke1State::Sub0,
            session_id: None,
...
impl Default for Test234SceSynthInvokeInvoke1Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for Test234SceSynthInvokeInvoke1Policy {
    type State = Test234SceSynthInvokeInvoke1State;
    type Event = Test234SceSynthInvokeInvoke1Event;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test234SceSynthInvokeInvoke1State::SubFinal2 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test234SceSynthInvokeInvoke1State::Sub0 => 0,
            Test234SceSynthInvokeInvoke1State::SubFinal2 => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test234SceSynthInvokeInvoke1Event::ErrorExecution => "error.execution",
            Test234SceSynthInvokeInvoke1Event::Timeout => "timeout",
            Test234SceSynthInvokeInvoke1Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(Test234SceSynthInvokeInvoke1Event::ErrorExecution),
            "timeout" => Some(Test234SceSynthInvokeInvoke1Event::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test234SceSynthInvokeInvoke1State::Sub0 => "sub0",
            Test234SceSynthInvokeInvoke1State::SubFinal2 => "subFinal2",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "sub0" => Some(Test234SceSynthInvokeInvoke1State::Sub0),
            "subFinal2" => Some(Test234SceSynthInvokeInvoke1State::SubFinal2),
            _ => None,
        }
    }
...
impl Test234SceSynthInvokeInvoke1Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test234SceSynthInvokeInvoke1State,
        event: Test234SceSynthInvokeInvoke1Event,
        current_state: &mut Test234SceSynthInvokeInvoke1State,
        ...
        match check_state {
            Test234SceSynthInvokeInvoke1State::Sub0 => {
                ...
                if event == Test234SceSynthInvokeInvoke1Event::Timeout {
                    ...
                    *current_state = Test234SceSynthInvokeInvoke1State::SubFinal2;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            Test234SceSynthInvokeInvoke1State::SubFinal2 => false,
            _ => false,
        }
    }
}
