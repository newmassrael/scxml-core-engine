...
impl Test234Policy {
    ...
    fn activate(&mut self, state: Test234State) -> bool {
    ...
    fn deactivate(&mut self, state: Test234State) {
...
impl StatePolicy for Test234Policy {
    ...
    fn get_document_initial_targets(
        ...
        &[::sce_rust_runtime::EntryTarget::State(Test234State::P0)]
    }
                ...
                if event == Test234Event::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test234State::Fail)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test234State::P01 => {
                if event == Test234Event::ChildToParent {
                    if self.safe_evaluate_guard("_scxml_eq(Var1, 2)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test234State::S1)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
            ...
            Test234State::S1 => {
                if event == Test234Event::Null {
                    if self.safe_evaluate_guard("_scxml_eq(Var2, 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(Test234State::Pass)],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                        });
