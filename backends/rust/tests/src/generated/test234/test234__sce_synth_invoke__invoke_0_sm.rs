...
//! Generated Rust state machine for `test234__sce_synth_invoke__invoke_0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: test234__sce_synth_invoke__invoke_0.scxml:3 :: _machine"]
// SCE-MAP: test234__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
pub enum Test234SceSynthInvokeInvoke0State {
...
pub enum Test234SceSynthInvokeInvoke0Event {
    ChildToParent,
    ErrorExecution,
...
impl Test234SceSynthInvokeInvoke0Event {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [Test234SceSynthInvokeInvoke0Event] = &[];
}
...
pub struct Test234SceSynthInvokeInvoke0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: Test234SceSynthInvokeInvoke0State,
...
impl Test234SceSynthInvokeInvoke0Policy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: Test234SceSynthInvokeInvoke0State::SubFinal1,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "test234__sce_synth_invoke__invoke_0", &io_processors)
        {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    Test234SceSynthInvokeInvoke0Event::ErrorExecution,
...
impl StatePolicy for Test234SceSynthInvokeInvoke0Policy {
    type State = Test234SceSynthInvokeInvoke0State;
    type Event = Test234SceSynthInvokeInvoke0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        Test234SceSynthInvokeInvoke0State::SubFinal1
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            Test234SceSynthInvokeInvoke0State::SubFinal1 => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            Test234SceSynthInvokeInvoke0State::SubFinal1 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            Test234SceSynthInvokeInvoke0Event::ChildToParent => "childToParent",
            Test234SceSynthInvokeInvoke0Event::ErrorExecution => "error.execution",
            Test234SceSynthInvokeInvoke0Event::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "childToParent" => Some(Test234SceSynthInvokeInvoke0Event::ChildToParent),
            "error.execution" => Some(Test234SceSynthInvokeInvoke0Event::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            Test234SceSynthInvokeInvoke0State::SubFinal1 => "subFinal1",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "subFinal1" => Some(Test234SceSynthInvokeInvoke0State::SubFinal1),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "2") {
                                Ok(val) => {
                                    wire_params
                                        .entry("aParam".to_string())
                                        .or_default()
                                        .push(val);
                                }
                                Err(e) => {
                                    ::sce_rust_runtime::sce_log_error!(
                                        "send param 'aParam' eval failed: {}",
                                        e
                                    );
                                    engine.raise(
...
impl Test234SceSynthInvokeInvoke0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: Test234SceSynthInvokeInvoke0State,
        event: Test234SceSynthInvokeInvoke0Event,
        current_state: &mut Test234SceSynthInvokeInvoke0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            Test234SceSynthInvokeInvoke0State::SubFinal1 => false,
            _ => false,
        }
    }
}
