...
//! Generated Rust state machine for `typed_reader_names`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: typed_reader_names.scxml:31 :: _machine"]
...
pub enum TypedReaderNamesState {
    Done,
...
pub enum TypedReaderNamesEvent {
    Bump,
    ErrorExecution,
    Finish,
...
impl TypedReaderNamesEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [TypedReaderNamesEvent] =
        &[TypedReaderNamesEvent::Bump, TypedReaderNamesEvent::Finish];
}
...
pub struct TypedReaderNamesPolicy {
...
impl TypedReaderNamesPolicy {
    ...
    /// answer — the session is not initialized yet, `box` was
    /// assigned a value of another type, or the engine refused.
    pub fn r#box(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `object` was
    /// assigned a value of another type, or the engine refused.
    pub fn object(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "object",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `pass` was
    /// assigned a value of another type, or the engine refused.
    pub fn pass(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "pass",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `screen-rules` was
    /// assigned a value of another type, or the engine refused.
    pub fn screen_rules(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "screen-rules",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `a_b` was
    /// assigned a value of another type, or the engine refused.
    pub fn a_b(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "a_b",
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "typed_reader_names", &io_processors) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'box' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'object' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "object", "2",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'pass' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "pass", "3",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'screen-rules' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "screen-rules",
        ...
        // W3C SCXML 5.2/5.3: Initialize 'auto' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "auto", "5",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'self' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "self", "6",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'new' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "new", "7",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'start' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "start", "8",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 't' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "t", "9",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'a_b' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "a_b", "10",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'a-b' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "a-b", "11",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='box'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='object'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='pass'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='screen-rules'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='auto'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='self'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='new'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='start'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='t'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='a_b'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TypedReaderNamesEvent::ErrorExecution,
                "<data id='a-b'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for TypedReaderNamesPolicy {
    type State = TypedReaderNamesState;
    type Event = TypedReaderNamesEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            TypedReaderNamesState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            TypedReaderNamesState::Done => 1,
            TypedReaderNamesState::Idle => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            TypedReaderNamesEvent::Bump => "bump",
            TypedReaderNamesEvent::ErrorExecution => "error.execution",
            TypedReaderNamesEvent::Finish => "finish",
            TypedReaderNamesEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "bump" => Some(TypedReaderNamesEvent::Bump),
            "error.execution" => Some(TypedReaderNamesEvent::ErrorExecution),
            "finish" => Some(TypedReaderNamesEvent::Finish),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            TypedReaderNamesState::Done => "done",
            TypedReaderNamesState::Idle => "idle",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(TypedReaderNamesState::Done),
            "idle" => Some(TypedReaderNamesState::Idle),
            _ => None,
        }
    }
    ...
    fn first_enabled_transition(
        ...
        match state {
            TypedReaderNamesState::Idle => {
                if event == TypedReaderNamesEvent::Bump {
                    {
                ...
                if event == TypedReaderNamesEvent::Finish {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                TypedReaderNamesState::Done,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
