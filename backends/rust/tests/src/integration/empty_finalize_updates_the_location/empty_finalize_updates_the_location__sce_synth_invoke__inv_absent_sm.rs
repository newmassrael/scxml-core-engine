...
//! Generated Rust state machine for `empty_finalize_updates_the_location__sce_synth_invoke__inv_absent`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: empty_finalize_updates_the_location__sce_synth_invoke__inv_absent.scxml:3 :: _machine"]
...
pub enum EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState {
...
pub enum EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent {
    ErrorExecution,
    FromAbsentChild,
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent] = &[];
}
...
pub struct EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState,
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        // W3C SCXML 5.2: Runtime variable 'guard' (global, late binding, init to nil)
        let _ = se.set_variable(&sid, "guard", sce_rust_runtime::ScriptValue::Null);
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::ErrorExecution,
...
impl StatePolicy for EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy {
    type State = EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState;
    type Event = EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Answer => 0,
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::FromAbsentChild => {
                "fromAbsentChild"
            }
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => {
                Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::ErrorExecution)
            }
            "fromAbsentChild" => {
                Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::FromAbsentChild)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Answer => "answer",
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done => "done",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "answer" => Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Answer),
            "done" => Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done),
            _ => None,
        }
    }
                    ...
                    0 => {
...

                        {
                            ...
                            let event_data_string: String = {
                                ...
                                match se.evaluate_expression(&sid, "9") {
                                    Ok(val) => {
                                        wire_params
                                    ...
                                    Err(e) => {
                                        ::sce_rust_runtime::sce_log_error!(
                                            "send param 'guard' eval failed: {}",
                                            e
                                        );
                                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::ErrorExecution, "<send> <param name='guard'> expr failed to evaluate"));
                                    }
                                }
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("fromAbsentChild".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState,
        event: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent,
        current_state: &mut EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState,
        ...
        match check_state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Answer => {
                ...
                if event == EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent::Null {
                    ...
                    *current_state =
                        EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState::Done => false,
            _ => false,
        }
    }
}
