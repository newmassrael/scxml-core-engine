...
//! Generated Rust state machine for `empty_finalize_updates_the_location__sce_synth_invoke__inv_empty`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: empty_finalize_updates_the_location__sce_synth_invoke__inv_empty.scxml:3 :: _machine"]
...
pub enum EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState {
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent] = &[];
}
...
pub struct EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState,
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state:
                EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Answer,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        // W3C SCXML 5.2: Runtime variable 'tally' (global, late binding, init to nil)
        let _ = se.set_variable(&sid, "tally", sce_rust_runtime::ScriptValue::Null);
...
impl StatePolicy for EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy {
    type State = EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState;
    type Event = EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Answer => 0,
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent::FromEmptyChild => {
                "fromEmptyChild"
            }
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "fromEmptyChild" => {
                Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent::FromEmptyChild)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Answer => "answer",
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done => "done",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "answer" => Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Answer),
            "done" => Some(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done),
            _ => None,
        }
    }
                            ...
                            let event_data_string: String = {
                                ...
                                match se.evaluate_expression(&sid, "7") {
                                    ...
                                    Err(e) => {
                                        ...
                                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent::ErrorExecution, "<send> <param name='tally'> expr failed to evaluate"));
                                    }
                                }
...
impl EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState,
        event: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent,
        current_state: &mut EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState,
        ...
        match check_state {
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Answer => {
                ...
                if event == EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyEvent::Null {
                    ...
                    *current_state =
                        EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyState::Done => false,
            _ => false,
        }
    }
}
