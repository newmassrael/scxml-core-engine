                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::TimeoutAbsent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent,
                            )],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EmptyFinalizeUpdatesTheLocationState::FailNotUpdated,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::TimeoutEmpty {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent,
                            )],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
