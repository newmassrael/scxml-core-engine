...
//! Generated Rust state machine for `empty_finalize_updates_the_location`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: empty_finalize_updates_the_location.scxml:52 :: _machine"]
...
pub enum EmptyFinalizeUpdatesTheLocationState {
    AbsentPhase,
...
impl EmptyFinalizeUpdatesTheLocationEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [EmptyFinalizeUpdatesTheLocationEvent] = &[
        EmptyFinalizeUpdatesTheLocationEvent::FromAbsentChild,
        EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild,
        EmptyFinalizeUpdatesTheLocationEvent::FromUnmatchedChild,
...
pub struct EmptyFinalizeUpdatesTheLocationPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: EmptyFinalizeUpdatesTheLocationState,
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<EmptyFinalizeUpdatesTheLocationState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_empty' (empty_finalize_updates_the_location__sce_synth_invoke__inv_empty)
    child_inv_empty: Option<Box<sce_rust_runtime::Engine<super::empty_finalize_updates_the_location__sce_synth_invoke__inv_empty_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy>>>,
    pending_done_invoke_inv_empty: bool,
    // W3C SCXML 6.4: Static invoke child 'inv_absent' (empty_finalize_updates_the_location__sce_synth_invoke__inv_absent)
    child_inv_absent: Option<Box<sce_rust_runtime::Engine<super::empty_finalize_updates_the_location__sce_synth_invoke__inv_absent_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy>>>,
    pending_done_invoke_inv_absent: bool,
    // W3C SCXML 6.4: Static invoke child 'inv_unmatched' (empty_finalize_updates_the_location__sce_synth_invoke__inv_unmatched)
    child_inv_unmatched: Option<Box<sce_rust_runtime::Engine<super::empty_finalize_updates_the_location__sce_synth_invoke__inv_unmatched_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvUnmatchedPolicy>>>,
...
impl EmptyFinalizeUpdatesTheLocationPolicy {
    ...
    /// answer — the session is not initialized yet, `tally` was
    /// assigned a value of another type, or the engine refused.
    pub fn tally(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `guard` was
    /// assigned a value of another type, or the engine refused.
    pub fn guard(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "guard",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `keeper` was
    /// assigned a value of another type, or the engine refused.
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: EmptyFinalizeUpdatesTheLocationState::EmptyPhase,
            ...
            child_inv_empty: None,
            pending_done_invoke_inv_empty: false,
            child_inv_absent: None,
            pending_done_invoke_inv_absent: false,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "empty_finalize_updates_the_location", &io_processors)
        {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'tally' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'guard' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "guard", "1",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'keeper' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "keeper", "3",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='tally'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                EmptyFinalizeUpdatesTheLocationEvent::ErrorExecution,
                "<data id='guard'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                EmptyFinalizeUpdatesTheLocationEvent::ErrorExecution,
                "<data id='keeper'> expr failed to evaluate",
            ));
        }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_absent") {
                ...
                let mut child_policy = super::empty_finalize_updates_the_location__sce_synth_invoke__inv_absent_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentPolicy::new(self.script_engine.clone());
                ...
                // W3C SCXML 6.3.2: Only set if variable is declared in child's datamodel
                {
                    ...
                    let se = self.script_engine.clone();
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                    let child_vars: &[&str] = &["guard"];
                    if child_vars.contains(&"guard") {
                        if let Ok(val) = se.evaluate_expression(&sid, "guard") {
                            // §scxml-6.4.1: "the value stored at the location
                            // is the value" — so the value crosses, not a
                            // rendering of it.
                            child_policy.set_param_value_in_script_engine("guard", val);
                        }
                    }
                }
                ...
                self.child_inv_absent = Some(Box::new(child_engine));
                ...
                {
                    self.pending_done_invoke_inv_absent = true;
            ...
            if pending.invoke_id.contains(".inv_empty") {
                ...
                // Engine DI Parity RFC: forward parent's script engine to child when the
                // child Policy was generated with `model.needs_script_engine = true`.
                let mut child_policy = super::empty_finalize_updates_the_location__sce_synth_invoke__inv_empty_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvEmptyPolicy::new(self.script_engine.clone());
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
                ...
                // W3C SCXML 6.3.2: Only set if variable is declared in child's datamodel
                {
                    ...
                    let se = self.script_engine.clone();
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                    let child_vars: &[&str] = &["tally"];
                    if child_vars.contains(&"tally") {
                        if let Ok(val) = se.evaluate_expression(&sid, "tally") {
                            // §scxml-6.4.1: "the value stored at the location
                            // is the value" — so the value crosses, not a
                            // rendering of it.
                            child_policy.set_param_value_in_script_engine("tally", val);
                        }
                    }
                }

                // W3C SCXML 6.4.1: Track active invoke session BEFORE initialize
                self.active_invokes.insert("inv_empty".to_string(),
                    sce_rust_runtime::invoke::ChildSession {
                        session_id: child_session_id,
                        // W3C SCXML 6.4: Element invoke_id for _event.invokeid (test 228)
                        invoke_id: "inv_empty".to_string(),
                        parent_session_id: self.session_id.clone().unwrap_or_default(),
                        autoforward: false,
                        finalize_script: "if (_scxml_truthy(_event.data) and (_event.data.tally ~= nil)) then\n  tally = _event.data.tally\nend".to_string(),
                    },
                );
                ...
                // W3C SCXML 6.4: Store child BEFORE draining events so autoforward can find it
                self.child_inv_empty = Some(Box::new(child_engine));
                ...
                if self
                    ...
                    .map_or(false, |c| c.is_in_final_state())
                {
                    self.pending_done_invoke_inv_empty = true;
                    // W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
                    // done.invoke.<id>._event.data. Mirrors the C++ AOT contract in
                    // tools/codegen/templates/invoke_methods.jinja2 (child->donedataAtFinal()
                    // + EventMetadataHelper::createDoneInvokeEvent).
            ...
            if pending.invoke_id.contains(".inv_unmatched") {
                ...
                // Engine DI Parity RFC: forward parent's script engine to child when the
                // child Policy was generated with `model.needs_script_engine = true`.
                let mut child_policy = super::empty_finalize_updates_the_location__sce_synth_invoke__inv_unmatched_sm::EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvUnmatchedPolicy::new(self.script_engine.clone());
                // W3C SCXML 6.4: Pass parent session info to child for #_parent routing
                child_policy.parent_external_queue = Some(engine.get_external_queue_handle());
                child_policy.invoke_id = pending.invoke_id.clone();
                child_policy.child_session_id = child_session_id.clone();
                ...
                // W3C SCXML 6.3.2: Only set if variable is declared in child's datamodel
                {
                    ...
                    let se = self.script_engine.clone();
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                    let child_vars: &[&str] = &["keeper"];
                    if child_vars.contains(&"keeper") {
                        if let Ok(val) = se.evaluate_expression(&sid, "keeper") {
                            // §scxml-6.4.1: "the value stored at the location
                            // is the value" — so the value crosses, not a
                            // rendering of it.
                            child_policy.set_param_value_in_script_engine("keeper", val);
                        }
                    }
                }

                // W3C SCXML 6.4.1: Track active invoke session BEFORE initialize
                self.active_invokes.insert("inv_unmatched".to_string(),
                    sce_rust_runtime::invoke::ChildSession {
                        session_id: child_session_id,
                        // W3C SCXML 6.4: Element invoke_id for _event.invokeid (test 228)
                        ...
                        parent_session_id: self.session_id.clone().unwrap_or_default(),
                        autoforward: false,
                        finalize_script: "if (_scxml_truthy(_event.data) and (_event.data.keeper ~= nil)) then\n  keeper = _event.data.keeper\nend".to_string(),
                    },
                );
    ...
    fn do_tick_children(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        if !self.pending_done_invoke_inv_empty {
            ...
            if let Some(mut child) = self.child_inv_empty.take() {
                ...
                if child.is_in_final_state() && !self.pending_done_invoke_inv_empty {
                    self.pending_done_invoke_inv_empty = true;
                    // W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
                ...
                // Put child back
                self.child_inv_empty = Some(child);
            }
        }
        if !self.pending_done_invoke_inv_absent {
            ...
            if let Some(mut child) = self.child_inv_absent.take() {
                ...
                // W3C SCXML 6.4: Check if child reached final state after tick
                if child.is_in_final_state() && !self.pending_done_invoke_inv_absent {
                    self.pending_done_invoke_inv_absent = true;
                    // W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
                    // done.invoke.<id>._event.data.
                    let donedata = child.donedata_at_final().to_string();
                ...
                // Put child back
                self.child_inv_absent = Some(child);
            }
        }
    ...
    fn do_execute_finalize_for_child_event(
        &mut self,
        event_with_meta: &sce_rust_runtime::EventWithMetadata<EmptyFinalizeUpdatesTheLocationEvent>,
...
impl StatePolicy for EmptyFinalizeUpdatesTheLocationPolicy {
    type State = EmptyFinalizeUpdatesTheLocationState;
    type Event = EmptyFinalizeUpdatesTheLocationEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent => true,
            EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent => true,
            EmptyFinalizeUpdatesTheLocationState::FailNotUpdated => true,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent => true,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedNameWrote => true,
            EmptyFinalizeUpdatesTheLocationState::FailUpdatedWithoutFinalize => true,
            EmptyFinalizeUpdatesTheLocationState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            EmptyFinalizeUpdatesTheLocationState::AbsentPhase => 1,
            EmptyFinalizeUpdatesTheLocationState::EmptyPhase => 0,
            EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent => 8,
            EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent => 7,
            EmptyFinalizeUpdatesTheLocationState::FailNotUpdated => 4,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent => 9,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedNameWrote => 6,
            EmptyFinalizeUpdatesTheLocationState::FailUpdatedWithoutFinalize => 5,
            EmptyFinalizeUpdatesTheLocationState::Pass => 3,
            EmptyFinalizeUpdatesTheLocationState::UnmatchedPhase => 2,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild => "fromEmptyChild",
            EmptyFinalizeUpdatesTheLocationEvent::FromUnmatchedChild => "fromUnmatchedChild",
            EmptyFinalizeUpdatesTheLocationEvent::TimeoutAbsent => "timeoutAbsent",
            EmptyFinalizeUpdatesTheLocationEvent::TimeoutEmpty => "timeoutEmpty",
            EmptyFinalizeUpdatesTheLocationEvent::TimeoutUnmatched => "timeoutUnmatched",
            EmptyFinalizeUpdatesTheLocationEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "fromEmptyChild" => Some(EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild),
            "fromUnmatchedChild" => Some(EmptyFinalizeUpdatesTheLocationEvent::FromUnmatchedChild),
            "timeoutAbsent" => Some(EmptyFinalizeUpdatesTheLocationEvent::TimeoutAbsent),
            "timeoutEmpty" => Some(EmptyFinalizeUpdatesTheLocationEvent::TimeoutEmpty),
            "timeoutUnmatched" => Some(EmptyFinalizeUpdatesTheLocationEvent::TimeoutUnmatched),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            EmptyFinalizeUpdatesTheLocationState::AbsentPhase => "absentPhase",
            EmptyFinalizeUpdatesTheLocationState::EmptyPhase => "emptyPhase",
            EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent => "failAbsentChildSilent",
            EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent => "failEmptyChildSilent",
            EmptyFinalizeUpdatesTheLocationState::FailNotUpdated => "failNotUpdated",
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent => {
                "failUnmatchedChildSilent"
            }
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedNameWrote => {
                "failUnmatchedNameWrote"
            }
            EmptyFinalizeUpdatesTheLocationState::FailUpdatedWithoutFinalize => {
                "failUpdatedWithoutFinalize"
            }
            EmptyFinalizeUpdatesTheLocationState::Pass => "pass",
            EmptyFinalizeUpdatesTheLocationState::UnmatchedPhase => "unmatchedPhase",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "absentPhase" => Some(EmptyFinalizeUpdatesTheLocationState::AbsentPhase),
            "emptyPhase" => Some(EmptyFinalizeUpdatesTheLocationState::EmptyPhase),
            "failAbsentChildSilent" => {
                Some(EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent)
            }
            "failEmptyChildSilent" => {
                Some(EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent)
            }
            "failNotUpdated" => Some(EmptyFinalizeUpdatesTheLocationState::FailNotUpdated),
            "failUnmatchedChildSilent" => {
                Some(EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent)
            }
            "failUnmatchedNameWrote" => {
                Some(EmptyFinalizeUpdatesTheLocationState::FailUnmatchedNameWrote)
            }
            "failUpdatedWithoutFinalize" => {
                Some(EmptyFinalizeUpdatesTheLocationState::FailUpdatedWithoutFinalize)
            }
            "pass" => Some(EmptyFinalizeUpdatesTheLocationState::Pass),
            "unmatchedPhase" => Some(EmptyFinalizeUpdatesTheLocationState::UnmatchedPhase),
            _ => None,
        }
    }
...
impl EmptyFinalizeUpdatesTheLocationPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: EmptyFinalizeUpdatesTheLocationState,
        event: EmptyFinalizeUpdatesTheLocationEvent,
        current_state: &mut EmptyFinalizeUpdatesTheLocationState,
        ...
        match check_state {
            EmptyFinalizeUpdatesTheLocationState::AbsentPhase => {
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromAbsentChild {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(guard ~= 1)", engine) {
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromAbsentChild {
                    ...
                    *current_state = EmptyFinalizeUpdatesTheLocationState::UnmatchedPhase;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EmptyFinalizeUpdatesTheLocationEvent::TimeoutAbsent {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            EmptyFinalizeUpdatesTheLocationState::EmptyPhase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(tally == 7)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;

                        *current_state = EmptyFinalizeUpdatesTheLocationState::AbsentPhase;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromEmptyChild {
                    ...
                    *current_state = EmptyFinalizeUpdatesTheLocationState::FailNotUpdated;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EmptyFinalizeUpdatesTheLocationEvent::TimeoutEmpty {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            EmptyFinalizeUpdatesTheLocationState::FailAbsentChildSilent => false,
            EmptyFinalizeUpdatesTheLocationState::FailEmptyChildSilent => false,
            EmptyFinalizeUpdatesTheLocationState::FailNotUpdated => false,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent => false,
            EmptyFinalizeUpdatesTheLocationState::FailUnmatchedNameWrote => false,
            EmptyFinalizeUpdatesTheLocationState::FailUpdatedWithoutFinalize => false,
            EmptyFinalizeUpdatesTheLocationState::Pass => false,
            EmptyFinalizeUpdatesTheLocationState::UnmatchedPhase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromUnmatchedChild {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(keeper ~= 3)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                ...
                if event == EmptyFinalizeUpdatesTheLocationEvent::FromUnmatchedChild {
                    ...
                    *current_state = EmptyFinalizeUpdatesTheLocationState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EmptyFinalizeUpdatesTheLocationEvent::TimeoutUnmatched {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = EmptyFinalizeUpdatesTheLocationState::FailUnmatchedChildSilent;
                    *transition_taken = true;
                    return true;
                }
                false
