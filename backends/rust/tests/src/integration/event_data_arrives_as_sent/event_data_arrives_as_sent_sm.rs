...
pub struct EventDataArrivesAsSentPolicy {
    ...
    last_transition_source_state: EventDataArrivesAsSentState,
...
impl EventDataArrivesAsSentPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: EventDataArrivesAsSentState::Waiting,
...
impl EventDataArrivesAsSentPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: EventDataArrivesAsSentState,
        event: EventDataArrivesAsSentEvent,
        current_state: &mut EventDataArrivesAsSentState,
        ...
        match check_state {
            ...
            EventDataArrivesAsSentState::Heard => {
                ...
                if event == EventDataArrivesAsSentEvent::Note {
                    ...
                    if self.safe_evaluate_guard("(_event.data == \"hold the line\")", engine) {
                        ...
                        *current_state = EventDataArrivesAsSentState::Quoted;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == EventDataArrivesAsSentEvent::Note {
                    ...
                    *current_state = EventDataArrivesAsSentState::Garbled;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            EventDataArrivesAsSentState::Quoted => {
                ...
                if event == EventDataArrivesAsSentEvent::Arith {
                    ...
                    *current_state = EventDataArrivesAsSentState::Evaluated;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            EventDataArrivesAsSentState::Waiting => {
                ...
                if event == EventDataArrivesAsSentEvent::Payload {
                    ...
                    if self.safe_evaluate_guard("((_scxml_truthy(_event.data) and (_event.data.milestone == \"refined\")) and (_event.data.turns == 2))", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = EventDataArrivesAsSentState::Heard;
                            *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == EventDataArrivesAsSentEvent::Payload {
                    ...
                    *current_state = EventDataArrivesAsSentState::Mangled;
                    *transition_taken = true;
                    return true;
                }
                false
