...
//! Generated Rust state machine for `invoke_precedes_external_dequeue__sce_synth_invoke__inv_watch`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState {
    Missed,
    Ordered,
    Saw,
...
impl InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent] = &[
        InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Kick,
        InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Probe,
    ];
}
...
pub struct InvokePrecedesExternalDequeueSceSynthInvokeInvWatchPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState,
...
impl InvokePrecedesExternalDequeueSceSynthInvokeInvWatchPolicy {
    pub fn new() -> Self {
        Self {
...
impl Default for InvokePrecedesExternalDequeueSceSynthInvokeInvWatchPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for InvokePrecedesExternalDequeueSceSynthInvokeInvWatchPolicy {
    type State = InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState;
    type Event = InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed => true,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed => 2,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered => 3,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Saw => 1,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Waiting => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Kick => "kick",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Probe => "probe",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Ready => "ready",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::SawKick => "sawKick",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::SawNoKick => "sawNoKick",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "kick" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Kick),
            "probe" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Probe),
            "ready" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Ready),
            "sawKick" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::SawKick),
            "sawNoKick" => {
                Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::SawNoKick)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed => "missed",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered => "ordered",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Saw => "saw",
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Waiting => "waiting",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "missed" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed),
            "ordered" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered),
            "saw" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Saw),
            "waiting" => Some(InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Waiting),
            _ => None,
        }
    }
...
impl InvokePrecedesExternalDequeueSceSynthInvokeInvWatchPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState,
        event: InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent,
        current_state: &mut InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed => false,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered => false,
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Saw => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Probe {
                    ...
                    *current_state =
                        InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Ordered;
            ...
            InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Kick {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = false;
                    ...
                    *current_state = InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Saw;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesExternalDequeueSceSynthInvokeInvWatchEvent::Probe {
                    ...
                    *current_state =
                        InvokePrecedesExternalDequeueSceSynthInvokeInvWatchState::Missed;
                    *transition_taken = true;
                    return true;
                }
                false
