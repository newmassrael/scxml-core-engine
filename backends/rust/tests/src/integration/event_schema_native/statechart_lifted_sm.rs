...
//! Generated Rust state machine for `statechart_lifted`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: statechart_lifted.scxml:23 :: _machine"]
...
pub enum StatechartLiftedState {
    Done,
    Refused,
...
pub enum StatechartLiftedEvent {
    ErrorExecution,
    JobCompleted,
...
impl StatechartLiftedEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [StatechartLiftedEvent] =
        &[StatechartLiftedEvent::JobCompleted];
}

// ── NL→IR Item C1 Path A: EventSchema typed `_event.data` payload ──
#[derive(Clone, Debug, Default, PartialEq)]
pub struct StatechartLiftedJobCompletedPayload {
    pub elapsed_ms: u32,
}
...
#[derive(Clone, Debug, Default, PartialEq)]
pub enum StatechartLiftedPayload {
    /// Schemaless / not-yet-populated default (W3C §5.10 empty `_event.data`).
    #[default]
    None,
    JobCompleted(StatechartLiftedJobCompletedPayload),
}

/// NL→IR Item C1 Path A: per-event typed `_event.data` inject seam.
/// Bring into scope with `use …::StatechartLiftedInject;` to call the
/// `raise_<event>` methods on the engine.
pub trait StatechartLiftedInject {
    ...
    fn raise_job_completed(&mut self, payload: StatechartLiftedJobCompletedPayload);
}

impl StatechartLiftedInject for ::sce_rust_runtime::Engine<StatechartLiftedPolicy> {
    fn raise_job_completed(&mut self, payload: StatechartLiftedJobCompletedPayload) {
        ...
        self.raise_external_typed_with_data(
            StatechartLiftedEvent::JobCompleted,
            StatechartLiftedPayload::JobCompleted(payload),
            &data,
        );
    }
}
...
pub struct StatechartLiftedPolicy {
    ...
    pending_payload: StatechartLiftedPayload,
...
impl StatechartLiftedPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: StatechartLiftedState::Waiting,
            pending_payload: StatechartLiftedPayload::default(),
            session_id: None,
...
impl Default for StatechartLiftedPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for StatechartLiftedPolicy {
    type State = StatechartLiftedState;
    type Event = StatechartLiftedEvent;
    ...
    type Payload = StatechartLiftedPayload;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            StatechartLiftedState::Done => 1,
            StatechartLiftedState::Refused => 2,
            StatechartLiftedState::Waiting => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            StatechartLiftedEvent::ErrorExecution => "error.execution",
            StatechartLiftedEvent::JobCompleted => "job.completed",
            StatechartLiftedEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(StatechartLiftedEvent::ErrorExecution),
            "job.completed" => Some(StatechartLiftedEvent::JobCompleted),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            StatechartLiftedState::Done => "done",
            StatechartLiftedState::Refused => "refused",
            StatechartLiftedState::Waiting => "waiting",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(StatechartLiftedState::Done),
            "refused" => Some(StatechartLiftedState::Refused),
            "waiting" => Some(StatechartLiftedState::Waiting),
            _ => None,
        }
    }
    ...
    fn lift_event_payload(
        ...
        if self.pending_payload != StatechartLiftedPayload::None {
            return Ok(());
        }
        match event {
            StatechartLiftedEvent::JobCompleted => {
                ...
                self.pending_payload =
                    StatechartLiftedPayload::JobCompleted(StatechartLiftedJobCompletedPayload {
...
impl StatechartLiftedPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: StatechartLiftedState,
        event: StatechartLiftedEvent,
        current_state: &mut StatechartLiftedState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            StatechartLiftedState::Done => false,
            StatechartLiftedState::Refused => false,
            StatechartLiftedState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartLiftedEvent::ErrorExecution {
                    ...
                    *current_state = StatechartLiftedState::Refused;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartLiftedEvent::JobCompleted {
                    // NL→IR Item C1 Path A: native typed `_event.data` guard
                    if matches!(&self.pending_payload, StatechartLiftedPayload::JobCompleted(ev) if ev.elapsed_ms == 0)
                    {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_is_internal = false;
                        ...
                        *current_state = StatechartLiftedState::Done;
                        *transition_taken = true;
                        return true;
                    }
                }
