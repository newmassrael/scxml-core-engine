...
//! Generated Rust state machine for `invoke_precedes_dequeue_midrun`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum InvokePrecedesDequeueMidrunState {
...
impl InvokePrecedesDequeueMidrunEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [InvokePrecedesDequeueMidrunEvent] = &[
        InvokePrecedesDequeueMidrunEvent::Go,
        InvokePrecedesDequeueMidrunEvent::Kick,
        InvokePrecedesDequeueMidrunEvent::Ready,
        InvokePrecedesDequeueMidrunEvent::SawKick,
        InvokePrecedesDequeueMidrunEvent::SawNoKick,
    ];
}
...
pub struct InvokePrecedesDequeueMidrunPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokePrecedesDequeueMidrunState,
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<InvokePrecedesDequeueMidrunState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_watch' (invoke_precedes_dequeue_midrun__sce_synth_invoke__inv_watch)
    child_inv_watch: Option<Box<sce_rust_runtime::Engine<super::invoke_precedes_dequeue_midrun__sce_synth_invoke__inv_watch_sm::InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy>>>,
...
impl InvokePrecedesDequeueMidrunPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: InvokePrecedesDequeueMidrunState::Arm,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_watch") {
                ...
                let mut child_policy = super::invoke_precedes_dequeue_midrun__sce_synth_invoke__inv_watch_sm::InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy::new();
...
impl Default for InvokePrecedesDequeueMidrunPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for InvokePrecedesDequeueMidrunPolicy {
    type State = InvokePrecedesDequeueMidrunState;
    type Event = InvokePrecedesDequeueMidrunEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokePrecedesDequeueMidrunState::Fail => true,
            InvokePrecedesDequeueMidrunState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokePrecedesDequeueMidrunState::Arm => 0,
            InvokePrecedesDequeueMidrunState::Fail => 3,
            InvokePrecedesDequeueMidrunState::Pass => 2,
            InvokePrecedesDequeueMidrunState::Phase => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokePrecedesDequeueMidrunEvent::Probe => "probe",
            InvokePrecedesDequeueMidrunEvent::Ready => "ready",
            InvokePrecedesDequeueMidrunEvent::SawKick => "sawKick",
            InvokePrecedesDequeueMidrunEvent::SawNoKick => "sawNoKick",
            InvokePrecedesDequeueMidrunEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "probe" => Some(InvokePrecedesDequeueMidrunEvent::Probe),
            "ready" => Some(InvokePrecedesDequeueMidrunEvent::Ready),
            "sawKick" => Some(InvokePrecedesDequeueMidrunEvent::SawKick),
            "sawNoKick" => Some(InvokePrecedesDequeueMidrunEvent::SawNoKick),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokePrecedesDequeueMidrunState::Arm => "arm",
            InvokePrecedesDequeueMidrunState::Fail => "fail",
            InvokePrecedesDequeueMidrunState::Pass => "pass",
            InvokePrecedesDequeueMidrunState::Phase => "phase",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "arm" => Some(InvokePrecedesDequeueMidrunState::Arm),
            "fail" => Some(InvokePrecedesDequeueMidrunState::Fail),
            "pass" => Some(InvokePrecedesDequeueMidrunState::Pass),
            "phase" => Some(InvokePrecedesDequeueMidrunState::Phase),
            _ => None,
        }
    }
...
impl InvokePrecedesDequeueMidrunPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokePrecedesDequeueMidrunState,
        event: InvokePrecedesDequeueMidrunEvent,
        current_state: &mut InvokePrecedesDequeueMidrunState,
        ...
        match check_state {
            InvokePrecedesDequeueMidrunState::Arm => {
                ...
                if event == InvokePrecedesDequeueMidrunEvent::Go {
                    ...
                    *current_state = InvokePrecedesDequeueMidrunState::Phase;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            InvokePrecedesDequeueMidrunState::Fail => false,
            InvokePrecedesDequeueMidrunState::Pass => false,
            InvokePrecedesDequeueMidrunState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunEvent::Kick {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunEvent::Ready {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunEvent::SawKick {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = InvokePrecedesDequeueMidrunState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunEvent::SawNoKick {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = InvokePrecedesDequeueMidrunState::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
