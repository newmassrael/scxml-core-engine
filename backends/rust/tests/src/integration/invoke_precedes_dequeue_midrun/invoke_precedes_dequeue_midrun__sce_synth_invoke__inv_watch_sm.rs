...
//! Generated Rust state machine for `invoke_precedes_dequeue_midrun__sce_synth_invoke__inv_watch`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_precedes_dequeue_midrun__sce_synth_invoke__inv_watch.scxml:3 :: _machine"]
...
pub enum InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState {
    Missed,
    Ordered,
    Saw,
...
impl InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent] = &[
        InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Kick,
        InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Probe,
    ];
}
...
pub struct InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState,
...
impl InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy {
    pub fn new() -> Self {
        Self {
...
impl Default for InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy {
    type State = InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState;
    type Event = InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed => true,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed => 2,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered => 3,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Saw => 1,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Waiting => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Kick => "kick",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Probe => "probe",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Ready => "ready",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::SawKick => "sawKick",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::SawNoKick => "sawNoKick",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "kick" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Kick),
            "probe" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Probe),
            "ready" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Ready),
            "sawKick" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::SawKick),
            "sawNoKick" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::SawNoKick),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed => "missed",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered => "ordered",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Saw => "saw",
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Waiting => "waiting",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "missed" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed),
            "ordered" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered),
            "saw" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Saw),
            "waiting" => Some(InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Waiting),
            _ => None,
        }
    }
...
impl InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState,
        event: InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent,
        current_state: &mut InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed => false,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered => false,
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Saw => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Probe {
                    ...
                    *current_state =
                        InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Ordered;
            ...
            InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Kick {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = false;
                    ...
                    *current_state = InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Saw;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchEvent::Probe {
                    ...
                    *current_state = InvokePrecedesDequeueMidrunSceSynthInvokeInvWatchState::Missed;
                    *transition_taken = true;
                    return true;
                }
                false
