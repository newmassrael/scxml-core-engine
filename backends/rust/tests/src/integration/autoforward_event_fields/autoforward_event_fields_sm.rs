...
//! Generated Rust state machine for `autoforward_event_fields`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum AutoforwardEventFieldsState {
    Fail,
    Pass,
...
pub enum AutoforwardEventFieldsEvent {
    CancelInvoke,
    ChildToParent,
    DoneInvoke,
    ErrorExecution,
...
impl AutoforwardEventFieldsEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [AutoforwardEventFieldsEvent] = &[
        AutoforwardEventFieldsEvent::ChildToParent,
        AutoforwardEventFieldsEvent::FieldsPreserved,
        AutoforwardEventFieldsEvent::FieldsStripped,
    ];
}
...
pub struct AutoforwardEventFieldsPolicy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<AutoforwardEventFieldsState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_echo' (autoforward_event_fields__sce_synth_invoke__inv_echo)
    child_inv_echo: Option<Box<sce_rust_runtime::Engine<super::autoforward_event_fields__sce_synth_invoke__inv_echo_sm::AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy>>>,
    pending_done_invoke_inv_echo: bool,
...
impl AutoforwardEventFieldsPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: AutoforwardEventFieldsState::Phase,
            ...
            child_inv_echo: None,
            pending_done_invoke_inv_echo: false,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "autoforward_event_fields", &io_processors)
        {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    AutoforwardEventFieldsEvent::ErrorExecution,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_echo") {
                ...
                let mut child_policy = super::autoforward_event_fields__sce_synth_invoke__inv_echo_sm::AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy::new(self.script_engine.clone());
                ...
                self.child_inv_echo = Some(Box::new(child_engine));
                ...
                {
                    self.pending_done_invoke_inv_echo = true;
    ...
    fn do_tick_children(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        if !self.pending_done_invoke_inv_echo {
            ...
            if let Some(mut child) = self.child_inv_echo.take() {
                ...
                if child.is_in_final_state() && !self.pending_done_invoke_inv_echo {
                    self.pending_done_invoke_inv_echo = true;
                    // W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
                ...
                // Put child back
                self.child_inv_echo = Some(child);
            }
        }
    }
    ...
    fn deliver_to_child_session(
        ...
        }
        {
            ...
            if addressed {
                if let Some(ref mut child) = self.child_inv_echo {
    ...
    fn do_forward_to_autoforward_children(
        ...
        // Check if child inv_echo has autoforward enabled and is active
        {
...
impl StatePolicy for AutoforwardEventFieldsPolicy {
    type State = AutoforwardEventFieldsState;
    type Event = AutoforwardEventFieldsEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardEventFieldsState::Fail => true,
            AutoforwardEventFieldsState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardEventFieldsState::Fail => 2,
            AutoforwardEventFieldsState::Pass => 1,
            AutoforwardEventFieldsState::Phase => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            AutoforwardEventFieldsEvent::CancelInvoke => "cancel.invoke",
            AutoforwardEventFieldsEvent::ChildToParent => "childToParent",
            AutoforwardEventFieldsEvent::DoneInvoke => "done.invoke",
            AutoforwardEventFieldsEvent::ErrorExecution => "error.execution",
            AutoforwardEventFieldsEvent::FieldsPreserved => "fieldsPreserved",
            AutoforwardEventFieldsEvent::FieldsStripped => "fieldsStripped",
            AutoforwardEventFieldsEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(AutoforwardEventFieldsEvent::CancelInvoke),
            "childToParent" => Some(AutoforwardEventFieldsEvent::ChildToParent),
            "done.invoke" => Some(AutoforwardEventFieldsEvent::DoneInvoke),
            "error.execution" => Some(AutoforwardEventFieldsEvent::ErrorExecution),
            "fieldsPreserved" => Some(AutoforwardEventFieldsEvent::FieldsPreserved),
            "fieldsStripped" => Some(AutoforwardEventFieldsEvent::FieldsStripped),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardEventFieldsState::Fail => "fail",
            AutoforwardEventFieldsState::Pass => "pass",
            AutoforwardEventFieldsState::Phase => "phase",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(AutoforwardEventFieldsState::Fail),
            "pass" => Some(AutoforwardEventFieldsState::Pass),
            "phase" => Some(AutoforwardEventFieldsState::Phase),
            _ => None,
        }
    }
    ...
    fn execute_exit_actions(
        ...
        match state {
            AutoforwardEventFieldsState::Phase => {
                ...
                // W3C SCXML 6.4: Cleanup running static child 'inv_echo'
                if self.child_inv_echo.is_some() {
                    if !self.pending_done_invoke_inv_echo {
                        engine.raise(sce_rust_runtime::EventWithMetadata::new(
                            AutoforwardEventFieldsEvent::CancelInvoke,
                        ));
                    }
                    self.child_inv_echo = None;
                }
                self.active_invokes.remove("inv_echo");
                self.pending_done_invoke_inv_echo = false;
            }
            _ => {}
        }
        match state {
...
impl AutoforwardEventFieldsPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardEventFieldsState,
        event: AutoforwardEventFieldsEvent,
        current_state: &mut AutoforwardEventFieldsState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            AutoforwardEventFieldsState::Fail => false,
            AutoforwardEventFieldsState::Pass => false,
            AutoforwardEventFieldsState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardEventFieldsEvent::ChildToParent {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardEventFieldsEvent::FieldsPreserved {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = AutoforwardEventFieldsState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardEventFieldsEvent::FieldsStripped {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = AutoforwardEventFieldsState::Fail;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardEventFieldsEvent::ErrorExecution {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
