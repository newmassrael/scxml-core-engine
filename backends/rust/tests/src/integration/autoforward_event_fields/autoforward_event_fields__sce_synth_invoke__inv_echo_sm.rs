                ...
                if event == AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::ChildToParent {
                    if self.safe_evaluate_guard("(((_scxml_truthy(_event.data) and (_event.data.value == 42)) and (_event.origin ~= \"\")) and (_event.invokeid ~= \"\"))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::ChildToParent {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported,
                            )],
                            transition_index: 1,
                            has_actions: true,
                            is_internal: false,
