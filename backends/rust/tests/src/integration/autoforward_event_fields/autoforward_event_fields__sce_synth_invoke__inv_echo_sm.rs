...
//! Generated Rust state machine for `autoforward_event_fields__sce_synth_invoke__inv_echo`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: autoforward_event_fields__sce_synth_invoke__inv_echo.scxml:3 :: _machine"]
...
pub enum AutoforwardEventFieldsSceSynthInvokeInvEchoState {
...
impl AutoforwardEventFieldsSceSynthInvokeInvEchoEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [AutoforwardEventFieldsSceSynthInvokeInvEchoEvent] =
        &[AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::ChildToParent];
}
...
pub struct AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: AutoforwardEventFieldsSceSynthInvokeInvEchoState,
...
impl AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: AutoforwardEventFieldsSceSynthInvokeInvEchoState::Emit,
...
impl StatePolicy for AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy {
    type State = AutoforwardEventFieldsSceSynthInvokeInvEchoState;
    type Event = AutoforwardEventFieldsSceSynthInvokeInvEchoEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ...
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "fieldsPreserved" => {
                Some(AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::FieldsPreserved)
            }
            "fieldsStripped" => {
                Some(AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::FieldsStripped)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Emit => "emit",
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported => "reported",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "emit" => Some(AutoforwardEventFieldsSceSynthInvokeInvEchoState::Emit),
            "reported" => Some(AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported),
            _ => None,
        }
    }
...
impl AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardEventFieldsSceSynthInvokeInvEchoState,
        event: AutoforwardEventFieldsSceSynthInvokeInvEchoEvent,
        current_state: &mut AutoforwardEventFieldsSceSynthInvokeInvEchoState,
        ...
        match check_state {
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Emit => {
                ...
                if event == AutoforwardEventFieldsSceSynthInvokeInvEchoEvent::ChildToParent {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(((_scxml_truthy(_event.data) and (_event.data.value == 42)) and (_event.origin ~= \"\")) and (_event.invokeid ~= \"\"))", engine) {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported;
            ...
            AutoforwardEventFieldsSceSynthInvokeInvEchoState::Reported => false,
            _ => false,
        }
    }
}
