...
//! Generated Rust state machine for `parallel_region_root_external_domain`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: parallel_region_root_external_domain.scxml:34 :: _machine"]
...
pub enum ParallelRegionRootExternalDomainState {
    Alive,
    Drive,
    Paused,
    Rebuilding,
...
pub enum ParallelRegionRootExternalDomainEvent {
    Hold,
    Restart,
...
impl ParallelRegionRootExternalDomainEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ParallelRegionRootExternalDomainEvent] = &[
        ParallelRegionRootExternalDomainEvent::Hold,
        ParallelRegionRootExternalDomainEvent::Restart,
    ];
}
...
pub struct ParallelRegionRootExternalDomainPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: ParallelRegionRootExternalDomainState,
    ...
    active_states:
        ::sce_rust_runtime::helpers::hierarchy::StateChain<ParallelRegionRootExternalDomainState>,
...
impl ParallelRegionRootExternalDomainPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: ParallelRegionRootExternalDomainState::Working,
...
impl Default for ParallelRegionRootExternalDomainPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for ParallelRegionRootExternalDomainPolicy {
    type State = ParallelRegionRootExternalDomainState;
    type Event = ParallelRegionRootExternalDomainEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        ParallelRegionRootExternalDomainState::Run
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            ParallelRegionRootExternalDomainState::Alive => {
                Some(ParallelRegionRootExternalDomainState::Watch)
            }
            ParallelRegionRootExternalDomainState::Drive => {
                Some(ParallelRegionRootExternalDomainState::Run)
            }
            ParallelRegionRootExternalDomainState::Paused => {
                Some(ParallelRegionRootExternalDomainState::Drive)
            }
            ParallelRegionRootExternalDomainState::Rebuilding => {
                Some(ParallelRegionRootExternalDomainState::Watch)
            }
            ParallelRegionRootExternalDomainState::Restarting => {
                Some(ParallelRegionRootExternalDomainState::Drive)
            }
            ParallelRegionRootExternalDomainState::Watch => {
                Some(ParallelRegionRootExternalDomainState::Run)
            }
            ParallelRegionRootExternalDomainState::Working => {
                Some(ParallelRegionRootExternalDomainState::Drive)
            }
            _ => None,
        }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            ParallelRegionRootExternalDomainState::Drive => true,
            ParallelRegionRootExternalDomainState::Watch => true,
            _ => false,
        }
    }
    ...
    fn is_parallel_state(state: Self::State) -> bool {
        match state {
            ParallelRegionRootExternalDomainState::Run => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ParallelRegionRootExternalDomainState::Alive => 6,
            ParallelRegionRootExternalDomainState::Drive => 1,
            ParallelRegionRootExternalDomainState::Paused => 4,
            ParallelRegionRootExternalDomainState::Rebuilding => 7,
            ParallelRegionRootExternalDomainState::Restarting => 3,
            ParallelRegionRootExternalDomainState::Run => 0,
            ParallelRegionRootExternalDomainState::Watch => 5,
            ParallelRegionRootExternalDomainState::Working => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ParallelRegionRootExternalDomainEvent::Hold => "hold",
            ParallelRegionRootExternalDomainEvent::Restart => "restart",
            ParallelRegionRootExternalDomainEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "hold" => Some(ParallelRegionRootExternalDomainEvent::Hold),
            "restart" => Some(ParallelRegionRootExternalDomainEvent::Restart),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            ParallelRegionRootExternalDomainState::Alive => "alive",
            ParallelRegionRootExternalDomainState::Drive => "drive",
            ParallelRegionRootExternalDomainState::Paused => "paused",
            ParallelRegionRootExternalDomainState::Rebuilding => "rebuilding",
            ParallelRegionRootExternalDomainState::Restarting => "restarting",
            ParallelRegionRootExternalDomainState::Run => "run",
            ParallelRegionRootExternalDomainState::Watch => "watch",
            ParallelRegionRootExternalDomainState::Working => "working",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "alive" => Some(ParallelRegionRootExternalDomainState::Alive),
            "drive" => Some(ParallelRegionRootExternalDomainState::Drive),
            "paused" => Some(ParallelRegionRootExternalDomainState::Paused),
            "rebuilding" => Some(ParallelRegionRootExternalDomainState::Rebuilding),
            "restarting" => Some(ParallelRegionRootExternalDomainState::Restarting),
            "run" => Some(ParallelRegionRootExternalDomainState::Run),
            "watch" => Some(ParallelRegionRootExternalDomainState::Watch),
            "working" => Some(ParallelRegionRootExternalDomainState::Working),
            _ => None,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(
                ParallelRegionRootExternalDomainState,
                usize,
...
impl ParallelRegionRootExternalDomainPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ParallelRegionRootExternalDomainState,
        event: ParallelRegionRootExternalDomainEvent,
        current_state: &mut ParallelRegionRootExternalDomainState,
        ...
        match check_state {
            ParallelRegionRootExternalDomainState::Alive => {
                ...
                if event == ParallelRegionRootExternalDomainEvent::Restart {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelRegionRootExternalDomainState::Rebuilding,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelRegionRootExternalDomainState::Rebuilding;
                        *transition_taken = true;
                    }
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelRegionRootExternalDomainEvent::Hold {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
            ...
            ParallelRegionRootExternalDomainState::Drive => {
                ...
                if event == ParallelRegionRootExternalDomainEvent::Restart {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelRegionRootExternalDomainState::Restarting,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelRegionRootExternalDomainState::Restarting;
                        *transition_taken = true;
                    }
                    return true;
                }
                ...
                if event == ParallelRegionRootExternalDomainEvent::Hold {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelRegionRootExternalDomainState::Paused,
                            transition_index: 1,
                            has_actions: false,
                            is_internal: true,
                            is_targetless: false,
                        ...
                        *current_state = ParallelRegionRootExternalDomainState::Paused;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            ParallelRegionRootExternalDomainState::Paused => false,
            ParallelRegionRootExternalDomainState::Rebuilding => false,
            ParallelRegionRootExternalDomainState::Restarting => false,
            ParallelRegionRootExternalDomainState::Run => false,
            ParallelRegionRootExternalDomainState::Watch => false,
            ParallelRegionRootExternalDomainState::Working => false,
            _ => false,
        }
    }
    ...
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<ParallelRegionRootExternalDomainState>
    {
        ...
        let lca: Option<ParallelRegionRootExternalDomainState> = {
    ...
    fn execute_microstep(
        ...
        for trans in transitions {
            ...
            let domain: Option<ParallelRegionRootExternalDomainState> = if is_internal_to_descendant
            {
                Some(trans.source)
            } else {
