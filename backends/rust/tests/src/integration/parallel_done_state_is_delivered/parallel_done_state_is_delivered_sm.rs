...
pub struct ParallelDoneStateIsDeliveredPolicy {
    ...
    last_transition_source_state: ParallelDoneStateIsDeliveredState,
...
impl ParallelDoneStateIsDeliveredPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: ParallelDoneStateIsDeliveredState::A1,
...
impl StatePolicy for ParallelDoneStateIsDeliveredPolicy {
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            ParallelDoneStateIsDeliveredState::A => ParallelDoneStateIsDeliveredState::A1,
            ParallelDoneStateIsDeliveredState::B => ParallelDoneStateIsDeliveredState::B1,
            _ => state,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(
                ParallelDoneStateIsDeliveredState,
                usize,
...
impl ParallelDoneStateIsDeliveredPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ParallelDoneStateIsDeliveredState,
        event: ParallelDoneStateIsDeliveredEvent,
        current_state: &mut ParallelDoneStateIsDeliveredState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            ParallelDoneStateIsDeliveredState::A => false,
            ParallelDoneStateIsDeliveredState::A1 => {
                ...
                if event == ParallelDoneStateIsDeliveredEvent::Go {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelDoneStateIsDeliveredState::A2,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelDoneStateIsDeliveredState::A2;
            ...
            ParallelDoneStateIsDeliveredState::A2 => false,
            ParallelDoneStateIsDeliveredState::B => false,
            ParallelDoneStateIsDeliveredState::B1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelDoneStateIsDeliveredEvent::Go {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelDoneStateIsDeliveredState::B2,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelDoneStateIsDeliveredState::B2;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            ParallelDoneStateIsDeliveredState::B2 => false,
            ParallelDoneStateIsDeliveredState::Run => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelDoneStateIsDeliveredEvent::DoneStateRun {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelDoneStateIsDeliveredState::Settled,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelDoneStateIsDeliveredState::Settled;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            ParallelDoneStateIsDeliveredState::Settled => false,
            _ => false,
        }
    }
    ...
    fn compute_exit_set(
        ...
        let lca: Option<ParallelDoneStateIsDeliveredState> = {
    ...
    fn execute_microstep(
        ...
        for trans in transitions {
            ...
            let domain: Option<ParallelDoneStateIsDeliveredState> = if is_internal_to_descendant {
                Some(trans.source)
            } else {
