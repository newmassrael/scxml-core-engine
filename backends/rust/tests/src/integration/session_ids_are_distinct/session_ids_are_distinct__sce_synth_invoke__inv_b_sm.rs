...
//! Generated Rust state machine for `session_ids_are_distinct__sce_synth_invoke__inv_b`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: session_ids_are_distinct__sce_synth_invoke__inv_b.scxml:3 :: _machine"]
...
pub enum SessionIdsAreDistinctSceSynthInvokeInvBState {
...
pub enum SessionIdsAreDistinctSceSynthInvokeInvBEvent {
    ErrorExecution,
    FromChild,
...
impl SessionIdsAreDistinctSceSynthInvokeInvBEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [SessionIdsAreDistinctSceSynthInvokeInvBEvent] = &[];
}
...
pub struct SessionIdsAreDistinctSceSynthInvokeInvBPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: SessionIdsAreDistinctSceSynthInvokeInvBState,
...
impl SessionIdsAreDistinctSceSynthInvokeInvBPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: SessionIdsAreDistinctSceSynthInvokeInvBState::Emit,
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    SessionIdsAreDistinctSceSynthInvokeInvBEvent::ErrorExecution,
...
impl StatePolicy for SessionIdsAreDistinctSceSynthInvokeInvBPolicy {
    type State = SessionIdsAreDistinctSceSynthInvokeInvBState;
    type Event = SessionIdsAreDistinctSceSynthInvokeInvBEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        SessionIdsAreDistinctSceSynthInvokeInvBState::Emit
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SessionIdsAreDistinctSceSynthInvokeInvBState::Emit => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            SessionIdsAreDistinctSceSynthInvokeInvBEvent::ErrorExecution => "error.execution",
            SessionIdsAreDistinctSceSynthInvokeInvBEvent::FromChild => "fromChild",
            SessionIdsAreDistinctSceSynthInvokeInvBEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(SessionIdsAreDistinctSceSynthInvokeInvBEvent::ErrorExecution),
            "fromChild" => Some(SessionIdsAreDistinctSceSynthInvokeInvBEvent::FromChild),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            SessionIdsAreDistinctSceSynthInvokeInvBState::Emit => "emit",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "emit" => Some(SessionIdsAreDistinctSceSynthInvokeInvBState::Emit),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "_sessionid") {
                                Ok(val) => {
                                    wire_params.entry("sid".to_string()).or_default().push(val);
                                }
                                Err(e) => {
                                    ...
                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(SessionIdsAreDistinctSceSynthInvokeInvBEvent::ErrorExecution, "<send> <param name='sid'> expr failed to evaluate"));
                                }
                            }
...
impl SessionIdsAreDistinctSceSynthInvokeInvBPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SessionIdsAreDistinctSceSynthInvokeInvBState,
        event: SessionIdsAreDistinctSceSynthInvokeInvBEvent,
        current_state: &mut SessionIdsAreDistinctSceSynthInvokeInvBState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            SessionIdsAreDistinctSceSynthInvokeInvBState::Emit => false,
            _ => false,
        }
    }
}
