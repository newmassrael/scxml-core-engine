...
//! Generated Rust state machine for `session_ids_are_distinct__sce_synth_invoke__inv_a`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: session_ids_are_distinct__sce_synth_invoke__inv_a.scxml:3 :: _machine"]
...
pub enum SessionIdsAreDistinctSceSynthInvokeInvAState {
...
impl SessionIdsAreDistinctSceSynthInvokeInvAEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [SessionIdsAreDistinctSceSynthInvokeInvAEvent] = &[];
}
...
pub struct SessionIdsAreDistinctSceSynthInvokeInvAPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: SessionIdsAreDistinctSceSynthInvokeInvAState,
...
impl SessionIdsAreDistinctSceSynthInvokeInvAPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: SessionIdsAreDistinctSceSynthInvokeInvAState::Emit,
...
impl StatePolicy for SessionIdsAreDistinctSceSynthInvokeInvAPolicy {
    type State = SessionIdsAreDistinctSceSynthInvokeInvAState;
    type Event = SessionIdsAreDistinctSceSynthInvokeInvAEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        SessionIdsAreDistinctSceSynthInvokeInvAState::Emit
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SessionIdsAreDistinctSceSynthInvokeInvAState::Emit => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            SessionIdsAreDistinctSceSynthInvokeInvAState::Emit => "emit",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "emit" => Some(SessionIdsAreDistinctSceSynthInvokeInvAState::Emit),
            _ => None,
        }
    }
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "_sessionid") {
                                ...
                                Err(e) => {
                                    ...
                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(SessionIdsAreDistinctSceSynthInvokeInvAEvent::ErrorExecution, "<send> <param name='sid'> expr failed to evaluate"));
                                }
                            }
...
impl SessionIdsAreDistinctSceSynthInvokeInvAPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SessionIdsAreDistinctSceSynthInvokeInvAState,
        event: SessionIdsAreDistinctSceSynthInvokeInvAEvent,
        current_state: &mut SessionIdsAreDistinctSceSynthInvokeInvAState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            SessionIdsAreDistinctSceSynthInvokeInvAState::Emit => false,
            _ => false,
        }
    }
}
