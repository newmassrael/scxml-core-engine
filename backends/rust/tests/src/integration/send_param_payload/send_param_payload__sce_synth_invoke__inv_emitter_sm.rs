...
//! Generated Rust state machine for `send_param_payload__sce_synth_invoke__inv_emitter`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum SendParamPayloadSceSynthInvokeInvEmitterState {
...
impl SendParamPayloadSceSynthInvokeInvEmitterEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [SendParamPayloadSceSynthInvokeInvEmitterEvent] = &[];
}
...
pub struct SendParamPayloadSceSynthInvokeInvEmitterPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: SendParamPayloadSceSynthInvokeInvEmitterState,
...
impl SendParamPayloadSceSynthInvokeInvEmitterPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: SendParamPayloadSceSynthInvokeInvEmitterState::Emit,
            session_id: None,
...
impl Default for SendParamPayloadSceSynthInvokeInvEmitterPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for SendParamPayloadSceSynthInvokeInvEmitterPolicy {
    type State = SendParamPayloadSceSynthInvokeInvEmitterState;
    type Event = SendParamPayloadSceSynthInvokeInvEmitterEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            SendParamPayloadSceSynthInvokeInvEmitterState::Sent => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SendParamPayloadSceSynthInvokeInvEmitterState::Emit => 0,
            SendParamPayloadSceSynthInvokeInvEmitterState::Sent => 1,
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "fromChild" => Some(SendParamPayloadSceSynthInvokeInvEmitterEvent::FromChild),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            SendParamPayloadSceSynthInvokeInvEmitterState::Emit => "emit",
            SendParamPayloadSceSynthInvokeInvEmitterState::Sent => "sent",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "emit" => Some(SendParamPayloadSceSynthInvokeInvEmitterState::Emit),
            "sent" => Some(SendParamPayloadSceSynthInvokeInvEmitterState::Sent),
            _ => None,
        }
    }
...
impl SendParamPayloadSceSynthInvokeInvEmitterPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SendParamPayloadSceSynthInvokeInvEmitterState,
        event: SendParamPayloadSceSynthInvokeInvEmitterEvent,
        current_state: &mut SendParamPayloadSceSynthInvokeInvEmitterState,
        ...
        match check_state {
            SendParamPayloadSceSynthInvokeInvEmitterState::Emit => {
                ...
                if event == SendParamPayloadSceSynthInvokeInvEmitterEvent::Null {
                    ...
                    *current_state = SendParamPayloadSceSynthInvokeInvEmitterState::Sent;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            SendParamPayloadSceSynthInvokeInvEmitterState::Sent => false,
            _ => false,
        }
    }
}
