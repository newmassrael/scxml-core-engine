...
//! Generated Rust state machine for `autoforward_dequeue_point__sce_synth_invoke__inv_probe`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum AutoforwardDequeuePointSceSynthInvokeInvProbeState {
    Awaiting,
    Early,
    Marked,
    Ordered,
...
impl AutoforwardDequeuePointSceSynthInvokeInvProbeEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [AutoforwardDequeuePointSceSynthInvokeInvProbeEvent] = &[
        AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::First,
        AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Mark,
        AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Second,
    ];
}
...
pub struct AutoforwardDequeuePointSceSynthInvokeInvProbePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: AutoforwardDequeuePointSceSynthInvokeInvProbeState,
...
impl AutoforwardDequeuePointSceSynthInvokeInvProbePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: AutoforwardDequeuePointSceSynthInvokeInvProbeState::Probe,
...
impl Default for AutoforwardDequeuePointSceSynthInvokeInvProbePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for AutoforwardDequeuePointSceSynthInvokeInvProbePolicy {
    type State = AutoforwardDequeuePointSceSynthInvokeInvProbeState;
    type Event = AutoforwardDequeuePointSceSynthInvokeInvProbeEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early => true,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Awaiting => 1,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early => 3,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Marked => 2,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered => 4,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Probe => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Ready => "ready",
            AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::SawMarkFirst => "sawMarkFirst",
            AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::SawSecondEarly => "sawSecondEarly",
            AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Second => "second",
            AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "first" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::First),
            "mark" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Mark),
            "ready" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Ready),
            "sawMarkFirst" => {
                Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::SawMarkFirst)
            }
            "sawSecondEarly" => {
                Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::SawSecondEarly)
            }
            "second" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Second),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Awaiting => "awaiting",
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early => "early",
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Marked => "marked",
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered => "ordered",
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Probe => "probe",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "awaiting" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeState::Awaiting),
            "early" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early),
            "marked" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeState::Marked),
            "ordered" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered),
            "probe" => Some(AutoforwardDequeuePointSceSynthInvokeInvProbeState::Probe),
            _ => None,
        }
    }
                ...
                match self.last_transition_index {
                    1 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("sawSecondEarly".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
                ...
                match self.last_transition_index {
                    0 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("sawMarkFirst".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl AutoforwardDequeuePointSceSynthInvokeInvProbePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardDequeuePointSceSynthInvokeInvProbeState,
        event: AutoforwardDequeuePointSceSynthInvokeInvProbeEvent,
        current_state: &mut AutoforwardDequeuePointSceSynthInvokeInvProbeState,
        ...
        match check_state {
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Awaiting => {
                ...
                if event == AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Mark {
                    ...
                    *current_state = AutoforwardDequeuePointSceSynthInvokeInvProbeState::Marked;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Second {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Early => false,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Marked => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::Second {
                    ...
                    *current_state = AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Ordered => false,
            AutoforwardDequeuePointSceSynthInvokeInvProbeState::Probe => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardDequeuePointSceSynthInvokeInvProbeEvent::First {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = false;
                    ...
                    *current_state = AutoforwardDequeuePointSceSynthInvokeInvProbeState::Awaiting;
                    *transition_taken = true;
                    return true;
                }
                false
