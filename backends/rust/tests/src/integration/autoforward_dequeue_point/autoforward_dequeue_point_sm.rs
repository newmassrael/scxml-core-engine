...
#![doc = "SCE-MAP: autoforward_dequeue_point.scxml:67 :: _machine"]
...
impl StatePolicy for AutoforwardDequeuePointPolicy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(AutoforwardDequeuePointState::Fail),
            "pass" => Some(AutoforwardDequeuePointState::Pass),
            "phase" => Some(AutoforwardDequeuePointState::Phase),
            _ => None,
        }
    }
