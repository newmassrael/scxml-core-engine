...
//! Generated Rust state machine for `nested_final_not_terminal`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum NestedFinalNotTerminalState {
    Pass,
    Phase,
    PhaseDone,
...
pub enum NestedFinalNotTerminalEvent {
    DoneStatePhase,
    Resume,
...
impl NestedFinalNotTerminalEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [NestedFinalNotTerminalEvent] =
        &[NestedFinalNotTerminalEvent::Resume];
}
...
impl NestedFinalNotTerminalPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: NestedFinalNotTerminalState::Running,
            session_id: None,
...
impl Default for NestedFinalNotTerminalPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for NestedFinalNotTerminalPolicy {
    type State = NestedFinalNotTerminalState;
    type Event = NestedFinalNotTerminalEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            NestedFinalNotTerminalState::Pass => true,
            NestedFinalNotTerminalState::PhaseDone => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            NestedFinalNotTerminalState::PhaseDone => Some(NestedFinalNotTerminalState::Phase),
            NestedFinalNotTerminalState::Running => Some(NestedFinalNotTerminalState::Phase),
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            NestedFinalNotTerminalState::Phase => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            NestedFinalNotTerminalState::Pass => 3,
            NestedFinalNotTerminalState::Phase => 0,
            NestedFinalNotTerminalState::PhaseDone => 2,
            NestedFinalNotTerminalState::Running => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            NestedFinalNotTerminalEvent::DoneStatePhase => "done.state.phase",
            NestedFinalNotTerminalEvent::Resume => "resume",
            NestedFinalNotTerminalEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "done.state.phase" => Some(NestedFinalNotTerminalEvent::DoneStatePhase),
            "resume" => Some(NestedFinalNotTerminalEvent::Resume),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            NestedFinalNotTerminalState::Pass => "pass",
            NestedFinalNotTerminalState::Phase => "phase",
            NestedFinalNotTerminalState::PhaseDone => "phaseDone",
            NestedFinalNotTerminalState::Running => "running",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "pass" => Some(NestedFinalNotTerminalState::Pass),
            "phase" => Some(NestedFinalNotTerminalState::Phase),
            "phaseDone" => Some(NestedFinalNotTerminalState::PhaseDone),
            "running" => Some(NestedFinalNotTerminalState::Running),
            _ => None,
        }
    }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            NestedFinalNotTerminalState::Phase => NestedFinalNotTerminalState::Running,
            _ => state,
        }
    }
...
impl NestedFinalNotTerminalPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: NestedFinalNotTerminalState,
        event: NestedFinalNotTerminalEvent,
        current_state: &mut NestedFinalNotTerminalState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            NestedFinalNotTerminalState::Pass => false,
            NestedFinalNotTerminalState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == NestedFinalNotTerminalEvent::Resume {
                    ...
                    *current_state = NestedFinalNotTerminalState::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            NestedFinalNotTerminalState::PhaseDone => false,
            NestedFinalNotTerminalState::Running => {
                // W3C SCXML 3.13: Eventless transitions
                if event == NestedFinalNotTerminalEvent::Null {
                    // Unconditional eventless transition
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    *current_state = NestedFinalNotTerminalState::PhaseDone;
                    *transition_taken = true;
                    return true;
                }
                false
