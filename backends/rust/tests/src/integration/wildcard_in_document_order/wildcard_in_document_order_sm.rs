...
//! Generated Rust state machine for `wildcard_in_document_order`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: wildcard_in_document_order.scxml:48 :: _machine"]
...
pub enum WildcardInDocumentOrderState {
    FailGuardedInternalReentered,
    FailGuardIgnored,
    FailGuardNeverFired,
    FailSealedInternalReentered,
    GuardClosed,
...
pub enum WildcardInDocumentOrderEvent {
    ErrorExecution,
    Hop,
    Probe,
...
impl WildcardInDocumentOrderEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [WildcardInDocumentOrderEvent] = &[];
}
...
impl WildcardInDocumentOrderPolicy {
    ...
    /// answer — the session is not initialized yet, `armed` was
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `guardedEntries` was
    /// assigned a value of another type, or the engine refused.
    pub fn guarded_entries(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `sealedEntries` was
    /// assigned a value of another type, or the engine refused.
    pub fn sealed_entries(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "sealedEntries",
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: WildcardInDocumentOrderState::GuardClosedLeaf,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "wildcard_in_document_order", &io_processors)
        {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'armed' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'guardedEntries' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "guardedEntries",
        ...
        // W3C SCXML 5.2/5.3: Initialize 'sealedEntries' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "sealedEntries",
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='armed'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                WildcardInDocumentOrderEvent::ErrorExecution,
                "<data id='guardedEntries'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                WildcardInDocumentOrderEvent::ErrorExecution,
                "<data id='sealedEntries'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for WildcardInDocumentOrderPolicy {
    type State = WildcardInDocumentOrderState;
    type Event = WildcardInDocumentOrderEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            WildcardInDocumentOrderState::FailGuardedInternalReentered => true,
            WildcardInDocumentOrderState::FailGuardIgnored => true,
            WildcardInDocumentOrderState::FailGuardNeverFired => true,
            WildcardInDocumentOrderState::FailSealedInternalReentered => true,
            WildcardInDocumentOrderState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            WildcardInDocumentOrderState::GuardClosedLeaf => {
                Some(WildcardInDocumentOrderState::GuardClosed)
            }
            WildcardInDocumentOrderState::GuardedFrom => {
                Some(WildcardInDocumentOrderState::GuardedInternal)
            }
            WildcardInDocumentOrderState::GuardedTo => {
                Some(WildcardInDocumentOrderState::GuardedInternal)
            }
            WildcardInDocumentOrderState::GuardOpenLeaf => {
                Some(WildcardInDocumentOrderState::GuardOpen)
            }
            WildcardInDocumentOrderState::SealedFrom => {
                Some(WildcardInDocumentOrderState::SealedInternal)
            }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            WildcardInDocumentOrderState::GuardClosed => true,
            WildcardInDocumentOrderState::GuardedInternal => true,
            WildcardInDocumentOrderState::GuardOpen => true,
            WildcardInDocumentOrderState::SealedInternal => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            WildcardInDocumentOrderState::FailGuardedInternalReentered => 13,
            WildcardInDocumentOrderState::FailGuardIgnored => 11,
            WildcardInDocumentOrderState::FailGuardNeverFired => 12,
            WildcardInDocumentOrderState::FailSealedInternalReentered => 14,
            WildcardInDocumentOrderState::GuardClosed => 0,
            WildcardInDocumentOrderState::GuardClosedLeaf => 1,
            WildcardInDocumentOrderState::GuardedFrom => 5,
            WildcardInDocumentOrderState::GuardedInternal => 4,
            WildcardInDocumentOrderState::GuardedTo => 6,
            WildcardInDocumentOrderState::GuardOpen => 2,
            WildcardInDocumentOrderState::GuardOpenLeaf => 3,
            WildcardInDocumentOrderState::Pass => 10,
            WildcardInDocumentOrderState::SealedFrom => 8,
            WildcardInDocumentOrderState::SealedInternal => 7,
            WildcardInDocumentOrderState::SealedTo => 9,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            WildcardInDocumentOrderState::FailGuardedInternalReentered => {
                "failGuardedInternalReentered"
            }
            WildcardInDocumentOrderState::FailGuardIgnored => "failGuardIgnored",
            WildcardInDocumentOrderState::FailGuardNeverFired => "failGuardNeverFired",
            WildcardInDocumentOrderState::FailSealedInternalReentered => {
                "failSealedInternalReentered"
            }
            WildcardInDocumentOrderState::GuardClosed => "guardClosed",
            WildcardInDocumentOrderState::GuardClosedLeaf => "guardClosedLeaf",
            WildcardInDocumentOrderState::GuardedFrom => "guardedFrom",
            WildcardInDocumentOrderState::GuardedInternal => "guardedInternal",
            WildcardInDocumentOrderState::GuardedTo => "guardedTo",
            WildcardInDocumentOrderState::GuardOpen => "guardOpen",
            WildcardInDocumentOrderState::GuardOpenLeaf => "guardOpenLeaf",
            WildcardInDocumentOrderState::Pass => "pass",
            WildcardInDocumentOrderState::SealedFrom => "sealedFrom",
            WildcardInDocumentOrderState::SealedInternal => "sealedInternal",
            WildcardInDocumentOrderState::SealedTo => "sealedTo",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "failGuardedInternalReentered" => {
                Some(WildcardInDocumentOrderState::FailGuardedInternalReentered)
            }
            "failGuardIgnored" => Some(WildcardInDocumentOrderState::FailGuardIgnored),
            "failGuardNeverFired" => Some(WildcardInDocumentOrderState::FailGuardNeverFired),
            "failSealedInternalReentered" => {
                Some(WildcardInDocumentOrderState::FailSealedInternalReentered)
            }
            "guardClosed" => Some(WildcardInDocumentOrderState::GuardClosed),
            "guardClosedLeaf" => Some(WildcardInDocumentOrderState::GuardClosedLeaf),
            "guardedFrom" => Some(WildcardInDocumentOrderState::GuardedFrom),
            "guardedInternal" => Some(WildcardInDocumentOrderState::GuardedInternal),
            "guardedTo" => Some(WildcardInDocumentOrderState::GuardedTo),
            "guardOpen" => Some(WildcardInDocumentOrderState::GuardOpen),
            "guardOpenLeaf" => Some(WildcardInDocumentOrderState::GuardOpenLeaf),
            "pass" => Some(WildcardInDocumentOrderState::Pass),
            "sealedFrom" => Some(WildcardInDocumentOrderState::SealedFrom),
            "sealedInternal" => Some(WildcardInDocumentOrderState::SealedInternal),
            "sealedTo" => Some(WildcardInDocumentOrderState::SealedTo),
            _ => None,
        }
    }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            ...
            WildcardInDocumentOrderState::GuardOpen => WildcardInDocumentOrderState::GuardOpenLeaf,
            WildcardInDocumentOrderState::SealedInternal => {
                WildcardInDocumentOrderState::SealedFrom
            }
            _ => state,
    ...
    fn execute_entry_actions(
        ...
        match state {
            ...
            WildcardInDocumentOrderState::GuardedInternal => {
                ...
                'action_block: {
                    {
                        // W3C SCXML 5.3: <assign location="guardedEntries">
                        self.ensure_script_engine();
                        let sid = self.session_id.as_ref().unwrap().clone();
                        let se = self.script_engine.clone();
                        let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                        let expr = "_scxml_add(guardedEntries, 1)";
                        ...
                        let assign_script = format!("{} = {}", "guardedEntries", expr);
                        if let Err(e) = se.execute_script(&sid, &assign_script) {
                            ::sce_rust_runtime::sce_log_error!(
                                "Assign failed for 'guardedEntries': {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                WildcardInDocumentOrderEvent::ErrorExecution,
                    ...
                    // W3C SCXML 3.8.1: <raise event="hop">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        WildcardInDocumentOrderEvent::Hop,
                    ));
                }
            }
            WildcardInDocumentOrderState::GuardOpen => {
            ...
            WildcardInDocumentOrderState::SealedInternal => {
                ...
                'action_block: {
                    {
                        // W3C SCXML 5.3: <assign location="sealedEntries">
                        self.ensure_script_engine();
                        let sid = self.session_id.as_ref().unwrap().clone();
                        let se = self.script_engine.clone();
                        let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                        let expr = "_scxml_add(sealedEntries, 1)";
                        // W3C SCXML 5.3: Assign via execute_script preserves Lua reference identity for
                        // table values (e.g. `Var2 = _event` — test 329 requires `Var2 == _event`). Going
                        // through evaluate_expression + set_variable would round-trip through ScriptValue
                        // and create a fresh table, breaking reference equality.
                        let assign_script = format!("{} = {}", "sealedEntries", expr);
                        if let Err(e) = se.execute_script(&sid, &assign_script) {
                            ::sce_rust_runtime::sce_log_error!(
                                "Assign failed for 'sealedEntries': {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                WildcardInDocumentOrderEvent::ErrorExecution,
...
impl WildcardInDocumentOrderPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: WildcardInDocumentOrderState,
        event: WildcardInDocumentOrderEvent,
        current_state: &mut WildcardInDocumentOrderState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            WildcardInDocumentOrderState::FailGuardedInternalReentered => false,
            WildcardInDocumentOrderState::FailGuardIgnored => false,
            WildcardInDocumentOrderState::FailGuardNeverFired => false,
            WildcardInDocumentOrderState::FailSealedInternalReentered => false,
            WildcardInDocumentOrderState::GuardClosed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == WildcardInDocumentOrderEvent::Probe {
                    ...
                    *current_state = WildcardInDocumentOrderState::GuardOpen;
            ...
            WildcardInDocumentOrderState::GuardClosedLeaf => {
                ...
                if event != WildcardInDocumentOrderEvent::Null
                    ...
                    )
                {
                    ...
                    if self.safe_evaluate_guard("_scxml_truthy(armed)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        *current_state = WildcardInDocumentOrderState::FailGuardIgnored;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            WildcardInDocumentOrderState::GuardedFrom => false,
            WildcardInDocumentOrderState::GuardedInternal => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != WildcardInDocumentOrderEvent::Null
                    ...
                    )
                {
                    ...
                    if self.safe_evaluate_guard("_scxml_truthy(armed)", engine) {
                        ...
                        *current_state = WildcardInDocumentOrderState::GuardedTo;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            WildcardInDocumentOrderState::GuardedTo => {
                ...
                if event == WildcardInDocumentOrderEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(guardedEntries, 1)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = WildcardInDocumentOrderState::SealedInternal;
                        *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = WildcardInDocumentOrderState::FailGuardedInternalReentered;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            WildcardInDocumentOrderState::GuardOpen => {
                ...
                if event == WildcardInDocumentOrderEvent::Probe {
                    ...
                    *current_state = WildcardInDocumentOrderState::FailGuardNeverFired;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            WildcardInDocumentOrderState::GuardOpenLeaf => {
                    ...
                    )
                {
                    ...
                    if self.safe_evaluate_guard("_scxml_truthy(armed)", engine) {
                        ...
                        *current_state = WildcardInDocumentOrderState::GuardedInternal;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            WildcardInDocumentOrderState::Pass => false,
            WildcardInDocumentOrderState::SealedFrom => false,
            WildcardInDocumentOrderState::SealedInternal => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Runtime event descriptor matching
                if event != WildcardInDocumentOrderEvent::Null
                    ...
                    )
                {
                    ...
                    *current_state = WildcardInDocumentOrderState::SealedTo;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            WildcardInDocumentOrderState::SealedTo => {
                // W3C SCXML 3.13: Eventless transitions
                if event == WildcardInDocumentOrderEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(sealedEntries, 1)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = WildcardInDocumentOrderState::Pass;
                        *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = WildcardInDocumentOrderState::FailSealedInternalReentered;
                        *transition_taken = true;
                        return true;
                    }
                }
