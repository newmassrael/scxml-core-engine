...
impl StatePolicy for WildcardInDocumentOrderPolicy {
    ...
    fn get_initial_targets(
        ...
        match state {
            WildcardInDocumentOrderState::GuardClosed => &[::sce_rust_runtime::EntryTarget::State(
                WildcardInDocumentOrderState::GuardClosedLeaf,
            )],
            WildcardInDocumentOrderState::GuardedInternal => {
            ...
            WildcardInDocumentOrderState::GuardOpen => &[::sce_rust_runtime::EntryTarget::State(
                WildcardInDocumentOrderState::GuardOpenLeaf,
            )],
            WildcardInDocumentOrderState::SealedInternal => {
                &[::sce_rust_runtime::EntryTarget::State(
                    ...
                    )
                {
                    if self.safe_evaluate_guard("_scxml_truthy(armed)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                WildcardInDocumentOrderState::FailGuardIgnored,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == WildcardInDocumentOrderEvent::Probe {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                WildcardInDocumentOrderState::FailGuardNeverFired,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
