...
//! Generated Rust state machine for `invoke_param_error_starts_the_child`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_error_starts_the_child.scxml:52 :: _machine"]
...
pub enum InvokeParamErrorStartsTheChildState {
...
impl InvokeParamErrorStartsTheChildEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [InvokeParamErrorStartsTheChildEvent] = &[
        InvokeParamErrorStartsTheChildEvent::ChildUp,
...
pub struct InvokeParamErrorStartsTheChildPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamErrorStartsTheChildState,
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<InvokeParamErrorStartsTheChildState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_probe' (invoke_param_error_starts_the_child__sce_synth_invoke__inv_probe)
    child_inv_probe: Option<Box<sce_rust_runtime::Engine<super::invoke_param_error_starts_the_child__sce_synth_invoke__inv_probe_sm::InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy>>>,
...
impl InvokeParamErrorStartsTheChildPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: InvokeParamErrorStartsTheChildState::ParamPhase,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "invoke_param_error_starts_the_child", &io_processors)
        {
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_probe") {
                ...
                let mut child_policy = super::invoke_param_error_starts_the_child__sce_synth_invoke__inv_probe_sm::InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy::new(self.script_engine.clone());
                ...
                // W3C SCXML 6.4.1: Pass params to child datamodel before initialization
                {
                    ...
                    let se = self.script_engine.clone();
                    let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                    match se.evaluate_expression(&sid, "\"here\"") {
                        Ok(val) => {
                            // §scxml-6.4.3: the VALUE of the param element becomes
                            // the child `<data>`'s initial value.
                            child_policy.set_param_value_in_script_engine("kept", val);
                        }
                        Err(e) => {
                    ...
                    match se.evaluate_expression(&sid, "nothing.deep") {
                        Ok(val) => {
                            // §scxml-6.4.3: the VALUE of the param element becomes
                            // the child `<data>`'s initial value.
                            child_policy.set_param_value_in_script_engine("broken", val);
                        }
                        Err(e) => {
                            // §scxml-5.7.1: BOTH halves — `error.execution` on the
                            // internal queue AND the name and value ignored. Only
                            ...
                            // `<donedata>` side.
                            ::sce_rust_runtime::sce_log_error!(
                                "invoke param 'broken' eval failed: {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                InvokeParamErrorStartsTheChildEvent::ErrorExecution,
...
impl StatePolicy for InvokeParamErrorStartsTheChildPolicy {
    type State = InvokeParamErrorStartsTheChildState;
    type Event = InvokeParamErrorStartsTheChildEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded => true,
            InvokeParamErrorStartsTheChildState::FailGoodParamLost => true,
            InvokeParamErrorStartsTheChildState::FailInvokeNotStarted => true,
            InvokeParamErrorStartsTheChildState::FailNoParamError => true,
            InvokeParamErrorStartsTheChildState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded => 5,
            InvokeParamErrorStartsTheChildState::FailGoodParamLost => 4,
            InvokeParamErrorStartsTheChildState::FailInvokeNotStarted => 3,
            InvokeParamErrorStartsTheChildState::FailNoParamError => 2,
            InvokeParamErrorStartsTheChildState::ParamPhase => 0,
            InvokeParamErrorStartsTheChildState::Pass => 1,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokeParamErrorStartsTheChildEvent::Timeout => "timeout",
            InvokeParamErrorStartsTheChildEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "timeout" => Some(InvokeParamErrorStartsTheChildEvent::Timeout),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded => "failBrokenParamSeeded",
            InvokeParamErrorStartsTheChildState::FailGoodParamLost => "failGoodParamLost",
            InvokeParamErrorStartsTheChildState::FailInvokeNotStarted => "failInvokeNotStarted",
            InvokeParamErrorStartsTheChildState::FailNoParamError => "failNoParamError",
            InvokeParamErrorStartsTheChildState::ParamPhase => "paramPhase",
            InvokeParamErrorStartsTheChildState::Pass => "pass",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "failBrokenParamSeeded" => {
                Some(InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded)
            }
            "failGoodParamLost" => Some(InvokeParamErrorStartsTheChildState::FailGoodParamLost),
            "failInvokeNotStarted" => {
                Some(InvokeParamErrorStartsTheChildState::FailInvokeNotStarted)
            }
            "failNoParamError" => Some(InvokeParamErrorStartsTheChildState::FailNoParamError),
            "paramPhase" => Some(InvokeParamErrorStartsTheChildState::ParamPhase),
            "pass" => Some(InvokeParamErrorStartsTheChildState::Pass),
            _ => None,
        }
    }
...
impl InvokeParamErrorStartsTheChildPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamErrorStartsTheChildState,
        event: InvokeParamErrorStartsTheChildEvent,
        current_state: &mut InvokeParamErrorStartsTheChildState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded => false,
            InvokeParamErrorStartsTheChildState::FailGoodParamLost => false,
            InvokeParamErrorStartsTheChildState::FailInvokeNotStarted => false,
            InvokeParamErrorStartsTheChildState::FailNoParamError => false,
            InvokeParamErrorStartsTheChildState::ParamPhase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokeParamErrorStartsTheChildEvent::ErrorExecution {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    ...
                    if self.safe_evaluate_guard("(sawParamError ~= 1)", engine) {
                        ...
                        *current_state = InvokeParamErrorStartsTheChildState::FailNoParamError;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    ...
                    if self.safe_evaluate_guard("(_event.data.kept ~= \"here\")", engine) {
                        ...
                        *current_state = InvokeParamErrorStartsTheChildState::FailGoodParamLost;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(_event.data.brokenPlaceholder == true)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        *current_state = InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    ...
                    *current_state = InvokeParamErrorStartsTheChildState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokeParamErrorStartsTheChildEvent::Timeout {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = InvokeParamErrorStartsTheChildState::FailInvokeNotStarted;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            InvokeParamErrorStartsTheChildState::Pass => false,
            _ => false,
        }
    }
}
