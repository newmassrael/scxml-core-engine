                    ...
                    if self.safe_evaluate_guard("(sawParamError ~= 1)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                InvokeParamErrorStartsTheChildState::FailNoParamError,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    if self.safe_evaluate_guard("(_event.data.kept ~= \"here\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                InvokeParamErrorStartsTheChildState::FailGoodParamLost,
                            )],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == InvokeParamErrorStartsTheChildEvent::ChildUp {
                    if self.safe_evaluate_guard("(_event.data.brokenPlaceholder == true)", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                InvokeParamErrorStartsTheChildState::FailBrokenParamSeeded,
                            )],
                            transition_index: 3,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == InvokeParamErrorStartsTheChildEvent::Timeout {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                InvokeParamErrorStartsTheChildState::FailInvokeNotStarted,
                            )],
                            transition_index: 5,
                            has_actions: false,
                            is_internal: false,
