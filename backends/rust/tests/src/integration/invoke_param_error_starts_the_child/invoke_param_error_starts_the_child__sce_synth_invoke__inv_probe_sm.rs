...
//! Generated Rust state machine for `invoke_param_error_starts_the_child__sce_synth_invoke__inv_probe`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_error_starts_the_child__sce_synth_invoke__inv_probe.scxml:3 :: _machine"]
...
pub enum InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState {
    Done,
...
impl InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent] = &[];
}
...
pub struct InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState,
...
impl InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        // W3C SCXML 5.2: Runtime variable 'kept' (global, late binding, init to nil)
        let _ = se.set_variable(&sid, "kept", sce_rust_runtime::ScriptValue::Null);

        // W3C SCXML 5.2: Runtime variable 'broken' (global, late binding, init to nil)
        let _ = se.set_variable(&sid, "broken", sce_rust_runtime::ScriptValue::Null);
...
impl StatePolicy for InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy {
    type State = InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState;
    type Event = InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done => 1,
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Report => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done => "done",
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Report => "report",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done),
            "report" => Some(InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Report),
            _ => None,
        }
    }
                    ...
                    0 => {
...

                        {
                            ...
                            let event_data_string: String = {
                                ...
                                match se.evaluate_expression(&sid, "kept") {
                                    Ok(val) => {
                                        wire_params
                                ...
                                match se.evaluate_expression(&sid, "(broken == \"\")") {
                                    Ok(val) => {
                                        wire_params
                                            .entry("brokenPlaceholder".to_string())
                                            .or_default()
                                            .push(val);
                                    }
                                    Err(e) => {
...
impl InvokeParamErrorStartsTheChildSceSynthInvokeInvProbePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState,
        event: InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent,
        current_state: &mut InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done => false,
            InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Report => {
                // W3C SCXML 3.13: Eventless transitions
                if event == InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeEvent::Null {
                    ...
                    *current_state =
                        InvokeParamErrorStartsTheChildSceSynthInvokeInvProbeState::Done;
