...
//! Generated Rust state machine for `event_origin_is_a_location__sce_synth_invoke__inv_peer`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: event_origin_is_a_location__sce_synth_invoke__inv_peer.scxml:3 :: _machine"]
...
pub enum EventOriginIsALocationSceSynthInvokeInvPeerState {
    Acked,
...
impl EventOriginIsALocationSceSynthInvokeInvPeerEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [EventOriginIsALocationSceSynthInvokeInvPeerEvent] =
        &[EventOriginIsALocationSceSynthInvokeInvPeerEvent::Reply];
}
...
pub struct EventOriginIsALocationSceSynthInvokeInvPeerPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: EventOriginIsALocationSceSynthInvokeInvPeerState,
...
impl EventOriginIsALocationSceSynthInvokeInvPeerPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: EventOriginIsALocationSceSynthInvokeInvPeerState::Emit,
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    EventOriginIsALocationSceSynthInvokeInvPeerEvent::ErrorExecution,
...
impl StatePolicy for EventOriginIsALocationSceSynthInvokeInvPeerPolicy {
    type State = EventOriginIsALocationSceSynthInvokeInvPeerState;
    type Event = EventOriginIsALocationSceSynthInvokeInvPeerEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            EventOriginIsALocationSceSynthInvokeInvPeerState::Acked => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            EventOriginIsALocationSceSynthInvokeInvPeerState::Acked => 1,
            EventOriginIsALocationSceSynthInvokeInvPeerState::Emit => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            EventOriginIsALocationSceSynthInvokeInvPeerEvent::ReplyArrived => "replyArrived",
            EventOriginIsALocationSceSynthInvokeInvPeerEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "fromChild" => Some(EventOriginIsALocationSceSynthInvokeInvPeerEvent::FromChild),
            "reply" => Some(EventOriginIsALocationSceSynthInvokeInvPeerEvent::Reply),
            "replyArrived" => Some(EventOriginIsALocationSceSynthInvokeInvPeerEvent::ReplyArrived),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            EventOriginIsALocationSceSynthInvokeInvPeerState::Acked => "acked",
            EventOriginIsALocationSceSynthInvokeInvPeerState::Emit => "emit",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "acked" => Some(EventOriginIsALocationSceSynthInvokeInvPeerState::Acked),
            "emit" => Some(EventOriginIsALocationSceSynthInvokeInvPeerState::Emit),
            _ => None,
        }
    }
                ...
                'action_block: {
                    {
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "_ioprocessors.scxml.location") {
                                Ok(val) => {
                                    wire_params
                                        .entry("myLocation".to_string())
                                        .or_default()
                                        .push(val);
                                }
                                Err(e) => {
                                    ::sce_rust_runtime::sce_log_error!(
                                        "send param 'myLocation' eval failed: {}",
                                        e
                                    );
                                    engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(EventOriginIsALocationSceSynthInvokeInvPeerEvent::ErrorExecution, "<send> <param name='myLocation'> expr failed to evaluate"));
                                }
                            }
                ...
                match self.last_transition_index {
                    0 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("replyArrived".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl EventOriginIsALocationSceSynthInvokeInvPeerPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: EventOriginIsALocationSceSynthInvokeInvPeerState,
        event: EventOriginIsALocationSceSynthInvokeInvPeerEvent,
        current_state: &mut EventOriginIsALocationSceSynthInvokeInvPeerState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            EventOriginIsALocationSceSynthInvokeInvPeerState::Acked => false,
            EventOriginIsALocationSceSynthInvokeInvPeerState::Emit => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == EventOriginIsALocationSceSynthInvokeInvPeerEvent::Reply {
                    ...
                    *current_state = EventOriginIsALocationSceSynthInvokeInvPeerState::Acked;
