...
pub struct StatechartDelayedHostSendPolicy {
    ...
    last_transition_source_state: StatechartDelayedHostSendState,
...
impl StatechartDelayedHostSendPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: StatechartDelayedHostSendState::Waiting,
            session_id: None,
...
impl StatechartDelayedHostSendPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: StatechartDelayedHostSendState,
        event: StatechartDelayedHostSendEvent,
        current_state: &mut StatechartDelayedHostSendState,
        ...
        match check_state {
            StatechartDelayedHostSendState::Armed => {
                ...
                if event == StatechartDelayedHostSendEvent::TurnDone {
                    ...
                    *current_state = StatechartDelayedHostSendState::Cancelling;
                ...
                if event == StatechartDelayedHostSendEvent::ErrorExecution {
                    ...
                    *current_state = StatechartDelayedHostSendState::Unserved;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            StatechartDelayedHostSendState::Cancelling => {
                ...
                if event == StatechartDelayedHostSendEvent::Settle {
                    ...
                    *current_state = StatechartDelayedHostSendState::CancelPending;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartDelayedHostSendEvent::TurnDone {
                    ...
                    *current_state = StatechartDelayedHostSendState::CancelLost;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            StatechartDelayedHostSendState::CancelLost => false,
            StatechartDelayedHostSendState::CancelPending => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartDelayedHostSendEvent::TurnDone {
                ...
                if event == StatechartDelayedHostSendEvent::Finish {
                    ...
                    *current_state = StatechartDelayedHostSendState::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            StatechartDelayedHostSendState::Pass => false,
            StatechartDelayedHostSendState::TooEarly => false,
            StatechartDelayedHostSendState::Unserved => false,
            StatechartDelayedHostSendState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartDelayedHostSendEvent::TurnDone {
                    ...
                    *current_state = StatechartDelayedHostSendState::TooEarly;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == StatechartDelayedHostSendEvent::Probe {
                    ...
                    *current_state = StatechartDelayedHostSendState::Armed;
                    *transition_taken = true;
                    return true;
                }
                false
