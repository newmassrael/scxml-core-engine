...
//! Generated Rust state machine for `invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_sole`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_sole.scxml:3 :: _machine"]
...
pub enum InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState {
    Done,
...
pub enum InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent {
    ErrorExecution,
    SeedMissing,
    SeedOk,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent] = &[];
}
...
pub struct InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSolePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSolePolicy {
    ...
    /// answer — the session is not initialized yet, `seen` was
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state:
                InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(
            &sid,
            "invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_sole",
            &io_processors,
        ) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'seen' from expr (global)
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::ErrorExecution,
                "<data id='seen'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSolePolicy {
    type State = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState;
    type Event = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done => 1,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::SeedMissing => {
                "seed.missing"
            }
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::SeedOk => "seed.ok",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::ErrorExecution)
            }
            "seed.missing" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::SeedMissing)
            }
            "seed.ok" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::SeedOk),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done => "done",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report => "report",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done),
            "report" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report),
            _ => None,
        }
    }
        ...
        match self.last_transition_source_state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_sole.scxml:9 :: report :: _transition_0
                    ...
                    1 => {
                        // SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_sole.scxml:12 :: report :: _transition_1
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("seed.missing".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSolePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState,
        event: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent,
        current_state: &mut InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done => false,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Report => {
                // W3C SCXML 3.13: Eventless transitions
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleEvent::Null {
                    if self.safe_evaluate_guard("(seen == \"sole\")", engine) {
                        ...
                        *current_state =
                            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvSoleState::Done;
