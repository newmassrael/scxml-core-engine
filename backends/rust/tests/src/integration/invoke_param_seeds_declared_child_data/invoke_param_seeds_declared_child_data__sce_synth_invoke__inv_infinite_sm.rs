...
//! Generated Rust state machine for `invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_infinite`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_infinite.scxml:3 :: _machine"]
...
pub enum InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState {
    Done,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent] = &[];
}
...
pub struct InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfinitePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfinitePolicy {
...
impl StatePolicy for InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfinitePolicy {
    type State = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState;
    type Event = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done => 1,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Report => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedCollapsed => {
                "seed.collapsed"
            }
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedMissing => {
                "seed.missing"
            }
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedOk => "seed.ok",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "seed.collapsed" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedCollapsed)
            }
            "seed.missing" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedMissing)
            }
            "seed.ok" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::SeedOk)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done => "done",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Report => "report",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done),
            "report" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Report)
            }
            _ => None,
        }
    }
                ...
                match self.last_transition_index {
                    ...
                    2 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("seed.collapsed".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfinitePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState,
        event: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent,
        current_state: &mut InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done => false,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Report => {
                // W3C SCXML 3.13: Eventless transitions
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::Null {
                    if self.safe_evaluate_guard(
                        "((_typeof(seen) == \"number\") and (seen > 1e308))",
                        engine,
                    ) {
                        ...
                        *current_state =
                            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done;
                        *transition_taken = true;
                        return true;
                    } else if self.safe_evaluate_guard("(_typeof(seen) == \"string\")", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
