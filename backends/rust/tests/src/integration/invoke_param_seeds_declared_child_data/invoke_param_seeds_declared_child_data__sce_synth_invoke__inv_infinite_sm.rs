    ...
    fn first_enabled_transition(
        ...
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Report => {
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::Null {
                    if self.safe_evaluate_guard(
                        ...
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteEvent::Null {
                    if self.safe_evaluate_guard("(_typeof(seen) == \"string\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvInfiniteState::Done)],
                            transition_index: 1,
