...
//! Generated Rust state machine for `invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_unmatched`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_unmatched.scxml:3 :: _machine"]
...
pub enum InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState {
    Done,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent] = &[];
}
...
pub struct InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedPolicy {
    /// §scxml-5.3: what the `declared` datamodel variable is holding now.
    ///
    /// The live value, not the authored one: `<assign>` writes into the
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `declared` was
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state:
                InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(
            &sid,
            "invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_unmatched",
            &io_processors,
        ) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'declared' from expr (global)
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='declared'> expr failed to evaluate",
            ));
        }
    ...
    fn safe_evaluate_guard(&mut self, cond: &str, engine: &mut Engine<Self>) -> bool {
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent::ErrorExecution, "a <transition> cond failed to evaluate"));
                false
            }
        }
    }
...
impl StatePolicy for InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedPolicy {
    type State = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState;
    type Event = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done => 1,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report => 0,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done => "done",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report => "report",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done),
            "report" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report)
            }
            _ => None,
        }
    }
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState,
        event: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent,
        current_state: &mut InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done => false,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report => {
                // W3C SCXML 3.13: Eventless transitions
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent::Null {
                    if self.safe_evaluate_guard("(_typeof(nowhere) ~= \"undefined\")", engine) {
                        ...
                        *current_state =
                            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done;
                        *transition_taken = true;
                        return true;
                    } else if self.safe_evaluate_guard("(declared == \"carried\")", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
