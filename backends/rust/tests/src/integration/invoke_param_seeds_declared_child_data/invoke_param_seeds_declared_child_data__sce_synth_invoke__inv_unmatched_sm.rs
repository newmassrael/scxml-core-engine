    ...
    fn first_enabled_transition(
        ...
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Report => {
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent::Null {
                    if self.safe_evaluate_guard("(_typeof(nowhere) ~= \"undefined\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done)],
                            transition_index: 0,
                            has_actions: true,
                            is_internal: false,
                        });
                ...
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedEvent::Null {
                    if self.safe_evaluate_guard("(declared == \"carried\")", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvUnmatchedState::Done)],
                            transition_index: 1,
