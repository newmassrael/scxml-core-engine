...
//! Generated Rust state machine for `invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_shadow`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_param_seeds_declared_child_data__sce_synth_invoke__inv_shadow.scxml:3 :: _machine"]
...
pub enum InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState {
    Done,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent] = &[];
}
...
pub struct InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState,
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowPolicy {
...
impl StatePolicy for InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowPolicy {
    type State = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState;
    type Event = InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done => 1,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Report => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedMissing => {
                "seed.missing"
            }
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedOk => "seed.ok",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedShadowed => {
                "seed.shadowed"
            }
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "seed.missing" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedMissing)
            }
            "seed.ok" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedOk)
            }
            "seed.shadowed" => {
                Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::SeedShadowed)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done => "done",
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Report => "report",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done),
            "report" => Some(InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Report),
            _ => None,
        }
    }
                ...
                match self.last_transition_index {
                    ...
                    1 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("seed.shadowed".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState,
        event: InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent,
        current_state: &mut InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done => false,
            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Report => {
                // W3C SCXML 3.13: Eventless transitions
                if event == InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowEvent::Null {
                    if self.safe_evaluate_guard("(seen == \"parent\")", engine) {
                        ...
                        *current_state =
                            InvokeParamSeedsDeclaredChildDataSceSynthInvokeInvShadowState::Done;
                        *transition_taken = true;
                        return true;
                    } else if self.safe_evaluate_guard("(seen == \"child\")", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
