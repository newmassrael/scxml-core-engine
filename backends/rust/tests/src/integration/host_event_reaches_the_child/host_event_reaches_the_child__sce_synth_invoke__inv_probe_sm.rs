...
//! Generated Rust state machine for `host_event_reaches_the_child__sce_synth_invoke__inv_probe`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: host_event_reaches_the_child__sce_synth_invoke__inv_probe.scxml:3 :: _machine"]
...
pub enum HostEventReachesTheChildSceSynthInvokeInvProbeState {
    Forwarded,
    Unforwarded,
...
impl HostEventReachesTheChildSceSynthInvokeInvProbeEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [HostEventReachesTheChildSceSynthInvokeInvProbeEvent] = &[
        HostEventReachesTheChildSceSynthInvokeInvProbeEvent::HostPing,
        HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Marker,
    ];
}
...
pub struct HostEventReachesTheChildSceSynthInvokeInvProbePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: HostEventReachesTheChildSceSynthInvokeInvProbeState,
...
impl HostEventReachesTheChildSceSynthInvokeInvProbePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state:
...
impl Default for HostEventReachesTheChildSceSynthInvokeInvProbePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for HostEventReachesTheChildSceSynthInvokeInvProbePolicy {
    type State = HostEventReachesTheChildSceSynthInvokeInvProbeState;
    type Event = HostEventReachesTheChildSceSynthInvokeInvProbeEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded => true,
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded => 1,
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded => 2,
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Watch => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::HostPing => "hostPing",
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Marker => "marker",
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Ready => "ready",
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::SawHostPing => "sawHostPing",
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::SawMarkerOnly => "sawMarkerOnly",
            HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "hostPing" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeEvent::HostPing),
            "marker" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Marker),
            "ready" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Ready),
            "sawHostPing" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeEvent::SawHostPing),
            "sawMarkerOnly" => {
                Some(HostEventReachesTheChildSceSynthInvokeInvProbeEvent::SawMarkerOnly)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded => "forwarded",
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded => "unforwarded",
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Watch => "watch",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "forwarded" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded),
            "unforwarded" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded),
            "watch" => Some(HostEventReachesTheChildSceSynthInvokeInvProbeState::Watch),
            _ => None,
        }
    }
                ...
                match self.last_transition_index {
                    ...
                    1 => {
...

                        {
                            ...
                            if let Some(ref parent_queue) = self.parent_external_queue {
                                if let Ok(mut q) = parent_queue.lock() {
                                    q.push(("sawMarkerOnly".to_string(), event_data.to_string()));
                                }
                            } else {
                            }
...
impl HostEventReachesTheChildSceSynthInvokeInvProbePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: HostEventReachesTheChildSceSynthInvokeInvProbeState,
        event: HostEventReachesTheChildSceSynthInvokeInvProbeEvent,
        current_state: &mut HostEventReachesTheChildSceSynthInvokeInvProbeState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded => false,
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded => false,
            HostEventReachesTheChildSceSynthInvokeInvProbeState::Watch => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == HostEventReachesTheChildSceSynthInvokeInvProbeEvent::HostPing {
                    ...
                    *current_state = HostEventReachesTheChildSceSynthInvokeInvProbeState::Forwarded;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == HostEventReachesTheChildSceSynthInvokeInvProbeEvent::Marker {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state =
                        HostEventReachesTheChildSceSynthInvokeInvProbeState::Unforwarded;
                    *transition_taken = true;
                    return true;
                }
                false
