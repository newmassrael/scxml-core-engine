...
pub struct HostEventReachesTheChildPolicy {
    ...
    last_transition_source_state: HostEventReachesTheChildState,
...
impl HostEventReachesTheChildPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: HostEventReachesTheChildState::Waiting,
...
impl StatePolicy for HostEventReachesTheChildPolicy {
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            HostEventReachesTheChildState::Phase => HostEventReachesTheChildState::Waiting,
            _ => state,
        }
    }
...
impl HostEventReachesTheChildPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: HostEventReachesTheChildState,
        event: HostEventReachesTheChildEvent,
        current_state: &mut HostEventReachesTheChildState,
        ...
        match check_state {
            ...
            HostEventReachesTheChildState::Fail => false,
            HostEventReachesTheChildState::Pass => false,
            HostEventReachesTheChildState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == HostEventReachesTheChildEvent::SawHostPing {
                    ...
                    *current_state = HostEventReachesTheChildState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == HostEventReachesTheChildEvent::SawMarkerOnly {
                    ...
                    *current_state = HostEventReachesTheChildState::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            HostEventReachesTheChildState::Waiting => {
                ...
                if event == HostEventReachesTheChildEvent::Ready {
                    ...
                    *current_state = HostEventReachesTheChildState::Armed;
                    *transition_taken = true;
                    return true;
                }
                false
