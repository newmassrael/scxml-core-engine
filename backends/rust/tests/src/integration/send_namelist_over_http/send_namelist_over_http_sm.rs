...
// From: integration_resources/send_namelist_over_http/send_namelist_over_http.scxml
//
...
//! Generated Rust state machine for `send_namelist_over_http`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: send_namelist_over_http.scxml:51 :: _machine"]
...
pub enum SendNamelistOverHttpState {
    DiscardPhase,
...
pub enum SendNamelistOverHttpEvent {
    ErrorCommunication,
    ErrorExecution,
    Mapped,
    ShouldNotArrive,
...
impl SendNamelistOverHttpEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [SendNamelistOverHttpEvent] = &[
        SendNamelistOverHttpEvent::Mapped,
        SendNamelistOverHttpEvent::ShouldNotArrive,
...
impl SendNamelistOverHttpPolicy {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `echoed` was
    /// assigned a value of another type, or the engine refused.
    pub fn echoed(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "echoed",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `sawNamelistError` was
    /// assigned a value of another type, or the engine refused.
    pub fn saw_namelist_error(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "sawNamelistError",
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: SendNamelistOverHttpState::MapPhase,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "send_namelist_over_http", &io_processors) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'echoed' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "echoed", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'sawNamelistError' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "sawNamelistError",
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                SendNamelistOverHttpEvent::ErrorExecution,
                "<data id='echoed'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                SendNamelistOverHttpEvent::ErrorExecution,
                "<data id='sawNamelistError'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for SendNamelistOverHttpPolicy {
    type State = SendNamelistOverHttpState;
    type Event = SendNamelistOverHttpEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            SendNamelistOverHttpState::FailMessageNotDiscarded => true,
            SendNamelistOverHttpState::FailNamelistNeverArrived => true,
            SendNamelistOverHttpState::FailNamelistNotPosted => true,
            SendNamelistOverHttpState::FailNoNamelistError => true,
            SendNamelistOverHttpState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SendNamelistOverHttpState::DiscardPhase => 2,
            SendNamelistOverHttpState::FailMessageNotDiscarded => 6,
            SendNamelistOverHttpState::FailNamelistNeverArrived => 4,
            SendNamelistOverHttpState::FailNamelistNotPosted => 5,
            SendNamelistOverHttpState::FailNoNamelistError => 7,
            SendNamelistOverHttpState::MapPhase => 0,
            SendNamelistOverHttpState::MapVerdict => 1,
            SendNamelistOverHttpState::Pass => 3,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            SendNamelistOverHttpEvent::ErrorCommunication => "error.communication",
            SendNamelistOverHttpEvent::ErrorExecution => "error.execution",
            SendNamelistOverHttpEvent::Mapped => "mapped",
            SendNamelistOverHttpEvent::ShouldNotArrive => "shouldNotArrive",
            SendNamelistOverHttpEvent::TimeoutDiscard => "timeoutDiscard",
            SendNamelistOverHttpEvent::TimeoutMap => "timeoutMap",
            SendNamelistOverHttpEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.communication" => Some(SendNamelistOverHttpEvent::ErrorCommunication),
            "error.execution" => Some(SendNamelistOverHttpEvent::ErrorExecution),
            "mapped" => Some(SendNamelistOverHttpEvent::Mapped),
            "shouldNotArrive" => Some(SendNamelistOverHttpEvent::ShouldNotArrive),
            "timeoutDiscard" => Some(SendNamelistOverHttpEvent::TimeoutDiscard),
            "timeoutMap" => Some(SendNamelistOverHttpEvent::TimeoutMap),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            SendNamelistOverHttpState::DiscardPhase => "discardPhase",
            SendNamelistOverHttpState::FailMessageNotDiscarded => "failMessageNotDiscarded",
            SendNamelistOverHttpState::FailNamelistNeverArrived => "failNamelistNeverArrived",
            SendNamelistOverHttpState::FailNamelistNotPosted => "failNamelistNotPosted",
            SendNamelistOverHttpState::FailNoNamelistError => "failNoNamelistError",
            SendNamelistOverHttpState::MapPhase => "mapPhase",
            SendNamelistOverHttpState::MapVerdict => "mapVerdict",
            SendNamelistOverHttpState::Pass => "pass",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "discardPhase" => Some(SendNamelistOverHttpState::DiscardPhase),
            "failMessageNotDiscarded" => Some(SendNamelistOverHttpState::FailMessageNotDiscarded),
            "failNamelistNeverArrived" => Some(SendNamelistOverHttpState::FailNamelistNeverArrived),
            "failNamelistNotPosted" => Some(SendNamelistOverHttpState::FailNamelistNotPosted),
            "failNoNamelistError" => Some(SendNamelistOverHttpState::FailNoNamelistError),
            "mapPhase" => Some(SendNamelistOverHttpState::MapPhase),
            "mapVerdict" => Some(SendNamelistOverHttpState::MapVerdict),
            "pass" => Some(SendNamelistOverHttpState::Pass),
            _ => None,
        }
    }
            ...
            SendNamelistOverHttpState::DiscardPhase => {
                match self.last_transition_index {
                    0 => {
                        ...
                        {
                            // W3C SCXML 5.3: <assign location="sawNamelistError">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            ...
                            let assign_script = format!("{} = {}", "sawNamelistError", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'sawNamelistError': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    SendNamelistOverHttpEvent::ErrorExecution,
                                    "<assign> to 'sawNamelistError' failed",
                                ));
                            }
                        }
                    }
            ...
            SendNamelistOverHttpState::MapPhase => {
                match self.last_transition_index {
                    0 => {
                        ...
                        {
                            // W3C SCXML 5.3: <assign location="echoed">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            let expr = "_event.data.Var1";
                            // W3C SCXML 5.3: Assign via execute_script preserves Lua reference identity for
                            // table values (e.g. `Var2 = _event` — test 329 requires `Var2 == _event`). Going
                            // through evaluate_expression + set_variable would round-trip through ScriptValue
                            // and create a fresh table, breaking reference equality.
                            let assign_script = format!("{} = {}", "echoed", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'echoed': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    SendNamelistOverHttpEvent::ErrorExecution,
                                    "<assign> to 'echoed' failed",
                                ));
                            }
                        }
                    }
...
impl SendNamelistOverHttpPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SendNamelistOverHttpState,
        event: SendNamelistOverHttpEvent,
        current_state: &mut SendNamelistOverHttpState,
        ...
        match check_state {
            SendNamelistOverHttpState::DiscardPhase => {
                ...
                if event == SendNamelistOverHttpEvent::ErrorExecution {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SendNamelistOverHttpEvent::ShouldNotArrive {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = SendNamelistOverHttpState::FailMessageNotDiscarded;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SendNamelistOverHttpEvent::TimeoutDiscard {
                    // W3C SCXML 5.9: Script engine guard
                    if self.safe_evaluate_guard("(sawNamelistError ~= 1)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        *current_state = SendNamelistOverHttpState::FailNoNamelistError;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == SendNamelistOverHttpEvent::TimeoutDiscard {
                    ...
                    *current_state = SendNamelistOverHttpState::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            SendNamelistOverHttpState::FailMessageNotDiscarded => false,
            SendNamelistOverHttpState::FailNamelistNeverArrived => false,
            SendNamelistOverHttpState::FailNamelistNotPosted => false,
            SendNamelistOverHttpState::FailNoNamelistError => false,
            SendNamelistOverHttpState::MapPhase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SendNamelistOverHttpEvent::Mapped {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 0;
                    self.has_transition_actions = true;
                    ...
                    *current_state = SendNamelistOverHttpState::MapVerdict;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SendNamelistOverHttpEvent::TimeoutMap {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_index = 1;
                    self.has_transition_actions = false;
                    ...
                    *current_state = SendNamelistOverHttpState::FailNamelistNeverArrived;
                    *transition_taken = true;
                    return true;
                }
                false
            ...
            SendNamelistOverHttpState::MapVerdict => {
                ...
                if event == SendNamelistOverHttpEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(echoed, 2)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = SendNamelistOverHttpState::DiscardPhase;
                        *transition_taken = true;
                        return true;
                    } else {
                        // W3C SCXML 3.4: Track transition metadata
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = SendNamelistOverHttpState::FailNamelistNotPosted;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            SendNamelistOverHttpState::Pass => false,
            _ => false,
        }
    }
}
