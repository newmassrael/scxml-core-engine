...
//! Generated Rust state machine for `donedata_late_completion`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum DonedataLateCompletionState {
    Fail,
    Pass,
...
impl DonedataLateCompletionEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [DonedataLateCompletionEvent] =
        &[DonedataLateCompletionEvent::Ready];
}
...
pub struct DonedataLateCompletionPolicy {
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_late' (donedata_late_completion__sce_synth_invoke__inv_late)
    child_inv_late: Option<Box<sce_rust_runtime::Engine<super::donedata_late_completion__sce_synth_invoke__inv_late_sm::DonedataLateCompletionSceSynthInvokeInvLatePolicy>>>,
    pending_done_invoke_inv_late: bool,
...
impl DonedataLateCompletionPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: DonedataLateCompletionState::Phase,
            ...
            child_inv_late: None,
            pending_done_invoke_inv_late: false,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_late") {
                ...
                let mut child_policy = super::donedata_late_completion__sce_synth_invoke__inv_late_sm::DonedataLateCompletionSceSynthInvokeInvLatePolicy::new(self.script_engine.clone());
                ...
                self.child_inv_late = Some(Box::new(child_engine));
                ...
                {
                    self.pending_done_invoke_inv_late = true;
    ...
    fn do_tick_children(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        if !self.pending_done_invoke_inv_late {
            ...
            if let Some(mut child) = self.child_inv_late.take() {
                ...
                if child.is_in_final_state() && !self.pending_done_invoke_inv_late {
                    self.pending_done_invoke_inv_late = true;
                    // W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
                ...
                // Put child back
                self.child_inv_late = Some(child);
            }
        }
    }
...
impl StatePolicy for DonedataLateCompletionPolicy {
    type State = DonedataLateCompletionState;
    type Event = DonedataLateCompletionEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            DonedataLateCompletionState::Fail => true,
            DonedataLateCompletionState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DonedataLateCompletionState::Fail => 2,
            DonedataLateCompletionState::Pass => 1,
            DonedataLateCompletionState::Phase => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            DonedataLateCompletionEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            DonedataLateCompletionState::Fail => "fail",
            DonedataLateCompletionState::Pass => "pass",
            DonedataLateCompletionState::Phase => "phase",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(DonedataLateCompletionState::Fail),
            "pass" => Some(DonedataLateCompletionState::Pass),
            "phase" => Some(DonedataLateCompletionState::Phase),
            _ => None,
        }
    }
...
impl DonedataLateCompletionPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DonedataLateCompletionState,
        event: DonedataLateCompletionEvent,
        current_state: &mut DonedataLateCompletionState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DonedataLateCompletionState::Fail => false,
            DonedataLateCompletionState::Pass => false,
            DonedataLateCompletionState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DonedataLateCompletionEvent::Ready {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DonedataLateCompletionEvent::DoneInvokeInvLate {
                    ...
                    if self.safe_evaluate_guard(
                        ...
                        *current_state = DonedataLateCompletionState::Pass;
                        *transition_taken = true;
                        return true;
                    }
                }
                ...
                if event == DonedataLateCompletionEvent::DoneInvokeInvLate {
                    ...
                    *current_state = DonedataLateCompletionState::Fail;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DonedataLateCompletionEvent::ErrorExecution {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
