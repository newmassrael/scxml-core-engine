...
//! Generated Rust state machine for `donedata_late_completion__sce_synth_invoke__inv_late`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: donedata_late_completion__sce_synth_invoke__inv_late.scxml:3 :: _machine"]
...
pub enum DonedataLateCompletionSceSynthInvokeInvLateState {
    Settled,
...
pub enum DonedataLateCompletionSceSynthInvokeInvLateEvent {
    ErrorExecution,
    Finish,
    Ready,
...
impl DonedataLateCompletionSceSynthInvokeInvLateEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [DonedataLateCompletionSceSynthInvokeInvLateEvent] =
        &[DonedataLateCompletionSceSynthInvokeInvLateEvent::Finish];
}
...
pub struct DonedataLateCompletionSceSynthInvokeInvLatePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: DonedataLateCompletionSceSynthInvokeInvLateState,
...
impl DonedataLateCompletionSceSynthInvokeInvLatePolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: DonedataLateCompletionSceSynthInvokeInvLateState::Waiting,
        ...
        match se.evaluate_expression(&sid, cond) {
            ...
            Err(e) => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                    DonedataLateCompletionSceSynthInvokeInvLateEvent::ErrorExecution,
...
impl StatePolicy for DonedataLateCompletionSceSynthInvokeInvLatePolicy {
    type State = DonedataLateCompletionSceSynthInvokeInvLateState;
    type Event = DonedataLateCompletionSceSynthInvokeInvLateEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            DonedataLateCompletionSceSynthInvokeInvLateState::Settled => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DonedataLateCompletionSceSynthInvokeInvLateState::Settled => 1,
            DonedataLateCompletionSceSynthInvokeInvLateState::Waiting => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            DonedataLateCompletionSceSynthInvokeInvLateEvent::ErrorExecution => "error.execution",
            DonedataLateCompletionSceSynthInvokeInvLateEvent::Finish => "finish",
            DonedataLateCompletionSceSynthInvokeInvLateEvent::Ready => "ready",
            DonedataLateCompletionSceSynthInvokeInvLateEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => {
                Some(DonedataLateCompletionSceSynthInvokeInvLateEvent::ErrorExecution)
            }
            "finish" => Some(DonedataLateCompletionSceSynthInvokeInvLateEvent::Finish),
            "ready" => Some(DonedataLateCompletionSceSynthInvokeInvLateEvent::Ready),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            DonedataLateCompletionSceSynthInvokeInvLateState::Settled => "settled",
            DonedataLateCompletionSceSynthInvokeInvLateState::Waiting => "waiting",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "settled" => Some(DonedataLateCompletionSceSynthInvokeInvLateState::Settled),
            "waiting" => Some(DonedataLateCompletionSceSynthInvokeInvLateState::Waiting),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        let _ = path_child;
        match state {
            DonedataLateCompletionSceSynthInvokeInvLateState::Settled => {
                ...
                let mut done_data_ok = true;
                {
                    ...
                    match se.evaluate_expression(&sid, "42") {
                        ...
                        Err(e) => {
                            ...
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                DonedataLateCompletionSceSynthInvokeInvLateEvent::ErrorExecution,
                                "<donedata> <param name='result'> failed to evaluate",
                            ));
                        }
                    }
                    if done_data_ok {
...
impl DonedataLateCompletionSceSynthInvokeInvLatePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DonedataLateCompletionSceSynthInvokeInvLateState,
        event: DonedataLateCompletionSceSynthInvokeInvLateEvent,
        current_state: &mut DonedataLateCompletionSceSynthInvokeInvLateState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DonedataLateCompletionSceSynthInvokeInvLateState::Settled => false,
            DonedataLateCompletionSceSynthInvokeInvLateState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DonedataLateCompletionSceSynthInvokeInvLateEvent::Finish {
                    ...
                    *current_state = DonedataLateCompletionSceSynthInvokeInvLateState::Settled;
