...
//! Generated Rust state machine for `event_type_names_its_queue`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: event_type_names_its_queue.scxml:29 :: _machine"]
...
pub enum EventTypeNamesItsQueueState {
    Done,
...
pub enum EventTypeNamesItsQueueEvent {
    ErrorExecution,
    Ext,
    Int,
    ViaInternalSend,
...
impl EventTypeNamesItsQueueEvent {
...
pub struct EventTypeNamesItsQueuePolicy {
...
impl EventTypeNamesItsQueuePolicy {
    ...
    /// answer — the session is not initialized yet, `intCode` was
    /// assigned a value of another type, or the engine refused.
    pub fn int_code(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `sendCode` was
    /// assigned a value of another type, or the engine refused.
    pub fn send_code(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "sendCode",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `extCode` was
    /// assigned a value of another type, or the engine refused.
    pub fn ext_code(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "extCode",
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "event_type_names_its_queue", &io_processors)
        {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'intCode' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'sendCode' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "sendCode", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'extCode' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "extCode", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='intCode'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                EventTypeNamesItsQueueEvent::ErrorExecution,
                "<data id='sendCode'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                EventTypeNamesItsQueueEvent::ErrorExecution,
                "<data id='extCode'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for EventTypeNamesItsQueuePolicy {
    type State = EventTypeNamesItsQueueState;
    type Event = EventTypeNamesItsQueueEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            EventTypeNamesItsQueueState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            EventTypeNamesItsQueueState::Done => 1,
            EventTypeNamesItsQueueState::S0 => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            EventTypeNamesItsQueueEvent::ErrorExecution => "error.execution",
            EventTypeNamesItsQueueEvent::Ext => "ext",
            EventTypeNamesItsQueueEvent::Int => "int",
            EventTypeNamesItsQueueEvent::ViaInternalSend => "viaInternalSend",
            EventTypeNamesItsQueueEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(EventTypeNamesItsQueueEvent::ErrorExecution),
            "ext" => Some(EventTypeNamesItsQueueEvent::Ext),
            "int" => Some(EventTypeNamesItsQueueEvent::Int),
            "viaInternalSend" => Some(EventTypeNamesItsQueueEvent::ViaInternalSend),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            EventTypeNamesItsQueueState::Done => "done",
            EventTypeNamesItsQueueState::S0 => "s0",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(EventTypeNamesItsQueueState::Done),
            "s0" => Some(EventTypeNamesItsQueueState::S0),
            _ => None,
        }
    }
        ...
        match state {
            EventTypeNamesItsQueueState::S0 => {
                ...
                'action_block: {
                    ...
                    // W3C SCXML 3.8.1: <raise event="int">
                    engine.raise(sce_rust_runtime::EventWithMetadata::new(
                        EventTypeNamesItsQueueEvent::Int,
                    ));

                    {
                        ...
                        let event_data_string: String = {
                            ...
                            match se.evaluate_expression(&sid, "1") {
                                Ok(val) => {
                                    wire_params.entry("a".to_string()).or_default().push(val);
                                }
                                Err(e) => {
                                    ::sce_rust_runtime::sce_log_error!(
                                        "send param 'a' eval failed: {}",
                                        e
                                    );
                                    engine.raise(
                                        sce_rust_runtime::EventWithMetadata::platform_error(
                                            EventTypeNamesItsQueueEvent::ErrorExecution,
                                            "<send> <param name='a'> expr failed to evaluate",
                                        ),
                                    );
                                }
                            }
    ...
    fn first_enabled_transition(
        ...
        match state {
            EventTypeNamesItsQueueState::S0 => {
                if event == EventTypeNamesItsQueueEvent::Int {
                    {
                ...
                if event == EventTypeNamesItsQueueEvent::ViaInternalSend {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[],
                ...
                if event == EventTypeNamesItsQueueEvent::Ext {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EventTypeNamesItsQueueState::Done,
                            )],
                            transition_index: 2,
                            has_actions: true,
                            is_internal: false,
