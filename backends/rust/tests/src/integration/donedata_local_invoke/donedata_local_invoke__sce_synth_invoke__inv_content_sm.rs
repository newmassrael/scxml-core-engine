...
//! Generated Rust state machine for `donedata_local_invoke__sce_synth_invoke__inv_content`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum DonedataLocalInvokeSceSynthInvokeInvContentState {
...
pub enum DonedataLocalInvokeSceSynthInvokeInvContentEvent {
    ErrorExecution,
...
impl DonedataLocalInvokeSceSynthInvokeInvContentEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [DonedataLocalInvokeSceSynthInvokeInvContentEvent] = &[];
}
...
pub struct DonedataLocalInvokeSceSynthInvokeInvContentPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: DonedataLocalInvokeSceSynthInvokeInvContentState,
...
impl StatePolicy for DonedataLocalInvokeSceSynthInvokeInvContentPolicy {
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvContentState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvContentState::Done => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            DonedataLocalInvokeSceSynthInvokeInvContentEvent::ErrorExecution => "error.execution",
            DonedataLocalInvokeSceSynthInvokeInvContentEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            DonedataLocalInvokeSceSynthInvokeInvContentState::Done => "done",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(DonedataLocalInvokeSceSynthInvokeInvContentState::Done),
            _ => None,
        }
    }
...
impl DonedataLocalInvokeSceSynthInvokeInvContentPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DonedataLocalInvokeSceSynthInvokeInvContentState,
        event: DonedataLocalInvokeSceSynthInvokeInvContentEvent,
        current_state: &mut DonedataLocalInvokeSceSynthInvokeInvContentState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DonedataLocalInvokeSceSynthInvokeInvContentState::Done => false,
            _ => false,
        }
    }
}
