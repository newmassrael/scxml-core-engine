...
#![doc = "SCE-MAP: donedata_local_invoke__sce_synth_invoke__inv_param.scxml:3 :: _machine"]
...
impl DonedataLocalInvokeSceSynthInvokeInvParamEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [DonedataLocalInvokeSceSynthInvokeInvParamEvent] = &[];
}
...
impl StatePolicy for DonedataLocalInvokeSceSynthInvokeInvParamPolicy {
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(DonedataLocalInvokeSceSynthInvokeInvParamState::Done),
            _ => None,
        }
    }
