...
impl ParallelCompletionRaisesDoneStatePolicy {
    ...
    fn activate(&mut self, state: ParallelCompletionRaisesDoneStateState) -> bool {
    ...
    fn deactivate(&mut self, state: ParallelCompletionRaisesDoneStateState) {
...
impl StatePolicy for ParallelCompletionRaisesDoneStatePolicy {
    ...
    fn get_initial_targets(
        ...
        match state {
            ParallelCompletionRaisesDoneStateState::A => &[::sce_rust_runtime::EntryTarget::State(
                ParallelCompletionRaisesDoneStateState::A1,
            )],
            ParallelCompletionRaisesDoneStateState::B => &[::sce_rust_runtime::EntryTarget::State(
                ParallelCompletionRaisesDoneStateState::B1,
            )],
            _ => &[],
        }
                ...
                if event == ParallelCompletionRaisesDoneStateEvent::Bail {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                ParallelCompletionRaisesDoneStateState::Stopped,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
