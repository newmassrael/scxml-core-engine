...
//! Generated Rust state machine for `parallel_completion_raises_done_state`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: parallel_completion_raises_done_state.scxml:21 :: _machine"]
...
pub enum ParallelCompletionRaisesDoneStateState {
    A,
    A1,
    A2,
    B,
...
pub enum ParallelCompletionRaisesDoneStateEvent {
    Bail,
    DoneStateA,
    DoneStateB,
    DoneStateRun,
...
impl ParallelCompletionRaisesDoneStateEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ParallelCompletionRaisesDoneStateEvent] = &[
        ParallelCompletionRaisesDoneStateEvent::Bail,
        ParallelCompletionRaisesDoneStateEvent::Go,
    ];
}
...
pub struct ParallelCompletionRaisesDoneStatePolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: ParallelCompletionRaisesDoneStateState,
    ...
    active_states:
        ::sce_rust_runtime::helpers::hierarchy::StateChain<ParallelCompletionRaisesDoneStateState>,
...
impl ParallelCompletionRaisesDoneStatePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: ParallelCompletionRaisesDoneStateState::A1,
...
impl Default for ParallelCompletionRaisesDoneStatePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for ParallelCompletionRaisesDoneStatePolicy {
    type State = ParallelCompletionRaisesDoneStateState;
    type Event = ParallelCompletionRaisesDoneStateEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            ParallelCompletionRaisesDoneStateState::A2 => true,
            ParallelCompletionRaisesDoneStateState::B2 => true,
            ParallelCompletionRaisesDoneStateState::Stopped => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            ParallelCompletionRaisesDoneStateState::A => {
                Some(ParallelCompletionRaisesDoneStateState::Run)
            }
            ParallelCompletionRaisesDoneStateState::A1 => {
                Some(ParallelCompletionRaisesDoneStateState::A)
            }
            ParallelCompletionRaisesDoneStateState::A2 => {
                Some(ParallelCompletionRaisesDoneStateState::A)
            }
            ParallelCompletionRaisesDoneStateState::B => {
                Some(ParallelCompletionRaisesDoneStateState::Run)
            }
            ParallelCompletionRaisesDoneStateState::B1 => {
                Some(ParallelCompletionRaisesDoneStateState::B)
            }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            ParallelCompletionRaisesDoneStateState::A => true,
            ParallelCompletionRaisesDoneStateState::B => true,
            _ => false,
        }
    }
    ...
    fn is_parallel_state(state: Self::State) -> bool {
        match state {
            ParallelCompletionRaisesDoneStateState::Run => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ParallelCompletionRaisesDoneStateState::A => 1,
            ParallelCompletionRaisesDoneStateState::A1 => 2,
            ParallelCompletionRaisesDoneStateState::A2 => 3,
            ParallelCompletionRaisesDoneStateState::B => 4,
            ParallelCompletionRaisesDoneStateState::B1 => 5,
            ParallelCompletionRaisesDoneStateState::B2 => 6,
            ParallelCompletionRaisesDoneStateState::Run => 0,
            ParallelCompletionRaisesDoneStateState::Stopped => 7,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ParallelCompletionRaisesDoneStateEvent::Bail => "bail",
            ParallelCompletionRaisesDoneStateEvent::DoneStateA => "done.state.a",
            ParallelCompletionRaisesDoneStateEvent::DoneStateB => "done.state.b",
            ParallelCompletionRaisesDoneStateEvent::DoneStateRun => "done.state.run",
            ParallelCompletionRaisesDoneStateEvent::Go => "go",
            ParallelCompletionRaisesDoneStateEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "bail" => Some(ParallelCompletionRaisesDoneStateEvent::Bail),
            "done.state.a" => Some(ParallelCompletionRaisesDoneStateEvent::DoneStateA),
            "done.state.b" => Some(ParallelCompletionRaisesDoneStateEvent::DoneStateB),
            "done.state.run" => Some(ParallelCompletionRaisesDoneStateEvent::DoneStateRun),
            "go" => Some(ParallelCompletionRaisesDoneStateEvent::Go),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            ParallelCompletionRaisesDoneStateState::A => "a",
            ParallelCompletionRaisesDoneStateState::A1 => "a1",
            ParallelCompletionRaisesDoneStateState::A2 => "a2",
            ParallelCompletionRaisesDoneStateState::B => "b",
            ParallelCompletionRaisesDoneStateState::B1 => "b1",
            ParallelCompletionRaisesDoneStateState::B2 => "b2",
            ParallelCompletionRaisesDoneStateState::Run => "run",
            ParallelCompletionRaisesDoneStateState::Stopped => "stopped",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "a" => Some(ParallelCompletionRaisesDoneStateState::A),
            "a1" => Some(ParallelCompletionRaisesDoneStateState::A1),
            "a2" => Some(ParallelCompletionRaisesDoneStateState::A2),
            "b" => Some(ParallelCompletionRaisesDoneStateState::B),
            "b1" => Some(ParallelCompletionRaisesDoneStateState::B1),
            "b2" => Some(ParallelCompletionRaisesDoneStateState::B2),
            "run" => Some(ParallelCompletionRaisesDoneStateState::Run),
            "stopped" => Some(ParallelCompletionRaisesDoneStateState::Stopped),
            _ => None,
        }
    }
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            ParallelCompletionRaisesDoneStateState::A => ParallelCompletionRaisesDoneStateState::A1,
            ParallelCompletionRaisesDoneStateState::B => ParallelCompletionRaisesDoneStateState::B1,
            _ => state,
        }
    }
        ...
        match state {
            ParallelCompletionRaisesDoneStateState::A2 => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(
                    ParallelCompletionRaisesDoneStateEvent::DoneStateA,
                ));
                // W3C SCXML 3.4: Check if parallel grandparent run has all regions complete
                {
                    let parallel_state = ParallelCompletionRaisesDoneStateState::Run;
                    ...
                    if all_complete {
                        engine.raise(sce_rust_runtime::EventWithMetadata::new(
                            ParallelCompletionRaisesDoneStateEvent::DoneStateRun,
                        ));
                    }
                }
            }
            ParallelCompletionRaisesDoneStateState::B2 => {
                ...
                engine.raise(sce_rust_runtime::EventWithMetadata::new(
                    ParallelCompletionRaisesDoneStateEvent::DoneStateB,
                ));
                // W3C SCXML 3.4: Check if parallel grandparent run has all regions complete
                {
                    let parallel_state = ParallelCompletionRaisesDoneStateState::Run;
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(
                ParallelCompletionRaisesDoneStateState,
                usize,
...
impl ParallelCompletionRaisesDoneStatePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ParallelCompletionRaisesDoneStateState,
        event: ParallelCompletionRaisesDoneStateEvent,
        current_state: &mut ParallelCompletionRaisesDoneStateState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
        mut collect_mode: Option<&mut TransitionList>,
    ) -> bool {
        match check_state {
            ParallelCompletionRaisesDoneStateState::A => false,
            ParallelCompletionRaisesDoneStateState::A1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelCompletionRaisesDoneStateEvent::Go {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelCompletionRaisesDoneStateState::A2,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelCompletionRaisesDoneStateState::A2;
            ...
            ParallelCompletionRaisesDoneStateState::A2 => false,
            ParallelCompletionRaisesDoneStateState::B => false,
            ParallelCompletionRaisesDoneStateState::B1 => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelCompletionRaisesDoneStateEvent::Go {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelCompletionRaisesDoneStateState::B2,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelCompletionRaisesDoneStateState::B2;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            ParallelCompletionRaisesDoneStateState::B2 => false,
            ParallelCompletionRaisesDoneStateState::Run => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ParallelCompletionRaisesDoneStateEvent::Bail {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: ParallelCompletionRaisesDoneStateState::Stopped,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = ParallelCompletionRaisesDoneStateState::Stopped;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            ParallelCompletionRaisesDoneStateState::Stopped => false,
            _ => false,
        }
    }
    ...
    fn execute_microstep(
        ...
        for trans in transitions {
            ...
            let domain: Option<ParallelCompletionRaisesDoneStateState> =
