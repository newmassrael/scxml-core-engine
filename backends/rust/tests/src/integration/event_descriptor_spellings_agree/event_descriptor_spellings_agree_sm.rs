                ...
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            ...
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EventDescriptorSpellingsAgreeState::FailBounded,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == EventDescriptorSpellingsAgreeEvent::Dot {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EventDescriptorSpellingsAgreeState::FailDotted,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == EventDescriptorSpellingsAgreeEvent::Wild {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EventDescriptorSpellingsAgreeState::FailSuffixed,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == EventDescriptorSpellingsAgreeEvent::AnyTokenSequence {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                EventDescriptorSpellingsAgreeState::FailUniversal,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
