...
//! Generated Rust state machine for `late_tick_honours_cancel`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: late_tick_honours_cancel.scxml:39 :: _machine"]
...
pub enum LateTickHonoursCancelState {
    Active,
    CancelLost,
    Pass,
...
pub enum LateTickHonoursCancelEvent {
    ErrorExecution,
    Finish,
    Poke,
    Settle,
...
impl LateTickHonoursCancelEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [LateTickHonoursCancelEvent] = &[
...
impl LateTickHonoursCancelPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: LateTickHonoursCancelState::Waiting,
            session_id: None,
...
impl Default for LateTickHonoursCancelPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for LateTickHonoursCancelPolicy {
    type State = LateTickHonoursCancelState;
    type Event = LateTickHonoursCancelEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            LateTickHonoursCancelState::CancelLost => true,
            LateTickHonoursCancelState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            LateTickHonoursCancelState::Active => 1,
            LateTickHonoursCancelState::CancelLost => 3,
            LateTickHonoursCancelState::Pass => 2,
            LateTickHonoursCancelState::Waiting => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            LateTickHonoursCancelEvent::ErrorExecution => "error.execution",
            LateTickHonoursCancelEvent::Finish => "finish",
            LateTickHonoursCancelEvent::Poke => "poke",
            LateTickHonoursCancelEvent::Settle => "settle",
            LateTickHonoursCancelEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(LateTickHonoursCancelEvent::ErrorExecution),
            "finish" => Some(LateTickHonoursCancelEvent::Finish),
            "poke" => Some(LateTickHonoursCancelEvent::Poke),
            "settle" => Some(LateTickHonoursCancelEvent::Settle),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            LateTickHonoursCancelState::Active => "active",
            LateTickHonoursCancelState::CancelLost => "cancelLost",
            LateTickHonoursCancelState::Pass => "pass",
            LateTickHonoursCancelState::Waiting => "waiting",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "active" => Some(LateTickHonoursCancelState::Active),
            "cancelLost" => Some(LateTickHonoursCancelState::CancelLost),
            "pass" => Some(LateTickHonoursCancelState::Pass),
            "waiting" => Some(LateTickHonoursCancelState::Waiting),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            LateTickHonoursCancelState::Active => {
                ...
                'action_block: {
                    // W3C SCXML 6.3: <cancel sendid="s1">
                    engine.cancel_event("s1");
            ...
            LateTickHonoursCancelState::Waiting => {
                ...
                'action_block: {
                    {
                        let send_id = ::sce_rust_runtime::sce_string_from_str("s1");
...
impl LateTickHonoursCancelPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: LateTickHonoursCancelState,
        event: LateTickHonoursCancelEvent,
        current_state: &mut LateTickHonoursCancelState,
        ...
        match check_state {
            LateTickHonoursCancelState::Active => {
                ...
                if event == LateTickHonoursCancelEvent::Settle {
                    ...
                    *current_state = LateTickHonoursCancelState::CancelLost;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == LateTickHonoursCancelEvent::Finish {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = LateTickHonoursCancelState::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
            }
            LateTickHonoursCancelState::CancelLost => false,
            LateTickHonoursCancelState::Pass => false,
            LateTickHonoursCancelState::Waiting => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == LateTickHonoursCancelEvent::Poke {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = LateTickHonoursCancelState::Active;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
