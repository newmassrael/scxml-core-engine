...
//! Generated Rust state machine for `autoforward_done_invoke__sce_synth_invoke__inv_short`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: autoforward_done_invoke__sce_synth_invoke__inv_short.scxml:3 :: _machine"]
...
pub enum AutoforwardDoneInvokeSceSynthInvokeInvShortState {
...
pub enum AutoforwardDoneInvokeSceSynthInvokeInvShortEvent {
...
impl AutoforwardDoneInvokeSceSynthInvokeInvShortEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [AutoforwardDoneInvokeSceSynthInvokeInvShortEvent] = &[];
}
...
pub struct AutoforwardDoneInvokeSceSynthInvokeInvShortPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: AutoforwardDoneInvokeSceSynthInvokeInvShortState,
...
impl AutoforwardDoneInvokeSceSynthInvokeInvShortPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over,
            session_id: None,
...
impl Default for AutoforwardDoneInvokeSceSynthInvokeInvShortPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for AutoforwardDoneInvokeSceSynthInvokeInvShortPolicy {
    type State = AutoforwardDoneInvokeSceSynthInvokeInvShortState;
    type Event = AutoforwardDoneInvokeSceSynthInvokeInvShortEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            AutoforwardDoneInvokeSceSynthInvokeInvShortEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over => "over",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "over" => Some(AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over),
            _ => None,
        }
    }
...
impl AutoforwardDoneInvokeSceSynthInvokeInvShortPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardDoneInvokeSceSynthInvokeInvShortState,
        event: AutoforwardDoneInvokeSceSynthInvokeInvShortEvent,
        current_state: &mut AutoforwardDoneInvokeSceSynthInvokeInvShortState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            AutoforwardDoneInvokeSceSynthInvokeInvShortState::Over => false,
            _ => false,
        }
    }
}
