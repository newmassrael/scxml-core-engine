...
//! Generated Rust state machine for `autoforward_done_invoke__sce_synth_invoke__inv_watch`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
pub enum AutoforwardDoneInvokeSceSynthInvokeInvWatchState {
    Missed,
    Saw,
...
impl AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent] =
        &[AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::Probe];
}
...
pub struct AutoforwardDoneInvokeSceSynthInvokeInvWatchPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: AutoforwardDoneInvokeSceSynthInvokeInvWatchState,
...
impl AutoforwardDoneInvokeSceSynthInvokeInvWatchPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Watch,
...
impl Default for AutoforwardDoneInvokeSceSynthInvokeInvWatchPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for AutoforwardDoneInvokeSceSynthInvokeInvWatchPolicy {
    type State = AutoforwardDoneInvokeSceSynthInvokeInvWatchState;
    type Event = AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed => true,
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed => 2,
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw => 1,
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Watch => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::SawProbeOnly => "sawProbeOnly",
            AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "probe" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::Probe),
            "sawPlatform" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::SawPlatform),
            "sawProbeOnly" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::SawProbeOnly),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed => "missed",
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw => "saw",
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Watch => "watch",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "missed" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed),
            "saw" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw),
            "watch" => Some(AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Watch),
            _ => None,
        }
    }
...
impl AutoforwardDoneInvokeSceSynthInvokeInvWatchPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardDoneInvokeSceSynthInvokeInvWatchState,
        event: AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent,
        current_state: &mut AutoforwardDoneInvokeSceSynthInvokeInvWatchState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed => false,
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw => false,
            AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Watch => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::DoneInvokeInvShort {
                    ...
                    *current_state = AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Saw;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardDoneInvokeSceSynthInvokeInvWatchEvent::Probe {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = AutoforwardDoneInvokeSceSynthInvokeInvWatchState::Missed;
                    *transition_taken = true;
                    return true;
                }
                false
