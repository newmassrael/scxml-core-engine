...
//! Generated Rust state machine for `invoke_expression_failure_is_reported_hybrid0`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_expression_failure_is_reported_hybrid0.scxml:2 :: _machine"]
...
pub enum InvokeExpressionFailureIsReportedHybrid0State {
...
pub enum InvokeExpressionFailureIsReportedHybrid0Event {
...
impl InvokeExpressionFailureIsReportedHybrid0Event {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [InvokeExpressionFailureIsReportedHybrid0Event] = &[];
}
...
pub struct InvokeExpressionFailureIsReportedHybrid0Policy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeExpressionFailureIsReportedHybrid0State,
...
impl InvokeExpressionFailureIsReportedHybrid0Policy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: InvokeExpressionFailureIsReportedHybrid0State::Final,
            session_id: None,
...
impl Default for InvokeExpressionFailureIsReportedHybrid0Policy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for InvokeExpressionFailureIsReportedHybrid0Policy {
    type State = InvokeExpressionFailureIsReportedHybrid0State;
    type Event = InvokeExpressionFailureIsReportedHybrid0Event;
    ...
    fn initial_state() -> Self::State {
        ...
        InvokeExpressionFailureIsReportedHybrid0State::Final
    }

    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeExpressionFailureIsReportedHybrid0State::Final => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeExpressionFailureIsReportedHybrid0State::Final => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            InvokeExpressionFailureIsReportedHybrid0Event::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeExpressionFailureIsReportedHybrid0State::Final => "final",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "final" => Some(InvokeExpressionFailureIsReportedHybrid0State::Final),
            _ => None,
        }
    }
...
impl InvokeExpressionFailureIsReportedHybrid0Policy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeExpressionFailureIsReportedHybrid0State,
        event: InvokeExpressionFailureIsReportedHybrid0Event,
        current_state: &mut InvokeExpressionFailureIsReportedHybrid0State,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeExpressionFailureIsReportedHybrid0State::Final => false,
            _ => false,
        }
    }
}
