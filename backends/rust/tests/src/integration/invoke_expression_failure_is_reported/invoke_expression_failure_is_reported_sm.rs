...
//! Generated Rust state machine for `invoke_expression_failure_is_reported`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: invoke_expression_failure_is_reported.scxml:38 :: _machine"]
...
pub enum InvokeExpressionFailureIsReportedState {
    Fail,
    Pass,
...
pub enum InvokeExpressionFailureIsReportedEvent {
    DoneInvoke,
    ErrorExecution,
...
impl InvokeExpressionFailureIsReportedEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [InvokeExpressionFailureIsReportedEvent] = &[];
}
...
pub struct InvokeExpressionFailureIsReportedPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: InvokeExpressionFailureIsReportedState,
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<InvokeExpressionFailureIsReportedState>>,
    ...
    // W3C SCXML 6.4: Hybrid invoke child '_invoke_0' (invoke_expression_failure_is_reported_hybrid0)
    child_invoke_0: Option<Box<sce_rust_runtime::Engine<super::invoke_expression_failure_is_reported_hybrid0_sm::InvokeExpressionFailureIsReportedHybrid0Policy>>>,
...
impl InvokeExpressionFailureIsReportedPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: InvokeExpressionFailureIsReportedState::Probe,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'target' from expr (global)
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                InvokeExpressionFailureIsReportedEvent::ErrorExecution,
                "<data id='target'> expr failed to evaluate",
            ));
        }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains("._invoke_0") {
                ...
                let se = self.script_engine.clone();
                let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                match se.evaluate_expression(&sid, "target.path") {
                    Ok(sce_rust_runtime::ScriptValue::Null) | Err(_) => {
                        ...
                        engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                            InvokeExpressionFailureIsReportedEvent::ErrorExecution,
                            "<invoke srcexpr='target.path'> could not be evaluated",
                        ));
                        continue;
                    }
                    Ok(_path) => {
                ...
                let mut child_policy = super::invoke_expression_failure_is_reported_hybrid0_sm::InvokeExpressionFailureIsReportedHybrid0Policy::new();
...
impl StatePolicy for InvokeExpressionFailureIsReportedPolicy {
    type State = InvokeExpressionFailureIsReportedState;
    type Event = InvokeExpressionFailureIsReportedEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            InvokeExpressionFailureIsReportedState::Fail => true,
            InvokeExpressionFailureIsReportedState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            InvokeExpressionFailureIsReportedState::Fail => 2,
            InvokeExpressionFailureIsReportedState::Pass => 1,
            InvokeExpressionFailureIsReportedState::Probe => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            InvokeExpressionFailureIsReportedEvent::DoneInvoke => "done.invoke",
            InvokeExpressionFailureIsReportedEvent::ErrorExecution => "error.execution",
            InvokeExpressionFailureIsReportedEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "done.invoke" => Some(InvokeExpressionFailureIsReportedEvent::DoneInvoke),
            "error.execution" => Some(InvokeExpressionFailureIsReportedEvent::ErrorExecution),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            InvokeExpressionFailureIsReportedState::Fail => "fail",
            InvokeExpressionFailureIsReportedState::Pass => "pass",
            InvokeExpressionFailureIsReportedState::Probe => "probe",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(InvokeExpressionFailureIsReportedState::Fail),
            "pass" => Some(InvokeExpressionFailureIsReportedState::Pass),
            "probe" => Some(InvokeExpressionFailureIsReportedState::Probe),
            _ => None,
        }
    }
...
impl InvokeExpressionFailureIsReportedPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: InvokeExpressionFailureIsReportedState,
        event: InvokeExpressionFailureIsReportedEvent,
        current_state: &mut InvokeExpressionFailureIsReportedState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            InvokeExpressionFailureIsReportedState::Fail => false,
            InvokeExpressionFailureIsReportedState::Pass => false,
            InvokeExpressionFailureIsReportedState::Probe => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokeExpressionFailureIsReportedEvent::ErrorExecution {
                    ...
                    *current_state = InvokeExpressionFailureIsReportedState::Pass;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == InvokeExpressionFailureIsReportedEvent::DoneInvoke {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    self.last_transition_is_internal = false;
                    self.last_transition_is_targetless = false;

                    *current_state = InvokeExpressionFailureIsReportedState::Fail;
                    *transition_taken = true;
                    return true;
                }
                false
