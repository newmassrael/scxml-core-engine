...
//! Generated Rust state machine for `onexit_runs_before_the_state_leaves`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: onexit_runs_before_the_state_leaves.scxml:33 :: _machine"]
...
pub enum OnexitRunsBeforeTheStateLeavesState {
    Check,
    FailChildInOuter,
    FailExits,
    FailParentInInner,
...
pub enum OnexitRunsBeforeTheStateLeavesEvent {
    ErrorExecution,
    Leave,
...
impl OnexitRunsBeforeTheStateLeavesEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [OnexitRunsBeforeTheStateLeavesEvent] =
        &[OnexitRunsBeforeTheStateLeavesEvent::Leave];
}
...
pub struct OnexitRunsBeforeTheStateLeavesPolicy {
    ...
    active_states:
        ::sce_rust_runtime::helpers::hierarchy::StateChain<OnexitRunsBeforeTheStateLeavesState>,
...
impl OnexitRunsBeforeTheStateLeavesPolicy {
    ...
    /// answer — the session is not initialized yet, `selfInInner` was
    /// assigned a value of another type, or the engine refused.
    pub fn self_in_inner(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `parentInInner` was
    /// assigned a value of another type, or the engine refused.
    pub fn parent_in_inner(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "parentInInner",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `selfInOuter` was
    /// assigned a value of another type, or the engine refused.
    pub fn self_in_outer(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "selfInOuter",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `childInOuter` was
    /// assigned a value of another type, or the engine refused.
    pub fn child_in_outer(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "childInOuter",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `exits` was
    /// assigned a value of another type, or the engine refused.
    pub fn exits(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "exits",
    ...
    fn activate(&mut self, state: OnexitRunsBeforeTheStateLeavesState) -> bool {
    ...
    fn deactivate(&mut self, state: OnexitRunsBeforeTheStateLeavesState) {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "onexit_runs_before_the_state_leaves", &io_processors)
        {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'selfInInner' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'parentInInner' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "parentInInner",
        ...
        // W3C SCXML 5.2/5.3: Initialize 'selfInOuter' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "selfInOuter",
        ...
        // W3C SCXML 5.2/5.3: Initialize 'childInOuter' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se,
            &sid,
            "childInOuter",
        ...
        // W3C SCXML 5.2/5.3: Initialize 'exits' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "exits", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='selfInInner'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                "<data id='parentInInner'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                "<data id='selfInOuter'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                "<data id='childInOuter'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                "<data id='exits'> expr failed to evaluate",
            ));
        }
    ...
    fn state_name_matches(state: OnexitRunsBeforeTheStateLeavesState, name: &str) -> bool {
...
impl StatePolicy for OnexitRunsBeforeTheStateLeavesPolicy {
    type State = OnexitRunsBeforeTheStateLeavesState;
    type Event = OnexitRunsBeforeTheStateLeavesEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            OnexitRunsBeforeTheStateLeavesState::FailChildInOuter => true,
            OnexitRunsBeforeTheStateLeavesState::FailExits => true,
            OnexitRunsBeforeTheStateLeavesState::FailParentInInner => true,
            OnexitRunsBeforeTheStateLeavesState::FailSelfInInner => true,
            OnexitRunsBeforeTheStateLeavesState::FailSelfInOuter => true,
            OnexitRunsBeforeTheStateLeavesState::Settled => true,
            _ => false,
        }
    }
    ...
    fn get_parent(state: Self::State) -> Option<Self::State> {
        match state {
            OnexitRunsBeforeTheStateLeavesState::Inner => {
                Some(OnexitRunsBeforeTheStateLeavesState::Outer)
            }
            _ => None,
        }
    }
    ...
    fn is_compound_state(state: Self::State) -> bool {
        match state {
            OnexitRunsBeforeTheStateLeavesState::Outer => true,
            _ => false,
        }
    }
    ...
    fn get_child_states(state: Self::State) -> &'static [Self::State] {
        match state {
            OnexitRunsBeforeTheStateLeavesState::Outer => {
                &[OnexitRunsBeforeTheStateLeavesState::Inner]
            }
            _ => &[],
        }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            OnexitRunsBeforeTheStateLeavesState::Check => 2,
            OnexitRunsBeforeTheStateLeavesState::FailChildInOuter => 8,
            OnexitRunsBeforeTheStateLeavesState::FailExits => 4,
            OnexitRunsBeforeTheStateLeavesState::FailParentInInner => 6,
            OnexitRunsBeforeTheStateLeavesState::FailSelfInInner => 5,
            OnexitRunsBeforeTheStateLeavesState::FailSelfInOuter => 7,
            OnexitRunsBeforeTheStateLeavesState::Inner => 1,
            OnexitRunsBeforeTheStateLeavesState::Outer => 0,
            OnexitRunsBeforeTheStateLeavesState::Settled => 3,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution => "error.execution",
            OnexitRunsBeforeTheStateLeavesEvent::Leave => "leave",
            OnexitRunsBeforeTheStateLeavesEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution),
            "leave" => Some(OnexitRunsBeforeTheStateLeavesEvent::Leave),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            OnexitRunsBeforeTheStateLeavesState::Check => "check",
            OnexitRunsBeforeTheStateLeavesState::FailChildInOuter => "failChildInOuter",
            OnexitRunsBeforeTheStateLeavesState::FailExits => "failExits",
            OnexitRunsBeforeTheStateLeavesState::FailParentInInner => "failParentInInner",
            OnexitRunsBeforeTheStateLeavesState::FailSelfInInner => "failSelfInInner",
            OnexitRunsBeforeTheStateLeavesState::FailSelfInOuter => "failSelfInOuter",
            OnexitRunsBeforeTheStateLeavesState::Inner => "inner",
            OnexitRunsBeforeTheStateLeavesState::Outer => "outer",
            OnexitRunsBeforeTheStateLeavesState::Settled => "settled",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "check" => Some(OnexitRunsBeforeTheStateLeavesState::Check),
            "failChildInOuter" => Some(OnexitRunsBeforeTheStateLeavesState::FailChildInOuter),
            "failExits" => Some(OnexitRunsBeforeTheStateLeavesState::FailExits),
            "failParentInInner" => Some(OnexitRunsBeforeTheStateLeavesState::FailParentInInner),
            "failSelfInInner" => Some(OnexitRunsBeforeTheStateLeavesState::FailSelfInInner),
            "failSelfInOuter" => Some(OnexitRunsBeforeTheStateLeavesState::FailSelfInOuter),
            "inner" => Some(OnexitRunsBeforeTheStateLeavesState::Inner),
            "outer" => Some(OnexitRunsBeforeTheStateLeavesState::Outer),
            "settled" => Some(OnexitRunsBeforeTheStateLeavesState::Settled),
            _ => None,
        }
    }
    ...
    fn execute_exit_actions(
        ...
        match state {
            OnexitRunsBeforeTheStateLeavesState::Inner => {
                ...
                'action_block: {
                    {
                        // W3C SCXML 5.3: <assign location="exits">
                        self.ensure_script_engine();
                        let sid = self.session_id.as_ref().unwrap().clone();
                        let se = self.script_engine.clone();
                        let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                        let expr = "_scxml_add(exits, 1)";
                        ...
                        let assign_script = format!("{} = {}", "exits", expr);
                        if let Err(e) = se.execute_script(&sid, &assign_script) {
                            ::sce_rust_runtime::sce_log_error!("Assign failed for 'exits': {}", e);
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                    ...
                    if self.is_state_active("inner") {
                        {
                            // W3C SCXML 5.3: <assign location="selfInInner">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            ...
                            // through evaluate_expression + set_variable would round-trip through ScriptValue
                            // and create a fresh table, breaking reference equality.
                            let assign_script = format!("{} = {}", "selfInInner", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'selfInInner': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                    ...
                    // W3C SCXML 5.9.2: In() predicate condition
                    if self.is_state_active("outer") {
                        {
                            // W3C SCXML 5.3: <assign location="parentInInner">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            ...
                            // through evaluate_expression + set_variable would round-trip through ScriptValue
                            // and create a fresh table, breaking reference equality.
                            let assign_script = format!("{} = {}", "parentInInner", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'parentInInner': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
            ...
            OnexitRunsBeforeTheStateLeavesState::Outer => {
                ...
                'action_block: {
                    ...
                    if self.is_state_active("outer") {
                        {
                            // W3C SCXML 5.3: <assign location="selfInOuter">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            ...
                            // through evaluate_expression + set_variable would round-trip through ScriptValue
                            // and create a fresh table, breaking reference equality.
                            let assign_script = format!("{} = {}", "selfInOuter", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'selfInOuter': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
                    ...
                    if self.is_state_active("inner") {
                        {
                            // W3C SCXML 5.3: <assign location="childInOuter">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            ...
                            // through evaluate_expression + set_variable would round-trip through ScriptValue
                            // and create a fresh table, breaking reference equality.
                            let assign_script = format!("{} = {}", "childInOuter", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'childInOuter': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    OnexitRunsBeforeTheStateLeavesEvent::ErrorExecution,
    ...
    fn first_enabled_transition(
        ...
        match state {
            OnexitRunsBeforeTheStateLeavesState::Check => {
                if event == OnexitRunsBeforeTheStateLeavesEvent::Null {
                    if self.safe_evaluate_guard("(not _scxml_eq(exits, 2))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                OnexitRunsBeforeTheStateLeavesState::FailExits,
                            )],
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == OnexitRunsBeforeTheStateLeavesEvent::Null {
                    if self.safe_evaluate_guard("(not _scxml_eq(selfInInner, 1))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                OnexitRunsBeforeTheStateLeavesState::FailSelfInInner,
                            )],
                            transition_index: 1,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == OnexitRunsBeforeTheStateLeavesEvent::Null {
                    if self.safe_evaluate_guard("(not _scxml_eq(parentInInner, 1))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                OnexitRunsBeforeTheStateLeavesState::FailParentInInner,
                            )],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == OnexitRunsBeforeTheStateLeavesEvent::Null {
                    if self.safe_evaluate_guard("(not _scxml_eq(selfInOuter, 1))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                OnexitRunsBeforeTheStateLeavesState::FailSelfInOuter,
                            )],
                            transition_index: 3,
                            has_actions: false,
                            is_internal: false,
                ...
                if event == OnexitRunsBeforeTheStateLeavesEvent::Null {
                    if self.safe_evaluate_guard("(not _scxml_eq(childInOuter, 0))", engine) {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                OnexitRunsBeforeTheStateLeavesState::FailChildInOuter,
                            )],
                            transition_index: 4,
                            has_actions: false,
                            is_internal: false,
            ...
            OnexitRunsBeforeTheStateLeavesState::Inner => {
                if event == OnexitRunsBeforeTheStateLeavesEvent::Leave {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
