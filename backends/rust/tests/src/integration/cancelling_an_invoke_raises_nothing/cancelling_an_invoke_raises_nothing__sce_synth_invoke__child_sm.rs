...
//! Generated Rust state machine for `cancelling_an_invoke_raises_nothing__sce_synth_invoke__child`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: cancelling_an_invoke_raises_nothing__sce_synth_invoke__child.scxml:3 :: _machine"]
...
pub enum CancellingAnInvokeRaisesNothingSceSynthInvokeChildState {
...
pub enum CancellingAnInvokeRaisesNothingSceSynthInvokeChildEvent {
...
impl CancellingAnInvokeRaisesNothingSceSynthInvokeChildEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [CancellingAnInvokeRaisesNothingSceSynthInvokeChildEvent] = &[];
}
...
pub struct CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy {
...
impl CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy {
    pub fn new() -> Self {
        Self {
            session_id: None,
...
impl Default for CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy {
    type State = CancellingAnInvokeRaisesNothingSceSynthInvokeChildState;
    type Event = CancellingAnInvokeRaisesNothingSceSynthInvokeChildEvent;
    ...
    fn initial_state() -> Self::State {
        ...
        CancellingAnInvokeRaisesNothingSceSynthInvokeChildState::Idle
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            CancellingAnInvokeRaisesNothingSceSynthInvokeChildState::Idle => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            CancellingAnInvokeRaisesNothingSceSynthInvokeChildEvent::Null => "",
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            CancellingAnInvokeRaisesNothingSceSynthInvokeChildState::Idle => "idle",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "idle" => Some(CancellingAnInvokeRaisesNothingSceSynthInvokeChildState::Idle),
            _ => None,
        }
    }
