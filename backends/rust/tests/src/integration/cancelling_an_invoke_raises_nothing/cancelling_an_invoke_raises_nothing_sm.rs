...
//! Generated Rust state machine for `cancelling_an_invoke_raises_nothing`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: cancelling_an_invoke_raises_nothing.scxml:13 :: _machine"]
...
pub enum CancellingAnInvokeRaisesNothingState {
    Done,
...
pub enum CancellingAnInvokeRaisesNothingEvent {
    CancelInvoke,
    CancelInvokeChild,
    DoneInvoke,
    ErrorExecution,
...
impl CancellingAnInvokeRaisesNothingEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [CancellingAnInvokeRaisesNothingEvent] = &[
        CancellingAnInvokeRaisesNothingEvent::CancelInvoke,
        CancellingAnInvokeRaisesNothingEvent::CancelInvokeChild,
...
pub struct CancellingAnInvokeRaisesNothingPolicy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<CancellingAnInvokeRaisesNothingState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'child' (cancelling_an_invoke_raises_nothing__sce_synth_invoke__child)
    child_child: Option<Box<sce_rust_runtime::Engine<super::cancelling_an_invoke_raises_nothing__sce_synth_invoke__child_sm::CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy>>>,
...
impl CancellingAnInvokeRaisesNothingPolicy {
    ...
    /// answer — the session is not initialized yet, `spurious` was
    /// assigned a value of another type, or the engine refused.
    pub fn spurious(&self) -> Option<i64> {
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) =
            se.setup_system_variables(&sid, "cancelling_an_invoke_raises_nothing", &io_processors)
        {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'spurious' from expr (global)
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                CancellingAnInvokeRaisesNothingEvent::ErrorExecution,
                "<data id='spurious'> expr failed to evaluate",
            ));
        }
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.document_id == "child" {
                ...
                let mut child_policy = super::cancelling_an_invoke_raises_nothing__sce_synth_invoke__child_sm::CancellingAnInvokeRaisesNothingSceSynthInvokeChildPolicy::new();
...
impl StatePolicy for CancellingAnInvokeRaisesNothingPolicy {
    type State = CancellingAnInvokeRaisesNothingState;
    type Event = CancellingAnInvokeRaisesNothingEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            CancellingAnInvokeRaisesNothingState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            CancellingAnInvokeRaisesNothingState::Done => 2,
            CancellingAnInvokeRaisesNothingState::P => 0,
            CancellingAnInvokeRaisesNothingState::S2 => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            CancellingAnInvokeRaisesNothingEvent::CancelInvoke => "cancel.invoke",
            CancellingAnInvokeRaisesNothingEvent::CancelInvokeChild => "cancel.invoke.child",
            CancellingAnInvokeRaisesNothingEvent::DoneInvoke => "done.invoke",
            CancellingAnInvokeRaisesNothingEvent::ErrorExecution => "error.execution",
            CancellingAnInvokeRaisesNothingEvent::Finish => "finish",
            CancellingAnInvokeRaisesNothingEvent::Leave => "leave",
            CancellingAnInvokeRaisesNothingEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "cancel.invoke" => Some(CancellingAnInvokeRaisesNothingEvent::CancelInvoke),
            "cancel.invoke.child" => Some(CancellingAnInvokeRaisesNothingEvent::CancelInvokeChild),
            "done.invoke" => Some(CancellingAnInvokeRaisesNothingEvent::DoneInvoke),
            "error.execution" => Some(CancellingAnInvokeRaisesNothingEvent::ErrorExecution),
            "finish" => Some(CancellingAnInvokeRaisesNothingEvent::Finish),
            "leave" => Some(CancellingAnInvokeRaisesNothingEvent::Leave),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            CancellingAnInvokeRaisesNothingState::Done => "done",
            CancellingAnInvokeRaisesNothingState::P => "p",
            CancellingAnInvokeRaisesNothingState::S2 => "s2",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(CancellingAnInvokeRaisesNothingState::Done),
            "p" => Some(CancellingAnInvokeRaisesNothingState::P),
            "s2" => Some(CancellingAnInvokeRaisesNothingState::S2),
            _ => None,
        }
    }
    ...
    fn first_enabled_transition(
        ...
        match state {
            CancellingAnInvokeRaisesNothingState::P => {
                if event == CancellingAnInvokeRaisesNothingEvent::Leave {
                    {
            ...
            CancellingAnInvokeRaisesNothingState::S2 => {
                if event == CancellingAnInvokeRaisesNothingEvent::CancelInvoke
                    || event == CancellingAnInvokeRaisesNothingEvent::CancelInvokeChild
                {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                ...
                if event == CancellingAnInvokeRaisesNothingEvent::CancelInvokeChild {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[],
                ...
                if event == CancellingAnInvokeRaisesNothingEvent::Finish {
                    {
                        return Some(::sce_rust_runtime::EnabledTransition {
                            source: state,
                            targets: &[::sce_rust_runtime::EntryTarget::State(
                                CancellingAnInvokeRaisesNothingState::Done,
                            )],
                            transition_index: 2,
                            has_actions: false,
                            is_internal: false,
            ...
            CancellingAnInvokeRaisesNothingState::S2 => {
                match transition_index {
                    0 => {
                        ...
                        {
                            // W3C SCXML 5.3: <assign location="spurious">
                            self.ensure_script_engine();
                            let sid = self.session_id.as_ref().unwrap().clone();
                            let se = self.script_engine.clone();
                            let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                            let expr = "_scxml_add(spurious, 1)";
                            ...
                            let assign_script = format!("{} = {}", "spurious", expr);
                            if let Err(e) = se.execute_script(&sid, &assign_script) {
                                ::sce_rust_runtime::sce_log_error!(
                                    "Assign failed for 'spurious': {}",
                                    e
                                );
                                engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                    CancellingAnInvokeRaisesNothingEvent::ErrorExecution,
                                    "<assign> to 'spurious' failed",
                                ));
                            }
                        }
                    }
