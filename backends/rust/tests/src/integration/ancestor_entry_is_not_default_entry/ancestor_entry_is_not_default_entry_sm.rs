...
pub struct AncestorEntryIsNotDefaultEntryPolicy {
    ...
    last_transition_source_state: AncestorEntryIsNotDefaultEntryState,
...
impl AncestorEntryIsNotDefaultEntryPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: AncestorEntryIsNotDefaultEntryState::Away,
...
impl StatePolicy for AncestorEntryIsNotDefaultEntryPolicy {
    ...
    fn get_initial_or_history_child(&self, state: Self::State) -> Self::State {
        match state {
            ...
            AncestorEntryIsNotDefaultEntryState::Watch => AncestorEntryIsNotDefaultEntryState::Idle,
            _ => state,
        }
    }
    ...
    fn process_transition(
        ...
        if event == Self::null_event() {
            ...
            let mut seen: ::sce_rust_runtime::SceDedupSet<(
                AncestorEntryIsNotDefaultEntryState,
                usize,
...
impl AncestorEntryIsNotDefaultEntryPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AncestorEntryIsNotDefaultEntryState,
        event: AncestorEntryIsNotDefaultEntryEvent,
        current_state: &mut AncestorEntryIsNotDefaultEntryState,
        ...
        match check_state {
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Cross {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: AncestorEntryIsNotDefaultEntryState::Chosen,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = AncestorEntryIsNotDefaultEntryState::Chosen;
            ...
            AncestorEntryIsNotDefaultEntryState::ByDefault => false,
            AncestorEntryIsNotDefaultEntryState::Chosen => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AncestorEntryIsNotDefaultEntryEvent::Back {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: AncestorEntryIsNotDefaultEntryState::Lobby,
                            transition_index: 0,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = AncestorEntryIsNotDefaultEntryState::Lobby;
                        *transition_taken = true;
                    }
                    return true;
                }
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Check {
                    ...
                    if self.safe_evaluate_guard("(not _scxml_eq(defaulted, 0))", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push_bounded(TransitionInfo {
                                source: check_state,
                                target: AncestorEntryIsNotDefaultEntryState::FailDefaulted,
                                transition_index: 1,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = AncestorEntryIsNotDefaultEntryState::FailDefaulted;
                            *transition_taken = true;
                        }
                        return true;
                    }
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Check {
                    ...
                    if self.safe_evaluate_guard("(not _scxml_eq(lobbied, 1))", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push_bounded(TransitionInfo {
                                source: check_state,
                                target: AncestorEntryIsNotDefaultEntryState::FailLobbied,
                                transition_index: 2,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = AncestorEntryIsNotDefaultEntryState::FailLobbied;
                            *transition_taken = true;
                        }
                        return true;
                    }
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Check {
                    ...
                    if self.safe_evaluate_guard("(not _scxml_eq(idled, 1))", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push_bounded(TransitionInfo {
                                source: check_state,
                                target: AncestorEntryIsNotDefaultEntryState::FailIdled,
                                transition_index: 3,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = AncestorEntryIsNotDefaultEntryState::FailIdled;
                            *transition_taken = true;
                        }
                        return true;
                    }
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Check {
                    ...
                    if self.safe_evaluate_guard("(not _scxml_eq(targeted, 2))", engine) {
                        ...
                        if let Some(ref mut collect) = collect_mode {
                            collect.push_bounded(TransitionInfo {
                                source: check_state,
                                target: AncestorEntryIsNotDefaultEntryState::FailTargeted,
                                transition_index: 4,
                                has_actions: false,
                                is_internal: false,
                                is_targetless: false,
                            ...
                            *current_state = AncestorEntryIsNotDefaultEntryState::FailTargeted;
                            *transition_taken = true;
                        }
                        return true;
                    }
                ...
                if event == AncestorEntryIsNotDefaultEntryEvent::Check {
                    ...
                    if let Some(ref mut collect) = collect_mode {
                        collect.push_bounded(TransitionInfo {
                            source: check_state,
                            target: AncestorEntryIsNotDefaultEntryState::Settled,
                            transition_index: 5,
                            has_actions: false,
                            is_internal: false,
                            is_targetless: false,
                        ...
                        *current_state = AncestorEntryIsNotDefaultEntryState::Settled;
                        *transition_taken = true;
                    }
                    return true;
                }
            ...
            AncestorEntryIsNotDefaultEntryState::Drive => false,
            AncestorEntryIsNotDefaultEntryState::FailDefaulted => false,
            AncestorEntryIsNotDefaultEntryState::FailIdled => false,
            AncestorEntryIsNotDefaultEntryState::FailLobbied => false,
            AncestorEntryIsNotDefaultEntryState::FailTargeted => false,
            AncestorEntryIsNotDefaultEntryState::Idle => false,
            AncestorEntryIsNotDefaultEntryState::Lobby => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            AncestorEntryIsNotDefaultEntryState::Outer => false,
            AncestorEntryIsNotDefaultEntryState::Run => false,
            AncestorEntryIsNotDefaultEntryState::Settled => false,
            AncestorEntryIsNotDefaultEntryState::Watch => false,
            _ => false,
        }
    }
    ...
    ) -> ::sce_rust_runtime::helpers::hierarchy::StateChain<AncestorEntryIsNotDefaultEntryState>
    {
        ...
        let lca: Option<AncestorEntryIsNotDefaultEntryState> = {
    ...
    fn execute_microstep(
        ...
        for trans in transitions {
            ...
            let domain: Option<AncestorEntryIsNotDefaultEntryState> = if is_internal_to_descendant {
                Some(trans.source)
            } else {
