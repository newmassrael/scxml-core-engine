...
//! Generated Rust state machine for `autoforward_internal_queue`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: autoforward_internal_queue.scxml:51 :: _machine"]
...
pub enum AutoforwardInternalQueueState {
    Fail,
    Pass,
...
impl AutoforwardInternalQueueEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [AutoforwardInternalQueueEvent] = &[
        AutoforwardInternalQueueEvent::Ready,
        AutoforwardInternalQueueEvent::SawInternal,
        AutoforwardInternalQueueEvent::SawProbeOnly,
    ];
}
...
pub struct AutoforwardInternalQueuePolicy {
    ...
    pending_invokes: Vec<sce_rust_runtime::invoke::PendingInvoke<AutoforwardInternalQueueState>>,
    ...
    // W3C SCXML 6.4: Static invoke child 'inv_watch' (autoforward_internal_queue__sce_synth_invoke__inv_watch)
    child_inv_watch: Option<Box<sce_rust_runtime::Engine<super::autoforward_internal_queue__sce_synth_invoke__inv_watch_sm::AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy>>>,
...
impl AutoforwardInternalQueuePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: AutoforwardInternalQueueState::Phase,
    ...
    fn do_execute_pending_invokes(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        for pending in &invokes_to_execute {
            if pending.invoke_id.contains(".inv_watch") {
                ...
                let mut child_policy = super::autoforward_internal_queue__sce_synth_invoke__inv_watch_sm::AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy::new();
...
impl Default for AutoforwardInternalQueuePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for AutoforwardInternalQueuePolicy {
    type State = AutoforwardInternalQueueState;
    type Event = AutoforwardInternalQueueEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardInternalQueueState::Fail => true,
            AutoforwardInternalQueueState::Pass => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardInternalQueueState::Fail => 2,
            AutoforwardInternalQueueState::Pass => 1,
            AutoforwardInternalQueueState::Phase => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            AutoforwardInternalQueueEvent::Ready => "ready",
            AutoforwardInternalQueueEvent::SawInternal => "sawInternal",
            AutoforwardInternalQueueEvent::SawProbeOnly => "sawProbeOnly",
            AutoforwardInternalQueueEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "ready" => Some(AutoforwardInternalQueueEvent::Ready),
            "sawInternal" => Some(AutoforwardInternalQueueEvent::SawInternal),
            "sawProbeOnly" => Some(AutoforwardInternalQueueEvent::SawProbeOnly),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardInternalQueueState::Fail => "fail",
            AutoforwardInternalQueueState::Pass => "pass",
            AutoforwardInternalQueueState::Phase => "phase",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "fail" => Some(AutoforwardInternalQueueState::Fail),
            "pass" => Some(AutoforwardInternalQueueState::Pass),
            "phase" => Some(AutoforwardInternalQueueState::Phase),
            _ => None,
        }
    }
...
impl AutoforwardInternalQueuePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardInternalQueueState,
        event: AutoforwardInternalQueueEvent,
        current_state: &mut AutoforwardInternalQueueState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            AutoforwardInternalQueueState::Fail => false,
            AutoforwardInternalQueueState::Pass => false,
            AutoforwardInternalQueueState::Phase => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueEvent::Ready {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueEvent::ErrorExecution {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueEvent::SawInternal {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = AutoforwardInternalQueueState::Fail;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueEvent::SawProbeOnly {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = AutoforwardInternalQueueState::Pass;
                    *transition_taken = true;
                    return true;
                }
                false
