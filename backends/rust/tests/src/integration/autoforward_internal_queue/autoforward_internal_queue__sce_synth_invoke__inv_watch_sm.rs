...
//! Generated Rust state machine for `autoforward_internal_queue__sce_synth_invoke__inv_watch`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: autoforward_internal_queue__sce_synth_invoke__inv_watch.scxml:3 :: _machine"]
...
pub enum AutoforwardInternalQueueSceSynthInvokeInvWatchState {
    Clean,
    Leaked,
...
impl AutoforwardInternalQueueSceSynthInvokeInvWatchEvent {
    ...
    pub const EXTERNALLY_DRIVABLE_EVENTS:
        &'static [AutoforwardInternalQueueSceSynthInvokeInvWatchEvent] =
        &[AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Probe];
}
...
pub struct AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: AutoforwardInternalQueueSceSynthInvokeInvWatchState,
...
impl AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy {
    pub fn new() -> Self {
        Self {
...
impl Default for AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy {
    type State = AutoforwardInternalQueueSceSynthInvokeInvWatchState;
    type Event = AutoforwardInternalQueueSceSynthInvokeInvWatchEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean => true,
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean => 2,
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked => 1,
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Watch => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Probe => "probe",
            AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Ready => "ready",
            AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::SawInternal => "sawInternal",
            AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::SawProbeOnly => "sawProbeOnly",
            AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "probe" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Probe),
            "ready" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Ready),
            "sawInternal" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::SawInternal),
            "sawProbeOnly" => {
                Some(AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::SawProbeOnly)
            }
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean => "clean",
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked => "leaked",
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Watch => "watch",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "clean" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean),
            "leaked" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked),
            "watch" => Some(AutoforwardInternalQueueSceSynthInvokeInvWatchState::Watch),
            _ => None,
        }
    }
...
impl AutoforwardInternalQueueSceSynthInvokeInvWatchPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: AutoforwardInternalQueueSceSynthInvokeInvWatchState,
        event: AutoforwardInternalQueueSceSynthInvokeInvWatchEvent,
        current_state: &mut AutoforwardInternalQueueSceSynthInvokeInvWatchState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean => false,
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked => false,
            AutoforwardInternalQueueSceSynthInvokeInvWatchState::Watch => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::ErrorExecution {
                    ...
                    *current_state = AutoforwardInternalQueueSceSynthInvokeInvWatchState::Leaked;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == AutoforwardInternalQueueSceSynthInvokeInvWatchEvent::Probe {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = AutoforwardInternalQueueSceSynthInvokeInvWatchState::Clean;
                    *transition_taken = true;
                    return true;
                }
                false
