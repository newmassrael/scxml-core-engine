...
//! Generated Rust state machine for `unseen_event_is_reported`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: unseen_event_is_reported.scxml:41 :: _machine"]
...
pub enum UnseenEventIsReportedState {
    Done,
...
pub enum UnseenEventIsReportedEvent {
    ErrorExecution,
    Finish,
    Poke,
...
impl UnseenEventIsReportedEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [UnseenEventIsReportedEvent] = &[
...
impl UnseenEventIsReportedPolicy {
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: UnseenEventIsReportedState::Working,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        if let Err(e) = se.setup_system_variables(&sid, "unseen_event_is_reported", &io_processors)
        {
...
impl StatePolicy for UnseenEventIsReportedPolicy {
    type State = UnseenEventIsReportedState;
    type Event = UnseenEventIsReportedEvent;
    ...
    fn is_final_state(state: Self::State) -> bool {
        match state {
            UnseenEventIsReportedState::Done => true,
            _ => false,
        }
    }
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            UnseenEventIsReportedState::Done => 1,
            UnseenEventIsReportedState::Working => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            UnseenEventIsReportedEvent::ErrorExecution => "error.execution",
            UnseenEventIsReportedEvent::Finish => "finish",
            UnseenEventIsReportedEvent::Poke => "poke",
            UnseenEventIsReportedEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "error.execution" => Some(UnseenEventIsReportedEvent::ErrorExecution),
            "finish" => Some(UnseenEventIsReportedEvent::Finish),
            "poke" => Some(UnseenEventIsReportedEvent::Poke),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            UnseenEventIsReportedState::Done => "done",
            UnseenEventIsReportedState::Working => "working",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "done" => Some(UnseenEventIsReportedState::Done),
            "working" => Some(UnseenEventIsReportedState::Working),
            _ => None,
        }
    }
...
impl UnseenEventIsReportedPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: UnseenEventIsReportedState,
        event: UnseenEventIsReportedEvent,
        current_state: &mut UnseenEventIsReportedState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            UnseenEventIsReportedState::Done => false,
            UnseenEventIsReportedState::Working => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == UnseenEventIsReportedEvent::Poke {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == UnseenEventIsReportedEvent::Finish {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = UnseenEventIsReportedState::Done;
                    *transition_taken = true;
                    return true;
                }
                false
