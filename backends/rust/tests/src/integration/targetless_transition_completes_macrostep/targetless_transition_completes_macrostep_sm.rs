...
//! Generated Rust state machine for `targetless_transition_completes_macrostep`.
//!
//! Generated by SCE Code Generator (Rust backend).
...
#![doc = "SCE-MAP: targetless_transition_completes_macrostep.scxml:51 :: _machine"]
...
pub enum TargetlessTransitionCompletesMacrostepState {
...
pub enum TargetlessTransitionCompletesMacrostepEvent {
    Arm,
    ErrorExecution,
    Ping,
    Pong,
...
impl TargetlessTransitionCompletesMacrostepEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [TargetlessTransitionCompletesMacrostepEvent] =
        &[
            TargetlessTransitionCompletesMacrostepEvent::Arm,
            TargetlessTransitionCompletesMacrostepEvent::Ping,
            TargetlessTransitionCompletesMacrostepEvent::Quiet,
            TargetlessTransitionCompletesMacrostepEvent::Recycle,
        ];
}
...
pub struct TargetlessTransitionCompletesMacrostepPolicy {
    // W3C SCXML 3.13: Last transition metadata
    last_transition_is_internal: bool,
    last_transition_is_targetless: bool,
    last_transition_source_state: TargetlessTransitionCompletesMacrostepState,
...
impl TargetlessTransitionCompletesMacrostepPolicy {
    ...
    /// answer — the session is not initialized yet, `quiet` was
    /// assigned a value of another type, or the engine refused.
    pub fn quiet(&self) -> Option<i64> {
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `chained` was
    /// assigned a value of another type, or the engine refused.
    pub fn chained(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "chained",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `polished` was
    /// assigned a value of another type, or the engine refused.
    pub fn polished(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "polished",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `answered` was
    /// assigned a value of another type, or the engine refused.
    pub fn answered(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "answered",
    ...
    /// session, so a reader frozen at generation time would answer the
    /// document's literal for the whole run. `None` means the machine cannot
    /// answer — the session is not initialized yet, `entries` was
    /// assigned a value of another type, or the engine refused.
    pub fn entries(&self) -> Option<i64> {
        ::sce_rust_runtime::helpers::datamodel_read::read_int(
            self.script_engine.as_ref(),
            self.session_id.as_deref(),
            "entries",
    ...
    pub fn new(script_engine: std::sync::Arc<dyn sce_rust_runtime::IScriptEngine>) -> Self {
        Self {
            ...
            last_transition_source_state: TargetlessTransitionCompletesMacrostepState::Idle,
    ...
    fn ensure_script_engine(&mut self) {
        ...
        // W3C SCXML 5.2/5.3: Initialize 'quiet' from expr (global)
        ...
        // W3C SCXML 5.2/5.3: Initialize 'chained' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "chained", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'polished' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "polished", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'answered' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "answered", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
        ...
        // W3C SCXML 5.2/5.3: Initialize 'entries' from expr (global)
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            se, &sid, "entries", "0",
        ) {
            ::sce_rust_runtime::sce_log_error!("global: {}", e);
    ...
    fn do_initialize_data_model(&mut self, engine: &mut Engine<Self>) {
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                ...
                "<data id='quiet'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TargetlessTransitionCompletesMacrostepEvent::ErrorExecution,
                "<data id='chained'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TargetlessTransitionCompletesMacrostepEvent::ErrorExecution,
                "<data id='polished'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TargetlessTransitionCompletesMacrostepEvent::ErrorExecution,
                "<data id='answered'> expr failed to evaluate",
            ));
        }
        ...
        if let Err(e) = sce_rust_runtime::helpers::datamodel_init::initialize_variable_from_expr(
            ...
            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                TargetlessTransitionCompletesMacrostepEvent::ErrorExecution,
                "<data id='entries'> expr failed to evaluate",
            ));
        }
...
impl StatePolicy for TargetlessTransitionCompletesMacrostepPolicy {
    type State = TargetlessTransitionCompletesMacrostepState;
    type Event = TargetlessTransitionCompletesMacrostepEvent;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            TargetlessTransitionCompletesMacrostepState::Idle => 0,
            TargetlessTransitionCompletesMacrostepState::Recycled => 2,
            TargetlessTransitionCompletesMacrostepState::Settled => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            TargetlessTransitionCompletesMacrostepEvent::Arm => "arm",
            TargetlessTransitionCompletesMacrostepEvent::ErrorExecution => "error.execution",
            TargetlessTransitionCompletesMacrostepEvent::Ping => "ping",
            TargetlessTransitionCompletesMacrostepEvent::Pong => "pong",
            TargetlessTransitionCompletesMacrostepEvent::Quiet => "quiet",
            TargetlessTransitionCompletesMacrostepEvent::Recycle => "recycle",
            TargetlessTransitionCompletesMacrostepEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "arm" => Some(TargetlessTransitionCompletesMacrostepEvent::Arm),
            "error.execution" => Some(TargetlessTransitionCompletesMacrostepEvent::ErrorExecution),
            "ping" => Some(TargetlessTransitionCompletesMacrostepEvent::Ping),
            "pong" => Some(TargetlessTransitionCompletesMacrostepEvent::Pong),
            "quiet" => Some(TargetlessTransitionCompletesMacrostepEvent::Quiet),
            "recycle" => Some(TargetlessTransitionCompletesMacrostepEvent::Recycle),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            TargetlessTransitionCompletesMacrostepState::Idle => "idle",
            TargetlessTransitionCompletesMacrostepState::Recycled => "recycled",
            TargetlessTransitionCompletesMacrostepState::Settled => "settled",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "idle" => Some(TargetlessTransitionCompletesMacrostepState::Idle),
            "recycled" => Some(TargetlessTransitionCompletesMacrostepState::Recycled),
            "settled" => Some(TargetlessTransitionCompletesMacrostepState::Settled),
            _ => None,
        }
    }
    ...
    fn execute_entry_actions(
        ...
        match state {
            TargetlessTransitionCompletesMacrostepState::Recycled => {
                ...
                'action_block: {
                    {
                        // W3C SCXML 5.3: <assign location="entries">
                        self.ensure_script_engine();
                        let sid = self.session_id.as_ref().unwrap().clone();
                        let se = self.script_engine.clone();
                        let se: &dyn sce_rust_runtime::IScriptEngine = &*se;
                        let expr = "_scxml_add(entries, 1)";
                        ...
                        let assign_script = format!("{} = {}", "entries", expr);
                        if let Err(e) = se.execute_script(&sid, &assign_script) {
                            ::sce_rust_runtime::sce_log_error!(
                                "Assign failed for 'entries': {}",
                                e
                            );
                            engine.raise(sce_rust_runtime::EventWithMetadata::platform_error(
                                TargetlessTransitionCompletesMacrostepEvent::ErrorExecution,
...
impl TargetlessTransitionCompletesMacrostepPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: TargetlessTransitionCompletesMacrostepState,
        event: TargetlessTransitionCompletesMacrostepEvent,
        current_state: &mut TargetlessTransitionCompletesMacrostepState,
        ...
        match check_state {
            TargetlessTransitionCompletesMacrostepState::Idle => {
                ...
                if event == TargetlessTransitionCompletesMacrostepEvent::Quiet {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TargetlessTransitionCompletesMacrostepEvent::Arm {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TargetlessTransitionCompletesMacrostepEvent::Ping {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TargetlessTransitionCompletesMacrostepEvent::Pong {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TargetlessTransitionCompletesMacrostepEvent::Recycle {
                    // W3C SCXML 3.4: Track transition metadata
                    self.last_transition_source_state = check_state;
                    ...
                    *current_state = TargetlessTransitionCompletesMacrostepState::Recycled;
                    *transition_taken = true;
                    return true;
                }
                // W3C SCXML 3.13: Eventless transitions
                if event == TargetlessTransitionCompletesMacrostepEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(armed, 1)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_internal = false;
                        self.last_transition_is_targetless = false;
                        *current_state = TargetlessTransitionCompletesMacrostepState::Settled;
                        *transition_taken = true;
                        return true;
                    }
                }
            ...
            TargetlessTransitionCompletesMacrostepState::Recycled => {
                // W3C SCXML 3.13: Eventless transitions
                if event == TargetlessTransitionCompletesMacrostepEvent::Null {
                    if self.safe_evaluate_guard("(entries < 2)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
            ...
            TargetlessTransitionCompletesMacrostepState::Settled => {
                // W3C SCXML 3.13: Eventless transitions
                if event == TargetlessTransitionCompletesMacrostepEvent::Null {
                    if self.safe_evaluate_guard("_scxml_eq(polished, 0)", engine) {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
