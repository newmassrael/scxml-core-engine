...
class Test339StateMachine(
    ...
    private fun processS0(
        ...
        event is Test339Event.Foo -> TransitionResult.External(Test339State.Pass, Test339State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test339State.Fail, Test339State.S0, 1)
    }
