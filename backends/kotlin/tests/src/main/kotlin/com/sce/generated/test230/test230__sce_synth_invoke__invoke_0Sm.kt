...
class Test230SceSynthInvokeInvoke0StateMachine(
    ...
    private fun safeEvaluateGuard(guardExpr: String): Boolean {
        ...
        return try {
            ...
            raiseInternal(Test230SceSynthInvokeInvoke0Event.Error.Execution)
            false
        }
    }
    ...
    // SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:3
    override fun onEntry(state: Test230SceSynthInvokeInvoke0State) {
        when (state) {
            is Test230SceSynthInvokeInvoke0State.Sub0 -> {
                // SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:4
            ...
            is Test230SceSynthInvokeInvoke0State.SubFinal -> {
                // SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:20
                // W3C SCXML 3.8: Track active state, skip duplicate entry
    ...
    override fun executeTransitionActions(
        ...
        is Test230SceSynthInvokeInvoke0State.Sub0 -> when {
            event is Test230SceSynthInvokeInvoke0Event.ChildToParent -> {
                // SCE-MAP: test230__sce_synth_invoke__invoke_0.scxml:9
