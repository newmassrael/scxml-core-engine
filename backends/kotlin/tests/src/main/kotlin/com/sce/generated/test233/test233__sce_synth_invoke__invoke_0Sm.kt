...
class Test233SceSynthInvokeInvoke0StateMachine(
    ...
    override fun isFinalState(state: Test233SceSynthInvokeInvoke0State): Boolean = when (state) {
        is Test233SceSynthInvokeInvoke0State.SubFinal -> true
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test233SceSynthInvokeInvoke0State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test233SceSynthInvokeInvoke0State, HistoryId>> =
            listOf(StateTarget(Test233SceSynthInvokeInvoke0State.SubFinal))
    }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test233SceSynthInvokeInvoke0Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test233SceSynthInvokeInvoke0Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test233SceSynthInvokeInvoke0Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test233SceSynthInvokeInvoke0Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test233SceSynthInvokeInvoke0Event) {
    ...
    ): EnabledTransition<Test233SceSynthInvokeInvoke0State, HistoryId>? = when (state) {
        else -> null
    }
    ...
    // SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun onEntry(state: Test233SceSynthInvokeInvoke0State, isDefaultEntry: Boolean) {
        when (state) {
            ...
            run {
                ...
                try {
                    ...
                    raisePlatformError(Test233SceSynthInvokeInvoke0Event.Error.Execution, "<send> <param name='aParam'> expr failed to evaluate")
                }
    ...
    // SCE-MAP: test233__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun executeTransitionContent(source: Test233SceSynthInvokeInvoke0State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
