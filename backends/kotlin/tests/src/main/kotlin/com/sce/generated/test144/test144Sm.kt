...
class Test144StateMachine(
    ...
    private fun processS0(
        ...
        event is Test144Event.Foo -> TransitionResult.External(Test144State.S1, Test144State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test144State.Fail, Test144State.S0, 1)
    }

    private fun processS1(
        event: Test144Event
    ): TransitionResult<Test144State> = when {
        event is Test144Event.Bar -> TransitionResult.External(Test144State.Pass, Test144State.S1, 2)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test144State.Fail, Test144State.S1, 3)
    }
    ...
    // SCE-MAP: test144.scxml:6 :: _machine
    override fun onEntry(state: Test144State, pathChild: Test144State?) {
        when (state) {
