...
class Test193StateMachine(
    ...
    private fun processS0(
        ...
        event is Test193Event.Event1 -> TransitionResult.External(Test193State.Fail, Test193State.S0, 0)

        event is Test193Event.Internal -> TransitionResult.External(Test193State.S1, Test193State.S0, 1)
    ...
    private fun processS1(
        ...
        event is Test193Event.Event1 -> TransitionResult.External(Test193State.Pass, Test193State.S1, 2)

        event is Test193Event.Timeout -> TransitionResult.External(Test193State.Fail, Test193State.S1, 3)
