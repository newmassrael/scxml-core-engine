...
class Test233StateMachine(
    ...
    private fun processS0(
        ...
        event is Test233Event.ChildToParent && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 2")) -> TransitionResult.External(Test233State.Pass, Test233State.S0)
    ...
    // SCE-MAP: test233.scxml:7 :: _machine
    override fun onEntry(state: Test233State, pathChild: Test233State?) {
        when (state) {
