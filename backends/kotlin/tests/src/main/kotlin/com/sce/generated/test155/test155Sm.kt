...
class Test155StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 6")) -> TransitionResult.External(Test155State.Pass, Test155State.S0)
    ...
    // SCE-MAP: test155.scxml:6 :: _machine
    override fun onEntry(state: Test155State, pathChild: Test155State?) {
        when (state) {
