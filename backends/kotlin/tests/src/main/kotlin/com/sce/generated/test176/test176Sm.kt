...
class Test176StateMachine(
    ...
    override fun isAtomicState(state: Test176State): Boolean = when (state) {
        else -> true
    }
    ...
    override fun processEvent(
        state: Test176State,
        event: Test176Event
    ): TransitionResult<Test176State> {
        // W3C SCXML 5.10: Set _event before guard evaluation
        setCurrentEventInScriptEngine(event)
        return when (state) {
        is Test176State.S0 -> processS0(event)
    ...
    override fun processNullEvent(
        state: Test176State
    ): TransitionResult<Test176State> = when (state) {
        is Test176State.S1 -> processNullS1()
        else -> TransitionResult.Ignored
    }
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var2 == 2")) -> TransitionResult.External(Test176State.Pass, Test176State.S1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test176State.Fail, Test176State.S1)
    }
    ...
    private fun processS0(
        ...
        event is Test176Event.Event1 -> TransitionResult.External(Test176State.S1, Test176State.S0)
    ...
    // SCE-MAP: test176.scxml:5 :: _machine
    override fun onEntry(state: Test176State, pathChild: Test176State?) {
        when (state) {
