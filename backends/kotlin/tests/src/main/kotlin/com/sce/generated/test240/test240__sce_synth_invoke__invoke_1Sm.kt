...
class Test240SceSynthInvokeInvoke1StateMachine(
    ...
    private fun processNullSub02(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 1")) -> TransitionResult.External(Test240SceSynthInvokeInvoke1State.SubFinal2, Test240SceSynthInvokeInvoke1State.Sub02, 0)
