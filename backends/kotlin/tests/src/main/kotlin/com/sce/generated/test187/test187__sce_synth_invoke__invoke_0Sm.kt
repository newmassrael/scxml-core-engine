...
// SCE-MAP: test187__sce_synth_invoke__invoke_0.scxml:3
...
class Test187SceSynthInvokeInvoke0StateMachine(
    ...
    // SCE-MAP: test187__sce_synth_invoke__invoke_0.scxml:3
    override fun onEntry(state: Test187SceSynthInvokeInvoke0State) {
        when (state) {
            is Test187SceSynthInvokeInvoke0State.Sub0 -> {
                // SCE-MAP: test187__sce_synth_invoke__invoke_0.scxml:4
            ...
            is Test187SceSynthInvokeInvoke0State.SubFinal -> {
                // SCE-MAP: test187__sce_synth_invoke__invoke_0.scxml:10
                // W3C SCXML 3.8: Track active state, skip duplicate entry
