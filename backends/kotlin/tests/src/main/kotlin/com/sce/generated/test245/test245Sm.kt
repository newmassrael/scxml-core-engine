...
class Test245StateMachine(
    ...
    private fun processS0(
        ...
        event is Test245Event.Success -> TransitionResult.External(Test245State.Pass, Test245State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test245State.Fail, Test245State.S0, 1)
    }
    ...
    // SCE-MAP: test245.scxml:6 :: _machine
    override fun onEntry(state: Test245State, pathChild: Test245State?) {
        when (state) {
