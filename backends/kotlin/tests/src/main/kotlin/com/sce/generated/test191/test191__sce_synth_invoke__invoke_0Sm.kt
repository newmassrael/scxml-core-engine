...
class Test191SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processNullSub0(
        ...
        else -> TransitionResult.External(Test191SceSynthInvokeInvoke0State.SubFinal, Test191SceSynthInvokeInvoke0State.Sub0, 0)
    }
    ...
    // SCE-MAP: test191__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun onEntry(state: Test191SceSynthInvokeInvoke0State, pathChild: Test191SceSynthInvokeInvoke0State?) {
        when (state) {
