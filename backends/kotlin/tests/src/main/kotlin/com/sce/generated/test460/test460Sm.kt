...
class Test460StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var2==3")) -> TransitionResult.External(Test460State.Pass, Test460State.S0)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test460State.Fail, Test460State.S0)
    }
    ...
    // SCE-MAP: test460.scxml:4 :: _machine
    override fun onEntry(state: Test460State, pathChild: Test460State?) {
        when (state) {
