...
class Test522StateMachine(
    ...
    private fun processS0(
        ...
        event is Test522Event.Timeout -> TransitionResult.External(Test522State.Fail, Test522State.S0, 0)

        // W3C SCXML 3.12.1: Prefix match for "error"
        (event is Test522Event.Error || event is Test522Event.Error.Communication || event is Test522Event.Error.Execution) -> TransitionResult.External(Test522State.Fail, Test522State.S0, 1)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test522State.Pass, Test522State.S0, 2)
    }
    ...
    // SCE-MAP: test522.scxml:6 :: _machine
    override fun onEntry(state: Test522State, pathChild: Test522State?) {
        when (state) {
