...
class Test578StateMachine(
    ...
    private fun processS0(
        ...
        event is Test578Event.Foo && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data.productName == 'bar'")) -> TransitionResult.External(Test578State.Pass, Test578State.S0)
