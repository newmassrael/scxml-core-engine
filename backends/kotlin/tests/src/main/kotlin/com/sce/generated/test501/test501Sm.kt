...
class Test501StateMachine(
    ...
    override fun isFinalState(state: Test501State): Boolean = when (state) {
        is Test501State.Fail, is Test501State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test501State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test501State, HistoryId>> =
            listOf(StateTarget(Test501State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test501State, HistoryId>(
            Test501State.S0,
            listOf(StateTarget(Test501State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test501State, HistoryId>(
            Test501State.S0,
            listOf(StateTarget(Test501State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test501Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test501Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test501Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test501Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test501Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test501Event) {
    ...
    override fun firstEnabledTransition(
        state: Test501State,
        event: Test501Event?
    ): EnabledTransition<Test501State, HistoryId>? = when (state) {
        is Test501State.S0 -> when {
            event is Test501Event.Foo -> transitionS0At0
    ...
    // SCE-MAP: test501.scxml:5 :: _machine
    override fun onEntry(state: Test501State, isDefaultEntry: Boolean) {
        when (state) {
    ...
    // SCE-MAP: test501.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test501State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
