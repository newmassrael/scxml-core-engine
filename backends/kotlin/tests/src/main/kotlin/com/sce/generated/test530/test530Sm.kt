...
class Test530StateMachine(
    ...
    private fun processS0(
        ...
        event is Test530Event.Done.Invoke -> TransitionResult.External(Test530State.Pass, Test530State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test530State.Fail, Test530State.S0, 1)
    }
