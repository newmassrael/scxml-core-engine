...
class Test558StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var1 == 'this is a string'")) -> TransitionResult.External(Test558State.S1, Test558State.S0)
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var2 == 'this is a string'")) -> TransitionResult.External(Test558State.Pass, Test558State.S1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
    ...
    // SCE-MAP: test558.scxml:5 :: _machine
    override fun onEntry(state: Test558State, pathChild: Test558State?) {
        when (state) {
