...
class Test350StateMachine(
    ...
    private fun processS0(
        ...
        event is Test350Event.S0Event -> TransitionResult.External(Test350State.Pass, Test350State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test350State.Fail, Test350State.S0, 1)
    }
    ...
    // SCE-MAP: test350.scxml:6 :: _machine
    override fun onEntry(state: Test350State, pathChild: Test350State?) {
        when (state) {
