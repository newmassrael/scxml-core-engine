...
class Test194StateMachine(
    ...
    private fun processS0(
        ...
        event is Test194Event.Error.Execution -> TransitionResult.External(Test194State.Pass, Test194State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test194State.Fail, Test194State.S0, 1)
    }
