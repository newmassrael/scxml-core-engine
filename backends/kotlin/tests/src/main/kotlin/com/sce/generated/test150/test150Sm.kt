...
class Test150StateMachine(
    ...
    override fun isFinalState(state: Test150State): Boolean = when (state) {
        is Test150State.Fail, is Test150State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test150State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test150State, HistoryId>> =
            listOf(StateTarget(Test150State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S0,
            listOf(StateTarget(Test150State.Fail)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S0,
            listOf(StateTarget(Test150State.S1)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S1,
            listOf(StateTarget(Test150State.Fail)),
            0,
            hasActions = false,
        ...
        val transitionS1At1 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S1,
            listOf(StateTarget(Test150State.S2)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS2At0 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S2,
            listOf(StateTarget(Test150State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS2At1 = EnabledTransition<Test150State, HistoryId>(
            Test150State.S2,
            listOf(StateTarget(Test150State.Fail)),
            1,
            hasActions = false,
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test150Event.Error.Execution, "<data id='Var3'> content failed to initialise")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test150Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test150Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test150Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test150Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test150Event) {
    ...
    override fun firstEnabledTransition(
        state: Test150State,
        event: Test150Event?
    ): EnabledTransition<Test150State, HistoryId>? = when (state) {
        is Test150State.S0 -> when {
            (event is Test150Event.Error || event is Test150Event.Error.Execution) -> transitionS0At0
            event != null -> transitionS0At1
            else -> null
        }
        is Test150State.S1 -> when {
            (event is Test150Event.Error || event is Test150Event.Error.Execution) -> transitionS1At0
            event != null -> transitionS1At1
            else -> null
        }
        is Test150State.S2 -> when {
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("(_typeof(Var4) ~= \"undefined\")", "typeof Var4 !== 'undefined'")) -> transitionS2At0
    ...
    // SCE-MAP: test150.scxml:6 :: _machine
    override fun onEntry(state: Test150State, isDefaultEntry: Boolean) {
        when (state) {
    ...
    // SCE-MAP: test150.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test150State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
