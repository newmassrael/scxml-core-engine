...
class Test518StateMachine(
    ...
    private fun processS0(
        ...
        event is Test518Event.Test -> TransitionResult.External(Test518State.Pass, Test518State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test518State.Fail, Test518State.S0, 1)
    }
    ...
    // SCE-MAP: test518.scxml:5 :: _machine
    override fun onEntry(state: Test518State, pathChild: Test518State?) {
        when (state) {
