...
class Test309StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("return")) -> TransitionResult.External(Test309State.Fail, Test309State.S0)
    ...
    // SCE-MAP: test309.scxml:5 :: _machine
    override fun onEntry(state: Test309State, pathChild: Test309State?) {
        when (state) {
