...
class Test149StateMachine(
    ...
    private fun processS0(
        ...
        event is Test149Event.Bat && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 0")) -> TransitionResult.External(Test149State.Pass, Test149State.S0)
    ...
    // SCE-MAP: test149.scxml:4 :: _machine
    override fun onEntry(state: Test149State, pathChild: Test149State?) {
        when (state) {
