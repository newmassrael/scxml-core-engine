...
class Test247StateMachine(
    ...
    private fun processS0(
        ...
        event is Test247Event.Done.Invoke -> TransitionResult.External(Test247State.Pass, Test247State.S0, 0)

        event is Test247Event.Timeout -> TransitionResult.External(Test247State.Fail, Test247State.S0, 1)
    ...
    // SCE-MAP: test247.scxml:5 :: _machine
    override fun onEntry(state: Test247State, pathChild: Test247State?) {
        when (state) {
