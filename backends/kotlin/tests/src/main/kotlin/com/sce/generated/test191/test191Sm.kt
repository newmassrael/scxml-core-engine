...
class Test191StateMachine(
    ...
    private fun processS0(
        ...
        event is Test191Event.ChildToParent -> TransitionResult.External(Test191State.Pass, Test191State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test191State.Fail, Test191State.S0, 1)
    }
    ...
    // SCE-MAP: test191.scxml:6 :: _machine
    override fun onEntry(state: Test191State, pathChild: Test191State?) {
        when (state) {
