...
class Test158StateMachine(
    ...
    override fun isFinalState(state: Test158State): Boolean = when (state) {
        is Test158State.Fail, is Test158State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test158State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test158State, HistoryId>> =
            listOf(StateTarget(Test158State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test158State, HistoryId>(
            Test158State.S0,
            listOf(StateTarget(Test158State.S1)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test158State, HistoryId>(
            Test158State.S0,
            listOf(StateTarget(Test158State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test158State, HistoryId>(
            Test158State.S1,
            listOf(StateTarget(Test158State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test158State, HistoryId>(
            Test158State.S1,
            listOf(StateTarget(Test158State.Fail)),
            1,
            hasActions = false,
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test158Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test158Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test158Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test158Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test158Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test158Event) {
    ...
    override fun firstEnabledTransition(
        state: Test158State,
        event: Test158Event?
    ): EnabledTransition<Test158State, HistoryId>? = when (state) {
        is Test158State.S0 -> when {
            event is Test158Event.Event1 -> transitionS0At0
            event != null -> transitionS0At1
            else -> null
        }
        is Test158State.S1 -> when {
            event is Test158Event.Event2 -> transitionS1At0
    ...
    // SCE-MAP: test158.scxml:5 :: _machine
    override fun onEntry(state: Test158State, isDefaultEntry: Boolean) {
        when (state) {
            is Test158State.Fail -> {
                // SCE-MAP: test158.scxml:25 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test158State.Pass -> {
                // SCE-MAP: test158.scxml:24 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test158State.S0 -> {
                // SCE-MAP: test158.scxml:10 :: s0 :: _state_body
            ...
            is Test158State.S1 -> {
                // SCE-MAP: test158.scxml:19 :: s1 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test158.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test158State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
