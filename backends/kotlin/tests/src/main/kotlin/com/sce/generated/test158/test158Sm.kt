...
class Test158StateMachine(
    ...
    private fun processS0(
        ...
        event is Test158Event.Event1 -> TransitionResult.External(Test158State.S1, Test158State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test158State.Fail, Test158State.S0, 1)
    }

    private fun processS1(
        event: Test158Event
    ): TransitionResult<Test158State> = when {
        event is Test158Event.Event2 -> TransitionResult.External(Test158State.Pass, Test158State.S1, 2)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test158State.Fail, Test158State.S1, 3)
    }
    ...
    // SCE-MAP: test158.scxml:5 :: _machine
    override fun onEntry(state: Test158State, pathChild: Test158State?) {
        when (state) {
