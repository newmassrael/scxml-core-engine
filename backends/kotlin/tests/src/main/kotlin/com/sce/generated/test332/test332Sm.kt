...
class Test332StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 === Var2")) -> TransitionResult.External(Test332State.Pass, Test332State.S1, 2)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test332State.Fail, Test332State.S1, 3)
    }
    ...
    private fun processS0(
        ...
        (event is Test332Event.Error || event is Test332Event.Error.Execution) -> TransitionResult.External(Test332State.S1, Test332State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test332State.Fail, Test332State.S0, 1)
    }
    ...
    // SCE-MAP: test332.scxml:5 :: _machine
    override fun onEntry(state: Test332State, pathChild: Test332State?) {
        when (state) {
