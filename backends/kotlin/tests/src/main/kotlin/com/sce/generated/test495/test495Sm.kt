...
class Test495StateMachine(
    ...
    private fun processS0(
        ...
        event is Test495Event.Event1 -> TransitionResult.External(Test495State.Fail, Test495State.S0, 0)

        event is Test495Event.Event2 -> TransitionResult.External(Test495State.S1, Test495State.S0, 1)
    ...
    private fun processS1(
        ...
        event is Test495Event.Event1 -> TransitionResult.External(Test495State.Pass, Test495State.S1, 2)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test495State.Fail, Test495State.S1, 3)
    }
    ...
    // SCE-MAP: test495.scxml:4 :: _machine
    override fun onEntry(state: Test495State, pathChild: Test495State?) {
        when (state) {
