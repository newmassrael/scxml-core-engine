...
// Source: integration_resources/empty_finalize_updates_the_location/empty_finalize_updates_the_location__sce_synth_invoke__inv_absent.scxml
...
sealed interface EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState : State {
    data object Answer : EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState
    data object Done : EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState
}

// --- Events (W3C SCXML 3.12.1) ---

sealed interface EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent : Event {
    sealed interface Error : EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent {
        data object Execution : Error
    }
    data object FromAbsentChild : EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent
}
// --- State Machine (W3C SCXML) ---

class EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentStateMachine(
    scriptEngine: ScxmlScriptEngine,
) : StateMachineEngine<EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState, EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent>(scriptEngine) {

    override val initialState: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState = EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer
    ...
    override fun resolveState(stateId: String): EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState? = when (stateId) {
        "answer" -> EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer
        "done" -> EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Done
        else -> null
    }

    // W3C SCXML: Get state ID string from State object
    override fun stateIdOf(state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState): String = when (state) {
        is EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer -> "answer"
    ...
    override fun resolveEventByName(name: String): EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent? = when (name) {
        "error.execution" -> EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution
        "fromAbsentChild" -> EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.FromAbsentChild
        else -> null
    }

    // W3C SCXML 6.4: Resolve Event object to event name string
    override fun eventNameOf(event: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent): String? = when (event) {
        is EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution -> "error.execution"
        is EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.FromAbsentChild -> "fromAbsentChild"
    }
    ...
    private fun ensureScriptEngine() {
        ...
        engine.setupSystemVariables(
            sid,
            "empty_finalize_updates_the_location__sce_synth_invoke__inv_absent",
            com.sce.runtime.IoProcessors.build(sid, basicHttpAccessUri),
        )

        // W3C SCXML 5.2: Runtime variable 'guard' (late binding, undefined)
        try {
            engine.evaluateExpr(sid, "undefined")
            engine.setVariable(sid, "guard", null)
        } catch (_: Exception) {}
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent.Error.Execution, "<script> failed to execute")
        }
    }

    // W3C SCXML 5.10: Set _event before event processing
    private fun setCurrentEventInScriptEngine(event: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentEvent) {
        ensureScriptEngine()
        val engine = scriptEngine ?: error("scriptEngine is required (codegen invariant: needs_script_engine == true)")
        val sid = scriptSessionId ?: error("scriptSessionId must be initialized after ensureScriptEngine() (codegen invariant)")
    ...
    private fun processNullAnswer(
        ...
        else -> TransitionResult.External(EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Done, EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer)
    }
    ...
    // SCE-MAP: empty_finalize_updates_the_location__sce_synth_invoke__inv_absent.scxml:3 :: _machine
    override fun onExit(state: EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState) {
        when (state) {
            is EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer -> {
                // SCE-MAP: empty_finalize_updates_the_location__sce_synth_invoke__inv_absent.scxml:8 :: answer :: _state_body
    ...
    override fun executeTransitionActions(
        ...
        is EmptyFinalizeUpdatesTheLocationSceSynthInvokeInvAbsentState.Answer -> when {
            ...
            run {
                ...
                try {
                    putParam(paramsP, "guard", engineP.evaluateExpr(sidP, com.sce.runtime.ScriptSource.ecmascript("9")))
                } catch (_: Exception) {
