...
class Test488StateMachine(
    ...
    private fun processNullS01(
        ...
        else -> TransitionResult.External(Test488State.S02, Test488State.S01, 3)
    }
    ...
    private fun processS0(
        ...
        event is Test488Event.Error.Execution -> TransitionResult.External(Test488State.S1, Test488State.S0, 0)

        event is Test488Event.Done.State.S0 -> TransitionResult.External(Test488State.Fail, Test488State.S0, 1)

        event is Test488Event.Done.State.S0 -> TransitionResult.External(Test488State.Fail, Test488State.S0, 2)
    ...
    private fun processS1(
        ...
        event is Test488Event.Done.State.S0 -> TransitionResult.External(Test488State.Pass, Test488State.S1, 4)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test488State.Fail, Test488State.S1, 5)
    }
    ...
    // SCE-MAP: test488.scxml:4 :: _machine
    override fun onEntry(state: Test488State, pathChild: Test488State?) {
        when (state) {
