...
class Test216StateMachine(
    ...
    private fun processS0(
        ...
        event is Test216Event.Done.Invoke -> TransitionResult.External(Test216State.Pass, Test216State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test216State.Fail, Test216State.S0, 1)
    }
    ...
    // SCE-MAP: test216.scxml:7 :: _machine
    override fun onEntry(state: Test216State, pathChild: Test216State?) {
        when (state) {
                ...
                run {
                    ...
                    deferInvoke(state, generatedInvokeId) {
                        ...
                        try {
                            ...
                            raisePlatformError(Test216Event.Error.Execution, "<invoke> could not evaluate its source or start a child")
                        }
                    }
                }
            }
