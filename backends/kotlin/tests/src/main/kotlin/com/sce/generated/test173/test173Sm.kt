...
class Test173StateMachine(
    ...
    private fun processS0(
        ...
        event is Test173Event.Event1 -> TransitionResult.External(Test173State.Pass, Test173State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test173State.Fail, Test173State.S0, 1)
    }
    ...
    // SCE-MAP: test173.scxml:5 :: _machine
    override fun onEntry(state: Test173State, pathChild: Test173State?) {
        when (state) {
