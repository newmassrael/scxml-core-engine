...
class Test302StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 1")) -> TransitionResult.External(Test302State.Pass, Test302State.S0)
    ...
    // SCE-MAP: test302.scxml:7 :: _machine
    override fun onEntry(state: Test302State, pathChild: Test302State?) {
        when (state) {
