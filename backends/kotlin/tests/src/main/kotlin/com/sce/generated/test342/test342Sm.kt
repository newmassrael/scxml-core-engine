...
class Test342StateMachine(
    ...
    override fun isAtomicState(state: Test342State): Boolean = when (state) {
        else -> true
    }
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard("Var1 === Var2") -> TransitionResult.External(Test342State.Pass, Test342State.S1)
    ...
    // SCE-MAP: test342.scxml:4 :: _machine
    override fun onEntry(state: Test342State, pathChild: Test342State?) {
        when (state) {
