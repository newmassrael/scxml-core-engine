...
class Test156StateMachine(
    ...
    override fun isFinalState(state: Test156State): Boolean = when (state) {
        is Test156State.Fail, is Test156State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test156State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test156State, HistoryId>> =
            listOf(StateTarget(Test156State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test156State, HistoryId>(
            Test156State.S0,
            listOf(StateTarget(Test156State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test156State, HistoryId>(
            Test156State.S0,
            listOf(StateTarget(Test156State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
        ...
        try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "<data id='Var3'> content failed to initialise")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test156Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test156Event) {
    ...
    override fun firstEnabledTransition(
        state: Test156State,
        event: Test156Event?
    ): EnabledTransition<Test156State, HistoryId>? = when (state) {
        is Test156State.S0 -> when {
    ...
    // SCE-MAP: test156.scxml:6 :: _machine
    override fun onEntry(state: Test156State, isDefaultEntry: Boolean) {
        when (state) {
            is Test156State.Fail -> {
                // SCE-MAP: test156.scxml:30 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test156State.Pass -> {
                // SCE-MAP: test156.scxml:29 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test156State.S0 -> {
                // SCE-MAP: test156.scxml:16 :: s0 :: _state_body
    ...
    // SCE-MAP: test156.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test156State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
