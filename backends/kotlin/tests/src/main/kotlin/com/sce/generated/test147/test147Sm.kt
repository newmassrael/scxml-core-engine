...
// SCE-MAP: test147.scxml:6 :: _machine
...
class Test147StateMachine(
    ...
    override fun isFinalState(state: Test147State): Boolean = when (state) {
        is Test147State.Fail, is Test147State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test147State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test147State, HistoryId>> =
            listOf(StateTarget(Test147State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test147State, HistoryId>(
            Test147State.S0,
            listOf(StateTarget(Test147State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test147State, HistoryId>(
            Test147State.S0,
            listOf(StateTarget(Test147State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test147Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test147Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test147Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test147Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test147Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test147Event) {
    ...
    override fun firstEnabledTransition(
        state: Test147State,
        event: Test147Event?
    ): EnabledTransition<Test147State, HistoryId>? = when (state) {
        is Test147State.S0 -> when {
            event is Test147Event.Bar && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> transitionS0At0
    ...
    // SCE-MAP: test147.scxml:6 :: _machine
    override fun onEntry(state: Test147State, isDefaultEntry: Boolean) {
        when (state) {
            is Test147State.Fail -> {
                // SCE-MAP: test147.scxml:32 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test147State.Pass -> {
                // SCE-MAP: test147.scxml:31 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test147State.S0 -> {
                // SCE-MAP: test147.scxml:11 :: s0 :: _state_body
            ...
            } else if (safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("true", "true"))) {
    ...
    // SCE-MAP: test147.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test147State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
