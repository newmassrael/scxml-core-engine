...
// SCE-MAP: test148.scxml:7 :: _machine
...
class Test148StateMachine(
    ...
    override fun isFinalState(state: Test148State): Boolean = when (state) {
        is Test148State.Fail, is Test148State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test148State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test148State, HistoryId>> =
            listOf(StateTarget(Test148State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test148State, HistoryId>(
            Test148State.S0,
            listOf(StateTarget(Test148State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test148State, HistoryId>(
            Test148State.S0,
            listOf(StateTarget(Test148State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test148Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test148Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test148Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test148Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test148Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test148Event) {
    ...
    override fun firstEnabledTransition(
        state: Test148State,
        event: Test148Event?
    ): EnabledTransition<Test148State, HistoryId>? = when (state) {
        is Test148State.S0 -> when {
            event is Test148Event.Baz && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> transitionS0At0
    ...
    // SCE-MAP: test148.scxml:7 :: _machine
    override fun onEntry(state: Test148State, isDefaultEntry: Boolean) {
        when (state) {
            is Test148State.Fail -> {
                // SCE-MAP: test148.scxml:33 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test148State.Pass -> {
                // SCE-MAP: test148.scxml:32 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test148State.S0 -> {
                // SCE-MAP: test148.scxml:12 :: s0 :: _state_body
    ...
    // SCE-MAP: test148.scxml:7 :: _machine
    override fun executeTransitionContent(source: Test148State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
