...
class Test375StateMachine(
    ...
    private fun processS0(
        ...
        event is Test375Event.Event1 -> TransitionResult.External(Test375State.S1, Test375State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test375State.Fail, Test375State.S0, 1)
    }

    private fun processS1(
        event: Test375Event
    ): TransitionResult<Test375State> = when {
        event is Test375Event.Event2 -> TransitionResult.External(Test375State.Pass, Test375State.S1, 2)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test375State.Fail, Test375State.S1, 3)
    }
    ...
    // SCE-MAP: test375.scxml:5 :: _machine
    override fun onEntry(state: Test375State, pathChild: Test375State?) {
        when (state) {
