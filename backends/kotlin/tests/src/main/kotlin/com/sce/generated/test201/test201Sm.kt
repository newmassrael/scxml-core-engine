...
class Test201StateMachine(
    ...
    private fun processS0(
        ...
        event is Test201Event.Event1 -> TransitionResult.External(Test201State.Pass, Test201State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test201State.Fail, Test201State.S0, 1)
    }
    ...
    // SCE-MAP: test201.scxml:6 :: _machine
    override fun onEntry(state: Test201State, pathChild: Test201State?) {
        when (state) {
