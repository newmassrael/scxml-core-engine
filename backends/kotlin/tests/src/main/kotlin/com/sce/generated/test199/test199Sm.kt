...
class Test199StateMachine(
    ...
    private fun processS0(
        ...
        event is Test199Event.Error.Execution -> TransitionResult.External(Test199State.Pass, Test199State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test199State.Fail, Test199State.S0, 1)
    }
