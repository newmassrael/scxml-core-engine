...
class Test409StateMachine(
    ...
    private fun processNullS011(
        ...
        else -> TransitionResult.External(Test409State.S02, Test409State.S011, 2)
    }
    ...
    private fun processS0(
        ...
        event is Test409Event.Timeout -> TransitionResult.External(Test409State.Pass, Test409State.S0, 0)

        event is Test409Event.Event1 -> TransitionResult.External(Test409State.Fail, Test409State.S0, 1)
