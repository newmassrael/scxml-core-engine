...
class Test569StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_ioprocessors['scxml'].location")) -> TransitionResult.External(Test569State.Pass, Test569State.S0)
    ...
    // SCE-MAP: test569.scxml:7 :: _machine
    override fun onEntry(state: Test569State, pathChild: Test569State?) {
        when (state) {
