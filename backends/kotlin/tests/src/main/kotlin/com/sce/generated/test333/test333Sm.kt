...
class Test333StateMachine(
    ...
    private fun processS0(
        ...
        event is Test333Event.Foo -> TransitionResult.External(Test333State.Pass, Test333State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test333State.Fail, Test333State.S0, 1)
    }
