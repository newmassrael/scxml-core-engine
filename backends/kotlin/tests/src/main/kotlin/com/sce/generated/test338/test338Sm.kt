...
class Test338StateMachine(
    ...
    private fun processS0(
        ...
        event is Test338Event.Event1 -> TransitionResult.External(Test338State.S1, Test338State.S0, 0)

        event is Test338Event.Event0 -> TransitionResult.External(Test338State.Fail, Test338State.S0, 1)
    ...
    // SCE-MAP: test338.scxml:6 :: _machine
    override fun onEntry(state: Test338State, pathChild: Test338State?) {
        when (state) {
