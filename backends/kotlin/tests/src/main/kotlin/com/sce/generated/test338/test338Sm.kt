...
// SCE-MAP: test338.scxml:6 :: _machine
...
class Test338StateMachine(
    ...
    override fun isFinalState(state: Test338State): Boolean = when (state) {
        is Test338State.Fail, is Test338State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test338State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test338State, HistoryId>> =
            listOf(StateTarget(Test338State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test338State, HistoryId>(
            Test338State.S0,
            listOf(StateTarget(Test338State.S1)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test338State, HistoryId>(
            Test338State.S0,
            listOf(StateTarget(Test338State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test338State, HistoryId>(
            Test338State.S1,
            listOf(StateTarget(Test338State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test338State, HistoryId>(
            Test338State.S1,
            listOf(StateTarget(Test338State.Fail)),
            1,
            hasActions = false,
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test338Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test338Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test338Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun storeIdInLocation(location: com.sce.runtime.ScriptSource, id: String, element: String): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test338Event.Error.Execution, "$element idlocation could not take the id")
            false
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test338Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test338Event) {
    ...
    override fun firstEnabledTransition(
        state: Test338State,
        event: Test338Event?
    ): EnabledTransition<Test338State, HistoryId>? = when (state) {
        is Test338State.S0 -> when {
            event is Test338Event.Event1 -> transitionS0At0
            event is Test338Event.Event0 -> transitionS0At1
            else -> null
        }
        is Test338State.S1 -> when {
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("(Var1 == Var2)", "Var1 === Var2")) -> transitionS1At0
    ...
    // SCE-MAP: test338.scxml:6 :: _machine
    override fun onEntry(state: Test338State, isDefaultEntry: Boolean) {
        when (state) {
            is Test338State.Fail -> {
                // SCE-MAP: test338.scxml:39 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test338State.Pass -> {
                // SCE-MAP: test338.scxml:38 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test338State.S0 -> {
                // SCE-MAP: test338.scxml:12 :: s0 :: _state_body
            ...
            is Test338State.S1 -> {
                // SCE-MAP: test338.scxml:33 :: s1 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test338.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test338State, transitionIndex: Int) {
        when (source) {
        is Test338State.S0 -> when (transitionIndex) {
            0 -> {
