...
class Test557StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var1.getElementsByTagName('book')[0].getAttribute('title') == 'title1'")) -> TransitionResult.External(Test557State.S1, Test557State.S0)
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var2.getElementsByTagName('book')[1].getAttribute('title') == 'title2'")) -> TransitionResult.External(Test557State.Pass, Test557State.S1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
