...
class Test531StateMachine(
    ...
    private fun processS0(
        ...
        event is Test531Event.Test -> TransitionResult.External(Test531State.Pass, Test531State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test531State.Fail, Test531State.S0, 1)
    }
    ...
    // SCE-MAP: test531.scxml:4 :: _machine
    override fun onEntry(state: Test531State, pathChild: Test531State?) {
        when (state) {
