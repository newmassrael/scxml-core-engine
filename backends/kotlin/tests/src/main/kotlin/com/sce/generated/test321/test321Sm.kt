...
// SCE-MAP: test321.scxml:5 :: _machine
...
class Test321StateMachine(
    ...
    override fun isFinalState(state: Test321State): Boolean = when (state) {
        is Test321State.Fail, is Test321State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test321State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test321State, HistoryId>> =
            listOf(StateTarget(Test321State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test321State, HistoryId>(
            Test321State.S0,
            listOf(StateTarget(Test321State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test321State, HistoryId>(
            Test321State.S0,
            listOf(StateTarget(Test321State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test321Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test321Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test321Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test321Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test321Event) {
    ...
    override fun firstEnabledTransition(
        state: Test321State,
        event: Test321Event?
    ): EnabledTransition<Test321State, HistoryId>? = when (state) {
        is Test321State.S0 -> when {
            ...
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("true", "true")) -> transitionS0At1
            else -> null
        }
        else -> null
    }
    ...
    // SCE-MAP: test321.scxml:5 :: _machine
    override fun onEntry(state: Test321State, isDefaultEntry: Boolean) {
        when (state) {
            is Test321State.Fail -> {
                // SCE-MAP: test321.scxml:17 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test321State.Pass -> {
                // SCE-MAP: test321.scxml:16 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test321State.S0 -> {
                // SCE-MAP: test321.scxml:10 :: s0 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test321.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test321State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
