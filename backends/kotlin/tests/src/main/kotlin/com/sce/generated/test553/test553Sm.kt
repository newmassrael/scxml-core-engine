...
class Test553StateMachine(
    ...
    private fun processS0(
        ...
        event is Test553Event.Timeout -> TransitionResult.External(Test553State.Pass, Test553State.S0, 0)

        event is Test553Event.Event1 -> TransitionResult.External(Test553State.Fail, Test553State.S0, 1)
    ...
    // SCE-MAP: test553.scxml:6 :: _machine
    override fun onEntry(state: Test553State, pathChild: Test553State?) {
        when (state) {
