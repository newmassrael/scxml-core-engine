...
class Test378StateMachine(
    ...
    private fun processNullS0(
        ...
        else -> TransitionResult.External(Test378State.S1, Test378State.S0, 0)
    }

    private fun processNullS1(
    ): TransitionResult<Test378State> = when {
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 2)", "Var1 == 2")) -> TransitionResult.External(Test378State.Pass, Test378State.S1, 1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test378State.Fail, Test378State.S1, 2)
    }
    ...
    // SCE-MAP: test378.scxml:6 :: _machine
    override fun onEntry(state: Test378State, pathChild: Test378State?) {
        when (state) {
