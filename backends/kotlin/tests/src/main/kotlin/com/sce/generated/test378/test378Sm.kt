...
class Test378StateMachine(
    ...
    override fun isFinalState(state: Test378State): Boolean = when (state) {
        is Test378State.Fail, is Test378State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test378State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test378State, HistoryId>> =
            listOf(StateTarget(Test378State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test378State, HistoryId>(
            Test378State.S0,
            listOf(StateTarget(Test378State.S1)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test378State, HistoryId>(
            Test378State.S1,
            listOf(StateTarget(Test378State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test378State, HistoryId>(
            Test378State.S1,
            listOf(StateTarget(Test378State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test378Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test378Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test378Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test378Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test378Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test378Event) {
    ...
    override fun firstEnabledTransition(
        state: Test378State,
        event: Test378Event?
    ): EnabledTransition<Test378State, HistoryId>? = when (state) {
        is Test378State.S0 -> when {
            event == null -> transitionS0At0
            else -> null
        }
        is Test378State.S1 -> when {
    ...
    // SCE-MAP: test378.scxml:6 :: _machine
    override fun onEntry(state: Test378State, isDefaultEntry: Boolean) {
        when (state) {
            is Test378State.Fail -> {
                // SCE-MAP: test378.scxml:28 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test378State.Pass -> {
                // SCE-MAP: test378.scxml:27 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test378State.S0 -> {
            ...
            is Test378State.S1 -> {
                // SCE-MAP: test378.scxml:22 :: s1 :: _state_body
            }
        }
    }
    ...
    override fun onExit(state: Test378State) {
        when (state) {
            ...
            raisePlatformError(Test378Event.Error.Execution, "<send target='!invalid'> is not a target this processor can address", "__send_0")
    ...
    // SCE-MAP: test378.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test378State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
