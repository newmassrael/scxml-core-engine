...
class Test560StateMachine(
    ...
    private fun processS0(
        ...
        event is Test560Event.Foo && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data.aParam == 1")) -> TransitionResult.External(Test560State.Pass, Test560State.S0)
    ...
    // SCE-MAP: test560.scxml:5 :: _machine
    override fun onEntry(state: Test560State, pathChild: Test560State?) {
        when (state) {
