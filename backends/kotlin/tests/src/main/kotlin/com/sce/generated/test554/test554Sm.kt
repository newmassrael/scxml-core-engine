...
class Test554StateMachine(
    ...
    private fun processS0(
        ...
        event is Test554Event.Timer -> TransitionResult.External(Test554State.Pass, Test554State.S0, 0)

        event is Test554Event.Done.Invoke -> TransitionResult.External(Test554State.Fail, Test554State.S0, 1)
    ...
    // SCE-MAP: test554.scxml:7 :: _machine
    override fun onEntry(state: Test554State, pathChild: Test554State?) {
        when (state) {
