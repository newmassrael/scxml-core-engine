...
// SCE-MAP: test226sub1.scxml:5 :: _machine
...
class Test226sub1StateMachine(
    ...
    override fun isFinalState(state: Test226sub1State): Boolean = when (state) {
        is Test226sub1State.Final -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test226sub1State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test226sub1State, HistoryId>> =
            listOf(StateTarget(Test226sub1State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test226sub1State, HistoryId>(
            Test226sub1State.S0,
            listOf(StateTarget(Test226sub1State.Final)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test226sub1State, HistoryId>(
            Test226sub1State.S0,
            listOf(StateTarget(Test226sub1State.Final)),
            1,
            hasActions = false,
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test226sub1Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test226sub1Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test226sub1Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test226sub1Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test226sub1Event) {
    ...
    ): EnabledTransition<Test226sub1State, HistoryId>? = when (state) {
    ...
    // SCE-MAP: test226sub1.scxml:5 :: _machine
    override fun onEntry(state: Test226sub1State, isDefaultEntry: Boolean) {
        when (state) {
            is Test226sub1State.Final -> {
                // SCE-MAP: test226sub1.scxml:18 :: final :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test226sub1State.S0 -> {
                // SCE-MAP: test226sub1.scxml:11 :: s0 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test226sub1.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test226sub1State, transitionIndex: Int) {
        when (source) {
        is Test226sub1State.S0 -> when (transitionIndex) {
            0 -> {
