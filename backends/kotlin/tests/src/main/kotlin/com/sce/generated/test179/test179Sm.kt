...
class Test179StateMachine(
    ...
    private fun processS0(
        ...
        event is Test179Event.Event1 && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data == 123")) -> TransitionResult.External(Test179State.Pass, Test179State.S0)
