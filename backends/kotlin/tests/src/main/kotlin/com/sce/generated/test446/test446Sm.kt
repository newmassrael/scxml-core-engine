...
class Test446StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var1 instanceof Array")) -> TransitionResult.External(Test446State.S1, Test446State.S0)
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("var2 instanceof Array")) -> TransitionResult.External(Test446State.Pass, Test446State.S1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
