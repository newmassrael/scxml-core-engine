...
class Test153StateMachine(
    ...
    override fun isFinalState(state: Test153State): Boolean = when (state) {
        is Test153State.Fail, is Test153State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test153State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test153State, HistoryId>> =
            listOf(StateTarget(Test153State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test153State, HistoryId>(
            Test153State.S0,
            listOf(StateTarget(Test153State.Fail)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test153State, HistoryId>(
            Test153State.S0,
            listOf(StateTarget(Test153State.Pass)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test153Event.Error.Execution, "<data id='Var3'> content failed to initialise")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test153Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test153Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test153Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test153Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test153Event) {
    ...
    override fun firstEnabledTransition(
        state: Test153State,
        event: Test153Event?
    ): EnabledTransition<Test153State, HistoryId>? = when (state) {
        is Test153State.S0 -> when {
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var4, 0)", "Var4 == 0")) -> transitionS0At0
    ...
    // SCE-MAP: test153.scxml:7 :: _machine
    override fun onEntry(state: Test153State, isDefaultEntry: Boolean) {
        when (state) {
            is Test153State.Fail -> {
                // SCE-MAP: test153.scxml:35 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test153State.Pass -> {
                // SCE-MAP: test153.scxml:34 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test153State.S0 -> {
            ...
            engine.assign(sid, com.sce.runtime.ScriptSource.lua("Var4", "Var4"), com.sce.runtime.ScriptSource.lua("0", "0"))
                    ...
                    raisePlatformError(Test153Event.Error.Execution, "<foreach array='Var3'> failed to iterate")
                }
            }
            }
        }
    ...
    // SCE-MAP: test153.scxml:7 :: _machine
    override fun executeTransitionContent(source: Test153State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
