...
class Test153StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var4 == 0")) -> TransitionResult.External(Test153State.Fail, Test153State.S0)
    ...
    // SCE-MAP: test153.scxml:7 :: _machine
    override fun onEntry(state: Test153State, pathChild: Test153State?) {
        when (state) {
