...
class Test277StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> TransitionResult.External(Test277State.Pass, Test277State.S1, 2)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test277State.Fail, Test277State.S1, 3)
    }
    ...
    private fun processS0(
        ...
        event is Test277Event.Error.Execution -> TransitionResult.External(Test277State.S1, Test277State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test277State.Fail, Test277State.S0, 1)
    }
    ...
    // SCE-MAP: test277.scxml:6 :: _machine
    override fun onEntry(state: Test277State, pathChild: Test277State?) {
        when (state) {
