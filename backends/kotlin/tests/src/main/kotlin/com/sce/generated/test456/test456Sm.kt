...
// SCE-MAP: test456.scxml:4 :: _machine
...
class Test456StateMachine(
    ...
    override fun isFinalState(state: Test456State): Boolean = when (state) {
        is Test456State.Fail, is Test456State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test456State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test456State, HistoryId>> =
            listOf(StateTarget(Test456State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test456State, HistoryId>(
            Test456State.S0,
            listOf(StateTarget(Test456State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test456State, HistoryId>(
            Test456State.S0,
            listOf(StateTarget(Test456State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test456Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test456Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test456Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test456Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test456Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test456Event) {
    ...
    override fun firstEnabledTransition(
        state: Test456State,
        event: Test456Event?
    ): EnabledTransition<Test456State, HistoryId>? = when (state) {
        is Test456State.S0 -> when {
    ...
    // SCE-MAP: test456.scxml:4 :: _machine
    override fun onEntry(state: Test456State, isDefaultEntry: Boolean) {
        when (state) {
            is Test456State.Fail -> {
                // SCE-MAP: test456.scxml:20 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test456State.Pass -> {
                // SCE-MAP: test456.scxml:19 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test456State.S0 -> {
                // SCE-MAP: test456.scxml:9 :: s0 :: _state_body


            executeScriptBlock(com.sce.runtime.ScriptSource.lua("Var1 = _scxml_add(Var1, 1)", "\n      Var1+=1\n      "))
            }
        }
    }
    ...
    // SCE-MAP: test456.scxml:4 :: _machine
    override fun executeTransitionContent(source: Test456State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
