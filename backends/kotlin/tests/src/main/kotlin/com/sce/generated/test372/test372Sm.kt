...
class Test372StateMachine(
    ...
    private fun processS0(
        ...
        event is Test372Event.Done.State.S0 && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 2")) -> TransitionResult.External(Test372State.Pass, Test372State.S0)
    ...
    // SCE-MAP: test372.scxml:6 :: _machine
    override fun onEntry(state: Test372State, pathChild: Test372State?) {
        when (state) {
