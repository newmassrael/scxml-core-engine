...
class Test226StateMachine(
    ...
    private fun processS0(
        ...
        event is Test226Event.VarBound -> TransitionResult.External(Test226State.Pass, Test226State.S0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test226State.Fail, Test226State.S0)
    }
