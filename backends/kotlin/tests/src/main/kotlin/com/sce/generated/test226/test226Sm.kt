...
class Test226StateMachine(
    ...
    override fun isAtomicState(state: Test226State): Boolean = when (state) {
        else -> true
    }
    ...
    private fun processS0(
        ...
        event is Test226Event.VarBound -> TransitionResult.External(Test226State.Pass, Test226State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test226State.Fail, Test226State.S0, 1)
    }
    ...
    // SCE-MAP: test226.scxml:7 :: _machine
    override fun onEntry(state: Test226State, pathChild: Test226State?) {
        when (state) {
