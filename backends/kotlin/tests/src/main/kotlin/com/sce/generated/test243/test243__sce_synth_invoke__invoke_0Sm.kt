...
class Test243SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processNullSub0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> TransitionResult.External(Test243SceSynthInvokeInvoke0State.SubFinal, Test243SceSynthInvokeInvoke0State.Sub0, 0)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test243SceSynthInvokeInvoke0State.SubFinal, Test243SceSynthInvokeInvoke0State.Sub0, 1)
    }
    ...
    // SCE-MAP: test243__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun onEntry(state: Test243SceSynthInvokeInvoke0State, pathChild: Test243SceSynthInvokeInvoke0State?) {
        when (state) {
