...
class Test349StateMachine(
    ...
    private fun processS0(
        ...
        event is Test349Event.S0Event -> TransitionResult.External(Test349State.S2, Test349State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test349State.Fail, Test349State.S0, 1)
    }

    private fun processS2(
        event: Test349Event
    ): TransitionResult<Test349State> = when {
        event is Test349Event.S0Event2 -> TransitionResult.External(Test349State.Pass, Test349State.S2, 2)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test349State.Fail, Test349State.S2, 3)
    }
    ...
    // SCE-MAP: test349.scxml:5 :: _machine
    override fun onEntry(state: Test349State, pathChild: Test349State?) {
        when (state) {
