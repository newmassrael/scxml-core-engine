...
class Test403aStateMachine(
    ...
    private fun processS0(
        ...
        event is Test403aEvent.Timeout -> TransitionResult.External(Test403aState.Fail, Test403aState.S0, 0)

        event is Test403aEvent.Event1 -> TransitionResult.External(Test403aState.Fail, Test403aState.S0, 1)

        event is Test403aEvent.Event2 -> TransitionResult.External(Test403aState.Pass, Test403aState.S0, 2)
    ...
    private fun processS01(
        ...
        event is Test403aEvent.Event1 -> TransitionResult.External(Test403aState.S02, Test403aState.S01, 3)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test403aState.Fail, Test403aState.S01, 4)
    }

    private fun processS02(
        event: Test403aEvent
    ): TransitionResult<Test403aState> = when {
        event is Test403aEvent.Event1 -> TransitionResult.External(Test403aState.Fail, Test403aState.S02, 5)

        event is Test403aEvent.Event2 && false -> TransitionResult.External(Test403aState.Fail, Test403aState.S02, 6)
    ...
    // SCE-MAP: test403a.scxml:11 :: _machine
    override fun onEntry(state: Test403aState, pathChild: Test403aState?) {
        when (state) {
