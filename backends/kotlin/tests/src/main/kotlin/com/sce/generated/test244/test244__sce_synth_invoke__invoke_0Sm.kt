...
class Test244SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processNullSub0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 1")) -> TransitionResult.External(Test244SceSynthInvokeInvoke0State.SubFinal, Test244SceSynthInvokeInvoke0State.Sub0, 0)
