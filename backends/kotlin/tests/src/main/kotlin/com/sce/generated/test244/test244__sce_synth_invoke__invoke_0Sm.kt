...
// SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:3 :: _machine
...
class Test244SceSynthInvokeInvoke0StateMachine(
    ...
    override fun isFinalState(state: Test244SceSynthInvokeInvoke0State): Boolean = when (state) {
        is Test244SceSynthInvokeInvoke0State.SubFinal -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test244SceSynthInvokeInvoke0State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test244SceSynthInvokeInvoke0State, HistoryId>> =
            listOf(StateTarget(Test244SceSynthInvokeInvoke0State.Sub0))

        // W3C SCXML 3.13: sub0's transition 0, as the microstep reads it.
        val transitionSub0At0 = EnabledTransition<Test244SceSynthInvokeInvoke0State, HistoryId>(
            Test244SceSynthInvokeInvoke0State.Sub0,
            listOf(StateTarget(Test244SceSynthInvokeInvoke0State.SubFinal)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionSub0At1 = EnabledTransition<Test244SceSynthInvokeInvoke0State, HistoryId>(
            Test244SceSynthInvokeInvoke0State.Sub0,
            listOf(StateTarget(Test244SceSynthInvokeInvoke0State.SubFinal)),
            1,
            hasActions = true,
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test244SceSynthInvokeInvoke0Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test244SceSynthInvokeInvoke0Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test244SceSynthInvokeInvoke0Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test244SceSynthInvokeInvoke0Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test244SceSynthInvokeInvoke0Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test244SceSynthInvokeInvoke0Event) {
    ...
    ): EnabledTransition<Test244SceSynthInvokeInvoke0State, HistoryId>? = when (state) {
        is Test244SceSynthInvokeInvoke0State.Sub0 -> when {
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> transitionSub0At0
    ...
    // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun onEntry(state: Test244SceSynthInvokeInvoke0State, isDefaultEntry: Boolean) {
        when (state) {
            is Test244SceSynthInvokeInvoke0State.Sub0 -> {
                // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:8 :: sub0 :: _state_body
            }
            is Test244SceSynthInvokeInvoke0State.SubFinal -> {
                // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:16 :: subFinal :: _state_body
    ...
    // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun executeTransitionContent(source: Test244SceSynthInvokeInvoke0State, transitionIndex: Int) {
        when (source) {
        is Test244SceSynthInvokeInvoke0State.Sub0 -> when (transitionIndex) {
            0 -> {
                // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:9 :: sub0 :: _transition_0
            ...
            1 -> {
                // SCE-MAP: test244__sce_synth_invoke__invoke_0.scxml:12 :: sub0 :: _transition_1
