...
// SCE-MAP: test228.scxml:5 :: _machine
...
class Test228StateMachine(
    ...
    override fun isFinalState(state: Test228State): Boolean = when (state) {
        is Test228State.Fail, is Test228State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test228State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test228State, HistoryId>> =
            listOf(StateTarget(Test228State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test228State, HistoryId>(
            Test228State.S0,
            listOf(StateTarget(Test228State.S1)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test228State, HistoryId>(
            Test228State.S0,
            listOf(StateTarget(Test228State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test228State, HistoryId>(
            Test228State.S1,
            listOf(StateTarget(Test228State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test228State, HistoryId>(
            Test228State.S1,
            listOf(StateTarget(Test228State.Fail)),
            1,
            hasActions = false,
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test228Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test228Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test228Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test228Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test228Event) {
    ...
    override fun firstEnabledTransition(
        state: Test228State,
        event: Test228Event?
    ): EnabledTransition<Test228State, HistoryId>? = when (state) {
        is Test228State.S0 -> when {
            event is Test228Event.Done.Invoke -> transitionS0At0
            event != null -> transitionS0At1
            else -> null
        }
        is Test228State.S1 -> when {
            event == null && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, \"foo\")", "Var1 == 'foo'")) -> transitionS1At0
    ...
    // SCE-MAP: test228.scxml:5 :: _machine
    override fun onEntry(state: Test228State, isDefaultEntry: Boolean) {
        when (state) {
            is Test228State.Fail -> {
                // SCE-MAP: test228.scxml:35 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test228State.Pass -> {
                // SCE-MAP: test228.scxml:34 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test228State.S0 -> {
                // SCE-MAP: test228.scxml:10 :: s0 :: _state_body
            ...
            is Test228State.S1 -> {
                // SCE-MAP: test228.scxml:29 :: s1 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test228.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test228State, transitionIndex: Int) {
        when (source) {
        is Test228State.S0 -> when (transitionIndex) {
            0 -> {
                // SCE-MAP: test228.scxml:23 :: s0 :: _transition_0


            executeAssign(com.sce.runtime.ScriptSource.lua("Var1", "Var1"), com.sce.runtime.ScriptSource.lua("_event.invokeid", "_event.invokeid"))
            }
            else -> {}
        }
        else -> {}
