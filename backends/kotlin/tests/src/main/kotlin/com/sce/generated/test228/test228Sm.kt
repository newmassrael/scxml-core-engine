...
class Test228StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, \"foo\")", "Var1 == 'foo'")) -> TransitionResult.External(Test228State.Pass, Test228State.S1, 2)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test228State.Fail, Test228State.S1, 3)
    }
    ...
    private fun processS0(
        ...
        event is Test228Event.Done.Invoke -> TransitionResult.External(Test228State.S1, Test228State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test228State.Fail, Test228State.S0, 1)
    }
    ...
    // SCE-MAP: test228.scxml:5 :: _machine
    override fun onEntry(state: Test228State, pathChild: Test228State?) {
        when (state) {
