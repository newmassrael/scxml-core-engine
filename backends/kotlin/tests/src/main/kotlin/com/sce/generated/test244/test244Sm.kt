...
class Test244StateMachine(
    ...
    private fun processS0(
        ...
        event is Test244Event.Success -> TransitionResult.External(Test244State.Pass, Test244State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test244State.Fail, Test244State.S0, 1)
    }
