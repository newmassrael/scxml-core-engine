...
// SCE-MAP: test225.scxml:5 :: _machine
...
class Test225StateMachine(
    ...
    override fun isFinalState(state: Test225State): Boolean = when (state) {
        is Test225State.Fail, is Test225State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test225State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test225State, HistoryId>> =
            listOf(StateTarget(Test225State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test225State, HistoryId>(
            Test225State.S0,
            listOf(StateTarget(Test225State.S1)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test225State, HistoryId>(
            Test225State.S1,
            listOf(StateTarget(Test225State.Fail)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test225State, HistoryId>(
            Test225State.S1,
            listOf(StateTarget(Test225State.Pass)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test225Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test225Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test225Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun storeIdInLocation(location: com.sce.runtime.ScriptSource, id: String, element: String): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test225Event.Error.Execution, "$element idlocation could not take the id")
            false
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test225Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test225Event) {
    ...
    override fun firstEnabledTransition(
        state: Test225State,
        event: Test225Event?
    ): EnabledTransition<Test225State, HistoryId>? = when (state) {
        is Test225State.S0 -> when {
            event != null -> transitionS0At0
            else -> null
        }
        is Test225State.S1 -> when {
    ...
    // SCE-MAP: test225.scxml:5 :: _machine
    override fun onEntry(state: Test225State, isDefaultEntry: Boolean) {
        when (state) {
            is Test225State.Fail -> {
                // SCE-MAP: test225.scxml:40 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test225State.Pass -> {
                // SCE-MAP: test225.scxml:39 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test225State.S0 -> {
                // SCE-MAP: test225.scxml:11 :: s0 :: _state_body
    ...
    // SCE-MAP: test225.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test225State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
