...
// SCE-MAP: test311.scxml:5 :: _machine
...
class Test311StateMachine(
    ...
    override fun isFinalState(state: Test311State): Boolean = when (state) {
        is Test311State.Fail, is Test311State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test311State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test311State, HistoryId>> =
            listOf(StateTarget(Test311State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test311State, HistoryId>(
            Test311State.S0,
            listOf(StateTarget(Test311State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test311State, HistoryId>(
            Test311State.S0,
            listOf(StateTarget(Test311State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test311Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test311Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test311Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test311Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test311Event) {
    ...
    override fun firstEnabledTransition(
        state: Test311State,
        event: Test311Event?
    ): EnabledTransition<Test311State, HistoryId>? = when (state) {
        is Test311State.S0 -> when {
            event is Test311Event.Error.Execution -> transitionS0At0
    ...
    // SCE-MAP: test311.scxml:5 :: _machine
    override fun onEntry(state: Test311State, isDefaultEntry: Boolean) {
        when (state) {
            is Test311State.Fail -> {
                // SCE-MAP: test311.scxml:18 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test311State.Pass -> {
                // SCE-MAP: test311.scxml:17 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test311State.S0 -> {
            ...
            raisePlatformError(Test311Event.Error.Execution, "<assign> has an invalid or read-only location")
            }
        }
    }
    ...
    // SCE-MAP: test311.scxml:5 :: _machine
    override fun executeTransitionContent(source: Test311State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
