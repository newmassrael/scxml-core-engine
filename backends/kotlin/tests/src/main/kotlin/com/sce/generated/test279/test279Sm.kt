...
class Test279StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 1")) -> TransitionResult.External(Test279State.Pass, Test279State.S0)
    ...
    // SCE-MAP: test279.scxml:5 :: _machine
    override fun onEntry(state: Test279State, pathChild: Test279State?) {
        when (state) {
