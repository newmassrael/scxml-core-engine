...
class Test527StateMachine(
    ...
    private fun processS0(
        ...
        event is Test527Event.Done.State.S0 && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data == 'foo'")) -> TransitionResult.External(Test527State.Pass, Test527State.S0)
    ...
    // SCE-MAP: test527.scxml:4 :: _machine
    override fun onEntry(state: Test527State, pathChild: Test527State?) {
        when (state) {
