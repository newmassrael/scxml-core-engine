...
class Test237SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processSub0(
        ...
        event is Test237SceSynthInvokeInvoke0Event.Timeout -> TransitionResult.External(Test237SceSynthInvokeInvoke0State.SubFinal, Test237SceSynthInvokeInvoke0State.Sub0, 0)
    ...
    // SCE-MAP: test237__sce_synth_invoke__invoke_0.scxml:3 :: _machine
    override fun onEntry(state: Test237SceSynthInvokeInvoke0State, pathChild: Test237SceSynthInvokeInvoke0State?) {
        when (state) {
