...
class Test318StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, \"foo\")", "Var1 == 'foo'")) -> TransitionResult.External(Test318State.Pass, Test318State.S1, 1)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test318State.Fail, Test318State.S1, 2)
    }
    ...
    private fun processS0(
        ...
        event is Test318Event.Foo -> TransitionResult.External(Test318State.S1, Test318State.S0, 0)
    ...
    // SCE-MAP: test318.scxml:5 :: _machine
    override fun onEntry(state: Test318State, pathChild: Test318State?) {
        when (state) {
