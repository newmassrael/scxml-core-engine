...
class Test276sub1StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> TransitionResult.External(Test276sub1State.Final, Test276sub1State.S0, 0)
    ...
    // SCE-MAP: test276sub1.scxml:2 :: _machine
    override fun onEntry(state: Test276sub1State, pathChild: Test276sub1State?) {
        when (state) {
