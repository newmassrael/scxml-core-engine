...
class Test276sub1StateMachine(
    ...
    override fun isFinalState(state: Test276sub1State): Boolean = when (state) {
        is Test276sub1State.Final -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test276sub1State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test276sub1State, HistoryId>> =
            listOf(StateTarget(Test276sub1State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test276sub1State, HistoryId>(
            Test276sub1State.S0,
            listOf(StateTarget(Test276sub1State.Final)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test276sub1State, HistoryId>(
            Test276sub1State.S0,
            listOf(StateTarget(Test276sub1State.Final)),
            1,
            hasActions = true,
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test276sub1Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test276sub1Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test276sub1Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test276sub1Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test276sub1Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test276sub1Event) {
    ...
    ): EnabledTransition<Test276sub1State, HistoryId>? = when (state) {
    ...
    // SCE-MAP: test276sub1.scxml:2 :: _machine
    override fun onEntry(state: Test276sub1State, isDefaultEntry: Boolean) {
        when (state) {
    ...
    // SCE-MAP: test276sub1.scxml:2 :: _machine
    override fun executeTransitionContent(source: Test276sub1State, transitionIndex: Int) {
        when (source) {
