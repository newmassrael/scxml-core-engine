...
class Test310StateMachine(
    ...
    private fun processNullS0(
        ...
        isStateActive("s1") -> TransitionResult.External(Test310State.Pass, Test310State.S0, 0)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test310State.Fail, Test310State.S0, 1)
    }
    ...
    // SCE-MAP: test310.scxml:5 :: _machine
    override fun onEntry(state: Test310State, pathChild: Test310State?) {
        when (state) {
            ...
            is Test310State.P -> {
                ...
                if (pathChild != Test310State.S0) {
                    onEntry(Test310State.S0)
                }
                if (pathChild != Test310State.S1) {
