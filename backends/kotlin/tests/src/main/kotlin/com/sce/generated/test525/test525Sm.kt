...
class Test525StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var2 == 3")) -> TransitionResult.External(Test525State.Pass, Test525State.S0)
    ...
    // SCE-MAP: test525.scxml:6 :: _machine
    override fun onEntry(state: Test525State, pathChild: Test525State?) {
        when (state) {
