...
class Test178StateMachine(
    ...
    private fun processS0(
        ...
        event is Test178Event.Event1 -> TransitionResult.External(Test178State.Final, Test178State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test178State.Fail, Test178State.S0, 1)
    }
