...
class Test562StateMachine(
    ...
    override fun isAtomicState(state: Test562State): Boolean = when (state) {
        else -> true
    }
    ...
    private fun processS0(
        ...
        event is Test562Event.Foo && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data == 'this is a string'")) -> TransitionResult.External(Test562State.Pass, Test562State.S0)
    ...
    // SCE-MAP: test562.scxml:5 :: _machine
    override fun onEntry(state: Test562State, pathChild: Test562State?) {
        when (state) {
