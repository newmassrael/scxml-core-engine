...
class Test183StateMachine(
    ...
    private fun processNullS0(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("(_typeof(Var1) ~= \"undefined\")", "typeof Var1 !== 'undefined'")) -> TransitionResult.External(Test183State.Pass, Test183State.S0, 0)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test183State.Fail, Test183State.S0, 1)
    }
