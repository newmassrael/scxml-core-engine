...
class Test186StateMachine(
    ...
    private fun processNullS1(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var2, 1)", "Var2 == 1")) -> TransitionResult.External(Test186State.Pass, Test186State.S1, 2)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test186State.Fail, Test186State.S1, 3)
    }
    ...
    private fun processS0(
        ...
        event is Test186Event.Event1 -> TransitionResult.External(Test186State.S1, Test186State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test186State.Fail, Test186State.S0, 1)
    }
    ...
    // SCE-MAP: test186.scxml:6 :: _machine
    override fun onEntry(state: Test186State, pathChild: Test186State?) {
        when (state) {
