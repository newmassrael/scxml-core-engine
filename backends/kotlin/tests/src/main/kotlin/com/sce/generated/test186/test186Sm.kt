...
// SCE-MAP: test186.scxml:6 :: _machine
...
class Test186StateMachine(
    ...
    override fun isFinalState(state: Test186State): Boolean = when (state) {
        is Test186State.Fail, is Test186State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test186State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test186State, HistoryId>> =
            listOf(StateTarget(Test186State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test186State, HistoryId>(
            Test186State.S0,
            listOf(StateTarget(Test186State.S1)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test186State, HistoryId>(
            Test186State.S0,
            listOf(StateTarget(Test186State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test186State, HistoryId>(
            Test186State.S1,
            listOf(StateTarget(Test186State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test186State, HistoryId>(
            Test186State.S1,
            listOf(StateTarget(Test186State.Fail)),
            1,
            hasActions = false,
    ...
    private fun ensureScriptEngine() {
        ...
        try {
            ...
            raisePlatformError(Test186Event.Error.Execution, "<data id='Var1'> expr failed to evaluate")
        }
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test186Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test186Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test186Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test186Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test186Event) {
    ...
    override fun firstEnabledTransition(
        state: Test186State,
        event: Test186Event?
    ): EnabledTransition<Test186State, HistoryId>? = when (state) {
        is Test186State.S0 -> when {
            event is Test186Event.Event1 -> transitionS0At0
            event != null -> transitionS0At1
            else -> null
        }
        is Test186State.S1 -> when {
    ...
    // SCE-MAP: test186.scxml:6 :: _machine
    override fun onEntry(state: Test186State, isDefaultEntry: Boolean) {
        when (state) {
            is Test186State.Fail -> {
                // SCE-MAP: test186.scxml:32 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test186State.Pass -> {
                // SCE-MAP: test186.scxml:31 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test186State.S0 -> {
            ...
            is Test186State.S1 -> {
                // SCE-MAP: test186.scxml:26 :: s1 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test186.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test186State, transitionIndex: Int) {
        when (source) {
        is Test186State.S0 -> when (transitionIndex) {
            0 -> {
                // SCE-MAP: test186.scxml:20 :: s0 :: _transition_0
