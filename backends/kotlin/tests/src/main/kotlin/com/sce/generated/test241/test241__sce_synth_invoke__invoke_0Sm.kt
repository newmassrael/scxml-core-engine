...
class Test241SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processNullSub01(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("Var1 == 1")) -> TransitionResult.External(Test241SceSynthInvokeInvoke0State.SubFinal1, Test241SceSynthInvokeInvoke0State.Sub01, 0)
