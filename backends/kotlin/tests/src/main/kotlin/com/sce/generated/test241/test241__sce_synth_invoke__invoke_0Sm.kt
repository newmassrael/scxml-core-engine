...
class Test241SceSynthInvokeInvoke0StateMachine(
    ...
    private fun processNullSub01(
        ...
        safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(Var1, 1)", "Var1 == 1")) -> TransitionResult.External(Test241SceSynthInvokeInvoke0State.SubFinal1, Test241SceSynthInvokeInvoke0State.Sub01, 0)
        // W3C SCXML 3.13: First unconditional transition wins (document order)
        else -> TransitionResult.External(Test241SceSynthInvokeInvoke0State.SubFinal1, Test241SceSynthInvokeInvoke0State.Sub01, 1)
    }
