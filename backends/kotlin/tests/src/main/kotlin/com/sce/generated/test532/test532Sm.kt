...
class Test532StateMachine(
    ...
    private fun processS0(
        ...
        event is Test532Event.HTTP.POST -> TransitionResult.External(Test532State.Pass, Test532State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test532State.Fail, Test532State.S0, 1)
    }
    ...
    // SCE-MAP: test532.scxml:4 :: _machine
    override fun onEntry(state: Test532State, pathChild: Test532State?) {
        when (state) {
