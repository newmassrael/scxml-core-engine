...
// SCE-MAP: test243.scxml:6 :: _machine
...
class Test243StateMachine(
    ...
    override fun isFinalState(state: Test243State): Boolean = when (state) {
        is Test243State.Fail, is Test243State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test243State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test243State, HistoryId>> =
            listOf(StateTarget(Test243State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test243State, HistoryId>(
            Test243State.S0,
            listOf(StateTarget(Test243State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test243State, HistoryId>(
            Test243State.S0,
            listOf(StateTarget(Test243State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test243Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test243Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test243Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test243Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test243Event) {
    ...
    override fun firstEnabledTransition(
        state: Test243State,
        event: Test243Event?
    ): EnabledTransition<Test243State, HistoryId>? = when (state) {
        is Test243State.S0 -> when {
            event is Test243Event.Success -> transitionS0At0
    ...
    // SCE-MAP: test243.scxml:6 :: _machine
    override fun onEntry(state: Test243State, isDefaultEntry: Boolean) {
        when (state) {
            is Test243State.Fail -> {
                // SCE-MAP: test243.scxml:39 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test243State.Pass -> {
                // SCE-MAP: test243.scxml:38 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test243State.S0 -> {
                // SCE-MAP: test243.scxml:9 :: s0 :: _state_body
            ...
            scheduleSend("__send_0", 2000L, Test243Event.Timeout)
                ...
                run {
                    ...
                    try {
                        ...
                        raisePlatformError(Test243Event.Error.Execution, "<invoke> <param name='Var1'> expr failed to evaluate")
                    }
    ...
    // SCE-MAP: test243.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test243State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
