...
class Test243StateMachine(
    ...
    private fun processS0(
        ...
        event is Test243Event.Success -> TransitionResult.External(Test243State.Pass, Test243State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test243State.Fail, Test243State.S0, 1)
    }
    ...
    // SCE-MAP: test243.scxml:6 :: _machine
    override fun onEntry(state: Test243State, pathChild: Test243State?) {
        when (state) {
