...
// SCE-MAP: test205.scxml:6 :: _machine
...
class Test205StateMachine(
    ...
    override fun isFinalState(state: Test205State): Boolean = when (state) {
        is Test205State.Fail, is Test205State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test205State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test205State, HistoryId>> =
            listOf(StateTarget(Test205State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test205State, HistoryId>(
            Test205State.S0,
            listOf(StateTarget(Test205State.S1)),
            0,
            hasActions = true,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test205State, HistoryId>(
            Test205State.S0,
            listOf(StateTarget(Test205State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At0 = EnabledTransition<Test205State, HistoryId>(
            Test205State.S1,
            listOf(StateTarget(Test205State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS1At1 = EnabledTransition<Test205State, HistoryId>(
            Test205State.S1,
            listOf(StateTarget(Test205State.Fail)),
            1,
            hasActions = false,
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test205Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test205Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test205Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test205Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test205Event) {
    ...
    override fun firstEnabledTransition(
        state: Test205State,
        event: Test205Event?
    ): EnabledTransition<Test205State, HistoryId>? = when (state) {
        is Test205State.S0 -> when {
            event is Test205Event.Event1 -> transitionS0At0
            event != null -> transitionS0At1
            else -> null
        }
        is Test205State.S1 -> when {
    ...
    // SCE-MAP: test205.scxml:6 :: _machine
    override fun onEntry(state: Test205State, isDefaultEntry: Boolean) {
        when (state) {
            is Test205State.Fail -> {
                // SCE-MAP: test205.scxml:32 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test205State.Pass -> {
                // SCE-MAP: test205.scxml:31 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test205State.S0 -> {
                // SCE-MAP: test205.scxml:11 :: s0 :: _state_body
            ...
            is Test205State.S1 -> {
                // SCE-MAP: test205.scxml:26 :: s1 :: _state_body
            }
        }
    }
    ...
    // SCE-MAP: test205.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test205State, transitionIndex: Int) {
        when (source) {
        is Test205State.S0 -> when (transitionIndex) {
            0 -> {
