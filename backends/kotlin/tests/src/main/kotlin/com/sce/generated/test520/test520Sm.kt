...
class Test520StateMachine(
    ...
    private fun processS0(
        ...
        event is Test520Event.HTTP.POST -> TransitionResult.External(Test520State.Pass, Test520State.S0, 0)

        event is Test520Event.HTTP.POST -> TransitionResult.External(Test520State.Pass, Test520State.S0, 1)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test520State.Fail, Test520State.S0, 2)
    }
    ...
    // SCE-MAP: test520.scxml:3 :: _machine
    override fun onEntry(state: Test520State, pathChild: Test520State?) {
        when (state) {
