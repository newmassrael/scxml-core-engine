...
class Test198StateMachine(
    ...
    private fun processS0(
        ...
        event is Test198Event.Event1 && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.origintype == 'http://www.w3.org/TR/scxml/#SCXMLEventProcessor'")) -> TransitionResult.External(Test198State.Pass, Test198State.S0)
    ...
    // SCE-MAP: test198.scxml:6 :: _machine
    override fun onEntry(state: Test198State, pathChild: Test198State?) {
        when (state) {
