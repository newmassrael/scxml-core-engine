...
// SCE-MAP: test198.scxml:6 :: _machine
...
class Test198StateMachine(
    ...
    override fun isFinalState(state: Test198State): Boolean = when (state) {
        is Test198State.Fail, is Test198State.Pass -> true
        else -> false
    }

    // W3C SCXML 3.2: the target of the document's own initial transition, as
    // written.
    override val documentInitialTargets: List<EntryTarget<Test198State, HistoryId>>
        get() = documentInitialTargetList

    private companion object {
        val documentInitialTargetList: List<EntryTarget<Test198State, HistoryId>> =
            listOf(StateTarget(Test198State.S0))

        // W3C SCXML 3.13: s0's transition 0, as the microstep reads it.
        val transitionS0At0 = EnabledTransition<Test198State, HistoryId>(
            Test198State.S0,
            listOf(StateTarget(Test198State.Pass)),
            0,
            hasActions = false,
            isInternal = false,
        )
        ...
        val transitionS0At1 = EnabledTransition<Test198State, HistoryId>(
            Test198State.S0,
            listOf(StateTarget(Test198State.Fail)),
            1,
            hasActions = false,
            isInternal = false,
        )
    ...
    private fun safeEvaluateGuard(guardExpr: com.sce.runtime.ScriptSource): Boolean {
        ...
        return try {
            ...
            raisePlatformError(Test198Event.Error.Execution, "a <transition> cond failed to evaluate")
            false
        }
    }
    ...
    private fun evaluateSendContent(source: com.sce.runtime.ScriptSource): String {
        ...
        return try {
            ...
            raisePlatformError(Test198Event.Error.Execution, "an expression could not be serialised to JSON")
            ""
        }
    }
    ...
    private fun executeAssign(location: com.sce.runtime.ScriptSource, expr: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test198Event.Error.Execution, "<assign> failed")
        }
    }
    ...
    private fun executeScriptBlock(script: com.sce.runtime.ScriptSource) {
        ...
        try {
            ...
            raisePlatformError(Test198Event.Error.Execution, "<script> failed to execute")
        }
    }
    ...
    override fun bindCurrentEvent(event: Test198Event) {
    ...
    override fun firstEnabledTransition(
        state: Test198State,
        event: Test198Event?
    ): EnabledTransition<Test198State, HistoryId>? = when (state) {
        is Test198State.S0 -> when {
            event is Test198Event.Event1 && safeEvaluateGuard(com.sce.runtime.ScriptSource.lua("_scxml_eq(_event.origintype, \"http://www.w3.org/TR/scxml/#SCXMLEventProcessor\")", "_event.origintype == 'http://www.w3.org/TR/scxml/#SCXMLEventProcessor'")) -> transitionS0At0
    ...
    // SCE-MAP: test198.scxml:6 :: _machine
    override fun onEntry(state: Test198State, isDefaultEntry: Boolean) {
        when (state) {
            is Test198State.Fail -> {
                // SCE-MAP: test198.scxml:21 :: fail :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test198State.Pass -> {
                // SCE-MAP: test198.scxml:20 :: pass :: _state_body
                // W3C SCXML 3.7: Top-level final state reached
                markFinalStateReached()
            }
            is Test198State.S0 -> {
                // SCE-MAP: test198.scxml:8 :: s0 :: _state_body
    ...
    // SCE-MAP: test198.scxml:6 :: _machine
    override fun executeTransitionContent(source: Test198State, transitionIndex: Int) {
        when (source) {
        else -> {}
        }
    }
