...
class Test200StateMachine(
    ...
    private fun processS0(
        ...
        event is Test200Event.Event1 -> TransitionResult.External(Test200State.Pass, Test200State.S0, 0)

        // W3C SCXML 3.12.1: Wildcard transition
        else -> TransitionResult.External(Test200State.Fail, Test200State.S0, 1)
    }
    ...
    // SCE-MAP: test200.scxml:5 :: _machine
    override fun onEntry(state: Test200State, pathChild: Test200State?) {
        when (state) {
