...
class Test529StateMachine(
    ...
    private fun processS0(
        ...
        event is Test529Event.Done.State.S0 && safeEvaluateGuard(com.sce.runtime.ScriptSource.ecmascript("_event.data == 21")) -> TransitionResult.External(Test529State.Pass, Test529State.S0)
    ...
    // SCE-MAP: test529.scxml:4 :: _machine
    override fun onEntry(state: Test529State, pathChild: Test529State?) {
        when (state) {
