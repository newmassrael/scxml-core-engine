...
const (
	// SCXMLEventProcessorType is the SCXML Event I/O Processor URI (§scxml-C-1).
	...
	// BasicHTTPEventProcessorType is the BasicHTTP Event I/O Processor URI (§scxml-C-2).
