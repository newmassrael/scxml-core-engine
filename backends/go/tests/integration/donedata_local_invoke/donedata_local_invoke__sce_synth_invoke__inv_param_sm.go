...
// DonedataLocalInvokeSceSynthInvokeInvParamStateFromName is the read half of the pair above — a state
...
// age together.
func DonedataLocalInvokeSceSynthInvokeInvParamStateFromName(name string) (DonedataLocalInvokeSceSynthInvokeInvParamState, bool) {
	switch name {
	case "done":
		return DonedataLocalInvokeSceSynthInvokeInvParamStateDone, true
	}
	var zero DonedataLocalInvokeSceSynthInvokeInvParamState
	return zero, false
}

// DonedataLocalInvokeSceSynthInvokeInvParamAllStates is every state this document declares, in the
...
var DonedataLocalInvokeSceSynthInvokeInvParamAllStates = []DonedataLocalInvokeSceSynthInvokeInvParamState{
...
// sce.PayloadReading.
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) SetParamValueInScriptEngine(name string, value interface{}) {
...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) GetStateFromName(name string) (DonedataLocalInvokeSceSynthInvokeInvParamState, bool) {
	return DonedataLocalInvokeSceSynthInvokeInvParamStateFromName(name)
}
...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) LiftTypedPayload(event DonedataLocalInvokeSceSynthInvokeInvParamEvent, meta *sce.EventMetadata) error {
