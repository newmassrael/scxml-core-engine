...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) evaluateGuard(guard string, eng *sce.Engine[DonedataLocalInvokeSceSynthInvokeInvParamState, DonedataLocalInvokeSceSynthInvokeInvParamEvent]) bool {
	...
	if err != nil {
		eng.Raise(sce.NewPlatformEvent(DonedataLocalInvokeSceSynthInvokeInvParamEventErrorExecution))
		return false
	}
...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) ForwardToAutoforwardChildren(_ string, _ *sce.Engine[DonedataLocalInvokeSceSynthInvokeInvParamState, DonedataLocalInvokeSceSynthInvokeInvParamEvent]) {}
...
func (p *DonedataLocalInvokeSceSynthInvokeInvParamPolicy) ExecuteEntryActions(state DonedataLocalInvokeSceSynthInvokeInvParamState, engine *sce.Engine[DonedataLocalInvokeSceSynthInvokeInvParamState, DonedataLocalInvokeSceSynthInvokeInvParamEvent]) {
	p.ensureScriptEngine()
	switch state {
	case DonedataLocalInvokeSceSynthInvokeInvParamStateDone:
