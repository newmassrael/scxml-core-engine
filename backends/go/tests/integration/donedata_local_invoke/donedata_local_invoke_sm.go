...
func (p *DonedataLocalInvokePolicy) ExecuteEntryActions(state DonedataLocalInvokeState, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	p.ensureScriptEngine()
	switch state {
	case DonedataLocalInvokeStatePhaseContent:
