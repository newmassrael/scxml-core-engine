...
// Generated Go state machine for `donedata_local_invoke`.
//
// Generated by SCE Code Generator (Go backend).
...
type DonedataLocalInvokeState int

const (
	DonedataLocalInvokeStateFail DonedataLocalInvokeState = 0
	DonedataLocalInvokeStatePass DonedataLocalInvokeState = 1
	DonedataLocalInvokeStatePhaseContent DonedataLocalInvokeState = 2
	DonedataLocalInvokeStatePhaseParam DonedataLocalInvokeState = 3
)

func (s DonedataLocalInvokeState) String() string {
	switch s {
	case DonedataLocalInvokeStateFail:
		return "fail"
	case DonedataLocalInvokeStatePass:
		return "pass"
...
// DonedataLocalInvokeStateFromName is the read half of the pair above — a state
...
// age together.
func DonedataLocalInvokeStateFromName(name string) (DonedataLocalInvokeState, bool) {
	switch name {
	case "fail":
		return DonedataLocalInvokeStateFail, true
	case "pass":
		return DonedataLocalInvokeStatePass, true
	case "phase_content":
		return DonedataLocalInvokeStatePhaseContent, true
	case "phase_param":
		return DonedataLocalInvokeStatePhaseParam, true
	}
	var zero DonedataLocalInvokeState
	return zero, false
}

// DonedataLocalInvokeAllStates is every state this document declares, in the
...
var DonedataLocalInvokeAllStates = []DonedataLocalInvokeState{
	DonedataLocalInvokeStateFail,
	DonedataLocalInvokeStatePass,
	DonedataLocalInvokeStatePhaseContent,
	DonedataLocalInvokeStatePhaseParam,
}

// DonedataLocalInvokeTarget is one token of a target list, as the document wrote
// it (W3C SCXML 3.13): a state, or a <history> the engine dereferences.
type DonedataLocalInvokeTarget = sce.EntryTarget[DonedataLocalInvokeState, sce.HistoryID]
...
// childStatesOfDonedataLocalInvoke is §scxml-D-getChildStates per state: its
// <state>, <parallel> and <final> children, in document order.
var childStatesOfDonedataLocalInvoke = [4][]DonedataLocalInvokeState{
}

// initialTargetsOfDonedataLocalInvoke is each compound state's initial transition
// target, as written (§scxml-3.3).
var initialTargetsOfDonedataLocalInvoke = [4][]DonedataLocalInvokeTarget{
}

// documentInitialTargetsOfDonedataLocalInvoke is the target of the document's own
// initial transition, as written (§scxml-3.2).
var documentInitialTargetsOfDonedataLocalInvoke = []DonedataLocalInvokeTarget{sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStatePhaseParam)}

// transitionTargetsOfDonedataLocalInvoke is each transition's target list, as
...
var transitionTargetsOfDonedataLocalInvoke = [4][][]DonedataLocalInvokeTarget{
	DonedataLocalInvokeStatePhaseContent: {
		0: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStatePass)},
		1: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStateFail)},
		2: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStateFail)},
	},
	DonedataLocalInvokeStatePhaseParam: {
		0: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStatePhaseContent)},
		1: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStateFail)},
		2: {sce.StateTarget[DonedataLocalInvokeState, sce.HistoryID](DonedataLocalInvokeStateFail)},
	},
}
...
func (e DonedataLocalInvokeEvent) String() string {
	...
	case DonedataLocalInvokeEventDoneInvokeInvContent:
		return "done.invoke.inv_content"
	case DonedataLocalInvokeEventDoneInvokeInvParam:
		return "done.invoke.inv_param"
	case DonedataLocalInvokeEventErrorExecution:
		return "error.execution"
	case DonedataLocalInvokeEventNull:
		return ""
	}
	return "unknown"
}
...
type DonedataLocalInvokePolicy struct {
	...
	pendingInvokes []sce.PendingInvoke[DonedataLocalInvokeState]
	activeInvokes  map[string]*sce.ChildSession
	childInvParam sce.ChildEngine
...
// NewDonedataLocalInvokePolicy creates a new policy with default values.
...
func (p *DonedataLocalInvokePolicy) ensureScriptEngine() {
	if p.scriptEngineInitialized {
		return
	}
	engine := p.ScriptEngine
	if engine == nil {
		panic("DonedataLocalInvokePolicy: ScriptEngine field must be set before Initialize()")
	}
...
func (p *DonedataLocalInvokePolicy) InitializeDataModel(eng *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	...
	_ = engine.SetVariable(sessionID, "_name", "donedata_local_invoke")

	// W3C SCXML 5.2.2: Initialize global datamodel variables
	// W3C SCXML 5.2/5.3: Initialize param_ok from expr="false"
	{
...
func (p *DonedataLocalInvokePolicy) evaluateGuard(guard string, eng *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) bool {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLocalInvokePolicy) executeScript(script string) error {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
// sce.PayloadReading.
func (p *DonedataLocalInvokePolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLocalInvokePolicy) assignVariable(location, expr string) error {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLocalInvokePolicy) getVariable(name string) interface{} {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLocalInvokePolicy) SetParamValueInScriptEngine(name string, value interface{}) {
...
func (p *DonedataLocalInvokePolicy) ExecutePendingInvokes(engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	if len(p.pendingInvokes) == 0 {
		return
	}

	// W3C SCXML 6.4: Copy-and-clear to prevent iterator invalidation
	invokesToExecute := make([]sce.PendingInvoke[DonedataLocalInvokeState], len(p.pendingInvokes))
	...
	for _, pending := range invokesToExecute {
		if pending.DocumentID == "inv_content" {
			...
			p.activeInvokes["inv_content"] = &sce.ChildSession{
				SessionID:       childSessionID,
				InvokeID:        "inv_content",
				ParentSessionID: p.SessionID,
				Autoforward:     false,
				FinalizeScript:  "",
			}

			childEngine := sce.NewEngine[DonedataLocalInvokeSceSynthInvokeInvContentState, DonedataLocalInvokeSceSynthInvokeInvContentEvent](&childPolicy)
			...
			wrapper := &childEngineWrapperInvContent{engine: childEngine, policy: &childPolicy}
			p.childInvContent = wrapper

			// W3C SCXML 6.4: Drain child-to-parent events raised during initialize
			sce.DrainAndRaiseChildEvents(wrapper, p.activeInvokes, "inv_content", engine)

			// W3C SCXML 6.4: Check if child completed during initialize
			if wrapper.IsInFinalState() {
				p.pendingDoneInvokeInvContent = true
				...
				sce.RaiseDoneInvoke("inv_content", wrapper.DonedataAtFinal(), engine)
			}
			continue
		}
		if pending.DocumentID == "inv_param" {
			...
			// W3C SCXML 6.4.1: Track active invoke session BEFORE initialize
			p.activeInvokes["inv_param"] = &sce.ChildSession{
				SessionID:       childSessionID,
				InvokeID:        "inv_param",
				ParentSessionID: p.SessionID,
				Autoforward:     false,
			...
			childEngine := sce.NewEngine[DonedataLocalInvokeSceSynthInvokeInvParamState, DonedataLocalInvokeSceSynthInvokeInvParamEvent](&childPolicy)
			// §scxml-6.4: the child's delayed sends are measured against the
			// same clock as ours. A child reading its own would start its
			// origin at construction time, so <send delay="100ms"> on either
			// side of the boundary would mean two different absolute instants —
			...
			// W3C SCXML 6.4: Store child and create wrapper
			wrapper := &childEngineWrapperInvParam{engine: childEngine, policy: &childPolicy}
			p.childInvParam = wrapper

			// W3C SCXML 6.4: Drain child-to-parent events raised during initialize
			sce.DrainAndRaiseChildEvents(wrapper, p.activeInvokes, "inv_param", engine)

			// W3C SCXML 6.4: Check if child completed during initialize
			if wrapper.IsInFinalState() {
				p.pendingDoneInvokeInvParam = true
				// W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
				// done.invoke.<id>._event.data. Mirrors the C++ AOT contract
				// and the Rust raise_done_invoke(donedata) 3-arg signature.
				sce.RaiseDoneInvoke("inv_param", wrapper.DonedataAtFinal(), engine)
			}
			continue
		}
	}
...
func (p *DonedataLocalInvokePolicy) TickChildren(engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	if !p.pendingDoneInvokeInvParam && p.childInvParam != nil {
		child := p.childInvParam
		sce.DrainAndRaiseChildEvents(child, p.activeInvokes, "inv_param", engine)
		child.Tick()
		sce.DrainAndRaiseChildEvents(child, p.activeInvokes, "inv_param", engine)
		if child.IsInFinalState() && !p.pendingDoneInvokeInvParam {
			p.pendingDoneInvokeInvParam = true
			// W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
			// done.invoke.<id>._event.data.
			sce.RaiseDoneInvoke("inv_param", child.DonedataAtFinal(), engine)
		}
	}
	if !p.pendingDoneInvokeInvContent && p.childInvContent != nil {
		child := p.childInvContent
		sce.DrainAndRaiseChildEvents(child, p.activeInvokes, "inv_content", engine)
		child.Tick()
		sce.DrainAndRaiseChildEvents(child, p.activeInvokes, "inv_content", engine)
		if child.IsInFinalState() && !p.pendingDoneInvokeInvContent {
			p.pendingDoneInvokeInvContent = true
			// W3C SCXML 5.5 + 6.3.1: Lift the child's stashed donedata onto
			// done.invoke.<id>._event.data.
			sce.RaiseDoneInvoke("inv_content", child.DonedataAtFinal(), engine)
		}
	}
}
...
func (p *DonedataLocalInvokePolicy) DeliverToChildSession(childSessionID, eventName, eventData string) bool {
	if childSessionID == "" {
		return false
	}
...
type childEngineWrapperInvParam struct {
	engine *sce.Engine[DonedataLocalInvokeSceSynthInvokeInvParamState, DonedataLocalInvokeSceSynthInvokeInvParamEvent]
	policy *DonedataLocalInvokeSceSynthInvokeInvParamPolicy
}
...
func (p *DonedataLocalInvokePolicy) InitialState() DonedataLocalInvokeState {
	return DonedataLocalInvokeStatePhaseParam
}

// IsFinalState returns true if state is a <final> state (W3C SCXML 3.7).
func (p *DonedataLocalInvokePolicy) IsFinalState(state DonedataLocalInvokeState) bool {
	switch state {
	case DonedataLocalInvokeStateFail:
		return true
	case DonedataLocalInvokeStatePass:
...
func (p *DonedataLocalInvokePolicy) GetParent(state DonedataLocalInvokeState) (DonedataLocalInvokeState, bool) {
	switch state {
	}
	return 0, false
}
...
// (W3C SCXML 3.3).
func (p *DonedataLocalInvokePolicy) IsCompoundState(state DonedataLocalInvokeState) bool {
	return len(initialTargetsOfDonedataLocalInvoke[state]) > 0
}

func (p *DonedataLocalInvokePolicy) IsParallelState(_ DonedataLocalInvokeState) bool { return false }
...
func (p *DonedataLocalInvokePolicy) GetChildStates(state DonedataLocalInvokeState) []DonedataLocalInvokeState {
	return childStatesOfDonedataLocalInvoke[state]
}
...
// (W3C SCXML 3.3).
func (p *DonedataLocalInvokePolicy) GetInitialTargets(state DonedataLocalInvokeState) []DonedataLocalInvokeTarget {
	return initialTargetsOfDonedataLocalInvoke[state]
}

// GetDocumentInitialTargets returns the target of the document's own initial
// transition, as written (W3C SCXML 3.2).
func (p *DonedataLocalInvokePolicy) GetDocumentInitialTargets() []DonedataLocalInvokeTarget {
	return documentInitialTargetsOfDonedataLocalInvoke
}
...
// one.
func (p *DonedataLocalInvokePolicy) GetHistoryParent(history sce.HistoryID) DonedataLocalInvokeState {
	panic(fmt.Sprintf("DonedataLocalInvokePolicy declares no <history>; asked for %d", history))
}
func (p *DonedataLocalInvokePolicy) GetHistoryDefaultTargets(history sce.HistoryID) []DonedataLocalInvokeTarget {
	panic(fmt.Sprintf("DonedataLocalInvokePolicy declares no <history>; asked for %d", history))
}
func (p *DonedataLocalInvokePolicy) HistoryValue(_ sce.HistoryID) ([]DonedataLocalInvokeState, bool) {
	return nil, false
}

// GetDocumentOrder returns the document order index (W3C SCXML Appendix D).
func (p *DonedataLocalInvokePolicy) GetDocumentOrder(state DonedataLocalInvokeState) int {
	switch state {
	case DonedataLocalInvokeStateFail:
		return 3
	case DonedataLocalInvokeStatePass:
...
func (p *DonedataLocalInvokePolicy) GetEventName(event DonedataLocalInvokeEvent) string {
	return event.String()
}
...
func (p *DonedataLocalInvokePolicy) GetEventFromName(name string) (DonedataLocalInvokeEvent, bool) {
	...
	case "done.invoke.inv_content":
		return DonedataLocalInvokeEventDoneInvokeInvContent, true
	case "done.invoke.inv_param":
		return DonedataLocalInvokeEventDoneInvokeInvParam, true
	case "error.execution":
		return DonedataLocalInvokeEventErrorExecution, true
	}
	return DonedataLocalInvokeEventNull, false
}

// GetStateName returns the string name of a state (W3C SCXML 3.3).
func (p *DonedataLocalInvokePolicy) GetStateName(state DonedataLocalInvokeState) string {
	return state.String()
}
...
func (p *DonedataLocalInvokePolicy) GetStateFromName(name string) (DonedataLocalInvokeState, bool) {
	return DonedataLocalInvokeStateFromName(name)
}

// NullEvent returns the sentinel for eventless transition dispatch (W3C SCXML 3.13).
func (p *DonedataLocalInvokePolicy) NullEvent() DonedataLocalInvokeEvent {
	return DonedataLocalInvokeEventNull
}
...
func (p *DonedataLocalInvokePolicy) NeedsScriptEngine() bool {
	return true
}
...
func (p *DonedataLocalInvokePolicy) NeedsEventScheduler() bool {
	return true
}

// NeedsDataModelInit returns whether the SM needs datamodel init.
func (p *DonedataLocalInvokePolicy) NeedsDataModelInit() bool {
	return true
}

// HasInvokeSupport returns true for invoke-capable SMs.
func (p *DonedataLocalInvokePolicy) HasInvokeSupport() bool { return true }
// HasChildTick returns true for child-ticking SMs.
func (p *DonedataLocalInvokePolicy) HasChildTick() bool { return true }
func (p *DonedataLocalInvokePolicy) HasFinalize() bool { return false }
func (p *DonedataLocalInvokePolicy) HasAutoforward() bool { return false }
func (p *DonedataLocalInvokePolicy) HasActiveStates() bool { return false }
func (p *DonedataLocalInvokePolicy) GetActiveStates() []DonedataLocalInvokeState { return nil }
...
func (p *DonedataLocalInvokePolicy) PopulateEventMetadata(meta *sce.EventMetadata) {
...
func (p *DonedataLocalInvokePolicy) LiftTypedPayload(event DonedataLocalInvokeEvent, meta *sce.EventMetadata) error {
...
func (p *DonedataLocalInvokePolicy) ClearEventMetadata() {
	p.pendingEventName = ""
	p.pendingEventData = ""
	p.pendingEventType = ""
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) ExecuteEntryActions(state DonedataLocalInvokeState, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent], isDefaultEntry bool) {
	p.ensureScriptEngine()
	switch state {
	case DonedataLocalInvokeStatePhaseContent:
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) ExecuteHistoryDefaultContent(history sce.HistoryID, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) ExecuteExitActions(state DonedataLocalInvokeState, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent], configurationBeforeExit []DonedataLocalInvokeState) {
	p.ensureScriptEngine()
	...
	case DonedataLocalInvokeStatePhaseContent:
		...
		p.pendingDoneInvokeInvContent = false
	case DonedataLocalInvokeStatePhaseParam:
		...
		p.pendingDoneInvokeInvParam = false
	default:
	}
}
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) BindCurrentEvent(event DonedataLocalInvokeEvent, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	if event != DonedataLocalInvokeEventNull {
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) FirstEnabledTransition(state DonedataLocalInvokeState, event DonedataLocalInvokeEvent, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) (sce.EnabledTransition[DonedataLocalInvokeState, sce.HistoryID], bool) {
	switch state {
	case DonedataLocalInvokeStatePhaseContent:
		if event == DonedataLocalInvokeEventDoneInvokeInvContent {
			if p.evaluateGuard(`(_scxml_truthy(param_ok) and (_event.data == "hello_content"))`, engine) {
				return sce.EnabledTransition[DonedataLocalInvokeState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfDonedataLocalInvoke[state][0],
					TransitionIndex: 0,
					HasActions:      false,
					IsInternal:      false,
				}, true
		...
		if event == DonedataLocalInvokeEventDoneInvokeInvContent {
			{
				return sce.EnabledTransition[DonedataLocalInvokeState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfDonedataLocalInvoke[state][1],
					TransitionIndex: 1,
					HasActions:      false,
					IsInternal:      false,
				}, true
		...
		if event == DonedataLocalInvokeEventErrorExecution {
			{
				return sce.EnabledTransition[DonedataLocalInvokeState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfDonedataLocalInvoke[state][2],
					TransitionIndex: 2,
					HasActions:      false,
					IsInternal:      false,
				}, true
	...
	return sce.EnabledTransition[DonedataLocalInvokeState, sce.HistoryID]{}, false
}
...
//line donedata_local_invoke.scxml:28
func (p *DonedataLocalInvokePolicy) ExecuteTransitionContent(source DonedataLocalInvokeState, transitionIndex int, engine *sce.Engine[DonedataLocalInvokeState, DonedataLocalInvokeEvent]) {
	p.ensureScriptEngine()
	switch source {
	case DonedataLocalInvokeStatePhaseParam:
