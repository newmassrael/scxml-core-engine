...
// ErrorCascadeIsBoundedStateFromName is the read half of the pair above — a state
...
// age together.
func ErrorCascadeIsBoundedStateFromName(name string) (ErrorCascadeIsBoundedState, bool) {
	switch name {
	case "idle":
		return ErrorCascadeIsBoundedStateIdle, true
	case "runaway":
		return ErrorCascadeIsBoundedStateRunaway, true
	case "settling":
		return ErrorCascadeIsBoundedStateSettling, true
	}
	var zero ErrorCascadeIsBoundedState
	return zero, false
}

// ErrorCascadeIsBoundedAllStates is every state this document declares, in the
...
var ErrorCascadeIsBoundedAllStates = []ErrorCascadeIsBoundedState{
...
func (p *ErrorCascadeIsBoundedPolicy) GetStateFromName(name string) (ErrorCascadeIsBoundedState, bool) {
	return ErrorCascadeIsBoundedStateFromName(name)
}
...
func (p *ErrorCascadeIsBoundedPolicy) LiftTypedPayload(event ErrorCascadeIsBoundedEvent, meta *sce.EventMetadata) error {
