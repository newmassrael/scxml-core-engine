...
// InvokeParamSeedsDeclaredChildDataStateFromName is the read half of the pair above — a state
...
// age together.
func InvokeParamSeedsDeclaredChildDataStateFromName(name string) (InvokeParamSeedsDeclaredChildDataState, bool) {
	switch name {
	case "failChildEvaluatedTheExpression":
		return InvokeParamSeedsDeclaredChildDataStateFailChildEvaluatedTheExpression, true
	case "failDeclaredParamLost":
		return InvokeParamSeedsDeclaredChildDataStateFailDeclaredParamLost, true
	case "failInfiniteParamCollapsed":
		return InvokeParamSeedsDeclaredChildDataStateFailInfiniteParamCollapsed, true
	case "failInfiniteParamLost":
		return InvokeParamSeedsDeclaredChildDataStateFailInfiniteParamLost, true
	case "failNamelistValueLost":
		return InvokeParamSeedsDeclaredChildDataStateFailNamelistValueLost, true
	case "failParentOnlyExprLost":
		return InvokeParamSeedsDeclaredChildDataStateFailParentOnlyExprLost, true
	case "failShadowSeedLost":
		return InvokeParamSeedsDeclaredChildDataStateFailShadowSeedLost, true
	case "failUnmatchedParamEnteredTheChild":
		return InvokeParamSeedsDeclaredChildDataStateFailUnmatchedParamEnteredTheChild, true
	case "infinite":
		return InvokeParamSeedsDeclaredChildDataStateInfinite, true
	case "namelistPhase":
		return InvokeParamSeedsDeclaredChildDataStateNamelistPhase, true
	case "pass":
		return InvokeParamSeedsDeclaredChildDataStatePass, true
	case "shadowed":
		return InvokeParamSeedsDeclaredChildDataStateShadowed, true
	case "soleName":
		return InvokeParamSeedsDeclaredChildDataStateSoleName, true
	case "unmatched":
		return InvokeParamSeedsDeclaredChildDataStateUnmatched, true
	}
	var zero InvokeParamSeedsDeclaredChildDataState
	return zero, false
}

// InvokeParamSeedsDeclaredChildDataAllStates is every state this document declares, in the
...
var InvokeParamSeedsDeclaredChildDataAllStates = []InvokeParamSeedsDeclaredChildDataState{
	InvokeParamSeedsDeclaredChildDataStateFailChildEvaluatedTheExpression,
	InvokeParamSeedsDeclaredChildDataStateFailDeclaredParamLost,
	InvokeParamSeedsDeclaredChildDataStateFailInfiniteParamCollapsed,
	InvokeParamSeedsDeclaredChildDataStateFailInfiniteParamLost,
	InvokeParamSeedsDeclaredChildDataStateFailNamelistValueLost,
	InvokeParamSeedsDeclaredChildDataStateFailParentOnlyExprLost,
	InvokeParamSeedsDeclaredChildDataStateFailShadowSeedLost,
	InvokeParamSeedsDeclaredChildDataStateFailUnmatchedParamEnteredTheChild,
	InvokeParamSeedsDeclaredChildDataStateInfinite,
	InvokeParamSeedsDeclaredChildDataStateNamelistPhase,
	InvokeParamSeedsDeclaredChildDataStatePass,
...
// sce.PayloadReading.
func (p *InvokeParamSeedsDeclaredChildDataPolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *InvokeParamSeedsDeclaredChildDataPolicy) GetStateFromName(name string) (InvokeParamSeedsDeclaredChildDataState, bool) {
	return InvokeParamSeedsDeclaredChildDataStateFromName(name)
}
...
func (p *InvokeParamSeedsDeclaredChildDataPolicy) LiftTypedPayload(event InvokeParamSeedsDeclaredChildDataEvent, meta *sce.EventMetadata) error {
