...
func (p *AutoforwardEventFieldsPolicy) evaluateGuard(guard string, eng *sce.Engine[AutoforwardEventFieldsState, AutoforwardEventFieldsEvent]) bool {
	...
	if err != nil {
		eng.Raise(sce.NewPlatformEvent(AutoforwardEventFieldsEventErrorExecution))
		return false
	}
...
func (p *AutoforwardEventFieldsPolicy) setCurrentEvent(name string) {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *AutoforwardEventFieldsPolicy) SetParamInScriptEngine(name, expr string) {
...
func (p *AutoforwardEventFieldsPolicy) ExecuteEntryActions(state AutoforwardEventFieldsState, engine *sce.Engine[AutoforwardEventFieldsState, AutoforwardEventFieldsEvent]) {
	p.ensureScriptEngine()
	switch state {
	case AutoforwardEventFieldsStatePhase:
