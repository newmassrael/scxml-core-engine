...
// AutoforwardEventFieldsSceSynthInvokeInvEchoTarget is one token of a target list, as the document wrote
// it (W3C SCXML 3.13): a state, or a <history> the engine dereferences.
type AutoforwardEventFieldsSceSynthInvokeInvEchoTarget = sce.EntryTarget[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID]
...
// childStatesOfAutoforwardEventFieldsSceSynthInvokeInvEcho is §scxml-D-getChildStates per state: its
// <state>, <parallel> and <final> children, in document order.
var childStatesOfAutoforwardEventFieldsSceSynthInvokeInvEcho = [2][]AutoforwardEventFieldsSceSynthInvokeInvEchoState{
}

// initialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho is each compound state's initial transition
// target, as written (§scxml-3.3).
var initialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho = [2][]AutoforwardEventFieldsSceSynthInvokeInvEchoTarget{
}

// documentInitialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho is the target of the document's own
// initial transition, as written (§scxml-3.2).
var documentInitialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho = []AutoforwardEventFieldsSceSynthInvokeInvEchoTarget{sce.StateTarget[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID](AutoforwardEventFieldsSceSynthInvokeInvEchoStateEmit)}

// transitionTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho is each transition's target list, as
...
var transitionTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho = [2][][]AutoforwardEventFieldsSceSynthInvokeInvEchoTarget{
	AutoforwardEventFieldsSceSynthInvokeInvEchoStateEmit: {
		0: {sce.StateTarget[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID](AutoforwardEventFieldsSceSynthInvokeInvEchoStateReported)},
		1: {sce.StateTarget[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID](AutoforwardEventFieldsSceSynthInvokeInvEchoStateReported)},
	},
}
...
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) IsCompoundState(state AutoforwardEventFieldsSceSynthInvokeInvEchoState) bool {
	return len(initialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho[state]) > 0
}
...
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) GetChildStates(state AutoforwardEventFieldsSceSynthInvokeInvEchoState) []AutoforwardEventFieldsSceSynthInvokeInvEchoState {
	return childStatesOfAutoforwardEventFieldsSceSynthInvokeInvEcho[state]
}
...
// (W3C SCXML 3.3).
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) GetInitialTargets(state AutoforwardEventFieldsSceSynthInvokeInvEchoState) []AutoforwardEventFieldsSceSynthInvokeInvEchoTarget {
	return initialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho[state]
}

// GetDocumentInitialTargets returns the target of the document's own initial
// transition, as written (W3C SCXML 3.2).
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) GetDocumentInitialTargets() []AutoforwardEventFieldsSceSynthInvokeInvEchoTarget {
	return documentInitialTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho
}
...
// one.
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) GetHistoryParent(history sce.HistoryID) AutoforwardEventFieldsSceSynthInvokeInvEchoState {
	panic(fmt.Sprintf("AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy declares no <history>; asked for %d", history))
}
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) GetHistoryDefaultTargets(history sce.HistoryID) []AutoforwardEventFieldsSceSynthInvokeInvEchoTarget {
	panic(fmt.Sprintf("AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy declares no <history>; asked for %d", history))
}
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) HistoryValue(_ sce.HistoryID) ([]AutoforwardEventFieldsSceSynthInvokeInvEchoState, bool) {
	return nil, false
}
...
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) LiftTypedPayload(event AutoforwardEventFieldsSceSynthInvokeInvEchoEvent, meta *sce.EventMetadata) error {
...
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) ExecuteEntryActions(state AutoforwardEventFieldsSceSynthInvokeInvEchoState, engine *sce.Engine[AutoforwardEventFieldsSceSynthInvokeInvEchoState, AutoforwardEventFieldsSceSynthInvokeInvEchoEvent], isDefaultEntry bool) {
	p.ensureScriptEngine()
	switch state {
	case AutoforwardEventFieldsSceSynthInvokeInvEchoStateEmit:
...
//line autoforward_event_fields__sce_synth_invoke__inv_echo.scxml:3
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) ExecuteHistoryDefaultContent(history sce.HistoryID, engine *sce.Engine[AutoforwardEventFieldsSceSynthInvokeInvEchoState, AutoforwardEventFieldsSceSynthInvokeInvEchoEvent]) {
...
//line autoforward_event_fields__sce_synth_invoke__inv_echo.scxml:3
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) BindCurrentEvent(event AutoforwardEventFieldsSceSynthInvokeInvEchoEvent, engine *sce.Engine[AutoforwardEventFieldsSceSynthInvokeInvEchoState, AutoforwardEventFieldsSceSynthInvokeInvEchoEvent]) {
...
//line autoforward_event_fields__sce_synth_invoke__inv_echo.scxml:3
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) FirstEnabledTransition(state AutoforwardEventFieldsSceSynthInvokeInvEchoState, event AutoforwardEventFieldsSceSynthInvokeInvEchoEvent, engine *sce.Engine[AutoforwardEventFieldsSceSynthInvokeInvEchoState, AutoforwardEventFieldsSceSynthInvokeInvEchoEvent]) (sce.EnabledTransition[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID], bool) {
	switch state {
	case AutoforwardEventFieldsSceSynthInvokeInvEchoStateEmit:
		if event == AutoforwardEventFieldsSceSynthInvokeInvEchoEventChildToParent {
			if p.evaluateGuard(`(((_scxml_truthy(_event.data) and (_event.data.value == 42)) and (_event.origin ~= "")) and (_event.invokeid ~= ""))`, engine) {
				return sce.EnabledTransition[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho[state][0],
					TransitionIndex: 0,
					HasActions:      true,
					IsInternal:      false,
				}, true
		...
		if event == AutoforwardEventFieldsSceSynthInvokeInvEchoEventChildToParent {
			{
				return sce.EnabledTransition[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfAutoforwardEventFieldsSceSynthInvokeInvEcho[state][1],
					TransitionIndex: 1,
					HasActions:      true,
					IsInternal:      false,
				}, true
	...
	return sce.EnabledTransition[AutoforwardEventFieldsSceSynthInvokeInvEchoState, sce.HistoryID]{}, false
}
...
//line autoforward_event_fields__sce_synth_invoke__inv_echo.scxml:3
func (p *AutoforwardEventFieldsSceSynthInvokeInvEchoPolicy) ExecuteTransitionContent(source AutoforwardEventFieldsSceSynthInvokeInvEchoState, transitionIndex int, engine *sce.Engine[AutoforwardEventFieldsSceSynthInvokeInvEchoState, AutoforwardEventFieldsSceSynthInvokeInvEchoEvent]) {
	p.ensureScriptEngine()
	switch source {
	case AutoforwardEventFieldsSceSynthInvokeInvEchoStateEmit:
