...
// EventOriginIsALocationSceSynthInvokeInvPeerTarget is one token of a target list, as the document wrote
// it (W3C SCXML 3.13): a state, or a <history> the engine dereferences.
type EventOriginIsALocationSceSynthInvokeInvPeerTarget = sce.EntryTarget[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID]
...
// childStatesOfEventOriginIsALocationSceSynthInvokeInvPeer is §scxml-D-getChildStates per state: its
// <state>, <parallel> and <final> children, in document order.
var childStatesOfEventOriginIsALocationSceSynthInvokeInvPeer = [2][]EventOriginIsALocationSceSynthInvokeInvPeerState{
}

// initialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer is each compound state's initial transition
// target, as written (§scxml-3.3).
var initialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer = [2][]EventOriginIsALocationSceSynthInvokeInvPeerTarget{
}

// documentInitialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer is the target of the document's own
// initial transition, as written (§scxml-3.2).
var documentInitialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer = []EventOriginIsALocationSceSynthInvokeInvPeerTarget{sce.StateTarget[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID](EventOriginIsALocationSceSynthInvokeInvPeerStateEmit)}

// transitionTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer is each transition's target list, as
...
var transitionTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer = [2][][]EventOriginIsALocationSceSynthInvokeInvPeerTarget{
	EventOriginIsALocationSceSynthInvokeInvPeerStateEmit: {
		0: {sce.StateTarget[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID](EventOriginIsALocationSceSynthInvokeInvPeerStateAcked)},
	},
}
...
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) IsCompoundState(state EventOriginIsALocationSceSynthInvokeInvPeerState) bool {
	return len(initialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer[state]) > 0
}
...
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) GetChildStates(state EventOriginIsALocationSceSynthInvokeInvPeerState) []EventOriginIsALocationSceSynthInvokeInvPeerState {
	return childStatesOfEventOriginIsALocationSceSynthInvokeInvPeer[state]
}
...
// (W3C SCXML 3.3).
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) GetInitialTargets(state EventOriginIsALocationSceSynthInvokeInvPeerState) []EventOriginIsALocationSceSynthInvokeInvPeerTarget {
	return initialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer[state]
}

// GetDocumentInitialTargets returns the target of the document's own initial
// transition, as written (W3C SCXML 3.2).
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) GetDocumentInitialTargets() []EventOriginIsALocationSceSynthInvokeInvPeerTarget {
	return documentInitialTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer
}
...
// one.
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) GetHistoryParent(history sce.HistoryID) EventOriginIsALocationSceSynthInvokeInvPeerState {
	panic(fmt.Sprintf("EventOriginIsALocationSceSynthInvokeInvPeerPolicy declares no <history>; asked for %d", history))
}
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) GetHistoryDefaultTargets(history sce.HistoryID) []EventOriginIsALocationSceSynthInvokeInvPeerTarget {
	panic(fmt.Sprintf("EventOriginIsALocationSceSynthInvokeInvPeerPolicy declares no <history>; asked for %d", history))
}
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) HistoryValue(_ sce.HistoryID) ([]EventOriginIsALocationSceSynthInvokeInvPeerState, bool) {
	return nil, false
}
...
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) LiftTypedPayload(event EventOriginIsALocationSceSynthInvokeInvPeerEvent, meta *sce.EventMetadata) error {
...
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) ExecuteEntryActions(state EventOriginIsALocationSceSynthInvokeInvPeerState, engine *sce.Engine[EventOriginIsALocationSceSynthInvokeInvPeerState, EventOriginIsALocationSceSynthInvokeInvPeerEvent], isDefaultEntry bool) {
	p.ensureScriptEngine()
	switch state {
	case EventOriginIsALocationSceSynthInvokeInvPeerStateEmit:
...
//line event_origin_is_a_location__sce_synth_invoke__inv_peer.scxml:3
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) ExecuteHistoryDefaultContent(history sce.HistoryID, engine *sce.Engine[EventOriginIsALocationSceSynthInvokeInvPeerState, EventOriginIsALocationSceSynthInvokeInvPeerEvent]) {
...
//line event_origin_is_a_location__sce_synth_invoke__inv_peer.scxml:3
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) BindCurrentEvent(event EventOriginIsALocationSceSynthInvokeInvPeerEvent, engine *sce.Engine[EventOriginIsALocationSceSynthInvokeInvPeerState, EventOriginIsALocationSceSynthInvokeInvPeerEvent]) {
...
//line event_origin_is_a_location__sce_synth_invoke__inv_peer.scxml:3
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) FirstEnabledTransition(state EventOriginIsALocationSceSynthInvokeInvPeerState, event EventOriginIsALocationSceSynthInvokeInvPeerEvent, engine *sce.Engine[EventOriginIsALocationSceSynthInvokeInvPeerState, EventOriginIsALocationSceSynthInvokeInvPeerEvent]) (sce.EnabledTransition[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID], bool) {
	switch state {
	case EventOriginIsALocationSceSynthInvokeInvPeerStateEmit:
		if event == EventOriginIsALocationSceSynthInvokeInvPeerEventReply {
			{
				return sce.EnabledTransition[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfEventOriginIsALocationSceSynthInvokeInvPeer[state][0],
					TransitionIndex: 0,
					HasActions:      true,
					IsInternal:      false,
				}, true
	...
	return sce.EnabledTransition[EventOriginIsALocationSceSynthInvokeInvPeerState, sce.HistoryID]{}, false
}
...
//line event_origin_is_a_location__sce_synth_invoke__inv_peer.scxml:3
func (p *EventOriginIsALocationSceSynthInvokeInvPeerPolicy) ExecuteTransitionContent(source EventOriginIsALocationSceSynthInvokeInvPeerState, transitionIndex int, engine *sce.Engine[EventOriginIsALocationSceSynthInvokeInvPeerState, EventOriginIsALocationSceSynthInvokeInvPeerEvent]) {
	p.ensureScriptEngine()
	switch source {
	case EventOriginIsALocationSceSynthInvokeInvPeerStateEmit:
