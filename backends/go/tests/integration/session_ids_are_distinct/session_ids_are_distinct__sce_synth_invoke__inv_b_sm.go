...
// SessionIdsAreDistinctSceSynthInvokeInvBStateFromName is the read half of the pair above — a state
...
// age together.
func SessionIdsAreDistinctSceSynthInvokeInvBStateFromName(name string) (SessionIdsAreDistinctSceSynthInvokeInvBState, bool) {
	switch name {
	case "emit":
		return SessionIdsAreDistinctSceSynthInvokeInvBStateEmit, true
	}
	var zero SessionIdsAreDistinctSceSynthInvokeInvBState
	return zero, false
}

// SessionIdsAreDistinctSceSynthInvokeInvBAllStates is every state this document declares, in the
...
var SessionIdsAreDistinctSceSynthInvokeInvBAllStates = []SessionIdsAreDistinctSceSynthInvokeInvBState{
...
// sce.PayloadReading.
func (p *SessionIdsAreDistinctSceSynthInvokeInvBPolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *SessionIdsAreDistinctSceSynthInvokeInvBPolicy) SetParamValueInScriptEngine(name string, value interface{}) {
...
func (p *SessionIdsAreDistinctSceSynthInvokeInvBPolicy) GetStateFromName(name string) (SessionIdsAreDistinctSceSynthInvokeInvBState, bool) {
	return SessionIdsAreDistinctSceSynthInvokeInvBStateFromName(name)
}
...
func (p *SessionIdsAreDistinctSceSynthInvokeInvBPolicy) LiftTypedPayload(event SessionIdsAreDistinctSceSynthInvokeInvBEvent, meta *sce.EventMetadata) error {
