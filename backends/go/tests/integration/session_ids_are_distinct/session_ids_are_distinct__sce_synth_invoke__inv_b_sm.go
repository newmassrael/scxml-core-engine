...
func (p *SessionIdsAreDistinctSceSynthInvokeInvBPolicy) ExecuteEntryActions(state SessionIdsAreDistinctSceSynthInvokeInvBState, engine *sce.Engine[SessionIdsAreDistinctSceSynthInvokeInvBState, SessionIdsAreDistinctSceSynthInvokeInvBEvent]) {
	p.ensureScriptEngine()
	switch state {
	case SessionIdsAreDistinctSceSynthInvokeInvBStateEmit:
