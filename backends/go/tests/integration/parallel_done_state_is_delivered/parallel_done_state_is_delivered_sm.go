...
func (p *ParallelDoneStateIsDeliveredPolicy) ExecuteEntryActions(state ParallelDoneStateIsDeliveredState, engine *sce.Engine[ParallelDoneStateIsDeliveredState, ParallelDoneStateIsDeliveredEvent]) {
