...
func (p *DonedataLateCompletionPolicy) ExecuteEntryActions(state DonedataLateCompletionState, engine *sce.Engine[DonedataLateCompletionState, DonedataLateCompletionEvent]) {
	p.ensureScriptEngine()
	switch state {
	case DonedataLateCompletionStatePhase:
