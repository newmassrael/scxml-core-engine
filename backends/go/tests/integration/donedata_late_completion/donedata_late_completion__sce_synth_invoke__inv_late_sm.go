...
// DonedataLateCompletionSceSynthInvokeInvLateStateFromName is the read half of the pair above — a state
...
// age together.
func DonedataLateCompletionSceSynthInvokeInvLateStateFromName(name string) (DonedataLateCompletionSceSynthInvokeInvLateState, bool) {
	switch name {
	case "settled":
		return DonedataLateCompletionSceSynthInvokeInvLateStateSettled, true
	case "waiting":
		return DonedataLateCompletionSceSynthInvokeInvLateStateWaiting, true
	}
	var zero DonedataLateCompletionSceSynthInvokeInvLateState
	return zero, false
}

// DonedataLateCompletionSceSynthInvokeInvLateAllStates is every state this document declares, in the
...
var DonedataLateCompletionSceSynthInvokeInvLateAllStates = []DonedataLateCompletionSceSynthInvokeInvLateState{
	DonedataLateCompletionSceSynthInvokeInvLateStateSettled,
...
// sce.PayloadReading.
func (p *DonedataLateCompletionSceSynthInvokeInvLatePolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *DonedataLateCompletionSceSynthInvokeInvLatePolicy) SetParamValueInScriptEngine(name string, value interface{}) {
...
func (p *DonedataLateCompletionSceSynthInvokeInvLatePolicy) GetStateFromName(name string) (DonedataLateCompletionSceSynthInvokeInvLateState, bool) {
	return DonedataLateCompletionSceSynthInvokeInvLateStateFromName(name)
}
...
func (p *DonedataLateCompletionSceSynthInvokeInvLatePolicy) NeedsEventScheduler() bool {
	return false
}
...
func (p *DonedataLateCompletionSceSynthInvokeInvLatePolicy) LiftTypedPayload(event DonedataLateCompletionSceSynthInvokeInvLateEvent, meta *sce.EventMetadata) error {
