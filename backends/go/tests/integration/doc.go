...
// `backends/go/tests/integration/<stem>/` is regenerated from a canonical
...
// `backends/rust/tests/src/integration/` and Kotlin's
// `com.sce.integration` package — its sibling
// `backends/go/tests/generated/` is reserved for the W3C IRP harness so
...
// hand-authored file under `backends/go/tests/integration/` and has no
// `SCE-GENERATED` header, mirroring `backends/rust/tests/src/integration/mod.rs`
// and `backends/kotlin/tests/src/main/kotlin/com/sce/integration/package-info.kt`.
package integration
