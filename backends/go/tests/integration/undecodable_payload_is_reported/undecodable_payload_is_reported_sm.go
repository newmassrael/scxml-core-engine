...
type UndecodablePayloadIsReportedPolicy struct {
	...
	lastTransitionSourceState UndecodablePayloadIsReportedState
...
func NewUndecodablePayloadIsReportedPolicy() UndecodablePayloadIsReportedPolicy {
	return UndecodablePayloadIsReportedPolicy{
		lastTransitionSourceState: UndecodablePayloadIsReportedStateWaiting,
	}
}
...
func (p *UndecodablePayloadIsReportedPolicy) GetParallelRegions(_ UndecodablePayloadIsReportedState) []UndecodablePayloadIsReportedState { return nil }

// IsDescendantOf returns true if desc is a descendant of anc (W3C SCXML 3.12).
func (p *UndecodablePayloadIsReportedPolicy) IsDescendantOf(desc, anc UndecodablePayloadIsReportedState) bool {
	current := desc
	for {
...
func (p *UndecodablePayloadIsReportedPolicy) GetInitialChildren(state UndecodablePayloadIsReportedState) []UndecodablePayloadIsReportedState {
	switch state {
	}
	return nil
}
...
func (p *UndecodablePayloadIsReportedPolicy) GetInitialOrHistoryChild(state UndecodablePayloadIsReportedState) UndecodablePayloadIsReportedState {
...
func (p *UndecodablePayloadIsReportedPolicy) ExecuteEntryActions(state UndecodablePayloadIsReportedState, engine *sce.Engine[UndecodablePayloadIsReportedState, UndecodablePayloadIsReportedEvent], pathChild *UndecodablePayloadIsReportedState) {
...
//line undecodable_payload_is_reported.scxml:56
func (p *UndecodablePayloadIsReportedPolicy) ExecuteExitActions(state UndecodablePayloadIsReportedState, engine *sce.Engine[UndecodablePayloadIsReportedState, UndecodablePayloadIsReportedEvent], preTransitionActive []UndecodablePayloadIsReportedState) {
	p.ensureScriptEngine()
	switch state {
	default:
		// No exit actions
...
//line undecodable_payload_is_reported.scxml:56
func (p *UndecodablePayloadIsReportedPolicy) ProcessTransition(currentState *UndecodablePayloadIsReportedState, event UndecodablePayloadIsReportedEvent, engine *sce.Engine[UndecodablePayloadIsReportedState, UndecodablePayloadIsReportedEvent]) bool {
...
//line undecodable_payload_is_reported.scxml:56
func (p *UndecodablePayloadIsReportedPolicy) tryTransitionInState(checkState UndecodablePayloadIsReportedState, event UndecodablePayloadIsReportedEvent, currentState *UndecodablePayloadIsReportedState, engine *sce.Engine[UndecodablePayloadIsReportedState, UndecodablePayloadIsReportedEvent]) bool {
	switch checkState {
	case UndecodablePayloadIsReportedStateWaiting:
		// W3C SCXML 5.9.3: Direct enum comparison
		if event == UndecodablePayloadIsReportedEventAnswer {
			if p.evaluateGuard(`_scxml_truthy(_event.data.done)`, engine) {
			*currentState = UndecodablePayloadIsReportedStateAccepted
			p.lastTransitionIsInternal = false
			p.lastTransitionIsTargetless = false
			p.lastTransitionSourceState = UndecodablePayloadIsReportedStateWaiting
...
//line undecodable_payload_is_reported.scxml:56
func (p *UndecodablePayloadIsReportedPolicy) ExecuteTransitionActions(engine *sce.Engine[UndecodablePayloadIsReportedState, UndecodablePayloadIsReportedEvent]) {
	p.ensureScriptEngine()
	...
	if source == UndecodablePayloadIsReportedStateWaiting && idx == 1 {
	...
	if source == UndecodablePayloadIsReportedStateWaiting && idx == 2 {
