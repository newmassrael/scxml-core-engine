...
// AutoforwardDequeuePointTarget is one token of a target list, as the document wrote
// it (W3C SCXML 3.13): a state, or a <history> the engine dereferences.
type AutoforwardDequeuePointTarget = sce.EntryTarget[AutoforwardDequeuePointState, sce.HistoryID]
...
// childStatesOfAutoforwardDequeuePoint is §scxml-D-getChildStates per state: its
// <state>, <parallel> and <final> children, in document order.
var childStatesOfAutoforwardDequeuePoint = [3][]AutoforwardDequeuePointState{
}

// initialTargetsOfAutoforwardDequeuePoint is each compound state's initial transition
// target, as written (§scxml-3.3).
var initialTargetsOfAutoforwardDequeuePoint = [3][]AutoforwardDequeuePointTarget{
}

// documentInitialTargetsOfAutoforwardDequeuePoint is the target of the document's own
// initial transition, as written (§scxml-3.2).
var documentInitialTargetsOfAutoforwardDequeuePoint = []AutoforwardDequeuePointTarget{sce.StateTarget[AutoforwardDequeuePointState, sce.HistoryID](AutoforwardDequeuePointStatePhase)}

// transitionTargetsOfAutoforwardDequeuePoint is each transition's target list, as
...
var transitionTargetsOfAutoforwardDequeuePoint = [3][][]AutoforwardDequeuePointTarget{
	AutoforwardDequeuePointStatePhase: {
		2: {sce.StateTarget[AutoforwardDequeuePointState, sce.HistoryID](AutoforwardDequeuePointStateFail)},
		3: {sce.StateTarget[AutoforwardDequeuePointState, sce.HistoryID](AutoforwardDequeuePointStatePass)},
	},
}
...
func (p *AutoforwardDequeuePointPolicy) IsCompoundState(state AutoforwardDequeuePointState) bool {
	return len(initialTargetsOfAutoforwardDequeuePoint[state]) > 0
}
...
func (p *AutoforwardDequeuePointPolicy) GetChildStates(state AutoforwardDequeuePointState) []AutoforwardDequeuePointState {
	return childStatesOfAutoforwardDequeuePoint[state]
}
...
// (W3C SCXML 3.3).
func (p *AutoforwardDequeuePointPolicy) GetInitialTargets(state AutoforwardDequeuePointState) []AutoforwardDequeuePointTarget {
	return initialTargetsOfAutoforwardDequeuePoint[state]
}

// GetDocumentInitialTargets returns the target of the document's own initial
// transition, as written (W3C SCXML 3.2).
func (p *AutoforwardDequeuePointPolicy) GetDocumentInitialTargets() []AutoforwardDequeuePointTarget {
	return documentInitialTargetsOfAutoforwardDequeuePoint
}
...
// one.
func (p *AutoforwardDequeuePointPolicy) GetHistoryParent(history sce.HistoryID) AutoforwardDequeuePointState {
	panic(fmt.Sprintf("AutoforwardDequeuePointPolicy declares no <history>; asked for %d", history))
}
func (p *AutoforwardDequeuePointPolicy) GetHistoryDefaultTargets(history sce.HistoryID) []AutoforwardDequeuePointTarget {
	panic(fmt.Sprintf("AutoforwardDequeuePointPolicy declares no <history>; asked for %d", history))
}
func (p *AutoforwardDequeuePointPolicy) HistoryValue(_ sce.HistoryID) ([]AutoforwardDequeuePointState, bool) {
	return nil, false
}
...
func (p *AutoforwardDequeuePointPolicy) NeedsEventScheduler() bool {
	return true
}
...
func (p *AutoforwardDequeuePointPolicy) LiftTypedPayload(event AutoforwardDequeuePointEvent, meta *sce.EventMetadata) error {
...
func (p *AutoforwardDequeuePointPolicy) ExecuteEntryActions(state AutoforwardDequeuePointState, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent], isDefaultEntry bool) {
	switch state {
	case AutoforwardDequeuePointStatePhase:
...
//line autoforward_dequeue_point.scxml:67
func (p *AutoforwardDequeuePointPolicy) ExecuteHistoryDefaultContent(history sce.HistoryID, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent]) {
...
//line autoforward_dequeue_point.scxml:67
func (p *AutoforwardDequeuePointPolicy) ExecuteExitActions(state AutoforwardDequeuePointState, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent], configurationBeforeExit []AutoforwardDequeuePointState) {
...
//line autoforward_dequeue_point.scxml:67
func (p *AutoforwardDequeuePointPolicy) BindCurrentEvent(event AutoforwardDequeuePointEvent, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent]) {
...
//line autoforward_dequeue_point.scxml:67
func (p *AutoforwardDequeuePointPolicy) FirstEnabledTransition(state AutoforwardDequeuePointState, event AutoforwardDequeuePointEvent, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent]) (sce.EnabledTransition[AutoforwardDequeuePointState, sce.HistoryID], bool) {
	switch state {
	case AutoforwardDequeuePointStatePhase:
		if event == AutoforwardDequeuePointEventReady {
			{
				return sce.EnabledTransition[AutoforwardDequeuePointState, sce.HistoryID]{
					Source:          state,
					TransitionIndex: 0,
					HasActions:      true,
					IsInternal:      false,
		...
		if event == AutoforwardDequeuePointEventSawSecondEarly {
			{
				return sce.EnabledTransition[AutoforwardDequeuePointState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfAutoforwardDequeuePoint[state][2],
					TransitionIndex: 2,
					HasActions:      false,
					IsInternal:      false,
				}, true
		...
		if event == AutoforwardDequeuePointEventSawMarkFirst {
			{
				return sce.EnabledTransition[AutoforwardDequeuePointState, sce.HistoryID]{
					Source:          state,
					Targets:         transitionTargetsOfAutoforwardDequeuePoint[state][3],
					TransitionIndex: 3,
					HasActions:      false,
					IsInternal:      false,
				}, true
	...
	return sce.EnabledTransition[AutoforwardDequeuePointState, sce.HistoryID]{}, false
}
...
//line autoforward_dequeue_point.scxml:67
func (p *AutoforwardDequeuePointPolicy) ExecuteTransitionContent(source AutoforwardDequeuePointState, transitionIndex int, engine *sce.Engine[AutoforwardDequeuePointState, AutoforwardDequeuePointEvent]) {
	switch source {
	case AutoforwardDequeuePointStatePhase:
