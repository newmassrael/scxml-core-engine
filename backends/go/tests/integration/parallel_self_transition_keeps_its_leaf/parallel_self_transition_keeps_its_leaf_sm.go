...
func (p *ParallelSelfTransitionKeepsItsLeafPolicy) setCurrentEvent(name string) {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *ParallelSelfTransitionKeepsItsLeafPolicy) ExecuteEntryActions(state ParallelSelfTransitionKeepsItsLeafState, engine *sce.Engine[ParallelSelfTransitionKeepsItsLeafState, ParallelSelfTransitionKeepsItsLeafEvent]) {
	p.ensureScriptEngine()
