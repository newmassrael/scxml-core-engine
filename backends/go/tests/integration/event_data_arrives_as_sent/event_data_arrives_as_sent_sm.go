...
// sce.PayloadReading.
func (p *EventDataArrivesAsSentPolicy) setCurrentEvent(name string) sce.PayloadReading {
	p.ensureScriptEngine()
	engine := p.ScriptEngine
...
func (p *EventDataArrivesAsSentPolicy) SetParamValueInScriptEngine(name string, value interface{}) {
...
func (p *EventDataArrivesAsSentPolicy) LiftTypedPayload(event EventDataArrivesAsSentEvent, meta *sce.EventMetadata) error {
