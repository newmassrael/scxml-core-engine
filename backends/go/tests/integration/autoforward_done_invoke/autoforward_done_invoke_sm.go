...
type AutoforwardDoneInvokePolicy struct {
	...
	lastTransitionSourceState AutoforwardDoneInvokeState
...
func NewAutoforwardDoneInvokePolicy() AutoforwardDoneInvokePolicy {
	return AutoforwardDoneInvokePolicy{
		lastTransitionSourceState: AutoforwardDoneInvokeStatePhase,
...
func (p *AutoforwardDoneInvokePolicy) GetParallelRegions(_ AutoforwardDoneInvokeState) []AutoforwardDoneInvokeState { return nil }

// IsDescendantOf returns true if desc is a descendant of anc (W3C SCXML 3.12).
func (p *AutoforwardDoneInvokePolicy) IsDescendantOf(desc, anc AutoforwardDoneInvokeState) bool {
	current := desc
	for {
...
func (p *AutoforwardDoneInvokePolicy) GetInitialChildren(state AutoforwardDoneInvokeState) []AutoforwardDoneInvokeState {
	switch state {
	}
	return nil
}
...
func (p *AutoforwardDoneInvokePolicy) GetInitialOrHistoryChild(state AutoforwardDoneInvokeState) AutoforwardDoneInvokeState {
...
func (p *AutoforwardDoneInvokePolicy) ExecuteEntryActions(state AutoforwardDoneInvokeState, engine *sce.Engine[AutoforwardDoneInvokeState, AutoforwardDoneInvokeEvent], pathChild *AutoforwardDoneInvokeState) {
...
//line autoforward_done_invoke.scxml:55
func (p *AutoforwardDoneInvokePolicy) ExecuteExitActions(state AutoforwardDoneInvokeState, engine *sce.Engine[AutoforwardDoneInvokeState, AutoforwardDoneInvokeEvent], preTransitionActive []AutoforwardDoneInvokeState) {
...
//line autoforward_done_invoke.scxml:55
func (p *AutoforwardDoneInvokePolicy) ProcessTransition(currentState *AutoforwardDoneInvokeState, event AutoforwardDoneInvokeEvent, engine *sce.Engine[AutoforwardDoneInvokeState, AutoforwardDoneInvokeEvent]) bool {
...
//line autoforward_done_invoke.scxml:55
func (p *AutoforwardDoneInvokePolicy) tryTransitionInState(checkState AutoforwardDoneInvokeState, event AutoforwardDoneInvokeEvent, currentState *AutoforwardDoneInvokeState, engine *sce.Engine[AutoforwardDoneInvokeState, AutoforwardDoneInvokeEvent]) bool {
	switch checkState {
	case AutoforwardDoneInvokeStatePhase:
		...
		if event == AutoforwardDoneInvokeEventDoneInvokeInvShort {
			...
			p.lastTransitionSourceState = AutoforwardDoneInvokeStatePhase
		...
		if event == AutoforwardDoneInvokeEventSawPlatform {
			*currentState = AutoforwardDoneInvokeStatePass
			p.lastTransitionIsInternal = false
		...
		if event == AutoforwardDoneInvokeEventSawProbeOnly {
			*currentState = AutoforwardDoneInvokeStateFail
			p.lastTransitionIsInternal = false
			p.lastTransitionIsTargetless = false
			p.lastTransitionSourceState = AutoforwardDoneInvokeStatePhase
...
//line autoforward_done_invoke.scxml:55
func (p *AutoforwardDoneInvokePolicy) ExecuteTransitionActions(engine *sce.Engine[AutoforwardDoneInvokeState, AutoforwardDoneInvokeEvent]) {
