...
# `backends/go/forge-runtime/` (that's where go.mod lives), and every
...
GO_MOD_FILE="$REPO_ROOT/backends/go/forge-runtime/go.mod"
...
(cd "$REPO_ROOT/backends/go/forge-runtime" && go build ./conformance/...)
