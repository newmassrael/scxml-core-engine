...
// bare-external dispatch — the same send_type carve-out test348/495 cover; the receiving transition matches event1
...
int main(void) {
    ...
    int rc = test200_ended_in(&sm, TEST200_STATE_PASS) ? 0 : 1;
    if (rc != 0) {
