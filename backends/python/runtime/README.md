...
of `backends/go/runtime`, `backends/rust/runtime`, and the Kotlin runtime: `sce-codegen
...
|---|---|---|
| `sce` (under `backends/python/bindings/`) | **Interpreter** | pybind11 → C++ Interpreter parses SCXML at runtime |
